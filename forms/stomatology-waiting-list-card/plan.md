# Plan: Stomatology Waiting List Card
...
months later. The Stomatology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form stomatology-waiting-list-card`.
