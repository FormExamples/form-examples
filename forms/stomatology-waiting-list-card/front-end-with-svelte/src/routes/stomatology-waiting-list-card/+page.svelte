...
<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		...
		<p class="mt-4 text-base leading-relaxed text-base-content/70">
			A practitioner-completed administrative card that places a patient on a stomatology waiting list and
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/stomatology-waiting-list-card/{plural}/new"
		...
		<a
			href="/stomatology-waiting-list-card/{plural}"
