# Tasks: Stomatology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/stomatology-waiting-list-card/`.
...
- [x] `cargo loco new stomatology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form stomatology-waiting-list-card` exits cleanly.
