# Stomatology Waiting List Card — specification
...
stomatology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form stomatology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check stomatology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `stomatology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `stomatology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
