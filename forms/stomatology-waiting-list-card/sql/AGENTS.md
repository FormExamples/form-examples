# Stomatology Waiting List Card — PostgreSQL migrations
...
Child `stomatology_waiting_list_card_*` tables reference
`stomatology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
