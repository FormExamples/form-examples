# stomatology-waiting-list-card — sql
...
- `stomatology_waiting_list_card` — top-level waiting list card.
- `stomatology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `stomatology_waiting_list_card_grade` — computed grading result.
- `stomatology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `stomatology_waiting_list_card_grade_flag` — safety / operational flags fired
