//! Who Counter Referral Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Counter Referral Form** medical form, built on the
...
//!
//! ```
//! use who_counter_referral_form_loco_crate::engine::types::AssessmentData;
//!
