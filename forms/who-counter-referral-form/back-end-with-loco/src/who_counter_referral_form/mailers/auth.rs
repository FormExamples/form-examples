...
static welcome: Dir<'_> = include_dir!("src/who_counter_referral_form/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/who_counter_referral_form/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/who_counter_referral_form/mailers/auth/magic_link");
