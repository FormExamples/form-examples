# WHO Counter-Referral Form — specification
...
- `bin/test-form who-counter-referral-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-counter-referral-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-counter-referral-form.front-end-form-with-html.v1` (HTML)
  - `who-counter-referral-form.front-end-form-with-svelte.v1` (SvelteKit)
