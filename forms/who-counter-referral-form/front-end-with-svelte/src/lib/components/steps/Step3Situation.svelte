...
>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Episode flags</h3>
	<p class="mb-3 text-xs text-base-content/60">Tick any that apply during this referral episode.</p>
