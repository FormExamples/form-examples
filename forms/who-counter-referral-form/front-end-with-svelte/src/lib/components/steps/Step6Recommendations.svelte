...
>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Contact for follow-up questions</h3>
	<TextInput
		label="Contact name"
		name="contactName"
		bind:value={r.contactName}
		required
	/>
	<TextInput
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Status flags</h3>
	<p class="mb-3 text-xs text-base-content/60">Tick any that apply to this patient.</p>
	<Checkbox
		label="Cognitive impairment"
		name="cognitiveImpairment"
		bind:checked={r.statusFlags.cognitiveImpairment}
	/>
	<Checkbox
		label="Carer-dependent"
		name="carerDependent"
		bind:checked={r.statusFlags.carerDependent}
	/>
	<Checkbox
		label="Spinal precautions"
		name="spinalPrecautions"
		bind:checked={r.statusFlags.spinalPrecautions}
	/>
	<Checkbox
		label="Weight-bearing restrictions"
		name="weightBearingRestrictions"
		bind:checked={r.statusFlags.weightBearingRestrictions}
	/>
	<Checkbox
