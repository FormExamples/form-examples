...
static welcome: Dir<'_> = include_dir!("src/framingham_risk_score_for_hard_coronary_heart_disease/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/framingham_risk_score_for_hard_coronary_heart_disease/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/framingham_risk_score_for_hard_coronary_heart_disease/mailers/auth/magic_link");
