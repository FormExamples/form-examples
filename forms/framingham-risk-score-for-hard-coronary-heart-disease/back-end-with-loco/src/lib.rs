//! Framingham Risk Score for Hard Coronary Heart Disease — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Framingham Risk Score for Hard Coronary Heart Disease** medical form, built on the
...
//!
//! ```
//! use framingham_risk_score_loco_crate::engine::types::AssessmentData;
//!
