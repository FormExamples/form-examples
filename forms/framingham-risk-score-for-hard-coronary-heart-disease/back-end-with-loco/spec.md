# Framingham Risk Score For Hard Coronary Heart Disease — back-end-with-loco spec

JSON API contract for the Framingham Risk Score For Hard Coronary Heart Disease back-end. This file is the living
