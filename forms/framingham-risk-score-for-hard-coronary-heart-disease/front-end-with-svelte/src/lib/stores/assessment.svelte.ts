...
function storageKey(id: string): string {
	return `framingham-risk-score-for-hard-coronary-heart-disease.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Framingham assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Framingham risk assessment, with localStorage
