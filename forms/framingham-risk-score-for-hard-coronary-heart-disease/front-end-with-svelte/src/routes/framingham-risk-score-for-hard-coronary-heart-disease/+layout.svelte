...
<svelte:head>
	<title>Framingham Risk Score for Hard Coronary Heart Disease</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/framingham-risk-score-for-hard-coronary-heart-disease/" class="text-lg font-bold text-base-content">Framingham Risk Score</a>
			<div class="flex items-center gap-1">
				<a href="/framingham-risk-score-for-hard-coronary-heart-disease/" class={navClass('/')}>Welcome</a>
				<a href="/framingham-risk-score-for-hard-coronary-heart-disease/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/framingham-risk-score-for-hard-coronary-heart-disease/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
