# Changelog — Framingham Risk Score for Hard Coronary Heart Disease
...
file only records changes scoped to the **Framingham Risk Score for Hard Coronary Heart Disease** form.
