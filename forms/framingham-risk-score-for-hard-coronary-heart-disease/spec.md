...
- LocalStorage key `framingham-risk-score-for-hard-coronary-heart-disease.front-end-form-with-html.v1` (HTML) and
  `framingham-risk-score-for-hard-coronary-heart-disease.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
