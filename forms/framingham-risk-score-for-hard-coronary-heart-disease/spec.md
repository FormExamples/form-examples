# Framingham Risk Score for Hard Coronary Heart Disease — specification
...
- `bin/test-form framingham-risk-score-for-hard-coronary-heart-disease` exits cleanly.
...
- `bin/lily-html-refactor --check framingham-risk-score-for-hard-coronary-heart-disease` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `framingham-risk-score-for-hard-coronary-heart-disease.front-end-form-with-html.v1` (HTML)
  - `framingham-risk-score-for-hard-coronary-heart-disease.front-end-form-with-svelte.v1` (SvelteKit)
