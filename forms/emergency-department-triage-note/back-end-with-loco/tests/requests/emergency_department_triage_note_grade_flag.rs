use emergency_department_triage_note::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_emergency_department_triage_note_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/emergency_department_triage_note_grade_flags").await;
