...
// with the SvelteKit front-end and the Loco back-end, mirroring the
 ...
 *           news2AnyParameterThree: boolean }} result
 * @returns {Flag[]}
 */
function detectFlaggedIssues(data, result) {
  ...
  if (missing.length > 0) {
    flags.push({
      ...
      suggestedAction:
        'Complete the missing bedside observation(s) and re-triage.'
    });
  }
