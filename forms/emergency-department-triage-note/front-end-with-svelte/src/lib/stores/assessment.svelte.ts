...
function storageKey(id: string): string {
	return `emergency-department-triage-note.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank ED triage assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the ED triage assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const v = assessment.data.vitals`) stay bound to live state.
	 */
