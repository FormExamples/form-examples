...
<svelte:head>
	<title>Emergency Department Triage Note</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/emergency-department-triage-note/" class="text-lg font-bold text-base-content">ED Triage</a>
			<div class="flex items-center gap-1">
				<a href="/emergency-department-triage-note/" class={navClass('/')}>Welcome</a>
				<a href="/emergency-department-triage-note/{plural}/new" class={navClass(`/${plural}/new`)}>New triage</a>
				<a href="/emergency-department-triage-note/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
