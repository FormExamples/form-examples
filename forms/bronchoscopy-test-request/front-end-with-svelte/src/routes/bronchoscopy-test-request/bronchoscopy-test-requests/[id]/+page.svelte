<script lang="ts">
	...
	import Step4SymptomsAndImaging from '$lib/components/steps/Step4SymptomsAndImaging.svelte';
	import Step5BleedingRisk from '$lib/components/steps/Step5BleedingRisk.svelte';
	import Step6ProceduralRisk from '$lib/components/steps/Step6ProceduralRisk.svelte';
	...
	function submit() {
		...
		goto(`/bronchoscopy-test-request/bronchoscopy-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New bronchoscopy request' : `Bronchoscopy request ${id}`}
	</h1>
