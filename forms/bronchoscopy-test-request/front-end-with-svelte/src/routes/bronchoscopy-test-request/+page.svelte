<script lang="ts">
	...
	// dashboard. The collection routes (`/bronchoscopy-test-requests` and
	// `/bronchoscopy-test-requests/new`) hold the actual functionality.
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/bronchoscopy-test-request/{plural}/new"
		...
		<a
			href="/bronchoscopy-test-request/{plural}"
		...
		<dl class="mt-4 space-y-4 text-sm">
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Capture why a patient needs airway endoscopy and how urgently, and produce a vetting report
					the bronchoscopy team can triage from.
				</dd>
			</div>
			<div>
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with the British Thoracic Society (BTS) guideline for diagnostic flexible
					bronchoscopy and NICE NG12 (suspected cancer recognition and referral; lung-cancer
					two-week-wait).
				</dd>
			</div>
		</dl>
