...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/bronchoscopy-test-request/"
                class="text-lg font-bold text-base-content"
                >Bronchoscopy Test Request</a
            >
            <div class="flex items-center gap-1">
                <a href="/bronchoscopy-test-request/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/bronchoscopy-test-request/bronchoscopy-test-requests/new"
                    class={navClass("/bronchoscopy-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/bronchoscopy-test-request/bronchoscopy-test-requests"
                    class={navClass("/bronchoscopy-test-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
