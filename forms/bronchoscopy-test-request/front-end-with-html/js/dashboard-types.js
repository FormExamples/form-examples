// Plain-JavaScript / JSDoc type definitions for the bronchoscopy vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (BTS 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Cancer-pathway urgency tier emitted by Axis B (NICE NG12).
 * @typedef {'routine' | 'urgent' | 'two-week-wait' | 'emergency'} TriageTier
 */

/**
 * Pre-procedure risk band emitted by Axis D.
 ...
 * @property {TriageTier} triageTier  - Axis B cancer-pathway urgency tier
...
// before they read `window.BronchoscopyTestRequestDashboard`.
