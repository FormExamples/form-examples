// Backend API client for the bronchoscopy vetting dashboard.
//
...
window.BronchoscopyTestRequestDashboard.fetchRequests = fetchRequests;
window.BronchoscopyTestRequestDashboard.API_BASE = API_BASE;
})();
