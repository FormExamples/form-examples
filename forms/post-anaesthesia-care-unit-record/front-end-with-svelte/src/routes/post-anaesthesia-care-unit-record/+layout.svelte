...
<svelte:head>
	<title>Post-Anaesthesia Care Unit (PACU) Record</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/post-anaesthesia-care-unit-record/" class="text-lg font-bold text-base-content">PACU Record</a>
			<div class="flex items-center gap-1">
				<a href="/post-anaesthesia-care-unit-record/" class={navClass('/')}>Welcome</a>
				<a href="/post-anaesthesia-care-unit-record/{plural}/new" class={navClass(`/${plural}/new`)}>New record</a>
				<a href="/post-anaesthesia-care-unit-record/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
