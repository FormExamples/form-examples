...
static welcome: Dir<'_> = include_dir!("src/post_anaesthesia_care_unit_record/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/post_anaesthesia_care_unit_record/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/post_anaesthesia_care_unit_record/mailers/auth/magic_link");
