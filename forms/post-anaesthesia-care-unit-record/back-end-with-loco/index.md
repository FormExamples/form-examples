...
Server-side Rust JSON API for the Post-Anaesthesia Care Unit (PACU) Record form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`post_anaesthesia_care_unit_record/`](post_anaesthesia_care_unit_record/) — one migration, SeaORM
