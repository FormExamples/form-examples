// Backend API client for the cardiac stress test vetting dashboard.
//
...
window.CardiacStressTestRequestDashboard.fetchRequests = fetchRequests;
window.CardiacStressTestRequestDashboard.API_BASE = API_BASE;
})();
