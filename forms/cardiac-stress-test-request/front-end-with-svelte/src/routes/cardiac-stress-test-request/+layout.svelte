...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/cardiac-stress-test-request/"
                class="text-lg font-bold text-base-content"
                >Cardiac Stress Test Request</a
            >
            <div class="flex items-center gap-1">
                <a href="/cardiac-stress-test-request/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/cardiac-stress-test-request/cardiac-stress-test-requests/new"
                    class={navClass("/cardiac-stress-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/cardiac-stress-test-request/cardiac-stress-test-requests"
                    class={navClass("/cardiac-stress-test-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
