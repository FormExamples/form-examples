...
- LocalStorage key `respirology-assessment.front-end-form-with-html.v1` (HTML) and
  `respirology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
