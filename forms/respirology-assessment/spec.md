# Respirology Assessment — specification
...
- `bin/test-form respirology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check respirology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `respirology-assessment.front-end-form-with-html.v1` (HTML)
  - `respirology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
