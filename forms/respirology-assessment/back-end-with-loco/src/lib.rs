//! Respirology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Respirology Assessment** medical form, built on the
...
//!
//! ```
//! use respirology_assessment_loco_crate::engine::types::AssessmentData;
//!
