// MRC Dyspnoea Scale grading rules.
//
// Each rule evaluates the AssessmentData and returns true if the condition
// is present. The MRC grade is determined by the highest-grade rule that
// fires; MRC 1 is the default when no rules fire (breathless only on
// strenuous exercise).
//
// Mirrors the SvelteKit `src/lib/engine/mrc-rules.ts`.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} MRCRule
 * @property {string} id
...
const mrcRules = [
  ...
  // ─── PULMONARY FUNCTION ─────────────────────────────────────
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.pulmonaryFunction.fev1 !== null &&
      d.pulmonaryFunction.fev1 >= 50 &&
      d.pulmonaryFunction.fev1 < 80
  },
  {
    id: 'PF-002',
    system: 'Pulmonary Function',
  ...
  },
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.pulmonaryFunction.fev1FvcRatio !== null && d.pulmonaryFunction.fev1FvcRatio < 70
  },
  {
    id: 'PF-005',
    system: 'Pulmonary Function',
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.respiratoryHistory.pneumonia === 'yes' &&
      d.respiratoryHistory.pneumoniaRecurrent === 'yes'
  },
