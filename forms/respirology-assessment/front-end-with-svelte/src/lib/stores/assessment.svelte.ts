...
function storageKey(id: string): string {
	return `respirology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank respirology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the respirology assessment, with localStorage
