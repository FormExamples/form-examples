...
<Fieldset legend="Patient identification">
	...
	<Field label="Body mass index (kg/m²)" inputId="bodyMassIndex">
		<NumberInput id="bodyMassIndex" label="Body mass index" min={10} max={80} step={0.1} bind:value={p.bodyMassIndex} />
	</Field>

	<label class="checkbox-field">
		<CheckboxInput id="interpreterRequired" label="Interpreter required" bind:checked={p.interpreterRequired} />
