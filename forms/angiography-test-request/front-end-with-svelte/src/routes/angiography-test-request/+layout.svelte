...
<svelte:head>
	<title>Angiography Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/angiography-test-request/" class="text-lg font-bold text-base-content">Angiography Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/angiography-test-request/" class={navClass('/')}>Welcome</a>
				<a
					href="/angiography-test-request/angiography-test-requests/new"
					class={navClass('/angiography-test-requests/new')}>New request</a
				>
				<a href="/angiography-test-request/angiography-test-requests" class={navClass('/angiography-test-requests')}
					>Dashboard</a
				>
