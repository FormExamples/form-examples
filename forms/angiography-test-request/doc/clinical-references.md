...
(indication × modality × body region). Representative variants:
...
*Asymptomatic Patient at Risk for Coronary Artery Disease* (2021 update).
<https://acsearch.acr.org/list>

## Contrast / radiation safety (ESUR, ACR–NKF, IR(ME)R)

| Condition | Band | Basis |
| --- | --- | --- |
| eGFR ≥ 60 | ok | Normal renal function |
| eGFR 30–59 + iodinated contrast | caution | Use low/iso-osmolar, lowest diagnostic dose, hydrate |
...
contrast and restarted after a 48-hour eGFR check. Sources:
...
| --- | --- | --- |
| Emergency | same hour / same day | active GI bleeding, suspected ruptured aneurysm, acute stroke (CTA), massive PE |
| Urgent | 24–72 h | symptomatic critical limb ischaemia, suspected PE, rapidly progressive symptoms |
| Routine | standard booking | elective stenosis / aneurysm surveillance, stable PAD work-up, pre-intervention planning |
