# Angiography Test Request — agent instructions

Vascular angiography request (referral). A clinician completes a single-page
wizard; the engine computes a **four-axis grading** (appropriateness, contrast /
radiation safety, request completeness, triage priority) plus safety flags, and
