// Backend API client for the vascular angiography vetting dashboard.
//
...
window.AngiographyTestRequestDashboard.fetchRequests = fetchRequests;
window.AngiographyTestRequestDashboard.API_BASE = API_BASE;
})();
