...
<svelte:head>
	<title>Hospital Dashboard Metrics</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hospital-dashboard-metrics/" class="text-lg font-bold text-base-content">Hospital Dashboard Metrics</a>
			<div class="flex items-center gap-1">
				<a href="/hospital-dashboard-metrics/" class={navClass('/')}>Welcome</a>
				<a
					href="/hospital-dashboard-metrics/hospital-dashboard-metrics-reports/new"
					class={navClass('/hospital-dashboard-metrics-reports/new')}>New reporting period</a
				>
				<a
					href="/hospital-dashboard-metrics/hospital-dashboard-metrics-reports"
					class={navClass('/hospital-dashboard-metrics-reports')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
