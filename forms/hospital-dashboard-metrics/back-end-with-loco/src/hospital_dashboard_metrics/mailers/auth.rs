...
static welcome: Dir<'_> = include_dir!("src/hospital_dashboard_metrics/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/hospital_dashboard_metrics/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/hospital_dashboard_metrics/mailers/auth/magic_link");
