import { SAMPLE_DASHBOARD_METRICS } from './data.js';

const API_BASE = '/api/hospital-dashboard-metrics';
const CACHE_KEY = 'hospital-dashboard-metrics-dashboard:cache:v1';
 ...
 */
export const fetchDashboardMetrics = function () {
  return fetch(API_BASE)
    ...
    .catch(function () {
      ...
      return { source: 'sample', rows: SAMPLE_DASHBOARD_METRICS };
    });
};

export { clearCache as clearDashboardMetricsCache };
