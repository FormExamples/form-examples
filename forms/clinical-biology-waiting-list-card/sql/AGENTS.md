# Clinical Biology Waiting List Card — PostgreSQL migrations
...
Child `clin_biology_waiting_list_card_*` tables reference
`clin_biology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
