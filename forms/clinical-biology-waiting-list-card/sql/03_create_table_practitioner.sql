-- Practitioner who places the patient on a clinical biology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a clinical biology waiting list card on behalf of the patient.';
