# Clinical Biology Waiting List Card — specification
...
clinical biology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/lily-html-refactor --check clinical-biology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `clinical-biology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `clinical-biology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
