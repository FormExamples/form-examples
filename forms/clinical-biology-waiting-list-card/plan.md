# Plan: Clinical Biology Waiting List Card
...
months later. The Clinical Biology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form clinical-biology-waiting-list-card`.
