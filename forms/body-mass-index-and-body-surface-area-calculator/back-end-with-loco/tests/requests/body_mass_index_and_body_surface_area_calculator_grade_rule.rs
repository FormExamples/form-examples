...
#[tokio::test]
#[serial]
async fn can_get_body_mass_index_and_body_surface_area_calculator_grade_rules() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/body_mass_index_and_body_surface_area_calculator_grade_rules").await;
