...
static welcome: Dir<'_> = include_dir!("src/body_mass_index_and_body_surface_area_calculator/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/body_mass_index_and_body_surface_area_calculator/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/body_mass_index_and_body_surface_area_calculator/mailers/auth/magic_link");
