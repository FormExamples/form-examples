...
Server-side Rust JSON API for the Body Mass Index and Body Surface Area Calculator form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`body_mass_index_and_body_surface_area_calculator/`](body_mass_index_and_body_surface_area_calculator/) — one migration, SeaORM
