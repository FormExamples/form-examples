...
function storageKey(id: string): string {
	return `body-mass-index-and-body-surface-area-calculator.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank BMI/BSA assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the BMI/BSA assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.height`) stay bound to live state.
	 */
