...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/body-mass-index-and-body-surface-area-calculator/"
                class="text-lg font-bold text-base-content">BMI and BSA</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/body-mass-index-and-body-surface-area-calculators/new",
                    )}>New calculation</a
                >
                <a
