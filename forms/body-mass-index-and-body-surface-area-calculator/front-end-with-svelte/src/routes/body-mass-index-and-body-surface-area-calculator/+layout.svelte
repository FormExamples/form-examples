...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/body-mass-index-and-body-surface-area-calculator/" class="text-lg font-bold text-base-content">BMI and BSA</a>
			<div class="flex items-center gap-1">
				<a href="/body-mass-index-and-body-surface-area-calculator/" class={navClass('/')}>Welcome</a>
				<a
				...
				>
				<a
					href="/body-mass-index-and-body-surface-area-calculator/body-mass-index-and-body-surface-area-calculators"
