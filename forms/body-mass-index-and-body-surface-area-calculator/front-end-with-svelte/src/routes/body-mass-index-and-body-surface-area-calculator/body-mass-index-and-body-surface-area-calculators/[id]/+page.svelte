<script lang="ts">
	...
	import Step3Height from '$lib/components/steps/Step3Height.svelte';
	import Step4Weight from '$lib/components/steps/Step4Weight.svelte';
	...
	function submit() {
		...
		assessment.result = calculateBmiBsa(assessment.data);
		goto(`/body-mass-index-and-body-surface-area-calculator/body-mass-index-and-body-surface-area-calculators/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New BMI and BSA calculation' : `BMI and BSA ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the five sections; the BMI, WHO category, and BSA are computed on submit.
	</p>
	...
	<Form label="BMI and BSA calculation" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3Height />
		<Step4Weight />
