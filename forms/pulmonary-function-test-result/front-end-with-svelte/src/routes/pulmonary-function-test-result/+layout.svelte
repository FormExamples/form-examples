...
<svelte:head>
	<title>Pulmonary Function Test Result</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/pulmonary-function-test-result/" class="text-lg font-bold text-base-content">Pulmonary Function Test Result</a>
			<div class="flex items-center gap-1">
				<a href="/pulmonary-function-test-result/" class={navClass('/')}>Welcome</a>
				<a href="/pulmonary-function-test-result/report" class={navClass('/report')}>New report</a>
				<a href="/pulmonary-function-test-result/reports" class={navClass('/reports')}>Reports</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
