<script lang="ts">
	...
	import Step2TestQuality from '#lib/components/steps/Step2TestQuality.svelte';
	import Step3MeasuredValues from '#lib/components/steps/Step3MeasuredValues.svelte';
	import Step4Interpretation from '#lib/components/steps/Step4Interpretation.svelte';
	import Step5Findings from '#lib/components/steps/Step5Findings.svelte';
	...
	function submit() {
		...
		goto('/pulmonary-function-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New lung-function report</h1>
	...
	<Form label="Pulmonary function test result" onsubmit={submit}>
