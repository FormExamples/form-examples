...
static welcome: Dir<'_> = include_dir!("src/pulmonary_function_test_result/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/pulmonary_function_test_result/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/pulmonary_function_test_result/mailers/auth/magic_link");
