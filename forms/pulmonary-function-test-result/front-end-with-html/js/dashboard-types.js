 ...
 * `forms/pulmonary-function-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {TestType} testType                            - performed test type
...
// namespace, `window.PulmonaryFunctionTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.PulmonaryFunctionTestResultDashboard`.
})();
