...
// Pulmonary Function Test Result grader. Faithful vanilla-JavaScript port of
// the SvelteKit engine module `src/lib/engine/grader.ts`.
//
// Pure four-axis interpretation engine for a pulmonary function test result:
...
//
// Invariant: a critical finding (severe / very-severe airflow obstruction or
// restriction) auto-escalates Axis D to critical-alert and raises the
 ...
 * @param {PulmonaryFunctionResult} result
