// Backend API client for the toxicology vetting dashboard.
//
...
window.ToxicologyTestRequestDashboard.fetchRequests = fetchRequests;
window.ToxicologyTestRequestDashboard.API_BASE = API_BASE;
})();
