# Toxicology Test Request — specification
...
- `bin/test-form toxicology-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check toxicology-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `toxicology-test-request.front-end-form-with-html.v1` (HTML)
  - `toxicology-test-request.front-end-form-with-svelte.v1` (SvelteKit)
