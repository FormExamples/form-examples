//! Ergonomic Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Ergonomic Assessment** medical form, built on the
...
//!
//! ```
//! use ergonomic_assessment_loco_crate::engine::types::AssessmentData;
//!
