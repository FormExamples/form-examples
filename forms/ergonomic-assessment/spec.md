# Ergonomic Assessment — specification
...
- `bin/test-form ergonomic-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check ergonomic-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `ergonomic-assessment.front-end-form-with-html.v1` (HTML)
  - `ergonomic-assessment.front-end-form-with-svelte.v1` (SvelteKit)
