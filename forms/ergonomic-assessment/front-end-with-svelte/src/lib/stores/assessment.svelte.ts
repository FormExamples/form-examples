...
function storageKey(id: string): string {
	return `ergonomic-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank ergonomic assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the ergonomic assessment, with localStorage
