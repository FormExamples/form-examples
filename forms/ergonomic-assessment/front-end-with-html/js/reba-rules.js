// REBA (Rapid Entire Body Assessment) scoring rules.
//
// Ported from the SvelteKit reference engine `src/lib/engine/reba-rules.ts`.
// Each rule evaluates assessment data and returns true if the condition
// is present. The REBA score is the sum of fired-rule scores, clamped to
// the 1-15 range.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {Object} RebaRule
 * @property {string} id
...
const rebaRules = [
  ...
  { id: 'MH-003', system: 'Manual Handling', description: 'Frequent lifting required', score: 2,
    evaluate: (d) =>
      d.manualHandling.liftingFrequency === 'frequent' ||
      d.manualHandling.liftingFrequency === 'constant' },
