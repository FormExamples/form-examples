# Tasks: Orthopaedics Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/orthopaedics-waiting-list-card/`.
...
- [x] `cargo loco new orthopaedics-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form orthopaedics-waiting-list-card` exits cleanly.
