-- Practitioner who places the patient on a orthopaedics waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a orthopaedics waiting list card on behalf of the patient.';
