# Orthopaedics Waiting List Card — PostgreSQL migrations
...
Child `orthopaedics_waiting_list_card_*` tables reference
`orthopaedics_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
