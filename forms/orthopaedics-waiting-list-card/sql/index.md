# orthopaedics-waiting-list-card — sql
...
- `orthopaedics_waiting_list_card` — top-level waiting list card.
- `orthopaedics_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `orthopaedics_waiting_list_card_grade` — computed grading result.
- `orthopaedics_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `orthopaedics_waiting_list_card_grade_flag` — safety / operational flags fired
