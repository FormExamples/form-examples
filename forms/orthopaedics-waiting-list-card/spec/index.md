# Orthopaedics Waiting List Card — specification
...
orthopaedics waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form orthopaedics-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check orthopaedics-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `orthopaedics-waiting-list-card.front-end-with-html.v1` (HTML)
  - `orthopaedics-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
