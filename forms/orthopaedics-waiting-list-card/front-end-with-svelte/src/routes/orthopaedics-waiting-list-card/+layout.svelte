...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/orthopaedics-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >Orthopaedics Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                <a href="/orthopaedics-waiting-list-card/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/orthopaedics-waiting-list-card/orthopaedics-waiting-list-cards/new"
                    class={navClass("/orthopaedics-waiting-list-cards/new")}
                    >New card</a
                >
                <a
                    href="/orthopaedics-waiting-list-card/orthopaedics-waiting-list-cards"
                    class={navClass("/orthopaedics-waiting-list-cards")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
