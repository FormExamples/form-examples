// Backend API client for the urinalysis vetting dashboard.
//
...
window.UrinalysisTestRequestDashboard.fetchRequests = fetchRequests;
window.UrinalysisTestRequestDashboard.API_BASE = API_BASE;
})();
