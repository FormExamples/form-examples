// Plain-JavaScript / JSDoc type definitions for the urinalysis vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (1-9 ordinal).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Preanalytical specimen-suitability band emitted by Axis B.
 ...
 * @property {string[]} tests         - Selected tests (camelCase or label keys)
 ...
 * @property {PreanalyticalBand} preanalyticalBand - Axis B specimen band
...
// before they read `window.UrinalysisTestRequestDashboard`.
