...
<svelte:head>
	<title>Urinalysis Test Request</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/urinalysis-test-request/" class="text-lg font-bold text-base-content">Urinalysis Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/urinalysis-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/urinalysis-test-request/urinalysis-test-requests/new" class={navClass('/urinalysis-test-requests/new')}>New request</a>
				<a href="/urinalysis-test-request/urinalysis-test-requests" class={navClass('/urinalysis-test-requests')}>Vetting dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
