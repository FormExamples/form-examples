<script lang="ts">
	...
	// dashboard. The collection routes (`/urinalysis-test-requests` and
	// `/urinalysis-test-requests/new`) hold the actual functionality.
	const plural = 'urinalysis-test-requests';
</script>

<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		<p class="text-sm font-semibold uppercase tracking-wide text-primary">Urinalysis Test Request</p>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/urinalysis-test-request/{plural}/new"
		...
		<a
			href="/urinalysis-test-request/{plural}"
		...
		<dl class="mt-4 space-y-4 text-sm">
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Capture which urine investigations to order and how urgently, and produce a vetting report
					the pathology / laboratory team can triage and accept from.
				</dd>
			</div>
			<div>
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with NICE NG109 (lower UTI), NICE NG12 (suspected cancer / haematuria), NICE NG203
					(CKD / ACR), and UK Standards for Microbiology Investigations (UK SMI) B41.
				</dd>
			</div>
		</dl>
	</section>
