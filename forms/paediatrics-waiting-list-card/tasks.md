# Tasks: Paediatrics Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/paediatrics-waiting-list-card/`.
...
- [x] `cargo loco new paediatrics-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form paediatrics-waiting-list-card` exits cleanly.
