# Plan: Paediatrics Waiting List Card
...
months later. The Paediatrics Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form paediatrics-waiting-list-card`.
