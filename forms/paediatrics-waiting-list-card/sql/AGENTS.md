# Paediatrics Waiting List Card — PostgreSQL migrations
...
Child `paediatrics_waiting_list_card_*` tables reference
`paediatrics_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
