# paediatrics-waiting-list-card — sql
...
- `paediatrics_waiting_list_card` — top-level waiting list card.
- `paediatrics_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `paediatrics_waiting_list_card_grade` — computed grading result.
- `paediatrics_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `paediatrics_waiting_list_card_grade_flag` — safety / operational flags fired
