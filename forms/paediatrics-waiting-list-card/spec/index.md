# Paediatrics Waiting List Card — specification
...
paediatrics waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form paediatrics-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check paediatrics-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `paediatrics-waiting-list-card.front-end-with-html.v1` (HTML)
  - `paediatrics-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
