//! Sports Medicine Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Sports Medicine Assessment** medical form, built on the
...
//!
//! ```
//! use sports_medicine_assessment_loco_crate::engine::types::AssessmentData;
//!
