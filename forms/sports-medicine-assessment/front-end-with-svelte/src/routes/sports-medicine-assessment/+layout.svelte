...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/sports-medicine-assessment/"
                class="text-lg font-bold text-base-content"
                >Sports Medicine Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/sports-medicine-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/sports-medicine-assessment/sports-medicine-assessments/new"
                    class={navClass("/sports-medicine-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/sports-medicine-assessment/sports-medicine-assessments"
                    class={navClass("/sports-medicine-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
