# Sports Medicine Assessment — specification
...
- `bin/test-form sports-medicine-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check sports-medicine-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `sports-medicine-assessment.front-end-form-with-html.v1` (HTML)
  - `sports-medicine-assessment.front-end-form-with-svelte.v1` (SvelteKit)
