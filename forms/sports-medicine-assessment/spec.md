...
- LocalStorage key `sports-medicine-assessment.front-end-form-with-html.v1` (HTML) and
  `sports-medicine-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
