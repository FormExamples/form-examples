...
Server-side Rust JSON API for the Newborn and Infant Physical Examination (NIPE) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`newborn_and_infant_physical_examination/`](newborn_and_infant_physical_examination/) — one migration, SeaORM
