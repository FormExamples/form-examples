...
<svelte:head>
	<title>Newborn and Infant Physical Examination (NIPE)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/newborn-and-infant-physical-examination/" class="text-lg font-bold text-base-content">NIPE</a>
			<div class="flex items-center gap-1">
				<a href="/newborn-and-infant-physical-examination/" class={navClass('/')}>Welcome</a>
				<a
					href="/newborn-and-infant-physical-examination/newborn-and-infant-physical-examinations/new"
					class={navClass('/newborn-and-infant-physical-examinations/new')}>New examination</a
				>
				<a
					href="/newborn-and-infant-physical-examination/newborn-and-infant-physical-examinations"
					class={navClass('/newborn-and-infant-physical-examinations')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
