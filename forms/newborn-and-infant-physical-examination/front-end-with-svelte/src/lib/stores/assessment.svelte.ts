...
function storageKey(id: string): string {
	return `newborn-and-infant-physical-examination.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank NIPE examination with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the NIPE examination, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.eyes`) stay bound to live state.
	 */
