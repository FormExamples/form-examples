...
- LocalStorage key `organ-donation-assessment.front-end-form-with-html.v1` (HTML) and
  `organ-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
