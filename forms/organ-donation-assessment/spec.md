# Organ Donation Assessment — specification
...
- `bin/test-form organ-donation-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check organ-donation-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `organ-donation-assessment.front-end-form-with-html.v1` (HTML)
  - `organ-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit)
