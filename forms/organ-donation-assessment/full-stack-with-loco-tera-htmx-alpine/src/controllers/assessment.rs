...
use crate::engine::{donation_grader, types::AssessmentData, utils};
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "immunological_assessment" => "immunologicalAssessment",
        "surgical_assessment" => "surgicalAssessment",
        "psychological_assessment" => "psychologicalAssessment",
        "ethical_legal_requirements" => "ethicalLegalRequirements",
        "eligibility_allocation" => "eligibilityAllocation",
        other => other,
    }
}
...
async fn show_report(
    ...
    let grade = donation_grader::grade(&assessment_data);
    ...
    context.insert("eligibility_class", &utils::eligibility_class(&grade.eligibility));
    context.insert("risk_level", &grade.risk_level);
    context.insert("risk_level_label", &utils::risk_level_label(&grade.risk_level));
    context.insert("risk_level_class", &utils::risk_level_class(&grade.risk_level));
    context.insert("suggested_eligibility", &grade.suggested_eligibility);
    context.insert(
        "donor_type_label",
        &utils::donor_type_label(&assessment_data.donor_type_registration.donor_type),
    );
