...
function storageKey(id: string): string {
	return `organ-donation-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank organ donation assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the organ donation assessment, with localStorage
