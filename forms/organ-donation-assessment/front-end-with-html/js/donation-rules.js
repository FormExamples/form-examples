...
//
// Absolute contraindications (typically Grade 4):
//   - HIV positive
//   - Active malignancy (non-CNS)
//   - Uncontrolled sepsis
//   - Severe organ failure incompatible with donation
//   - CJD risk
//   - ABO incompatibility
//   - Positive crossmatch with donor-specific antibodies
//   - Coercion concerns or non-voluntary decision (living)
//   - Lack of mental capacity (living)
//
// Relative / expanded-criteria findings (Grade 2-3):
//   - Advanced age, hypertension, diabetes
//   - Modest renal/liver dysfunction
//   - Recent infection or travel exposure
//   - HBcAb positive (with negative HBsAg) — risk of occult HBV
//   - Difficult airway, ASA III
...
const donationRules = [
  ...
  },
  {
    ...
    evaluate: (d) => {
      const age = calculateAge(d.demographics.dateOfBirth);
      return d.donorTypeRegistration.donorType === 'living'
        && age !== null && age < 18;
    }
  },
  {
  ...
  // ─── MEDICAL HISTORY ───────────────────────────────────────
  {
    ...
    grade: 4,
    evaluate: (d) =>
      d.medicalHistory.hasMalignancy === 'yes' &&
      d.medicalHistory.hasCnsMalignancy !== 'yes'
  },
  {
    id: 'MH-002',
    category: 'Medical History',
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.organFunction.egfr !== null && d.organFunction.egfr < 60
  },
  {
    id: 'OF-003',
    category: 'Organ Function',
    ...
    grade: 2,
    evaluate: (d) =>
      d.organFunction.egfr !== null &&
      d.organFunction.egfr >= 60 && d.organFunction.egfr < 90
  },
  {
    id: 'OF-004',
    category: 'Organ Function',
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.organFunction.ejectionFraction !== null &&
      d.organFunction.ejectionFraction < 50
  },
  {
    id: 'OF-006',
    category: 'Organ Function',
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.organFunction.pao2Fio2Ratio !== null &&
      d.organFunction.pao2Fio2Ratio < 300
  },
  {
    id: 'OF-008',
    category: 'Organ Function',
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.immunologicalAssessment.pra !== null &&
      d.immunologicalAssessment.pra > 50
  },
  ...
  },
  {
    ...
    grade: 4,
    evaluate: (d) =>
      d.surgicalAssessment.asaGrade === 'IV' ||
      d.surgicalAssessment.asaGrade === 'V'
  },
  {
    id: 'SU-005',
    category: 'Surgical',
  ...
  },
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.surgicalAssessment.mallampatiScore === 'III' ||
      d.surgicalAssessment.mallampatiScore === 'IV'
  },
