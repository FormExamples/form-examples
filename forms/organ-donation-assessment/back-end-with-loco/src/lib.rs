//! Organ Donation Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Organ Donation Assessment** medical form, built on the
...
//!
//! ```
//! use organ_donation_assessment_loco_crate::engine::types::AssessmentData;
//!
