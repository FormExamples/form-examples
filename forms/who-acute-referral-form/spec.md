...
- LocalStorage key `who-acute-referral-form.front-end-form-with-html.v1` (HTML) and
  `who-acute-referral-form.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
