# WHO Acute Referral Form — specification
...
- `bin/test-form who-acute-referral-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-acute-referral-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-acute-referral-form.front-end-form-with-html.v1` (HTML)
  - `who-acute-referral-form.front-end-form-with-svelte.v1` (SvelteKit)
