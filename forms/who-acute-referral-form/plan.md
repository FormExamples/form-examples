...
SvelteKit patient front-end implemented. WHO standardized acute referral (SBAR) — 8-step wizard, two-party completion (initiating facility steps 1–7, receiving facility step 8), 28 validation rules, clinical flags for SpO2<90, GCS≤8, hypotension, hypertension, infectious-disease precaution.
