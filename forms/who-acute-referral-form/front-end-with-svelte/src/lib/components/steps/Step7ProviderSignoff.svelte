...
>
	<TextInput
		label="Provider name"
		name="initiatingProviderName"
		bind:value={s.providerName}
		required
	/>
	<TextInput
		label="Signature"
		name="initiatingProviderSignature"
	...
	<TextInput
		label="Date"
		name="initiatingProviderSignatureDate"
		type="date"
		bind:value={s.signatureDate}
		required
	/>

	<div class="mt-4 rounded-lg border border-info bg-info/10 p-3 text-xs text-info">
