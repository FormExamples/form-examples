//! Who Acute Referral Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Acute Referral Form** medical form, built on the
...
//!
//! ```
//! use who_acute_referral_form_loco_crate::engine::types::AssessmentData;
//!
