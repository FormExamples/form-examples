# Seasonal Affective Disorder Assessment — specification
...
- `bin/test-form seasonal-affective-disorder-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check seasonal-affective-disorder-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `seasonal-affective-disorder-assessment.front-end-form-with-html.v1` (HTML)
  - `seasonal-affective-disorder-assessment.front-end-form-with-svelte.v1` (SvelteKit)
