...
- LocalStorage key `seasonal-affective-disorder-assessment.front-end-form-with-html.v1` (HTML) and
  `seasonal-affective-disorder-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
