//! Seasonal Affective Disorder Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Seasonal Affective Disorder Assessment** medical form, built on the
...
//!
//! ```
//! use seasonal_affective_disorder_assessment_loco_crate::engine::types::AssessmentData;
//!
