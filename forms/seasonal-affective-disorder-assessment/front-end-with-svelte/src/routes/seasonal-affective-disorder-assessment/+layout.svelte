...
<svelte:head>
	<title>Seasonal Affective Disorder Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/seasonal-affective-disorder-assessment/" class="text-lg font-bold text-base-content">Seasonal Affective Disorder Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/seasonal-affective-disorder-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/seasonal-affective-disorder-assessment/seasonal-affective-disorder-assessments/new"
					class={navClass('/seasonal-affective-disorder-assessments/new')}>New assessment</a
				>
				<a
					href="/seasonal-affective-disorder-assessment/seasonal-affective-disorder-assessments"
					class={navClass('/seasonal-affective-disorder-assessments')}>Dashboard</a
				>
