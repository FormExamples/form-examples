...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/seasonal-affective-disorder-assessment/"
                class="text-lg font-bold text-base-content"
                >Seasonal Affective Disorder Assessment</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/seasonal-affective-disorder-assessments/new",
                    )}>New assessment</a
                >
                <a
                    href="/seasonal-affective-disorder-assessment/seasonal-affective-disorder-assessments"
                    class={navClass("/seasonal-affective-disorder-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
