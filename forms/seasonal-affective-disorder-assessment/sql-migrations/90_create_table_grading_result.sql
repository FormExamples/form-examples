...
COMMENT ON COLUMN grade.gss_total IS
    'SPAQ Global Seasonality Score total (0-24).';
COMMENT ON COLUMN grade.gss_category IS
    'GSS category: no-sad (0-7), subsyndromal (8-10), sad-likely (11-24), or empty.';
COMMENT ON COLUMN grade.phq9_total IS
...
COMMENT ON COLUMN grade.combined_severity IS
