...
static welcome: Dir<'_> = include_dir!("src/paediatric_early_warning_score/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/paediatric_early_warning_score/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/paediatric_early_warning_score/mailers/auth/magic_link");
