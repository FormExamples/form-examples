...
Server-side Rust JSON API for the Paediatric Early Warning Score (PEWS) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`paediatric_early_warning_score/`](paediatric_early_warning_score/) — one migration, SeaORM
