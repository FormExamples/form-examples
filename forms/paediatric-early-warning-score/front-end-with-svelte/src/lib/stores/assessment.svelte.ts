...
function storageKey(id: string): string {
	return `paediatric-early-warning-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank PEWS assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the PEWS assessment, with localStorage
