...
<svelte:head>
	<title>Paediatric Early Warning Score (PEWS)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/paediatric-early-warning-score/" class="text-lg font-bold text-base-content">PEWS</a>
			<div class="flex items-center gap-1">
				<a href="/paediatric-early-warning-score/" class={navClass('/')}>Welcome</a>
				<a href="/paediatric-early-warning-score/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/paediatric-early-warning-score/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
