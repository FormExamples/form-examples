...
<svelte:head>
	<title>First Aid Training Checklist</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/first-aid-training-checklist/" class="text-lg font-bold text-base-content">First Aid Training Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/first-aid-training-checklist/" class={navClass('/')}>Welcome</a>
				<a href="/first-aid-training-checklist/first-aid-training-checklists/new" class={navClass('/first-aid-training-checklists/new')}>New assessment</a>
				<a href="/first-aid-training-checklist/first-aid-training-checklists" class={navClass('/first-aid-training-checklists')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
