//! First Aid Training Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **First Aid Training Checklist** medical form, built on the
...
//!
//! ```
//! use first_aid_training_checklist_loco_crate::engine::types::AssessmentData;
//!
