...
- LocalStorage key `first-aid-training-checklist.front-end-form-with-html.v1` (HTML) and
  `first-aid-training-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
