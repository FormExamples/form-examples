# First Aid Training Checklist — specification
...
- `bin/test-form first-aid-training-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check first-aid-training-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `first-aid-training-checklist.front-end-form-with-html.v1` (HTML)
  - `first-aid-training-checklist.front-end-form-with-svelte.v1` (SvelteKit)
