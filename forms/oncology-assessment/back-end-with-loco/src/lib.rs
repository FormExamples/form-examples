//! Oncology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Oncology Assessment** medical form, built on the
...
//!
//! ```
//! use oncology_assessment_loco_crate::engine::types::AssessmentData;
//!
