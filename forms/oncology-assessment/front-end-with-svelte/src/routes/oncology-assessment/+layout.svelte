...
<svelte:head>
	<title>Oncology Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/oncology-assessment/" class="text-lg font-bold text-base-content">Oncology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/oncology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/oncology-assessment/oncology-assessments/new" class={navClass('/oncology-assessments/new')}>New assessment</a>
				<a href="/oncology-assessment/oncology-assessments" class={navClass('/oncology-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
