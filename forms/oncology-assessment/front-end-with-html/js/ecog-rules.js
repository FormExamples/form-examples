// ECOG Performance Status declarative rules. Each rule evaluates patient
// data and returns true if the condition is present. The ECOG grade is
// determined by the highest-grade rule that fires. ECOG 0 (fully active)
// is the default when no rules fire.
//
// Mirrors `src/lib/engine/ecog-rules.ts` from the SvelteKit reference.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {0 | 1 | 2 | 3 | 4} ECOGGrade
 *
 * @typedef {Object} ECOGRule
 * @property {string} id
