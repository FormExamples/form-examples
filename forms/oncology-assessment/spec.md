# Oncology Assessment — specification
...
- `bin/test-form oncology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check oncology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `oncology-assessment.front-end-form-with-html.v1` (HTML)
  - `oncology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
