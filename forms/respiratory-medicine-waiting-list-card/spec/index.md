# Respiratory Medicine Waiting List Card — specification
...
respiratory medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form respiratory-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check respiratory-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `respiratory-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `respiratory-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
