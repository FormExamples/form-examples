# respiratory-medicine-waiting-list-card — sql
...
- `resp_med_waiting_list_card` — top-level waiting list card.
- `resp_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `resp_med_waiting_list_card_grade` — computed grading result.
- `resp_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `resp_med_waiting_list_card_grade_flag` — safety / operational flags fired
