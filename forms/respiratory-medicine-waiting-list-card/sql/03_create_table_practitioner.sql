-- Practitioner who places the patient on a respiratory medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a respiratory medicine waiting list card on behalf of the patient.';
