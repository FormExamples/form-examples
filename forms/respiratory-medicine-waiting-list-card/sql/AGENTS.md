# Respiratory Medicine Waiting List Card — PostgreSQL migrations
...
Child `resp_med_waiting_list_card_*` tables reference
`resp_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
