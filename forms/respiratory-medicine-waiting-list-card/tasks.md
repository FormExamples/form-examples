# Tasks: Respiratory Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/respiratory-medicine-waiting-list-card/`.
...
- [x] `cargo loco new respiratory-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form respiratory-medicine-waiting-list-card` exits cleanly.
