...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/respiratory-medicine-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >Respiratory Medicine Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/respiratory-medicine-waiting-list-cards/new",
                    )}>New card</a
                >
                <a
                    href="/respiratory-medicine-waiting-list-card/respiratory-medicine-waiting-list-cards"
                    class={navClass("/respiratory-medicine-waiting-list-cards")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
