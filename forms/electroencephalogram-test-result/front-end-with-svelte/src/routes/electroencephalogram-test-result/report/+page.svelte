<script lang="ts">
	...
	import Step2RecordingDetails from '$lib/components/steps/Step2RecordingDetails.svelte';
	...
	function submit() {
		...
		goto('/electroencephalogram-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New EEG report</h1>
	...
	<Form label="Electroencephalogram test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2RecordingDetails />
