...
// Electroencephalogram (EEG) Test Result grader. Faithful vanilla-JavaScript
// port of the SvelteKit engine module `src/lib/engine/grader.ts`.
//
// Pure four-axis interpretation engine for an EEG result:
...
//
// Invariant: a critical finding (status epilepticus, a recorded seizure, or
// epileptiform discharges) auto-escalates Axis D to critical-alert and raises
// the critical-result-alert flag, regardless of the other axes. The
 ...
 * @param {ElectroencephalogramResult} result
