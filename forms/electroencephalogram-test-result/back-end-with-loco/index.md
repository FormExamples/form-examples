...
Server-side Rust JSON API for the Electroencephalogram Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`electroencephalogram_test_result/`](electroencephalogram_test_result/) — one migration, SeaORM
