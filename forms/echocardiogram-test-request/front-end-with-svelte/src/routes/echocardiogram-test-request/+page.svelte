<script lang="ts">
	...
	// dashboard. The collection routes (`/echocardiogram-test-requests` and
	// `/echocardiogram-test-requests/new`) hold the actual functionality.
	const plural = 'echocardiogram-test-requests';
</script>

<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		<p class="text-sm font-semibold uppercase tracking-wide text-primary">Echocardiogram Test Request</p>
		<h1 class="mt-2 text-3xl font-bold text-base-content">
			Cardiac echocardiogram request (referral)
		</h1>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/echocardiogram-test-request/{plural}/new"
		...
		<a
			href="/echocardiogram-test-request/{plural}"
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with the ACC/AHA/ASE Appropriate Use Criteria for echocardiography, British Society
					of Echocardiography (BSE) referral guidance, and NICE NG106 chronic heart failure
