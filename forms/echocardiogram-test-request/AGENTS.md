# Echocardiogram Test Request — agent instructions

Cardiac echocardiogram request (referral). A clinician completes a single-page
wizard; the engine computes a **four-axis grading** (appropriateness, urgency,
request completeness, clinical priority) plus safety flags, and produces a
vetting report.
...
back-end. Red flags (suspected endocarditis, severe symptomatic valve disease,
acute heart failure) auto-escalate the urgency tier. Choose the least-alarming
