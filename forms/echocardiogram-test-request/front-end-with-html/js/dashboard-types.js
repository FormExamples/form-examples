// Plain-JavaScript / JSDoc type definitions for the echocardiogram vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (ACC/AHA/ASE & BSE 1-9).
 * @typedef {'appropriate' | 'may-be-appropriate' | 'rarely-appropriate'} AppropriatenessBand
 */

/**
 * Urgency triage tier emitted by Axis B (red-flag escalation).
 * @typedef {'routine' | 'urgent' | 'emergency'} TriageTier
 */

/**
 * Clinical-priority band emitted by Axis D (NYHA / NT-proBNP / severe disease).
 ...
 * @property {string} echoType        - Requested echo type (kebab-case)
 ...
 * @property {TriageTier} triageTier  - Axis B urgency triage tier
...
// before they read `window.EchocardiogramTestRequestDashboard`.
