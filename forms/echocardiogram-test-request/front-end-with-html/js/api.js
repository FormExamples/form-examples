// Backend API client for the echocardiogram vetting dashboard.
//
...
window.EchocardiogramTestRequestDashboard.fetchRequests = fetchRequests;
window.EchocardiogramTestRequestDashboard.API_BASE = API_BASE;
})();
