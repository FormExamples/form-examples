use echocardiogram_test_request::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_echocardiogram_test_request_grade_rules() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/echocardiogram_test_request_grade_rules").await;
