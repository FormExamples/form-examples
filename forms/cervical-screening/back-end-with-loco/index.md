...
Server-side Rust JSON API for the Cervical Screening record form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`cervical_screening/`](cervical_screening/) — one migration, SeaORM
