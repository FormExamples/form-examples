...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/ophthalmology-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >Ophthalmology Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/ophthalmology-waiting-list-cards/new")}
                    >New card</a
                >
                <a
                    href="/ophthalmology-waiting-list-card/ophthalmology-waiting-list-cards"
                    class={navClass("/ophthalmology-waiting-list-cards")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
