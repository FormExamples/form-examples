# ophthalmology-waiting-list-card — sql
...
- `ophthalmology_waiting_list_card` — top-level waiting list card.
- `ophthalmology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `ophthalmology_waiting_list_card_grade` — computed grading result.
- `ophthalmology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `ophthalmology_waiting_list_card_grade_flag` — safety / operational flags fired
