-- Practitioner who places the patient on a ophthalmology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a ophthalmology waiting list card on behalf of the patient.';
