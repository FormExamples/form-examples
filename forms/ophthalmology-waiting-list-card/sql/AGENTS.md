# Ophthalmology Waiting List Card — PostgreSQL migrations
...
Child `ophthalmology_waiting_list_card_*` tables reference
`ophthalmology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
