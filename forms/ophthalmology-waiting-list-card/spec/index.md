# Ophthalmology Waiting List Card — specification
...
ophthalmology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form ophthalmology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check ophthalmology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `ophthalmology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `ophthalmology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form ophthalmology-waiting-list-card
```
