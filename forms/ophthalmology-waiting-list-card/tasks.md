# Tasks: Ophthalmology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/ophthalmology-waiting-list-card/`.
...
- [x] `cargo loco new ophthalmology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form ophthalmology-waiting-list-card` exits cleanly.
