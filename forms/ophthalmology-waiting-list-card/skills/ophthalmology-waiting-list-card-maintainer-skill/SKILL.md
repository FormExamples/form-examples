...
bin/test-sql-apply ophthalmology-waiting-list-card
bin/test-personas ophthalmology-waiting-list-card
bin/test-e2e --html ophthalmology-waiting-list-card
```
