<script lang="ts">
	...
	function submit() {
		...
		goto('/tumor-marker-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New tumour-marker report</h1>
	...
	<Form label="Tumor marker test result" onsubmit={submit}>
