...
<Fieldset legend="7. Interpretation & Sign-off">
	...
	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a critical result (very high AFP / beta-hCG, or a reported critical
				status). Communicate the result directly to the requester and record it below before
				signing.
			</p>
		</Alert>
	{/if}
