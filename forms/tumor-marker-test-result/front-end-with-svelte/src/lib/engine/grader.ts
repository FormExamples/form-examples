import type { TumorMarkerResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a tumour-marker result.
 *
 * Computes:
 ...
 *
 * Invariant: a very high AFP / beta-hCG (suggesting a germ-cell tumour), or a
 * reported critical status, auto-escalates Axis D to critical-alert and raises
 ...
 */
export function calculateGrade(result: TumorMarkerResult): GradingResult {
