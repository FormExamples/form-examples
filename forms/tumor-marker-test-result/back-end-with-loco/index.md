...
Server-side Rust JSON API for the Tumor Marker Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`tumor_marker_test_result/`](tumor_marker_test_result/) — one migration, SeaORM
