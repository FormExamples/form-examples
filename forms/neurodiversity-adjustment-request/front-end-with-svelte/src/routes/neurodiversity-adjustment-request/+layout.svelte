...
<svelte:head>
	<title>Neurodiversity Adjustment Request</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/neurodiversity-adjustment-request/" class="text-lg font-bold text-base-content">Neurodiversity Adjustment Request</a>
			<div class="flex items-center gap-1">
				<a href="/neurodiversity-adjustment-request/" class={navClass('/')}>Welcome</a>
				<a href="/neurodiversity-adjustment-request/neurodiversity-adjustment-requests/new" class={navClass('/neurodiversity-adjustment-requests/new')}>New request</a>
				<a href="/neurodiversity-adjustment-request/neurodiversity-adjustment-requests" class={navClass('/neurodiversity-adjustment-requests')}>Handling dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
