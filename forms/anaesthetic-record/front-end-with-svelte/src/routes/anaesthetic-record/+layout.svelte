...
<svelte:head>
	<title>Anaesthetic Record — intra-operative chart</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/anaesthetic-record/" class="text-lg font-bold text-base-content">Anaesthetic Record</a>
			<div class="flex items-center gap-1">
				<a href="/anaesthetic-record/" class={navClass('/')}>Welcome</a>
				<a href="/anaesthetic-record/anaesthetic-records/new" class={navClass('/anaesthetic-records/new')}>New record</a>
				<a href="/anaesthetic-record/anaesthetic-records" class={navClass('/anaesthetic-records')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
