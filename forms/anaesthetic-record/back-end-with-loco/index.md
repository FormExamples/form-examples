...
Server-side Rust JSON API for the Anaesthetic Record form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`anaesthetic_record/`](anaesthetic_record/) — one migration, SeaORM
