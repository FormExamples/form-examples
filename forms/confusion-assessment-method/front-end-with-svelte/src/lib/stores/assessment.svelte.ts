...
function storageKey(id: string): string {
	return `confusion-assessment-method.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank CAM assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the CAM assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.feature1`) stay bound to live state.
	 */
