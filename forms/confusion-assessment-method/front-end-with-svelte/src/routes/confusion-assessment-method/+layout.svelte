...
<svelte:head>
	<title>Confusion Assessment Method (CAM)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/confusion-assessment-method/" class="text-lg font-bold text-base-content">CAM</a>
			<div class="flex items-center gap-1">
				<a href="/confusion-assessment-method/" class={navClass('/')}>Welcome</a>
				<a
					href="/confusion-assessment-method/confusion-assessment-methods/new"
					class={navClass('/confusion-assessment-methods/new')}>New assessment</a
				>
				<a
					href="/confusion-assessment-method/confusion-assessment-methods"
					class={navClass('/confusion-assessment-methods')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
