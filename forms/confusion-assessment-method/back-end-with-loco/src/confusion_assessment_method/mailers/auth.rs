...
static welcome: Dir<'_> = include_dir!("src/confusion_assessment_method/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/confusion_assessment_method/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/confusion_assessment_method/mailers/auth/magic_link");
