# Patient Satisfaction Survey — specification
...
- `bin/test-form patient-satisfaction-survey` exits cleanly.
...
- `bin/lily-html-refactor --check patient-satisfaction-survey` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `patient-satisfaction-survey.front-end-form-with-html.v1` (HTML)
  - `patient-satisfaction-survey.front-end-form-with-svelte.v1` (SvelteKit)
