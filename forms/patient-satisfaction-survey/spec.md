...
- LocalStorage key `patient-satisfaction-survey.front-end-form-with-html.v1` (HTML) and
  `patient-satisfaction-survey.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
