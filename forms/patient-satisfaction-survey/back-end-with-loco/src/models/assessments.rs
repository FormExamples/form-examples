...
impl ActiveModel {
    /// Create a new in-progress survey with empty data.
...
/// List surveys with pagination (page is 0-indexed, per_page items each).
