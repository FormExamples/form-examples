//! Patient Satisfaction Survey — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Patient Satisfaction Survey** medical form, built on the
...
//!
//! ```
//! use patient_satisfaction_survey_loco_crate::engine::types::AssessmentData;
//!
