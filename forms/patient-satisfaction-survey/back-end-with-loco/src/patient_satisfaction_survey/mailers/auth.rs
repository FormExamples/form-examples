...
static welcome: Dir<'_> = include_dir!("src/patient_satisfaction_survey/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/patient_satisfaction_survey/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/patient_satisfaction_survey/mailers/auth/magic_link");
