...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/patient-satisfaction-survey/"
                class="text-lg font-bold text-base-content"
                >Patient Satisfaction Survey</a
            >
            <div class="flex items-center gap-1">
                <a href="/patient-satisfaction-survey/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/patient-satisfaction-survey/patient-satisfaction-surveys/new"
                    class={navClass("/patient-satisfaction-surveys/new")}
                    >New survey</a
                >
                <a
                    href="/patient-satisfaction-survey/patient-satisfaction-surveys"
                    class={navClass("/patient-satisfaction-surveys")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
