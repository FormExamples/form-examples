<script lang="ts">
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/patient-satisfaction-survey/patient-satisfaction-surveys/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/patient-satisfaction-survey/patient-satisfaction-surveys/new" class="button" data-variant="primary">New survey</a>
	</div>
