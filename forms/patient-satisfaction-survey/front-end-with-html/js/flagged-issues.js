// Flagged-issue detection for the Patient Satisfaction Survey.
// Independent of rule-based scoring; raises clinician-/manager-facing
// safety, complaint, dignity, and service-quality alerts.
//
...
function detectAdditionalFlags(data) {
  ...
  if (
    typeof data.commentsSuggestions.specificStaffPraise === 'string' &&
    data.commentsSuggestions.specificStaffPraise.trim().length > 0
  ) {
    flags.push({
      id: 'FLAG-PRAISE-001',
