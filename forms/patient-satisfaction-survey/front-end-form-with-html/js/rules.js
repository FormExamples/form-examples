...
// detected. Severity 1 = minor concern, 2 = moderate, 3 = significant,
// 4 = critical. Mirrors src/lib/engine/rules.ts in the SvelteKit form.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} SatisfactionRule
 * @property {string} id
...
const satisfactionRules = [
  // ─── ACCESS & WAITING TIMES ────────────────────────────────
  {
    ...
    severity: 2,
    evaluate: (d) =>
      d.accessWaitingTimes.easeOfBooking !== null &&
      d.accessWaitingTimes.easeOfBooking <= 2
  },
  {
    id: 'ACC-002',
    domain: 'Access',
