// Backend API client for the screening dashboard.
//
 ...
 *
 * @returns {Promise<import('./types.js').ScreeningRow[]>}
 */
async function fetchScreenings() {
  ...
  /** @type {import('./types.js').DashboardScreeningsResponse} */
  const data = await res.json();
  return data.items || [];
}

window.NewbornBloodSpotScreeningDashboard.fetchScreenings = fetchScreenings;
window.NewbornBloodSpotScreeningDashboard.API_BASE = API_BASE;
})();
