...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/newborn-blood-spot-screening/"
                class="text-lg font-bold text-base-content">NBS</a
            >
            <div class="flex items-center gap-1">
                <a href="/newborn-blood-spot-screening/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/newborn-blood-spot-screening/newborn-blood-spot-screenings/new"
                    class={navClass("/newborn-blood-spot-screenings/new")}
                    >New screening</a
                >
                <a
                    href="/newborn-blood-spot-screening/newborn-blood-spot-screenings"
                    class={navClass("/newborn-blood-spot-screenings")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
