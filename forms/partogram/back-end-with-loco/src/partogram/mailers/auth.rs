...
static welcome: Dir<'_> = include_dir!("src/partogram/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/partogram/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/partogram/mailers/auth/magic_link");
