...
<svelte:head>
	<title>Partogram — labour-progress record</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/partogram/" class="text-lg font-bold text-base-content">Partogram</a>
			<div class="flex items-center gap-1">
				<a href="/partogram/" class={navClass('/')}>Welcome</a>
				<a href="/partogram/partograms/new" class={navClass('/partograms/new')}>New partogram</a>
				<a href="/partogram/partograms" class={navClass('/partograms')}>Dashboard</a>
