...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a href="/partogram/" class="text-lg font-bold text-base-content"
                >Partogram</a
            >
            <div class="flex items-center gap-1">
                <a href="/partogram/" class={navClass("/")}>Welcome</a>
                <a
                    href="/partogram/partograms/new"
                    class={navClass("/partograms/new")}>New partogram</a
                >
                <a href="/partogram/partograms" class={navClass("/partograms")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
