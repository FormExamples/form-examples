# Anaesthetics Waiting List Card — PostgreSQL migrations
...
Child `anaesthetics_waiting_list_card_*` tables reference
`anaesthetics_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
