# anaesthetics-waiting-list-card — sql
...
- `anaesthetics_waiting_list_card` — top-level waiting list card.
- `anaesthetics_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `anaesthetics_waiting_list_card_grade` — computed grading result.
- `anaesthetics_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `anaesthetics_waiting_list_card_grade_flag` — safety / operational flags fired
