-- Practitioner who places the patient on a anaesthetics waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a anaesthetics waiting list card on behalf of the patient.';
