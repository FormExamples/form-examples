# Anaesthetics Waiting List Card — specification
...
anaesthetics waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form anaesthetics-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check anaesthetics-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `anaesthetics-waiting-list-card.front-end-with-html.v1` (HTML)
  - `anaesthetics-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
