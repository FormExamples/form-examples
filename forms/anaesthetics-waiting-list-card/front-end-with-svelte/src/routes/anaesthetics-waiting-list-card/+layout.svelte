...
<svelte:head>
	<title>Anaesthetics Waiting List Card</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/anaesthetics-waiting-list-card/" class="text-lg font-bold text-base-content">Anaesthetics Waiting List Card</a>
			<div class="flex items-center gap-1">
				<a href="/anaesthetics-waiting-list-card/" class={navClass('/')}>Welcome</a>
				<a
					href="/anaesthetics-waiting-list-card/anaesthetics-waiting-list-cards/new"
					class={navClass('/anaesthetics-waiting-list-cards/new')}>New card</a
				>
				<a href="/anaesthetics-waiting-list-card/anaesthetics-waiting-list-cards" class={navClass('/anaesthetics-waiting-list-cards')}
					>Dashboard</a
				>
				<LocaleChooser
					label="Language"
