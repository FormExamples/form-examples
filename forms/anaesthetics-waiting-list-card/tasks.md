# Tasks: Anaesthetics Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/anaesthetics-waiting-list-card/`.
...
- [x] `cargo loco new anaesthetics-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form anaesthetics-waiting-list-card` exits cleanly.
