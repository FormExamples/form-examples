# Physical Medicine and Rehabilitation Waiting List Card — SvelteKit practitioner form

Single-page wizard for practitioners (GPs, consultants, referral
co-ordinators) to place a patient on a physical medicine and rehabilitation waiting list. SvelteKit 2.x
