...
import type { GradingResult, WaitingListCard } from '$lib/engine/types';
			...
			resolve(
				new Response(pdfBuffer, {
					headers: {
						...
						'Content-Disposition': `attachment; filename="physical-medicine-and-rehabilitation-waiting-list-card.pdf"`
					}
				})
			);
		});
