-- Practitioner who places the patient on a physical medicine and rehabilitation waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a physical medicine and rehabilitation waiting list card on behalf of the patient.';
