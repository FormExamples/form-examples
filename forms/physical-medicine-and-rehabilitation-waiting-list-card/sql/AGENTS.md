# Physical Medicine and Rehabilitation Waiting List Card — PostgreSQL migrations
...
Child `pmr_waiting_list_card_*` tables reference
`pmr_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
