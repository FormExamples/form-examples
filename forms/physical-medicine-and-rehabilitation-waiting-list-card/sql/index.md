# physical-medicine-and-rehabilitation-waiting-list-card — sql
...
- `pmr_waiting_list_card` — top-level waiting list card.
- `pmr_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `pmr_waiting_list_card_grade` — computed grading result.
- `pmr_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `pmr_waiting_list_card_grade_flag` — safety / operational flags fired
