# Physical Medicine and Rehabilitation Waiting List Card — Agent Instructions

A practitioner-completed administrative card that places a patient on a
physical medicine and rehabilitation waiting list and gives the patient a transparent view of their
