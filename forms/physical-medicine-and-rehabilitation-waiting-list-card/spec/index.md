# Physical Medicine and Rehabilitation Waiting List Card — specification
...
physical medicine and rehabilitation waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form physical-medicine-and-rehabilitation-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check physical-medicine-and-rehabilitation-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `physical-medicine-and-rehabilitation-waiting-list-card.front-end-with-html.v1` (HTML)
  - `physical-medicine-and-rehabilitation-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form physical-medicine-and-rehabilitation-waiting-list-card
```
