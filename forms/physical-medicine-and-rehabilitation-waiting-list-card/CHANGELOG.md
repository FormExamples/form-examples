# Changelog — Physical Medicine and Rehabilitation Waiting List Card
...
file only records changes scoped to the **Physical Medicine and Rehabilitation Waiting List Card** form.
