# Physical Medicine and Rehabilitation Waiting List Card — back-end-with-loco spec

JSON API contract for the Physical Medicine and Rehabilitation Waiting List Card back-end. This file is the living
