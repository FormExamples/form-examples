# Plan: Physical Medicine and Rehabilitation Waiting List Card
...
months later. The Physical Medicine and Rehabilitation Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form physical-medicine-and-rehabilitation-waiting-list-card`.
