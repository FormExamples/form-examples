# Tasks: Physical Medicine and Rehabilitation Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/physical-medicine-and-rehabilitation-waiting-list-card/`.
...
- [x] `cargo loco new physical-medicine-and-rehabilitation-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form physical-medicine-and-rehabilitation-waiting-list-card` exits cleanly.
