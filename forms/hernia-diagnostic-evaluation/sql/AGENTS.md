# Hernia Diagnostic Evaluation — PostgreSQL migrations
...
`hernia_diagnostic_evaluation(id) ON DELETE CASCADE` with a UNIQUE constraint
on the foreign key to enforce 1:1. The `hernia_diagnostic_evaluation_grade_flag`
child references the grade and is 1:many.
