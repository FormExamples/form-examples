use hernia_diagnostic_evaluation::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_hernia_diagnostic_evaluation_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/hernia_diagnostic_evaluation_grade_flags").await;
