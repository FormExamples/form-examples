...
<svelte:head>
    <title>Hernia Diagnostic Evaluation</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/hernia-diagnostic-evaluation/"
                class="text-lg font-bold text-base-content"
                >Hernia Diagnostic Evaluation</a
            >
            <div class="flex items-center gap-1">
                <a href="/hernia-diagnostic-evaluation/" class={navClass("/")}>Welcome</a>
                <a
                    href="/hernia-diagnostic-evaluation/hernia-diagnostic-evaluations/new"
                    class={navClass("/hernia-diagnostic-evaluations/new")}>New evaluation</a
                >
                <a
                    href="/hernia-diagnostic-evaluation/hernia-diagnostic-evaluations"
                    class={navClass("/hernia-diagnostic-evaluations")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
