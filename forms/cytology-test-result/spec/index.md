# Cytology Test Result — specification
...
- `bin/test-form cytology-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check cytology-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cytology-test-result.front-end-with-html.v1` (HTML)
  - `cytology-test-result.front-end-with-svelte.v1` (SvelteKit)
