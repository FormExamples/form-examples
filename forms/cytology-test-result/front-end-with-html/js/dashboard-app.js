...
// Cytology Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.CytologyTestResultDashboard`; display labels come
// from the form namespace `window.CytologyTestResult` (js/types.js). The
