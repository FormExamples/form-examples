<script lang="ts">
	...
	import Step5DiagnosisCategory from '$lib/components/steps/Step5DiagnosisCategory.svelte';
	...
	function submit() {
		...
		goto('/cytology-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New cytology report</h1>
	...
	<Form label="Cytology test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2SpecimenDetails />
		<Step3ClinicalHistory />
		<Step4Findings />
		<Step5DiagnosisCategory />
		<Step6Impression />
