import type { CytologyResult, Flag, FlagPriority } from './types';
 ...
 * categories mirror sql/07_create_table_cytology_test_result_grade_flag.sql.
 * Flags are returned sorted high → medium → low priority.
 */
export function detectFlags(r: CytologyResult): Flag[] {
	const flags: Flag[] = [];
