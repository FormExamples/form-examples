import type { CytologyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a cytology test result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (malignant cells, high-grade dyskaryosis, Thy5,
 * or breast C5) auto-escalates Axis D to critical-alert and raises the
 ...
 */
export function calculateGrade(result: CytologyResult): GradingResult {
