// ──────────────────────────────────────────────
// Cytology Test Result — core data types
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_cytology_test_result.sql and
...
export type HpvResult = 'positive' | 'negative' | 'not-tested' | 'not-applicable' | '';
...
/**
 * The cytology test result (report) — the source-of-truth record the four-axis
...
export interface CytologyResult {
	...
	cytologyResultCategory: string;
	hpvResult: HpvResult;
	malignancyPresent: boolean;
	dysplasiaPresent: boolean;
