...
function selectInput(opts) {
  ...
  sel.addEventListener('change', () => { setField(opts.path, sel.value); clearFieldError(id); });
  return wrapper;
}
...
const STEP_DEFINITIONS = [
  ...
  { step: 3, section: 'otoscopicExamination',          title: 'Otoscopic' },
  { step: 4, section: 'pureToneAudiometry',            title: 'PTA' },
  { step: 5, section: 'speechAudiometry',              title: 'Speech' },
  { step: 6, section: 'tympanometryAcousticReflexes',  title: 'Tympanometry' },
  { step: 7, section: 'vestibularScreening',           title: 'Vestibular' },
  { step: 8, section: 'dizzinessHandicapInventory',    title: 'DHI' },
  { step: 9, section: 'clinicalImpressionReferral',    title: 'Clinical & Referral' }
];
