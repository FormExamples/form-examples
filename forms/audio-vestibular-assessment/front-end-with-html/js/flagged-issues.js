 ...
 * @returns {{id:string, category:string, message:string, priority:'urgent'|'high'|'medium'|'low'}[]}
 */
function detectAdditionalFlags(data, result) {
  const flags = [];
  ...
  if (
    ...
    flags.push({
      id: 'FLAG-RED-001',
      category: 'Red Flag',
      message: 'Sudden hearing loss reported - possible sudden sensorineural hearing loss; same-day ENT review and consider corticosteroids.',
      priority: 'urgent'
    });
  }
  ...
  if (data.presentingSymptoms.neurologicalSymptoms === 'yes') {
    flags.push({
      id: 'FLAG-RED-002',
      category: 'Red Flag',
      message: 'Associated neurological symptoms (weakness, diplopia, dysarthria, etc.) - urgent neurology evaluation.',
      priority: 'urgent'
    });
  }
  ...
  if (
    ...
    flags.push({
      id: 'FLAG-RED-003',
      category: 'Red Flag',
      message: 'Acute vertigo with normal HIT and nystagmus - consider central cause (HINTS: refer for neurology / posterior circulation imaging).',
      priority: 'urgent'
    });
  }
  ...
  if (
    ...
    flags.push({
      id: 'FLAG-VEST-001',
      category: 'Vestibular',
      message: 'Positive Dix-Hallpike - posterior canal BPPV; particle-repositioning manoeuvre indicated.',
      priority: 'medium'
    });
  }
  ...
  if (
    ...
    flags.push({
      id: 'FLAG-VEST-002',
      category: 'Vestibular',
      message: 'Abnormal head-impulse test - peripheral vestibular hypofunction; vestibular rehabilitation indicated.',
      priority: 'medium'
    });
  }
  ...
  if (
    ...
    flags.push({
      ...
      message: 'Fluctuating hearing loss + episodic vertigo + tinnitus - consider Meniere disease.',
      priority: 'medium'
    });
  }
