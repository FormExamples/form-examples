//! Audio Vestibular Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Audio Vestibular Assessment** medical form, built on the
...
//!
//! ```
//! use audio_vestibular_assessment_loco_crate::engine::types::AssessmentData;
//!
