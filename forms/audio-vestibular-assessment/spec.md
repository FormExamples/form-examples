# Audio-Vestibular Assessment — specification
...
- `bin/test-form audio-vestibular-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check audio-vestibular-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `audio-vestibular-assessment.front-end-form-with-html.v1` (HTML)
  - `audio-vestibular-assessment.front-end-form-with-svelte.v1` (SvelteKit)
