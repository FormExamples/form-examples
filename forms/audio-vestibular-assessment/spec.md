...
- LocalStorage key `audio-vestibular-assessment.front-end-form-with-html.v1` (HTML) and
  `audio-vestibular-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
