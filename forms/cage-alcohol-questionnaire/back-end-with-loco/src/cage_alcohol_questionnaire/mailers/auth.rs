...
static welcome: Dir<'_> = include_dir!("src/cage_alcohol_questionnaire/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/cage_alcohol_questionnaire/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/cage_alcohol_questionnaire/mailers/auth/magic_link");
