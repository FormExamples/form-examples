# CAGE Alcohol Questionnaire: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the CAGE Alcohol Questionnaire form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`cage_alcohol_questionnaire/`](cage_alcohol_questionnaire/) — one migration, SeaORM
