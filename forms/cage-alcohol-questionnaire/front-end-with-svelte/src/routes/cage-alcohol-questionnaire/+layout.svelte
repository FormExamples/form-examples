...
<svelte:head>
	<title>CAGE Alcohol Questionnaire</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/cage-alcohol-questionnaire/" class="text-lg font-bold text-base-content">CAGE</a>
			<div class="flex items-center gap-1">
				<a href="/cage-alcohol-questionnaire/" class={navClass('/')}>Welcome</a>
				<a
					href="/cage-alcohol-questionnaire/cage-alcohol-questionnaires/new"
					class={navClass('/cage-alcohol-questionnaires/new')}>New assessment</a
				>
				<a
					href="/cage-alcohol-questionnaire/cage-alcohol-questionnaires"
					class={navClass('/cage-alcohol-questionnaires')}>Dashboard</a
				>
