...
function storageKey(id: string): string {
	return `cage-alcohol-questionnaire.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank CAGE assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the CAGE assessment, with localStorage
