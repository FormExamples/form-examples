...
<svelte:head>
	<title>Mental Health Act Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/mental-health-act-assessment/" class="text-lg font-bold text-base-content">MHA Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/mental-health-act-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/mental-health-act-assessment/mental-health-act-assessments/new"
					class={navClass('/mental-health-act-assessments/new')}>New assessment</a
				>
				<a
					href="/mental-health-act-assessment/mental-health-act-assessments"
					class={navClass('/mental-health-act-assessments')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
