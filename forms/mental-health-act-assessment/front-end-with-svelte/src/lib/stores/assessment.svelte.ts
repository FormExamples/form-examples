...
function storageKey(id: string): string {
	return `mental-health-act-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Mental Health Act assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Mental Health Act assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.context`) stay bound to live state.
	 */
