// Backend API client for the Mental Health Act Assessment clinician dashboard.
//
...
window.MentalHealthActAssessmentDashboard.fetchAssessments = fetchAssessments;
window.MentalHealthActAssessmentDashboard.API_BASE = API_BASE;
})();
