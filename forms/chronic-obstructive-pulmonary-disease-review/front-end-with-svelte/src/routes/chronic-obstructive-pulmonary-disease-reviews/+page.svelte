<script lang="ts">
	...
	import { goldGradeShort, abeGroupShort, reviewStatusLabel, reviewTypeLabel } from '$lib/engine/utils';
...
<main class="mx-auto max-w-6xl px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/{plural}/new" class="button" data-variant="primary">New review</a>
	</div>
