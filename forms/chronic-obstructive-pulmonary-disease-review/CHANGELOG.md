# Changelog — Chronic Obstructive Pulmonary Disease Review (COPD Annual Review)
...
file only records changes scoped to the **Chronic Obstructive Pulmonary Disease Review (COPD Annual Review)** form.
