// Backend API client for the Workplace Climate Assessment leadership
// dashboard.
//
...
window.WorkplaceClimateAssessmentDashboard.fetchTeams = fetchTeams;
window.WorkplaceClimateAssessmentDashboard.API_BASE = API_BASE;
})();
