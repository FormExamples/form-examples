# Tasks: Workplace Climate Assessment
...
- [ ] Implement employee form frontend (10 steps)
- [ ] Implement climate index scoring engine
- [x] Implement flagged issues detection
- [x] Implement PDF report generation
- [ ] Implement leadership dashboard with SVAR DataGrid
