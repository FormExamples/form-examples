//! Workplace Climate Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Workplace Climate Assessment** medical form, built on the
...
//!
//! ```
//! use workplace_climate_assessment_loco_crate::engine::types::AssessmentData;
//!
