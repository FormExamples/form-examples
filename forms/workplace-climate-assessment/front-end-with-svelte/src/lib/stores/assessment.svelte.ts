...
function storageKey(id: string): string {
	return `workplace-climate-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank workplace-climate assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the workplace-climate assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.leadership`) stay bound to live state.
	 */
