...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/workplace-climate-assessment/"
                class="text-lg font-bold text-base-content"
                >Workplace Climate Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/workplace-climate-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/workplace-climate-assessment/workplace-climate-assessments/new"
                    class={navClass("/workplace-climate-assessments/new")}
                    >New response</a
                >
                <a
                    href="/workplace-climate-assessment/workplace-climate-assessments"
                    class={navClass("/workplace-climate-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
