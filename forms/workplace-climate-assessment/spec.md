...
- LocalStorage key `workplace-climate-assessment.front-end-form-with-html.v1` (HTML) and
  `workplace-climate-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
