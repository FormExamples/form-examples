# Workplace Climate Assessment — specification
...
- `bin/test-form workplace-climate-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check workplace-climate-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `workplace-climate-assessment.front-end-form-with-html.v1` (HTML)
  - `workplace-climate-assessment.front-end-form-with-svelte.v1` (SvelteKit)
