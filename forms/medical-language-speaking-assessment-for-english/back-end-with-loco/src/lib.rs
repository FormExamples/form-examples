//! Medical Language Speaking Assessment for English — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Medical Language Speaking Assessment for English** medical form, built on the
...
//!
//! ```
//! use medical_language_speaking_assessment_for_english_loco_crate::engine::types::AssessmentData;
//!
