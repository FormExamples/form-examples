...
- `bin/lily-html-refactor --check medical-language-speaking-assessment-for-english` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `medical-language-speaking-assessment-for-english.front-end-form-with-html.v1` (HTML)
  - `medical-language-speaking-assessment-for-english.front-end-form-with-svelte.v1` (SvelteKit)
