...
function storageKey(id: string): string {
	return `medical-language-speaking-assessment-for-english.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank OET speaking assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the OET speaking assessment, with localStorage
