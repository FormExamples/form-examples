...
import type { HospitalPerformanceIndicators, IndicatorsSummaryResult } from '$lib/engine/types';
			...
			resolve(
				new Response(pdfBuffer, {
					headers: {
						...
						'Content-Disposition': `attachment; filename="hospital-performance-indicators.pdf"`
					}
				})
			);
		});
