...
static welcome: Dir<'_> = include_dir!("src/hospital_performance_indicators/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/hospital_performance_indicators/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/hospital_performance_indicators/mailers/auth/magic_link");
