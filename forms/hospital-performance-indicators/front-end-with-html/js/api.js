import { SAMPLE_PERFORMANCE_INDICATORS } from './data.js';

const API_BASE = '/api/hospital-performance-indicators';
const CACHE_KEY = 'hospital-performance-indicators-dashboard:cache:v1';
 ...
 */
export const fetchPerformanceIndicators = function () {
  return fetch(API_BASE)
    ...
    .catch(function () {
      ...
      return { source: 'sample', rows: SAMPLE_PERFORMANCE_INDICATORS };
    });
};

export { clearCache as clearPerformanceIndicatorsCache };
