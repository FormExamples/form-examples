use histopathology_test_request::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_histopathology_test_request_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/histopathology_test_request_grade_flags").await;
