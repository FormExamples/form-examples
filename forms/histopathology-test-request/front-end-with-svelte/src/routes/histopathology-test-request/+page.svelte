<script lang="ts">
	...
	// dashboard. The collection routes (`/histopathology-test-requests` and
	// `/histopathology-test-requests/new`) hold the actual functionality.
	const plural = 'histopathology-test-requests';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		...
		<h1 class="mt-2 text-3xl font-bold text-base-content">
			Tissue histopathology specimen request
		</h1>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/histopathology-test-request/{plural}/new"
		...
		<a
			href="/histopathology-test-request/{plural}"
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the nested data model, the four-axis grading
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with the Royal College of Pathologists (RCPath) cancer datasets and tissue
					pathways, NICE NG12 (suspected cancer: recognition and referral), and RCPath
