// Backend API client for the histopathology vetting dashboard.
//
...
window.HistopathologyTestRequestDashboard.fetchRequests = fetchRequests;
window.HistopathologyTestRequestDashboard.API_BASE = API_BASE;
})();
