// Plain-JavaScript / JSDoc type definitions for the histopathology vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (RCPath 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Specimen-quality band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'reject-risk'} SpecimenQualityBand
 */

/**
 * Urgency triage tier emitted by Axis D (frozen-section / 2WW escalation).
 * @typedef {'routine' | 'urgent' | 'two-week-wait'} TriageTier
 */
 ...
 * @property {string} specimenType    - Requested specimen type (kebab-case)
 ...
 * @property {SpecimenQualityBand} specimenQualityBand - Axis B specimen-quality band
 * @property {TriageTier} triageTier  - Axis D urgency tier
...
// before they read `window.HistopathologyTestRequestDashboard`.
