# Tasks: Internal Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/internal-medicine-waiting-list-card/`.
...
- [x] `cargo loco new internal-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form internal-medicine-waiting-list-card` exits cleanly.
