# Internal Medicine Waiting List Card — specification
...
internal medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form internal-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check internal-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `internal-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `internal-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
