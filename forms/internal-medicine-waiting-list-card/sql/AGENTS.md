# Internal Medicine Waiting List Card — PostgreSQL migrations
...
Child `internal_med_waiting_list_card_*` tables reference
`internal_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
