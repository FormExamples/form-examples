-- Practitioner who places the patient on a internal medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a internal medicine waiting list card on behalf of the patient.';
