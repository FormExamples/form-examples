# internal-medicine-waiting-list-card — sql
...
- `internal_med_waiting_list_card` — top-level waiting list card.
- `internal_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `internal_med_waiting_list_card_grade` — computed grading result.
- `internal_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `internal_med_waiting_list_card_grade_flag` — safety / operational flags fired
