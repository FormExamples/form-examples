# Plan: Internal Medicine Waiting List Card
...
months later. The Internal Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form internal-medicine-waiting-list-card`.
