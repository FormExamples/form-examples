...
function storageKey(id: string): string {
	return `bone-marrow-donation-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank donor assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the donor assessment, with localStorage
