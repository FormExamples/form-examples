# Bone Marrow Donation Assessment — specification
...
- `bin/test-form bone-marrow-donation-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check bone-marrow-donation-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `bone-marrow-donation-assessment.front-end-form-with-html.v1` (HTML)
  - `bone-marrow-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit)
