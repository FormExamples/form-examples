...
- LocalStorage key `bone-marrow-donation-assessment.front-end-form-with-html.v1` (HTML) and
  `bone-marrow-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
