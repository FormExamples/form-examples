//! Bone Marrow Donation Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Bone Marrow Donation Assessment** medical form, built on the
...
//!
//! ```
//! use bone_marrow_donation_assessment_loco_crate::engine::types::AssessmentData;
//!
