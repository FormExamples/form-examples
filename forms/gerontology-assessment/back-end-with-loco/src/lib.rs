//! Gerontology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Gerontology Assessment** medical form, built on the
...
//!
//! ```
//! use gerontology_assessment_loco_crate::engine::types::AssessmentData;
//!
