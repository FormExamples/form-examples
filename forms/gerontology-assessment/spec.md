# Gerontology Assessment — specification
...
- `bin/test-form gerontology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check gerontology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `gerontology-assessment.front-end-form-with-html.v1` (HTML)
  - `gerontology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
