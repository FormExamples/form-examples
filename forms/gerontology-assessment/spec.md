...
- LocalStorage key `gerontology-assessment.front-end-form-with-html.v1` (HTML) and
  `gerontology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
