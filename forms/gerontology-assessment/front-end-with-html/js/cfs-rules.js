...
const cfsRules = [
  ...
  },
  {
    ...
    evaluate: (d) => {
      ...
      return age !== null && age >= 75 &&
        d.comorbidities.cardiovascularDisease !== 'yes' &&
  ...
  },
  {
    ...
    score: 3,
    evaluate: (d) =>
      d.mobilityFalls.mobilityAids === 'yes' &&
      d.mobilityFalls.gaitAssessment === 'normal'
  },
  {
    id: 'CFS-005',
    ...
    evaluate: (d) =>
      d.comorbidities.diabetes === 'yes' &&
      d.comorbidities.diabetesControl === 'well-controlled'
  },
  ...
  // ─── CFS 4 - VULNERABLE ─────────────────────────────────
  {
    ...
    evaluate: (d) => {
      const adlHelp = countADLsNeedingHelp(d.functionalAssessment);
      return adlHelp >= 1 && adlHelp <= 2 &&
        countDependentADLs(d.functionalAssessment) === 0;
    }
  },
  {
    id: 'CFS-007',
    ...
    score: 4,
    evaluate: (d) =>
      d.mobilityFalls.gaitAssessment === 'unsteady' &&
  ...
  },
  {
    ...
    score: 5,
    evaluate: (d) =>
      d.mobilityFalls.timedUpAndGo !== null &&
      d.mobilityFalls.timedUpAndGo >= 14
  },
  {
    id: 'CFS-013',
    domain: 'Cognition',
  ...
  },
  {
    ...
    evaluate: (d) =>
      ...
      (d.comorbidities.cardiovascularDisease === 'yes' ||
        d.comorbidities.renalDisease === 'yes')
  },
  {
    id: 'CFS-020',
    domain: 'Psychosocial',
  ...
  },
  {
    ...
    score: 7,
    evaluate: (d) =>
      d.cognitiveScreen.mmseScore !== null &&
      d.cognitiveScreen.mmseScore < 10
  },
  {
    id: 'CFS-024',
    domain: 'Continence',
  ...
  },
  {
    ...
    evaluate: (d) =>
      ...
      (d.continenceSkin.pressureInjuryStage === '3' ||
        d.continenceSkin.pressureInjuryStage === '4')
  },
  ...
  },
  {
    ...
    score: 6,
    evaluate: (d) =>
      d.continenceSkin.bradenScale !== null &&
      d.continenceSkin.bradenScale <= 12
  }
];
