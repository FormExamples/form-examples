...
function storageKey(id: string): string {
	return `gerontology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank gerontology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the gerontology assessment, with localStorage
