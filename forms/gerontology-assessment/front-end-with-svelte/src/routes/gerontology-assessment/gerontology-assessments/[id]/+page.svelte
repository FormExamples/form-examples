<script lang="ts">
	...
	import { gradeAssessment } from '$lib/engine/cfs-grader';
	...
	function submit() {
		...
		goto(`/gerontology-assessment/gerontology-assessments/${id}/report`);
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-base-content">
			{isNew ? 'New gerontology assessment' : `Gerontology assessment ${id}`}
		</h1>
		<p class="mt-1 text-sm text-base-content/70">
			Complete the nine sections; the Clinical Frailty Scale score and flagged issues are computed on
			submit.
		</p>
	...
	<Form label="Gerontology assessment" onsubmit={submit}>
		<Step1Demographics />
		...
		<div class="button-group">
			<Button type="submit" data-variant="primary">Compute CFS &amp; view report</Button>
