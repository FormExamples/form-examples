<script lang="ts">
	...
	// dashboard. The collection routes (`/gerontology-assessments` and
	// `/gerontology-assessments/new`) hold the actual functionality.
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/gerontology-assessment/{plural}/new"
		...
		<a
			href="/gerontology-assessment/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed CFS score, cognitive status and flagged
				issues, and filter by frailty band and cognitive status.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the CFS grading engine, and the
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the Clinical Frailty Scale (CFS), a validated 1–9 frailty grading instrument, with
					additional safety flags for falls, delirium, polypharmacy, malnutrition and skin integrity.
				</dd>
			</div>
		</dl>
	</section>
