// Plain-JavaScript / JSDoc type definitions for the hearing test request
// vetting dashboard.
//
 ...
 * @property {string} laterality      - Affected side (kebab-case)
...
// before they read `window.HearingTestRequestDashboard`.
