// Backend API client for the hearing test request vetting dashboard.
//
...
window.HearingTestRequestDashboard.fetchRequests = fetchRequests;
window.HearingTestRequestDashboard.API_BASE = API_BASE;
})();
