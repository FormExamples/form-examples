// Hearing Test Request — vetting dashboard (vanilla classic-script app).
//
...
// priority dropdown + safety-flags dropdown).
//
// Sibling modules loaded as plain `<script>` tags (in dependency order)
// attach their exports to `window.HearingTestRequestDashboard`. The whole
...
function compareRows(a, b) {
  ...
  // Default: string compare (nhs, patient, testType, laterality, indication,
