<script lang="ts">
	...
	function submit() {
		...
		goto(`/hearing-test-request/hearing-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New hearing test request' : `Hearing test request ${id}`}
	</h1>
	...
	<Form label="Hearing test request" onsubmit={submit}>
