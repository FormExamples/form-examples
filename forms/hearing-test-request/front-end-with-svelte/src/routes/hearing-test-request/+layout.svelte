...
<svelte:head>
	<title>Hearing Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hearing-test-request/" class="text-lg font-bold text-base-content">Hearing Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/hearing-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/hearing-test-request/hearing-test-requests/new" class={navClass('/hearing-test-requests/new')}>New request</a>
				<a href="/hearing-test-request/hearing-test-requests" class={navClass('/hearing-test-requests')}>Vetting dashboard</a>
