...
static welcome: Dir<'_> = include_dir!("src/pre_operative_assessment_by_clinician/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/pre_operative_assessment_by_clinician/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/pre_operative_assessment_by_clinician/mailers/auth/magic_link");
