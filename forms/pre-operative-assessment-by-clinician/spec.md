...
- LocalStorage key `pre-operative-assessment-by-clinician.front-end-form-with-html.v1` (HTML) and
  `pre-operative-assessment-by-clinician.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
