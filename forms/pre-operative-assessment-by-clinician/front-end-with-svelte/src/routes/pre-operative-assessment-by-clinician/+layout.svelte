...
<div class="min-h-screen bg-base-200 text-base-content">
  <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
    <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
      <a
        href="/pre-operative-assessment-by-clinician/"
        class="text-lg font-bold text-base-content"
        >Pre-operative Assessment by Clinician</a
      >
      <div class="flex items-center gap-1">
        <a href="/pre-operative-assessment-by-clinician/" class={navClass("/")}
          >Welcome</a
        >
        <a
          href="/pre-operative-assessment-by-clinician/pre-operative-assessments-by-clinician/new"
          class={navClass("/pre-operative-assessments-by-clinician/new")}
          >New assessment</a
        >
        <a
          href="/pre-operative-assessment-by-clinician/pre-operative-assessments-by-clinician"
          class={navClass("/pre-operative-assessments-by-clinician")}
          >Dashboard</a
        >
        <LocalePicker
          label="Language"
