...
import { computeFriedPhenotypeScore } from "./frailty-rules.js";
...
export function detectAdditionalFlags(
  ...
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Prepare difficult-airway trolley; consider awake fibreoptic intubation.",
    });
  }
  if (data.airway.familyHistoryAnaestheticComplications === "yes") {
    flags.push({
      ...
      priority: "high",
      description:
        "Family history of anaesthetic complications — malignant hyperthermia susceptibility cannot be excluded",
      suggestedAction:
        "Confirm details; use a trigger-free (TIVA) technique and ensure dantrolene is available if MH is not excluded.",
    });
  }
  if (data.airway.previousAnaestheticIssues === "yes") {
    flags.push({
      ...
      suggestedAction:
        "Review prior anaesthetic records before planning technique.",
    });
  }
  ...
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Cardiology review; consider invasive monitoring and HDU disposition.",
    });
  }
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Respiratory review; consider optimisation before surgery.",
    });
  }
  if (
  ...
  if (data.haematology.hbGL !== null && data.haematology.hbGL < 80) {
    flags.push({
      ...
      suggestedAction:
        "Investigate and treat; consider iron / transfusion pre-op.",
    });
  }
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Diabetes team review; defer elective surgery if possible.",
    });
  }
  if (
  ...
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Comprehensive Geriatric Assessment; shared-decision-making conversation.",
    });
  }
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Consider deferring elective surgery until 7 weeks post-infection (CPOC 2021).",
    });
  }
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Reschedule or perform rapid-sequence induction with informed consent.",
    });
  }
  if (
  ...
  if (data.neurological.capacityConcern === "yes") {
    flags.push({
      ...
      suggestedAction:
        "Mental Capacity Act 2005 assessment; involve family / advocate.",
    });
  }
  if (
    data.allergies.some(
  ...
  if (data.functionalCapacity.malnutritionRisk === "high") {
    flags.push({
      ...
      suggestedAction:
        "Dietitian referral; consider oral nutritional supplements pre-op.",
    });
  }
  ...
  const glp1NotHeldOrConfirmed =
    glp1.glp1HeldPerGuideline !== "yes" &&
    glp1.glp1ExtendedClearFluidsConfirmed !== "yes";
  ...
  if (
    ...
    flags.push({
      ...
      suggestedAction:
        "Perform Mini-Cog and consider a Comprehensive Geriatric Assessment before surgery.",
    });
  }
  if (onGlp1 && isFrail) {
    flags.push({
  ...
  if (onGlp1 && glp1.glp1GiSymptoms === "yes" && isFrail) {
    flags.push({
      ...
      priority: "high",
      description:
        "Frail patient with GLP-1-related GI symptoms plus fasting — elevated risk of dehydration, acute kidney injury, and delirium",
      suggestedAction:
        "Consider pre-admission IV fluids, minimise fasting duration, and monitor renal function and cognition closely.",
    });
  }
  if (
    onGlp1 &&
    ...
    flags.push({
      ...
      priority: "medium",
      description:
        "GLP-1 receptor agonist held or fasting extended in a patient on insulin — risk of rebound hyperglycaemia or hypoglycaemia",
      suggestedAction:
