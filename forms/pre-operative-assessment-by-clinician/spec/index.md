# Pre-operative Assessment by Clinician — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (12 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form pre-operative-assessment-by-clinician` exits cleanly.
...
- `bin/lily-html-refactor --check pre-operative-assessment-by-clinician` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `pre-operative-assessment-by-clinician.front-end-form-with-html.v1` (HTML)
  - `pre-operative-assessment-by-clinician.front-end-form-with-svelte.v1` (SvelteKit)
