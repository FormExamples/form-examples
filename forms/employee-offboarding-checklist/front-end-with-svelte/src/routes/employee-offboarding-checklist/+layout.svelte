...
<svelte:head>
	<title>Employee Offboarding Checklist</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/employee-offboarding-checklist/" class="text-lg font-bold text-base-content">Employee Offboarding Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/employee-offboarding-checklist/" class={navClass('/')}>Welcome</a>
				<a href="/employee-offboarding-checklist/employee-offboarding-checklists/new" class={navClass('/employee-offboarding-checklists/new')}>New checklist</a>
				<a href="/employee-offboarding-checklist/employee-offboarding-checklists" class={navClass('/employee-offboarding-checklists')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
