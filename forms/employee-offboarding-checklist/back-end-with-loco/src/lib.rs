//! Employee Offboarding Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Employee Offboarding Checklist** medical form, built on the
...
//!
//! ```
//! use employee_offboarding_checklist_loco_crate::engine::types::AssessmentData;
//!
