# Employee Offboarding Checklist: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Employee Offboarding Checklist form. Pure back-end: no HTML
