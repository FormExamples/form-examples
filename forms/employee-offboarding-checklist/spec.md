...
- LocalStorage key `employee-offboarding-checklist.front-end-form-with-html.v1` (HTML) and
  `employee-offboarding-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
