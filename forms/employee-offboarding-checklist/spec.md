# Employee Offboarding Checklist — specification
...
- `bin/test-form employee-offboarding-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check employee-offboarding-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `employee-offboarding-checklist.front-end-form-with-html.v1` (HTML)
  - `employee-offboarding-checklist.front-end-form-with-svelte.v1` (SvelteKit)
