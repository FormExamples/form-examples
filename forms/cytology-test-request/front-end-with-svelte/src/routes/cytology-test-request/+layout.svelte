...
<svelte:head>
	<title>Cytology Test Request</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/cytology-test-request/" class="text-lg font-bold text-base-content">Cytology Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/cytology-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/cytology-test-request/cytology-test-requests/new" class={navClass('/cytology-test-requests/new')}>New request</a>
				<a href="/cytology-test-request/cytology-test-requests" class={navClass('/cytology-test-requests')}>Vetting dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
