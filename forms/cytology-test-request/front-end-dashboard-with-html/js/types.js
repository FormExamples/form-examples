// Plain-JavaScript / JSDoc type definitions for the cytology vetting dashboard.
//
...
/**
 * Pre-analytical specimen adequacy band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'reject-risk'} PreanalyticalBand
 */

/**
 * Triage tier emitted by Axis D (suspected-cancer escalation).
 ...
 * @property {PreanalyticalBand} preanalyticalBand - Axis B specimen adequacy
...
// before they read `window.CytologyTestRequestDashboard`.
})();
