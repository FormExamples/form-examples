// Backend API client for the cytology vetting dashboard.
//
...
window.CytologyTestRequestDashboard.fetchRequests = fetchRequests;
window.CytologyTestRequestDashboard.API_BASE = API_BASE;
})();
