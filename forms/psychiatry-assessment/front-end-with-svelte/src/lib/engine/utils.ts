...
export function gafScoreColor(score: number): string {
	if (score >= 81) return 'bg-success text-success-content border-success';
	if (score >= 61) return 'bg-warning text-warning-content border-warning';
	if (score >= 41) return 'bg-warning text-warning-content border-warning';
	if (score >= 21) return 'bg-error text-error-content border-error';
