...
function storageKey(id: string): string {
	return `psychiatry-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank psychiatry assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the psychiatry assessment, with localStorage
