<script lang="ts">
	...
	function submit() {
		...
		goto(`/psychiatry-assessment/psychiatry-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New psychiatry assessment' : `Psychiatry assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the eleven sections; the GAF score, violence risk, and flagged issues are computed on
		submit.
	</p>
	...
	<Form label="Psychiatry assessment" onsubmit={submit}>
		<Step1Demographics />
		...
		<div class="button-group">
			<Button type="submit" data-variant="primary">Compute GAF &amp; view report</Button>
