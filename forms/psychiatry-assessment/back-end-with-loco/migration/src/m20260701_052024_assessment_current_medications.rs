...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "assessment_current_medications",
            ...
            ("takes_psychiatric_medications", ColType::StringWithDefault(String::new())),
            ("takes_other_medications", ColType::StringWithDefault(String::new())),
            ("medication_adherence", ColType::StringWithDefault(String::new())),
            ("adherence_barriers", ColType::TextWithDefault(String::new())),
            ("side_effects", ColType::TextWithDefault(String::new())),
            ("clozapine_registered", ColType::StringWithDefault(String::new())),
