//! Psychiatry Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Psychiatry Assessment** medical form, built on the
...
//!
//! ```
//! use psychiatry_assessment_loco_crate::engine::types::AssessmentData;
//!
