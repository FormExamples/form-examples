...
- LocalStorage key `psychiatry-assessment.front-end-form-with-html.v1` (HTML) and
  `psychiatry-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
