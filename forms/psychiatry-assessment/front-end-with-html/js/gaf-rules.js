// GAF (Global Assessment of Functioning) scoring rules.
//
// Each rule evaluates patient data and returns true if the condition is
// present. The GAF score starts at 100 and is decremented by each fired
// rule's `scoreImpact`. The final score is clamped to 1-100.
//
// Mirrors the SvelteKit reference engine (`src/lib/engine/gaf-rules.ts`).

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} GAFRule
 * @property {string} id
...
const gafRules = [
  ...
  },
  {
    ...
    scoreImpact: 35,
    evaluate: (d) =>
      d.riskAssessment.violenceRisk === 'high' ||
      d.riskAssessment.violenceRisk === 'imminent'
  },
  {
    id: 'RA-007',
    domain: 'Risk Assessment',
  ...
  // Substance Use
  {
    ...
    scoreImpact: 15,
    evaluate: (d) =>
      d.substanceUse.alcoholAuditScore !== null &&
      d.substanceUse.alcoholAuditScore >= 16
  },
  {
    id: 'SU-002',
    domain: 'Substance Use',
    ...
    evaluate: (d) =>
      d.substanceUse.alcoholAuditScore !== null &&
      d.substanceUse.alcoholAuditScore >= 20
  },
  {
    id: 'SU-003',
    domain: 'Substance Use',
  ...
  // Social History
  {
    ...
    scoreImpact: 15,
    evaluate: (d) =>
      d.socialHistory.housing === 'homeless' ||
      d.socialHistory.housing === 'temporary'
  },
  {
    id: 'SOC-002',
    domain: 'Social History',
  ...
  // Capacity & Consent
  {
    ...
    scoreImpact: 25,
    evaluate: (d) =>
      d.capacityAndConsent.decisionMakingCapacity === 'lacks-capacity'
  },
  {
    id: 'CC-002',
    domain: 'Capacity & Consent',
    ...
    scoreImpact: 15,
    evaluate: (d) =>
      d.capacityAndConsent.decisionMakingCapacity === 'fluctuating'
  },
