//! Sundowner Syndrome Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Sundowner Syndrome Assessment** medical form, built on the
...
//!
//! ```
//! use sundowner_syndrome_assessment_loco_crate::engine::types::AssessmentData;
//!
