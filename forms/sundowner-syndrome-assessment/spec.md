...
- `bin/lily-html-refactor --check sundowner-syndrome-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `sundowner-syndrome-assessment.front-end-form-with-html.v1` (HTML)
  - `sundowner-syndrome-assessment.front-end-form-with-svelte.v1` (SvelteKit)
