...
<svelte:head>
    <title>Knee Replacement Surgery Evaluation</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/knee-replacement-surgery-evaluation/"
                class="text-lg font-bold text-base-content"
                >Knee Replacement Surgery Evaluation</a
            >
            <div class="flex items-center gap-1">
                <a href="/knee-replacement-surgery-evaluation/" class={navClass("/")}>Welcome</a>
                <a
                    href="/knee-replacement-surgery-evaluation/knee-replacement-surgery-evaluations/new"
                    class={navClass("/knee-replacement-surgery-evaluations/new")}>New evaluation</a
                >
                <a
                    href="/knee-replacement-surgery-evaluation/knee-replacement-surgery-evaluations"
                    class={navClass("/knee-replacement-surgery-evaluations")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
