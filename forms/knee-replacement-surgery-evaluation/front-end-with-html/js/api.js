// Back-end API client for the Knee Replacement Surgery Evaluation dashboard.
//
...
const EVALUATIONS_PATH = '/api/knee_replacement_surgery_evaluations';
...
async function fetchEvaluations() {
  ...
  if (!res.ok) {
    throw new Error(`Failed to fetch evaluations: ${res.status} ${res.statusText}`);
  }
