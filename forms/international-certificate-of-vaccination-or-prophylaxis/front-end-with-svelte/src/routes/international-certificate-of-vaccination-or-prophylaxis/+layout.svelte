...
<svelte:head>
	<title>International Certificate of Vaccination or Prophylaxis</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/international-certificate-of-vaccination-or-prophylaxis/" class="text-lg font-bold text-base-content">ICVP</a>
			<div class="flex items-center gap-1">
				<a href="/international-certificate-of-vaccination-or-prophylaxis/" class={navClass('/')}>Welcome</a>
				<a href="/international-certificate-of-vaccination-or-prophylaxis/{plural}/new" class={navClass(`/${plural}/new`)}>New certificate</a>
				<a href="/international-certificate-of-vaccination-or-prophylaxis/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
