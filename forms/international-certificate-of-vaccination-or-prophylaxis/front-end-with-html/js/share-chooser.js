// Lily Design System — share-chooser (headless, vanilla JS).
...
function init() {
  const root = document.querySelector('.share-chooser');
  const trigger = document.getElementById('share-chooser');
  const list = document.getElementById('share-chooser-list');
  const copyButton = document.getElementById('share-chooser-copy');
  const status = document.getElementById('share-chooser-status');
