...
- LocalStorage key `international-certificate-of-vaccination-or-prophylaxis.front-end-form-with-html.v1` (HTML) and
  `international-certificate-of-vaccination-or-prophylaxis.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
