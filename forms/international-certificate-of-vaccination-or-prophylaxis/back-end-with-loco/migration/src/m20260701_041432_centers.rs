...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "centers",
            ...
            ("name", ColType::Text),
            ("who_designation_reference", ColType::String),
            ("national_authority_reference", ColType::String),
            ...
            ("uniform_stamp_image_data_url", ColType::Text),
            ("authorised_diseases", ColType::Text),
