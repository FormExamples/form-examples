//! International Certificate of Vaccination Or Prophylaxis — Loco JSON API back-end.
//!
//! Server-side JSON API for the **International Certificate of Vaccination Or Prophylaxis** medical form, built on the
