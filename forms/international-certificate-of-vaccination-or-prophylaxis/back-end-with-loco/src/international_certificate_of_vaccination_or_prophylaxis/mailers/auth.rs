...
static welcome: Dir<'_> = include_dir!("src/international_certificate_of_vaccination_or_prophylaxis/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/international_certificate_of_vaccination_or_prophylaxis/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/international_certificate_of_vaccination_or_prophylaxis/mailers/auth/magic_link");
