# International Certificate Of Vaccination Or Prophylaxis: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the International Certificate Of Vaccination Or Prophylaxis form. Pure back-end: no HTML
