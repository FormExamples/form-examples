# International Certificate of Vaccination or Prophylaxis (ICVP) — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the International Certificate of Vaccination or Prophylaxis (ICVP) form, built with axum + Loco +
...
- [`international_certificate_of_vaccination_or_prophylaxis/`](./international_certificate_of_vaccination_or_prophylaxis/) — the Loco crate: `src/international_certificate_of_vaccination_or_prophylaxis/` holds `app.rs`
...
`src/international_certificate_of_vaccination_or_prophylaxis/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd international_certificate_of_vaccination_or_prophylaxis && cargo check --all-targets && cargo test
```
