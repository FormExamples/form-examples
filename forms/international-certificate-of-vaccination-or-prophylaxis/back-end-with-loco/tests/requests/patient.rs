...
async fn can_create_and_read_back_patient() {
    request::<App, _, _>(|request, _ctx| async move {
        let new_patient = serde_json::json!({
            ...
            "sex": "male",
            "nationalityAsIso31661Alpha3": "Test nationalityAsIso31661Alpha3",
            "travelDocumentKind": "passport",
            "travelDocumentNumber": "Test travelDocumentNumber",
            "travelDocumentIssuerAsIso31661Alpha3": "Test travelDocumentIssuerAsIso31661Alpha3",
            "email": "test.patient@example.com",
            "phone": "+441234567890",
            "postalAddressAsFullText": "10 Downing Street, London",
            "countryAsIso31661Alpha2": "GB",
            "postcode": "SW1A 2AA",
            "consentedToDataSharing": "yes",
            "signatureImageDataUrl": "Test signatureImageDataUrl"
        });
        ...
        assert_eq!(fetched["surname"], "Test surname");
        assert_eq!(fetched["givenNames"], "Test givenNames");
        assert_eq!(fetched["birthDate"], "1990-01-01");
        assert_eq!(fetched["sex"], "male");
        assert_eq!(fetched["nationalityAsIso31661Alpha3"], "Test nationalityAsIso31661Alpha3");
        assert_eq!(fetched["travelDocumentKind"], "passport");
        assert_eq!(fetched["travelDocumentNumber"], "Test travelDocumentNumber");
        assert_eq!(fetched["travelDocumentIssuerAsIso31661Alpha3"], "Test travelDocumentIssuerAsIso31661Alpha3");
        ...
        assert_eq!(fetched["consentedToDataSharing"], "yes");
        assert_eq!(fetched["signatureImageDataUrl"], "Test signatureImageDataUrl");
