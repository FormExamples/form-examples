# International Certificate of Vaccination or Prophylaxis (ICVP) — specification
...
- `bin/test-form international-certificate-of-vaccination-or-prophylaxis` exits cleanly.
...
- `bin/lily-html-refactor --check international-certificate-of-vaccination-or-prophylaxis` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `international-certificate-of-vaccination-or-prophylaxis.front-end-form-with-html.v1` (HTML)
  - `international-certificate-of-vaccination-or-prophylaxis.front-end-form-with-svelte.v1` (SvelteKit)
