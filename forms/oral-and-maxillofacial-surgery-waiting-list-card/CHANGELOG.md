# Changelog — Oral and Maxillofacial Surgery Waiting List Card
...
file only records changes scoped to the **Oral and Maxillofacial Surgery Waiting List Card** form.
