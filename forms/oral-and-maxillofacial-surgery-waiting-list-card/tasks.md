# Tasks: Oral and Maxillofacial Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/oral-and-maxillofacial-surgery-waiting-list-card/`.
...
- [x] `cargo loco new oral-and-maxillofacial-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form oral-and-maxillofacial-surgery-waiting-list-card` exits cleanly.
