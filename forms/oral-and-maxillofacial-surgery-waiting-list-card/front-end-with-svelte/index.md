# Oral and Maxillofacial Surgery Waiting List Card — SvelteKit practitioner form

Single-page wizard for practitioners (GPs, consultants, referral
co-ordinators) to place a patient on a oral and maxillofacial surgery waiting list. SvelteKit 2.x
