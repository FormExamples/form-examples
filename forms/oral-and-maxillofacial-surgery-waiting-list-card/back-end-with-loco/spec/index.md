# Oral and Maxillofacial Surgery Waiting List Card — back-end-with-loco spec

JSON API contract for the Oral and Maxillofacial Surgery Waiting List Card back-end. This file is the living
