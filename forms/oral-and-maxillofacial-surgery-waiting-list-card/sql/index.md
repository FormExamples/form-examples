# oral-and-maxillofacial-surgery-waiting-list-card — sql
...
- `omfs_waiting_list_card` — top-level waiting list card.
- `omfs_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `omfs_waiting_list_card_grade` — computed grading result.
- `omfs_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `omfs_waiting_list_card_grade_flag` — safety / operational flags fired
