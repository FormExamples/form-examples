# Oral and Maxillofacial Surgery Waiting List Card — PostgreSQL migrations
...
Child `omfs_waiting_list_card_*` tables reference
`omfs_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
