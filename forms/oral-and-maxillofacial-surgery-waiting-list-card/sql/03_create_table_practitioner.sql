-- Practitioner who places the patient on a oral and maxillofacial surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a oral and maxillofacial surgery waiting list card on behalf of the patient.';
