...
function storageKey(id: string): string {
	return `palliative-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank palliative assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the palliative assessment, with localStorage
