//! Palliative Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Palliative Assessment** medical form, built on the
...
//!
//! ```
//! use palliative_assessment_loco_crate::engine::types::AssessmentData;
//!
