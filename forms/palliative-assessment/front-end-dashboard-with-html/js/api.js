// Backend API client for the palliative MDT clinician dashboard.
//
...
window.PalliativeAssessmentDashboard.fetchPatients = fetchPatients;
window.PalliativeAssessmentDashboard.API_BASE = API_BASE;
})();
