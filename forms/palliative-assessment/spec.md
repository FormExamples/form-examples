# Palliative Assessment — specification
...
- `bin/test-form palliative-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check palliative-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `palliative-assessment.front-end-form-with-html.v1` (HTML)
  - `palliative-assessment.front-end-form-with-svelte.v1` (SvelteKit)
