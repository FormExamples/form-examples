...
- LocalStorage key `palliative-assessment.front-end-form-with-html.v1` (HTML) and
  `palliative-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
