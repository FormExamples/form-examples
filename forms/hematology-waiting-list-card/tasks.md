# Tasks: Hematology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/hematology-waiting-list-card/`.
...
- [x] `cargo loco new hematology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form hematology-waiting-list-card` exits cleanly.
