# Plan: Hematology Waiting List Card
...
months later. The Hematology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form hematology-waiting-list-card`.
