# Hematology Waiting List Card — PostgreSQL migrations
...
Child `hematology_waiting_list_card_*` tables reference
`hematology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
