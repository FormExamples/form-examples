# hematology-waiting-list-card — sql
...
- `hematology_waiting_list_card` — top-level waiting list card.
- `hematology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `hematology_waiting_list_card_grade` — computed grading result.
- `hematology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `hematology_waiting_list_card_grade_flag` — safety / operational flags fired
