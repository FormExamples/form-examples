# Hematology Waiting List Card — specification
...
hematology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form hematology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check hematology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `hematology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `hematology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
