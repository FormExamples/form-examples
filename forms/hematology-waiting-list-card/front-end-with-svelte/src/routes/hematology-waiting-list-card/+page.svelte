<script lang="ts">
	...
	const plural = 'hematology-waiting-list-cards';
</script>

<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		<p class="text-sm font-semibold uppercase tracking-wide text-primary">Hematology Waiting List Card</p>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/hematology-waiting-list-card/{plural}/new"
		...
		<a
			href="/hematology-waiting-list-card/{plural}"
