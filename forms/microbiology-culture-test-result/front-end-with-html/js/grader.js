...
// Microbiology Culture Test Result grader. Faithful vanilla-JavaScript port of
// the SvelteKit engine module `src/lib/engine/grader.ts`.
//
// Pure four-axis interpretation engine for a microbiology culture result:
...
//
// Invariant: a critical organism / result (positive blood culture, CSF isolate,
// CPE, or a flagged critical organism) auto-escalates Axis D to critical-alert
// and raises the critical-result-alert flag, regardless of the other axes. The
 ...
 * @param {MicrobiologyCultureResult} result
