...
// Microbiology Culture Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.MicrobiologyCultureTestResultDashboard`; display
// labels come from the form namespace `window.MicrobiologyCultureTestResult`
