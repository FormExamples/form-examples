 ...
 * `forms/microbiology-culture-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {SpecimenType} specimenType                    - cultured specimen type
...
// namespace, `window.MicrobiologyCultureTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.MicrobiologyCultureTestResultDashboard`.
})();
