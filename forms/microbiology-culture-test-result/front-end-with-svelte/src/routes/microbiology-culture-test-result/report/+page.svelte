<script lang="ts">
	...
	import Step2Specimen from '#lib/components/steps/Step2Specimen.svelte';
	import Step3ClinicalHistory from '#lib/components/steps/Step3ClinicalHistory.svelte';
	import Step4MicroscopyCulture from '#lib/components/steps/Step4MicroscopyCulture.svelte';
	import Step5SensitivitiesResistance from '#lib/components/steps/Step5SensitivitiesResistance.svelte';
	...
	function submit() {
		...
		goto('/microbiology-culture-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New microbiology culture report</h1>
	...
	<Form label="Microbiology culture test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2Specimen />
		<Step3ClinicalHistory />
		<Step4MicroscopyCulture />
		<Step5SensitivitiesResistance />
