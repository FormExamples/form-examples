...
Server-side Rust JSON API for the Microbiology Culture Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`microbiology_culture_test_result/`](microbiology_culture_test_result/) — one migration, SeaORM
