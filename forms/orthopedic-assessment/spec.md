...
- LocalStorage key `orthopedic-assessment.front-end-form-with-html.v1` (HTML) and
  `orthopedic-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
