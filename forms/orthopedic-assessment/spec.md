# Orthopaedic Assessment — specification
...
- `bin/test-form orthopedic-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check orthopedic-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `orthopedic-assessment.front-end-form-with-html.v1` (HTML)
  - `orthopedic-assessment.front-end-form-with-svelte.v1` (SvelteKit)
