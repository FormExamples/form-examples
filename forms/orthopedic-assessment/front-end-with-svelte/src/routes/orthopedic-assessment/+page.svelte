<script lang="ts">
	...
	// dashboard. The collection routes (`/orthopedic-assessments` and
	// `/orthopedic-assessments/new`) hold the actual functionality.
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/orthopedic-assessment/{plural}/new"
		...
		<a
			href="/orthopedic-assessment/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed DASH score and disability category, and filter
				by disability level and surgical candidacy.
			</p>
		...
		<dl class="mt-4 space-y-4 text-sm">
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Capture a structured orthopedic profile and produce a graded report — DASH disability
					score, disability category, and flagged issues — to support orthopedic surgical review.
				</dd>
			</div>
			<div>
				<dt class="font-semibold text-base-content">Specification</dt>
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the DASH grading engine, and
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the DASH (Disabilities of the Arm, Shoulder and Hand) Outcome Measure, scored 0–100,
					with categories from no disability to very severe disability.
				</dd>
			</div>
		</dl>
	</section>
