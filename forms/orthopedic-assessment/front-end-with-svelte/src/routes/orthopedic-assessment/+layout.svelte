...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/orthopedic-assessment/" class="text-lg font-bold text-base-content">Orthopedic Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/orthopedic-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/orthopedic-assessment/orthopedic-assessments/new" class={navClass('/orthopedic-assessments/new')}>New assessment</a>
				<a href="/orthopedic-assessment/orthopedic-assessments" class={navClass('/orthopedic-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
