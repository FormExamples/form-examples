...
- LocalStorage key `plastic-surgery-assessment.front-end-form-with-html.v1` (HTML) and
  `plastic-surgery-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
