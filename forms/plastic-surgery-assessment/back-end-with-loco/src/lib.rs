//! Plastic Surgery Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Plastic Surgery Assessment** medical form, built on the
...
//!
//! ```
//! use plastic_surgery_assessment_loco_crate::engine::types::AssessmentData;
//!
