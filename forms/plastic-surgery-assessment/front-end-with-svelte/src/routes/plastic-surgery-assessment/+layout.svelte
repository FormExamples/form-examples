...
<svelte:head>
	<title>Plastic Surgery Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/plastic-surgery-assessment/" class="text-lg font-bold text-base-content">Plastic Surgery Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/plastic-surgery-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/plastic-surgery-assessment/plastic-surgery-assessments/new" class={navClass('/plastic-surgery-assessments/new')}>New assessment</a>
				<a href="/plastic-surgery-assessment/plastic-surgery-assessments" class={navClass('/plastic-surgery-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
