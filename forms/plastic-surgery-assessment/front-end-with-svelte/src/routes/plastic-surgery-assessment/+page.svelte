<script lang="ts">
	...
	// dashboard. The collection routes (`/plastic-surgery-assessments` and
	// `/plastic-surgery-assessments/new`) hold the actual functionality.
	const plural = 'plastic-surgery-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/plastic-surgery-assessment/{plural}/new"
		...
		<a
			href="/plastic-surgery-assessment/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed ASA / wound / complexity classifications and
				overall risk level, and filter by risk and ASA class.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the ASA / wound / complexity
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the ASA Physical Status Classification (I–V), the Surgical Wound Classification
					(I–IV), and a surgical complexity score (1–4).
				</dd>
			</div>
		</dl>
	</section>
