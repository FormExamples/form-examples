# Plastic Surgery Assessment — specification
...
- `bin/test-form plastic-surgery-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check plastic-surgery-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `plastic-surgery-assessment.front-end-form-with-html.v1` (HTML)
  - `plastic-surgery-assessment.front-end-form-with-svelte.v1` (SvelteKit)
