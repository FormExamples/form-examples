<script lang="ts">
	...
	import { calculateChildPughGrade } from '$lib/engine/child-pugh-grader';
	...
	import Step3TotalBilirubin from '$lib/components/steps/Step3TotalBilirubin.svelte';
	import Step4SerumAlbumin from '$lib/components/steps/Step4SerumAlbumin.svelte';
	import Step5Coagulation from '$lib/components/steps/Step5Coagulation.svelte';
	import Step6Ascites from '$lib/components/steps/Step6Ascites.svelte';
	import Step7Encephalopathy from '$lib/components/steps/Step7Encephalopathy.svelte';
	...
	function submit() {
		...
		assessment.result = calculateChildPughGrade(assessment.data);
		goto(`/child-pugh-score/child-pugh-scores/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New Child-Pugh assessment' : `Child-Pugh assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the eight sections; the Child-Pugh score and class are computed on submit.
	</p>
	...
	<Form label="Child-Pugh assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3TotalBilirubin />
		<Step4SerumAlbumin />
