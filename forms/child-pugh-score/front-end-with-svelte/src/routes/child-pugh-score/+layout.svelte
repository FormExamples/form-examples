...
<svelte:head>
	<title>Child-Pugh Score</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/child-pugh-score/" class="text-lg font-bold text-base-content">Child-Pugh score</a>
			<div class="flex items-center gap-1">
				<a href="/child-pugh-score/" class={navClass('/')}>Welcome</a>
				<a
					href="/child-pugh-score/child-pugh-scores/new"
					class={navClass('/child-pugh-scores/new')}>New assessment</a
				>
				<a
					href="/child-pugh-score/child-pugh-scores"
					class={navClass('/child-pugh-scores')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
