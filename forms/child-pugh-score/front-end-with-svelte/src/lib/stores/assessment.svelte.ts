...
function storageKey(id: string): string {
	return `child-pugh-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Child-Pugh assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Child-Pugh assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.bilirubin`) stay bound to live state.
	 */
