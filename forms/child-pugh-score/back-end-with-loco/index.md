...
Server-side Rust JSON API for the Child-Pugh Score (Child-Turcotte-Pugh) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`child_pugh_score/`](child_pugh_score/) — one migration, SeaORM
