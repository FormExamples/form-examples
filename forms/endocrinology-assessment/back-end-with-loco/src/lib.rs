//! Endocrinology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Endocrinology Assessment** medical form, built on the
...
//!
//! ```
//! use endocrinology_assessment_loco_crate::engine::types::AssessmentData;
//!
