# Endocrinology Assessment — specification
...
- `bin/test-form endocrinology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check endocrinology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `endocrinology-assessment.front-end-form-with-html.v1` (HTML)
  - `endocrinology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
