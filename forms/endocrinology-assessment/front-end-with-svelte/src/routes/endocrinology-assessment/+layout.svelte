...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/endocrinology-assessment/"
                class="text-lg font-bold text-base-content"
                >Endocrinology Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/endocrinology-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/endocrinology-assessment/endocrinology-assessments/new"
                    class={navClass("/endocrinology-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/endocrinology-assessment/endocrinology-assessments"
                    class={navClass("/endocrinology-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
