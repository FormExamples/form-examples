...
function storageKey(id: string): string {
	return `endocrinology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank endocrinology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the endocrinology assessment, with localStorage
