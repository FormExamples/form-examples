...
- LocalStorage key `endocrinology-assessment.front-end-form-with-html.v1` (HTML) and
  `endocrinology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
