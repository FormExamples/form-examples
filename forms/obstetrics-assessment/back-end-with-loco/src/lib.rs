//! Obstetrics Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Obstetrics Assessment** medical form, built on the
...
//!
//! ```
//! use obstetrics_assessment_loco_crate::engine::types::AssessmentData;
//!
