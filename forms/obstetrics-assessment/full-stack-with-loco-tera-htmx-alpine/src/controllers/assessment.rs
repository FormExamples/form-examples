...
use crate::engine::{antenatal_grader, types::AssessmentData};
...
async fn show_report(
    ...
    let grade = antenatal_grader::grade(&assessment_data);
    ...
    context.insert(
        "risk_level_label",
        &antenatal_grader::risk_level_label(&grade.risk_level),
    );
    context.insert(
        "risk_level_class",
        &antenatal_grader::risk_level_class(&grade.risk_level),
    );
