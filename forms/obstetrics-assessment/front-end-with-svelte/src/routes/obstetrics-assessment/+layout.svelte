...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/obstetrics-assessment/"
                class="text-lg font-bold text-base-content"
                >Obstetrics Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/obstetrics-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/obstetrics-assessment/obstetrics-assessments/new"
                    class={navClass("/obstetrics-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/obstetrics-assessment/obstetrics-assessments"
                    class={navClass("/obstetrics-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
