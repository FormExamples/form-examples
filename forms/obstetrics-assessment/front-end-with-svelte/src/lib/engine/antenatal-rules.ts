import type { NG201Rule } from './types';
 ...
 */
export const ng201Rules: NG201Rule[] = [
	// ─── Maternal age ─────────────────────────────────────────
	{
		id: 'NG201-AGE-001',
	...
	},
	{
		...
		evaluate: (d) => (d.obstetricHistory.previousPreEclampsia === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-OBS-003',
		category: 'Obstetric History',
		description: 'Previous preterm birth — high risk.',
		evaluate: (d) => (d.obstetricHistory.previousPretermBirth === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-OBS-004',
		category: 'Obstetric History',
		description: 'Previous gestational diabetes — moderate risk.',
		evaluate: (d) => (d.obstetricHistory.previousGestationalDiabetes === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-OBS-005',
		category: 'Obstetric History',
		description: 'Previous caesarean section — moderate risk.',
		evaluate: (d) => (d.obstetricHistory.previousCaesarean === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-OBS-006',
		category: 'Obstetric History',
		description: 'Previous postpartum haemorrhage — moderate risk.',
		evaluate: (d) => (d.obstetricHistory.previousPostpartumHaemorrhage === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-OBS-007',
		category: 'Obstetric History',
		description: 'Previous shoulder dystocia — moderate risk.',
		evaluate: (d) => (d.obstetricHistory.previousShoulderDystocia === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-OBS-008',
		category: 'Obstetric History',
	...
	},
	{
		...
		evaluate: (d) => (d.obstetricHistory.previousCongenitalAnomaly === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-OBS-010',
		category: 'Obstetric History',
	...
	// ─── Medical history ─────────────────────────────────────
	{
		...
		evaluate: (d) => (d.medicalHistory.cardiacDisease === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-002',
		category: 'Medical History',
		description: 'Pre-existing diabetes (Type 1 or Type 2) — high risk.',
		evaluate: (d) => (d.medicalHistory.preExistingDiabetes === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-003',
		category: 'Medical History',
		description: 'Chronic hypertension — high risk.',
		evaluate: (d) => (d.medicalHistory.chronicHypertension === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-004',
		category: 'Medical History',
		description: 'Renal disease — high risk.',
		evaluate: (d) => (d.medicalHistory.renalDisease === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-005',
		category: 'Medical History',
		description: 'Previous venous thromboembolism — high risk.',
		evaluate: (d) => (d.medicalHistory.previousVte === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-006',
		category: 'Medical History',
		description: 'Thrombophilia — high risk.',
		evaluate: (d) => (d.medicalHistory.thrombophilia === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-007',
		category: 'Medical History',
		description: 'HIV positive — high risk.',
		evaluate: (d) => (d.medicalHistory.hivPositive === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MED-008',
		category: 'Medical History',
		description: 'Autoimmune disease — moderate risk.',
		evaluate: (d) => (d.medicalHistory.autoimmuneDisease === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-MED-009',
		category: 'Medical History',
		description: 'Epilepsy — moderate risk.',
		evaluate: (d) => (d.medicalHistory.epilepsy === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-MED-010',
		category: 'Medical History',
		description: 'Thyroid disease — moderate risk.',
		evaluate: (d) => (d.medicalHistory.thyroidDisease === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-MED-011',
		category: 'Medical History',
		description: 'Hepatitis B or C — moderate risk.',
		evaluate: (d) => (d.medicalHistory.hepatitis === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-MED-012',
		category: 'Medical History',
		description: 'Bariatric surgery history — moderate risk.',
		evaluate: (d) => (d.medicalHistory.bariatricSurgery === 'yes' ? 'moderate' : null)
	},
	...
	// ─── Current pregnancy ────────────────────────────────────
	{
		...
		evaluate: (d) => (d.currentPregnancy.multiplePregnancy === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-PREG-002',
		category: 'Current Pregnancy',
		description: 'IVF / assisted conception — moderate risk.',
		evaluate: (d) => (d.currentPregnancy.ivfConception === 'yes' ? 'moderate' : null)
	},
	...
	// ─── Lifestyle / social ───────────────────────────────────
	{
		...
		evaluate: (d) => (d.lifestyleSocialFactors.smokingStatus === 'current' ? 'moderate' : null)
	},
	{
		id: 'NG201-SOCIAL-002',
		category: 'Lifestyle & Social',
	...
	},
	{
		...
		evaluate: (d) => (d.lifestyleSocialFactors.domesticAbuse === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-SOCIAL-005',
		category: 'Lifestyle & Social',
		description: 'Safeguarding concerns — high risk.',
		evaluate: (d) => (d.lifestyleSocialFactors.safeguardingConcerns === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-SOCIAL-006',
		category: 'Lifestyle & Social',
		description: 'Female genital mutilation — high risk.',
		evaluate: (d) => (d.lifestyleSocialFactors.femaleGenitalMutilation === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-SOCIAL-007',
		category: 'Lifestyle & Social',
		description: 'Asylum seeker / refugee — moderate risk.',
		evaluate: (d) => (d.lifestyleSocialFactors.asylumOrRefugee === 'yes' ? 'moderate' : null)
	},
	{
		id: 'NG201-SOCIAL-008',
		category: 'Lifestyle & Social',
		description: 'Housing insecurity — moderate risk.',
		evaluate: (d) => (d.lifestyleSocialFactors.housingInsecurity === 'yes' ? 'moderate' : null)
	},
	...
	// ─── Screening results ────────────────────────────────────
	{
		...
		evaluate: (d) => (d.screeningResults.combinedTestResult === 'higher-chance' ? 'high' : null)
	},
	{
		id: 'NG201-SCREEN-002',
		category: 'Screening',
		description: 'Glucose tolerance test diagnostic of GDM — high risk.',
		evaluate: (d) => (d.screeningResults.gttResult === 'gdm-confirmed' ? 'high' : null)
	},
	{
		id: 'NG201-SCREEN-003',
		category: 'Screening',
		description: 'Anomaly scan abnormal — high risk.',
		evaluate: (d) => (d.screeningResults.anomalyScanFindings === 'abnormal' ? 'high' : null)
	},
	{
		id: 'NG201-SCREEN-004',
		category: 'Screening',
		description: 'Red-cell antibody screen positive — high risk.',
		evaluate: (d) => (d.screeningResults.antibodyScreenPositive === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-SCREEN-005',
		category: 'Screening',
		description: 'Infection screen abnormal — moderate risk.',
		evaluate: (d) => (d.screeningResults.infectionScreenAbnormal === 'yes' ? 'moderate' : null)
	},
	...
	// ─── Mental health ────────────────────────────────────────
	{
		...
		evaluate: (d) => (d.mentalHealthAssessment.selfHarmIdeation === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MH-002',
		category: 'Mental Health',
		description: 'Previous severe mental illness — high risk.',
		evaluate: (d) => (d.mentalHealthAssessment.previousSevereMentalIllness === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-MH-003',
		category: 'Mental Health',
		...
		evaluate: (d) =>
			d.mentalHealthAssessment.whooley1 === 'yes' && d.mentalHealthAssessment.whooley2 === 'yes'
				? 'moderate'
				: null
	},
	{
	...
	},
	{
		...
		evaluate: (d) => {
			const gad2Map: Record<string, number> = {
				'not-at-all': 0,
				'several-days': 1,
				'more-than-half': 2,
				'nearly-every-day': 3
	...
	// ─── Fetal assessment ─────────────────────────────────────
	{
		...
		evaluate: (d) => (d.fetalAssessment.reducedFetalMovements === 'yes' ? 'high' : null)
	},
	{
		id: 'NG201-FETAL-002',
		category: 'Fetal Assessment',
		description: 'Growth concern (SGA / LGA / IUGR) — high risk.',
		evaluate: (d) => (d.fetalAssessment.growthConcern === 'yes' ? 'high' : null)
	}
];
