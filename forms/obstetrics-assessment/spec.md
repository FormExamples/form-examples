...
- LocalStorage key `obstetrics-assessment.front-end-form-with-html.v1` (HTML) and
  `obstetrics-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
