 ...
 * `forms/x-ray-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.XRayTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.XRayTestResultDashboard`.
})();
