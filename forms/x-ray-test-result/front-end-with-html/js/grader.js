// X-Ray Test Result grader. Faithful vanilla-JavaScript port of the
// SvelteKit engine module `src/lib/engine/grader.ts`.
//
// Pure four-axis interpretation engine for an X-ray result:
...
//
// Invariant: a critical finding (pneumothorax, free intraperitoneal air, or an
// unstable fracture) auto-escalates Axis D to critical-alert and raises the
