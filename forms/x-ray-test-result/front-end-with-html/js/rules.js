// Declarative four-axis grading rules for the X-Ray Test Result.
//
...
// `x_ray_test_result_grade_rule` SQL table.
//
...
/**
 * @typedef {import('./types.js').XRayResult} XRayResult
 ...
 * - critical: a critical structured finding (pneumothorax / free air /
 *   unstable fracture) is present.
...
function classifyResult(r) {
  ...
  if (hasCriticalFinding(r)) {
    firedRules.push({
      ...
      description:
        'A critical structured finding (pneumothorax, free intraperitoneal air, or unstable fracture) is present; classified as critical.'
    });
