...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "x_ray_test_results",
            ...
            ("projections", ColType::StringWithDefault(String::new())),
            ...
            ("dislocation", ColType::BooleanWithDefault(false)),
            ("consolidation", ColType::BooleanWithDefault(false)),
            ("pneumothorax", ColType::BooleanWithDefault(false)),
            ("pleural_effusion", ColType::BooleanWithDefault(false)),
            ("foreign_body", ColType::BooleanWithDefault(false)),
            ("free_air", ColType::BooleanWithDefault(false)),
            ("bony_lesion", ColType::BooleanWithDefault(false)),
