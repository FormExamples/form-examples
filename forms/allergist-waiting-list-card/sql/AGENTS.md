# Allergist Waiting List Card — PostgreSQL migrations
...
Child `allergist_waiting_list_card_*` tables reference
`allergist_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
