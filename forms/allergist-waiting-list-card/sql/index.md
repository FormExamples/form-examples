# allergist-waiting-list-card — sql
...
- `allergist_waiting_list_card` — top-level waiting list card.
- `allergist_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `allergist_waiting_list_card_grade` — computed grading result.
- `allergist_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `allergist_waiting_list_card_grade_flag` — safety / operational flags fired
