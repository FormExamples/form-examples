# Tasks: Allergist Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/allergist-waiting-list-card/`.
...
- [x] `cargo loco new allergist-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form allergist-waiting-list-card` exits cleanly.
