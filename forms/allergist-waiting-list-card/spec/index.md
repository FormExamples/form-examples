# Allergist Waiting List Card — specification
...
allergist waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form allergist-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check allergist-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `allergist-waiting-list-card.front-end-with-html.v1` (HTML)
  - `allergist-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
