---
name: allergist-waiting-list-card-maintainer-skill
description: "Implementation workflow for maintaining and extending the Allergist Waiting List Card form (forms/allergist-waiting-list-card/) — editing its spec, schema, or engine, regenerating derived artefacts, and running its verify gates. Use when implementing a change to this form's spec, SQL schema, front-end, back-end, or personas. For the repo-wide workflow, use form-examples-maintainer-skill instead."
---

# Allergist Waiting List Card — Maintainer Skill

Implementation-facing companion to `allergist-waiting-list-card-skill` (this form's end-user concepts skill) and to `form-examples-maintainer-skill` (the repo-wide maintainer skill — read that one first for the golden rule, generators, and the full verify-gate catalogue). This skill is the one-form-scoped map.

## Directory layout

`forms/allergist-waiting-list-card/` contains:
...
```sh
bin/test-form allergist-waiting-list-card
bin/test-sql-apply allergist-waiting-list-card
bin/test-personas allergist-waiting-list-card
bin/test-e2e --html allergist-waiting-list-card
```
