# Plan: Allergist Waiting List Card
...
months later. The Allergist Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form allergist-waiting-list-card`.
