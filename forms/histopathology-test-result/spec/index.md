# Histopathology Test Result — specification
...
- `bin/test-form histopathology-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check histopathology-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `histopathology-test-result.front-end-with-html.v1` (HTML)
  - `histopathology-test-result.front-end-with-svelte.v1` (SvelteKit)
