import type { HistopathologyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a histopathology result.
 *
 * Computes:
 * - Axis A: result classification (normal / abnormal / critical / inconclusive).
 * - Axis B: abnormality severity + structured reporting category (grade/stage).
 ...
 */
export function calculateGrade(result: HistopathologyResult): GradingResult {
