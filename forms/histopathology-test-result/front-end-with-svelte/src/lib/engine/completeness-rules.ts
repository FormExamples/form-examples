import type { HistopathologyResult, FiredRule } from './types';
...
/**
 * The five mandatory report sections per RCPath structured-reporting standards:
 * clinical history, macroscopic description, microscopic description,
 ...
 */
export function gradeCompleteness(r: HistopathologyResult): {
