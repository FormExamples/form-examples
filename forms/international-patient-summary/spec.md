...
- LocalStorage key `international-patient-summary.front-end-form-with-html.v1` (HTML) and
  `international-patient-summary.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
