...
static welcome: Dir<'_> = include_dir!("src/international_patient_summary/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/international_patient_summary/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/international_patient_summary/mailers/auth/magic_link");
