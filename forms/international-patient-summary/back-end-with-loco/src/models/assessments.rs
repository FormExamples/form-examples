...
impl ActiveModel {
    /// Create a new in-progress IPS with empty data.
...
/// List IPS records with pagination (page is 0-indexed, per_page items each).
