//! International Patient Summary — Loco JSON API back-end.
//!
//! Server-side JSON API for the **International Patient Summary** medical form, built on the
...
//!
//! ```
//! use international_patient_summary_loco_crate::engine::types::AssessmentData;
//!
