// Backend API client for the IPS clinician dashboard.
//
...
window.InternationalPatientSummaryDashboard.fetchPatients = fetchPatients;
window.InternationalPatientSummaryDashboard.API_BASE = API_BASE;
})();
