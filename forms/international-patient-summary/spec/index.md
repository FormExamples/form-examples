...
- `bin/test-form international-patient-summary` exits cleanly.
...
- `bin/lily-html-refactor --check international-patient-summary` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `international-patient-summary.front-end-form-with-html.v1` (HTML)
  - `international-patient-summary.front-end-form-with-svelte.v1` (SvelteKit)
