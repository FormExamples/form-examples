...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/" class="text-lg font-bold text-base-content">International Patient Summary</a>
			<div class="flex items-center gap-1">
				<a href="/" class={navClass('/')}>Welcome</a>
				<a href="/international-patient-summaries/new" class={navClass('/international-patient-summaries/new')}>New IPS</a>
				<a href="/international-patient-summaries" class={navClass('/international-patient-summaries')}>Dashboard</a>
