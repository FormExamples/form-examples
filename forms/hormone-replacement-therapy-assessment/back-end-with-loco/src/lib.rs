//! Hormone Replacement Therapy Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Hormone Replacement Therapy Assessment** medical form, built on the
...
//!
//! ```
//! use hrt_assessment_loco_crate::engine::types::AssessmentData;
//!
