...
- LocalStorage key `hormone-replacement-therapy-assessment.front-end-form-with-html.v1` (HTML) and
  `hormone-replacement-therapy-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
