# Hormone Replacement Therapy Assessment — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (14 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form hormone-replacement-therapy-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check hormone-replacement-therapy-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `hormone-replacement-therapy-assessment.front-end-form-with-html.v1` (HTML)
  - `hormone-replacement-therapy-assessment.front-end-form-with-svelte.v1` (SvelteKit)
