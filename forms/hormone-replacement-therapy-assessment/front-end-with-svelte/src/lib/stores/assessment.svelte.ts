...
function storageKey(id: string): string {
	return `hormone-replacement-therapy-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank HRT assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the HRT assessment, with localStorage
