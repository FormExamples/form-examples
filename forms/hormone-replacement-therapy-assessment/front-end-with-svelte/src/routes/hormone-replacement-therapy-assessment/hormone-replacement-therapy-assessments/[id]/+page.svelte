<script lang="ts">
	...
	function submit() {
		...
		goto(`/hormone-replacement-therapy-assessment/hormone-replacement-therapy-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New HRT assessment' : `HRT assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the ten sections; the MRS score, severity, and HRT risk classification are computed on
		submit.
	</p>
	...
	<Form label="HRT assessment" onsubmit={submit}>
		<Step1Demographics />
