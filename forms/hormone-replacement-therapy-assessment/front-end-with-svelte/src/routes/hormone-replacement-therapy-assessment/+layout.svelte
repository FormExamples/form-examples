...
<svelte:head>
	<title>Hormone Replacement Therapy Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hormone-replacement-therapy-assessment/" class="text-lg font-bold text-base-content">Hormone Replacement Therapy Assessment</a
			>
			<div class="flex items-center gap-1">
				<a href="/hormone-replacement-therapy-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/hormone-replacement-therapy-assessment/hormone-replacement-therapy-assessments/new"
					class={navClass('/hormone-replacement-therapy-assessments/new')}>New assessment</a
				>
				<a
					href="/hormone-replacement-therapy-assessment/hormone-replacement-therapy-assessments"
					class={navClass('/hormone-replacement-therapy-assessments')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
