...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/hormone-replacement-therapy-assessment/"
                class="text-lg font-bold text-base-content"
                >Hormone Replacement Therapy Assessment</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/hormone-replacement-therapy-assessments/new",
                    )}>New assessment</a
                >
                <a
                    href="/hormone-replacement-therapy-assessment/hormone-replacement-therapy-assessments"
                    class={navClass("/hormone-replacement-therapy-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
