...
function storageKey(id: string): string {
	return `timi-risk-score-for-acute-coronary-syndrome.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank TIMI assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the TIMI assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.riskProfile`) stay bound to live state.
	 */
