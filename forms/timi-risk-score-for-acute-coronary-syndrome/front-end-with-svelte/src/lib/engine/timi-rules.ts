import type { TimiRule } from './types';
 ...
 * criterion is positive; the grader (`timi-grader.ts`) sums the points into the
 * total TIMI score (0-7), derives the risk band, and looks up the 14-day
 * composite-event risk. Rows mirror the
 * `timi_risk_score_for_acute_coronary_syndrome_grade_rule` SQL table.
 */
export const timiRules: TimiRule[] = [
	// ─── CRITERION 1: AGE >= 65 ───────────────────────────────────
	{
		id: 'R-AGE-OVER-65-01',
		criterion: 'age',
