...
static welcome: Dir<'_> = include_dir!("src/timi_risk_score_for_acute_coronary_syndrome/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/timi_risk_score_for_acute_coronary_syndrome/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/timi_risk_score_for_acute_coronary_syndrome/mailers/auth/magic_link");
