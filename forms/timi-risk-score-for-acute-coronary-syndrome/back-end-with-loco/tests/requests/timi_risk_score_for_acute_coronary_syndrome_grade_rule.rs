...
#[tokio::test]
#[serial]
async fn can_get_timi_risk_score_for_acute_coronary_syndrome_grade_rules() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/timi_risk_score_for_acute_coronary_syndrome_grade_rules").await;
