// Backend API client for the colonoscopy vetting dashboard.
//
...
window.ColonoscopyTestRequestDashboard.fetchRequests = fetchRequests;
window.ColonoscopyTestRequestDashboard.API_BASE = API_BASE;
})();
