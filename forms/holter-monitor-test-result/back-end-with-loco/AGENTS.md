...
Pure JSON API back-end for the Holter Monitor Test Result form, built with axum + Loco +
...
- [`holter_monitor_test_result/`](holter_monitor_test_result/) — the Loco crate (migrations, `src/models/`,
...
```sh
cd holter_monitor_test_result && cargo build && cargo test
```
