...
<Fieldset legend="3. Clinical History">
	<p class="hint">The clinical question and any comparison with previous ambulatory ECG studies.</p>
	...
	<Field label="Comparison with previous studies" inputId="comparisonWithPrevious">
		<TextAreaInput
