import type { HolterMonitorResult, GradingResult, Recommendation, FiredRule } from './types';
 ...
 */
export function calculateGrade(result: HolterMonitorResult): GradingResult {
