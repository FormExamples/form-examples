// Plain-JavaScript / JSDoc type definitions for the mammography vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (ACR 1-9 / NHSBSP).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Cancer-pathway triage tier emitted by Axis B (NICE NG12 escalation).
 * @typedef {'routine' | 'urgent' | 'two-week-wait' | 'emergency'} TriageTier
 */

/**
 * Clinical priority band emitted by Axis D.
 ...
 * @property {string} examType        - Requested exam type (kebab-case)
 ...
 * @property {boolean} twoWeekWaitEligible - Axis B two-week-wait eligibility
...
// before they read `window.MammographyTestRequestDashboard`.
})();
