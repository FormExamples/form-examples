# Mammography Test Request — plan

## Current status

Scaffolded to foundation depth: SQL schema (source of truth) is in place.
...
Imaging departments triage incoming mammography requests by clinical acuity and
...
and aligned with ACR Appropriateness Criteria / NHS Breast Screening Programme /
NICE NG12 guidance.
...
- Curated low-priority / urgent / two-week-wait example fixtures.
- ACR appropriateness lookup table per (indication × exam type × age band).
- BI-RADS-aligned previous-finding capture.
