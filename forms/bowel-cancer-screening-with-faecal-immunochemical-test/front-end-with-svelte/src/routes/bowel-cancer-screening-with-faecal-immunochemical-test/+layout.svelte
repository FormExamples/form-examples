...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/bowel-cancer-screening-with-faecal-immunochemical-test/"
                class="text-lg font-bold text-base-content"
                >Bowel cancer screening (FIT)</a
            >
            <div class="flex items-center gap-1">
                ...
                >
                <a
                    href="/bowel-cancer-screening-with-faecal-immunochemical-test/fit-screenings/new"
                    class={navClass("/fit-screenings/new")}>New screening</a
                >
                <a
                    href="/bowel-cancer-screening-with-faecal-immunochemical-test/fit-screenings"
                    class={navClass("/fit-screenings")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
