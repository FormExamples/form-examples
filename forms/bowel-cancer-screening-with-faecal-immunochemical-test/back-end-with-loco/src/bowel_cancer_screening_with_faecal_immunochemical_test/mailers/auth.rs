...
static welcome: Dir<'_> = include_dir!("src/bowel_cancer_screening_with_faecal_immunochemical_test/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/bowel_cancer_screening_with_faecal_immunochemical_test/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/bowel_cancer_screening_with_faecal_immunochemical_test/mailers/auth/magic_link");
