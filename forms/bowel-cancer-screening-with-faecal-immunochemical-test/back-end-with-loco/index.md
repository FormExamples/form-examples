...
Server-side Rust JSON API for the Bowel Cancer Screening with Faecal Immunochemical Test (FIT) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`bowel_cancer_screening_with_faecal_immunochemical_test/`](bowel_cancer_screening_with_faecal_immunochemical_test/) — one migration, SeaORM
