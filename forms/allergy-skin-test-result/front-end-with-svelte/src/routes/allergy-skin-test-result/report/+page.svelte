<script lang="ts">
	...
	import Step3ValidityControls from '#lib/components/steps/Step3ValidityControls.svelte';
	import Step4AllergensReactions from '#lib/components/steps/Step4AllergensReactions.svelte';
	import Step5ReactionSummary from '#lib/components/steps/Step5ReactionSummary.svelte';
	...
	function submit() {
		...
		goto('/allergy-skin-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New allergy skin test report</h1>
	...
	<Form label="Allergy skin test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2ClinicalHistory />
		<Step3ValidityControls />
		<Step4AllergensReactions />
		<Step5ReactionSummary />
