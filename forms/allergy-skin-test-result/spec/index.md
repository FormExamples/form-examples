# Allergy Skin Test Result — specification
...
- `bin/test-form allergy-skin-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check allergy-skin-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `allergy-skin-test-result.front-end-with-html.v1` (HTML)
  - `allergy-skin-test-result.front-end-with-svelte.v1` (SvelteKit)
