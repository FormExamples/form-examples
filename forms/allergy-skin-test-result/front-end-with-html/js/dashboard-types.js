 ...
 * `forms/allergy-skin-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.AllergySkinTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.AllergySkinTestResultDashboard`.
})();
