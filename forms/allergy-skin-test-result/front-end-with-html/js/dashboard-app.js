// Allergy Skin Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.AllergySkinTestResultDashboard`; display labels come
// from the form namespace `window.AllergySkinTestResult` (js/types.js). The
