...
Server-side Rust JSON API for the Allergy Skin Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`allergy_skin_test_result/`](allergy_skin_test_result/) — one migration, SeaORM
