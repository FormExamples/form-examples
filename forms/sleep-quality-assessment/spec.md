# Sleep Quality Assessment — specification
...
- `bin/test-form sleep-quality-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check sleep-quality-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `sleep-quality-assessment.front-end-form-with-html.v1` (HTML)
  - `sleep-quality-assessment.front-end-form-with-svelte.v1` (SvelteKit)
