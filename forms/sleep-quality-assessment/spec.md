...
- LocalStorage key `sleep-quality-assessment.front-end-form-with-html.v1` (HTML) and
  `sleep-quality-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
