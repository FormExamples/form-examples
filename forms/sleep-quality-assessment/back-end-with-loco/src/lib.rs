//! Sleep Quality Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Sleep Quality Assessment** medical form, built on the
...
//!
//! ```
//! use sleep_quality_assessment_loco_crate::engine::types::AssessmentData;
//!
