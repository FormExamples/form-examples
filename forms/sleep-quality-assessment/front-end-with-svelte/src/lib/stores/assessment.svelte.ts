...
function storageKey(id: string): string {
	return `sleep-quality-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank sleep quality assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the sleep quality assessment, with localStorage
