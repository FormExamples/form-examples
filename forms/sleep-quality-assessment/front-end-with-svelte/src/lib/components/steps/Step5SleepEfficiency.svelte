<script lang="ts">
	...
	import { sleepEfficiencyCalc } from '#lib/engine/utils.js';
...
<Fieldset title="Sleep Efficiency" description="The proportion of time in bed spent actually sleeping">
	...
	{#if efficiency !== null}
		<div class="mt-4 rounded-lg border p-4 {efficiency >= 85 ? 'border-success bg-success/10' : efficiency >= 75 ? 'border-warning bg-warning/10' : 'border-error bg-error/10'}">
