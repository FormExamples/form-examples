//! Employee Onboarding Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Employee Onboarding Checklist** medical form, built on the
...
//!
//! ```
//! use employee_onboarding_checklist_loco_crate::engine::types::AssessmentData;
//!
