...
static welcome: Dir<'_> = include_dir!("src/employee_onboarding_checklist/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/employee_onboarding_checklist/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/employee_onboarding_checklist/mailers/auth/magic_link");
