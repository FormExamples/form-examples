# Employee Onboarding Checklist: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Employee Onboarding Checklist form. Pure back-end: no HTML
