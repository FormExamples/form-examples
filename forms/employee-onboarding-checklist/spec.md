# Employee Onboarding Checklist — specification
...
- `bin/test-form employee-onboarding-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check employee-onboarding-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `employee-onboarding-checklist.front-end-form-with-html.v1` (HTML)
  - `employee-onboarding-checklist.front-end-form-with-svelte.v1` (SvelteKit)
