...
- LocalStorage key `employee-onboarding-checklist.front-end-form-with-html.v1` (HTML) and
  `employee-onboarding-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
