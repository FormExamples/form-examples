//! Substance Abuse Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Substance Abuse Assessment** medical form, built on the
...
//!
//! ```
//! use substance_abuse_assessment_loco_crate::engine::types::AssessmentData;
//!
