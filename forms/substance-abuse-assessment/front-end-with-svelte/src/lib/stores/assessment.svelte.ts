...
function storageKey(id: string): string {
	return `substance-abuse-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank substance abuse assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the substance abuse assessment, with localStorage
