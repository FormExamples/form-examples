...
- LocalStorage key `substance-abuse-assessment.front-end-form-with-html.v1` (HTML) and
  `substance-abuse-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
