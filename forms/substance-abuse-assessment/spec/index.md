# Substance Abuse Assessment — specification
...
- `bin/test-form substance-abuse-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check substance-abuse-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `substance-abuse-assessment.front-end-form-with-html.v1` (HTML)
  - `substance-abuse-assessment.front-end-form-with-svelte.v1` (SvelteKit)
