# dermatology-waiting-list-card — sql
...
- `dermatology_waiting_list_card` — top-level waiting list card.
- `dermatology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `dermatology_waiting_list_card_grade` — computed grading result.
- `dermatology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `dermatology_waiting_list_card_grade_flag` — safety / operational flags fired
