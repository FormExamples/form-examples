# Dermatology Waiting List Card — PostgreSQL migrations
...
Child `dermatology_waiting_list_card_*` tables reference
`dermatology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
