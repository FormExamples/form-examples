# Dermatology Waiting List Card — specification
...
dermatology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form dermatology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check dermatology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `dermatology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `dermatology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
