# Tasks: Dermatology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/dermatology-waiting-list-card/`.
...
- [x] `cargo loco new dermatology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form dermatology-waiting-list-card` exits cleanly.
