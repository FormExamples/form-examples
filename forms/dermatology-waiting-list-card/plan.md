# Plan: Dermatology Waiting List Card
...
months later. The Dermatology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form dermatology-waiting-list-card`.
