//! Legal Requirements Privacy Notice — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Legal Requirements Privacy Notice** medical form, built on the
...
//!
//! ```
//! use legal_requirements_privacy_notice_loco_crate::engine::types::AssessmentData;
//!
