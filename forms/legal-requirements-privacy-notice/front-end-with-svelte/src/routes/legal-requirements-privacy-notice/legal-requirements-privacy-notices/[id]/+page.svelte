<script lang="ts">
	...
	function submit() {
		...
		goto(`/legal-requirements-privacy-notice/legal-requirements-privacy-notices/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	...
	<Form label="Legal requirements privacy notice acknowledgment" onsubmit={submit}>
