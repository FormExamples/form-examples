...
export function buildPdf(data: AgileChecklist, result: GradingResult): void {
  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      {
        text: `${result.maturity.toUpperCase()} — overall ${pctOrDash(
  ...
  pdfMake.createPdf(docDefinition).download('agile-checklist.pdf');
}
