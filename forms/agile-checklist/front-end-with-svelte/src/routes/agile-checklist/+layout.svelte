...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/agile-checklist/" class="text-lg font-bold text-base-content">Agile Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/agile-checklist/" class={navClass('/')}>Welcome</a>
				<a href="/agile-checklist/agile-checklists/new" class={navClass('/agile-checklists/new')}>New checklist</a>
				<a href="/agile-checklist/agile-checklists" class={navClass('/agile-checklists')}>Dashboard</a>
