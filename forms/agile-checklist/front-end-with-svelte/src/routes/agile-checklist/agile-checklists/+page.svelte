<script lang="ts">
	...
	import { maturityLabel, bandLabel, pctOrDash } from '#lib/engine/utils.js';
	import type { Band, Maturity } from '#lib/engine/types.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/agile-checklist/agile-checklists/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/agile-checklist/agile-checklists/new" class="button" data-variant="primary">New checklist</a>
	</div>
