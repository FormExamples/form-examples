//! Agile Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Agile Checklist** medical form, built on the
...
//!
//! ```
//! use agile_checklist_loco_crate::engine::types::AssessmentData;
//!
