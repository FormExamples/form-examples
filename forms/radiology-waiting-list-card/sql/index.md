# radiology-waiting-list-card — sql
...
- `radiology_waiting_list_card` — top-level waiting list card.
- `radiology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `radiology_waiting_list_card_grade` — computed grading result.
- `radiology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `radiology_waiting_list_card_grade_flag` — safety / operational flags fired
