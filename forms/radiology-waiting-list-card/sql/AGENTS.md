# Radiology Waiting List Card — PostgreSQL migrations
...
Child `radiology_waiting_list_card_*` tables reference
`radiology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
