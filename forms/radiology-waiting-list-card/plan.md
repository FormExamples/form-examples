# Plan: Radiology Waiting List Card
...
months later. The Radiology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form radiology-waiting-list-card`.
