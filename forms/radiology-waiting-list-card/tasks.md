# Tasks: Radiology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/radiology-waiting-list-card/`.
...
- [x] `cargo loco new radiology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form radiology-waiting-list-card` exits cleanly.
