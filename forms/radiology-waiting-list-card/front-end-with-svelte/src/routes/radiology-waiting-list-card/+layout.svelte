...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/radiology-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >Radiology Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                <a href="/radiology-waiting-list-card/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/radiology-waiting-list-card/radiology-waiting-list-cards/new"
                    class={navClass("/radiology-waiting-list-cards/new")}
                    >New card</a
                >
                <a
                    href="/radiology-waiting-list-card/radiology-waiting-list-cards"
                    class={navClass("/radiology-waiting-list-cards")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
