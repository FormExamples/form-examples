# Radiology Waiting List Card — specification
...
radiology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form radiology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check radiology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `radiology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `radiology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
