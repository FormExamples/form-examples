...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-driver-and-vehicle-licensing-agency-v1-form/" class="text-lg font-bold text-base-content">UK DVLA V1 Form</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-driver-and-vehicle-licensing-agency-v1-form/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-driver-and-vehicle-licensing-agency-v1-form/{plural}/new" class={navClass(`/${plural}/new`)}>New form</a>
				<a href="/united-kingdom-driver-and-vehicle-licensing-agency-v1-form/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
