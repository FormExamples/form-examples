...
>
	<div class="mb-4 rounded-lg border border-info/40 bg-info/10 p-3 text-sm text-base-content">
		<p class="mb-2">
	...
	<div class="mb-4 rounded-lg border border-base-300 bg-base-200 p-4 text-sm text-base-content">
