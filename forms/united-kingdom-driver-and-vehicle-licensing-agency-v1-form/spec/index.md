# United Kingdom Driver and Vehicle Licensing Agency V1 Form — specification
...
- `bin/test-form united-kingdom-driver-and-vehicle-licensing-agency-v1-form` exits cleanly.
...
- `bin/lily-html-refactor --check united-kingdom-driver-and-vehicle-licensing-agency-v1-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-driver-and-vehicle-licensing-agency-v1-form.front-end-form-with-html.v1` (HTML)
  - `united-kingdom-driver-and-vehicle-licensing-agency-v1-form.front-end-form-with-svelte.v1` (SvelteKit)
