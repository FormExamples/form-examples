...
- LocalStorage key `united-kingdom-driver-and-vehicle-licensing-agency-v1-form.front-end-form-with-html.v1` (HTML) and
  `united-kingdom-driver-and-vehicle-licensing-agency-v1-form.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
