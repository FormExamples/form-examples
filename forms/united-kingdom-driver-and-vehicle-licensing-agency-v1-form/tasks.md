...
- [ ] Implement patient form frontend with HTML/CSS/JS (14 steps)
- [ ] Implement patient form frontend with SvelteKit/Tailwind (14 steps)
- [ ] Implement conditional logic (per-question branching)
- [ ] Implement clinician dashboard with HTML/CSS/JS
- [ ] Implement clinician dashboard with SvelteKit/SVAR DataGrid
