...
static welcome: Dir<'_> = include_dir!("src/united_kingdom_driver_and_vehicle_licensing_agency_v1_form/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/united_kingdom_driver_and_vehicle_licensing_agency_v1_form/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/united_kingdom_driver_and_vehicle_licensing_agency_v1_form/mailers/auth/magic_link");
