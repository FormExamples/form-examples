...
/**
 * Detects clinically concerning patterns in the V1 self-declaration that
 * warrant DVLA medical-adviser review. The V1 form is primarily a data
 ...
 *
 * Priority ladder:
 *   urgent — patient asserts they do not meet the eyesight standard.
 *   high   — uncontrolled vision condition (blepharospasm, double vision,
 *            field defect) likely to bar driving until resolved.
