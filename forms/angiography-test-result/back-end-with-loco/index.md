...
Server-side Rust JSON API for the Angiography Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`angiography_test_result/`](angiography_test_result/) — one migration, SeaORM
