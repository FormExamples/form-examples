<script lang="ts">
	...
	function submit() {
		...
		goto('/angiography-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New angiography report</h1>
	...
	<Form label="Angiography test result" onsubmit={submit}>
