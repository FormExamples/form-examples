import type { AngiographyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for an angiography result.
 *
 * Computes:
 ...
 * or a critical near-occlusive stenosis) auto-escalates Axis D to critical-alert
 ...
 */
export function calculateGrade(result: AngiographyResult): GradingResult {
