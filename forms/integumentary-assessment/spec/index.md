# Integumentary Assessment — specification
...
- `bin/test-form integumentary-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check integumentary-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `integumentary-assessment.front-end-form-with-html.v1` (HTML)
  - `integumentary-assessment.front-end-form-with-svelte.v1` (SvelteKit)
