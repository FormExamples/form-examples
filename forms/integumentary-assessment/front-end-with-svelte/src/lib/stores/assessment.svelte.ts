...
function storageKey(id: string): string {
	return `integumentary-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank integumentary assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the integumentary assessment, with localStorage
