//! Integumentary Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Integumentary Assessment** medical form, built on the
...
//!
//! ```
//! use integumentary_assessment_loco_crate::engine::types::AssessmentData;
//!
