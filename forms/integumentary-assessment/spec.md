...
- LocalStorage key `integumentary-assessment.front-end-form-with-html.v1` (HTML) and
  `integumentary-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
