...
use crate::engine::{integumentary_grader, types::AssessmentData};
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "presenting_skin_concern" => "presentingSkinConcern",
        "skin_inspection" => "skinInspection",
        "hair_scalp_examination" => "hairScalpExamination",
        ...
        "clinical_impression_care_plan" => "clinicalImpressionCarePlan",
        other => other,
    }
}
...
async fn show_report(
    ...
    let grade = integumentary_grader::grade(&assessment_data);
    ...
    context.insert("braden_score", &grade.braden_score);
