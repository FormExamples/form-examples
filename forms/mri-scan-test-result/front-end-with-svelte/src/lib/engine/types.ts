// ──────────────────────────────────────────────
// MRI Scan Test Result — core data types
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_mri_scan_test_result.sql and
...
export type ContrastUsed = 'none' | 'iv-gadolinium' | '';
 ...
 */
export interface MriScanResult {
