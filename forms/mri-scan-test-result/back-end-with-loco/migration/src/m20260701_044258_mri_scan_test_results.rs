...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "mri_scan_test_results",
            ...
            ("sequences_performed", ColType::StringWithDefault(String::new())),
            ...
            ("demyelination", ColType::BooleanWithDefault(false)),
            ("disc_herniation", ColType::BooleanWithDefault(false)),
            ("cord_compression", ColType::BooleanWithDefault(false)),
