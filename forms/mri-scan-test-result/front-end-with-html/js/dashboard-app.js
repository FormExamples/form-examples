// MRI Scan Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.MriScanTestResultDashboard`; display labels come
// from the form namespace `window.MriScanTestResult` (js/types.js). The
