 ...
 * `forms/mri-scan-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.MriScanTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.MriScanTestResultDashboard`.
})();
