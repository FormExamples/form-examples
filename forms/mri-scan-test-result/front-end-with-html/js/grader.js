// MRI Scan Test Result grader. Faithful vanilla-JavaScript port of the
// SvelteKit engine module `src/lib/engine/grader.ts`.
//
// Pure four-axis interpretation engine for an MRI scan result:
...
//
// Invariant: a critical finding (cord / cauda-equina compression, haemorrhage,
// or infarct) auto-escalates Axis D to critical-alert and raises the
