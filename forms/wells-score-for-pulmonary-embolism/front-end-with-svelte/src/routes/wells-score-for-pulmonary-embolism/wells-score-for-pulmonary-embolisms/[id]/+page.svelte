<script lang="ts">
	...
	import { calculateWellsGrade } from '#lib/engine/wells-pe-grader.js';
	...
	import Step3Haemodynamic from '#lib/components/steps/Step3Haemodynamic.svelte';
	import Step4Criteria from '#lib/components/steps/Step4Criteria.svelte';
	...
	function submit() {
		...
		assessment.result = calculateWellsGrade(assessment.data);
		goto(`/wells-score-for-pulmonary-embolism/wells-score-for-pulmonary-embolisms/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New Wells PE assessment' : `Wells PE assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the six sections; the Wells score, bands, and recommended pathway are computed on
		submit.
	</p>
	...
	<Form label="Wells PE assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3Haemodynamic />
		<Step4Criteria />
