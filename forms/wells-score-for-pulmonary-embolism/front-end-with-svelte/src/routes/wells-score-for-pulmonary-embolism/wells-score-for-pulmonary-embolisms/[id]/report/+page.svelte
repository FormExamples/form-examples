<script lang="ts">
	...
	$effect(() => {
		if (!assessment.result) {
			goto(`/wells-score-for-pulmonary-embolism/wells-score-for-pulmonary-embolisms/${id}`);
		}
	});
		...
		<div class="mx-auto flex max-w-4xl items-center justify-between px-4 py-4">
			...
			<div class="flex items-center gap-3">
				...
				<Button
					...
					onclick={() => goto(`/wells-score-for-pulmonary-embolism/wells-score-for-pulmonary-embolisms/${id}`)}>Edit</Button
				>
			</div>
		</div>
	</header>
