...
function storageKey(id: string): string {
	return `wells-score-for-pulmonary-embolism.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Wells PE assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Wells PE assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.criteria`) stay bound to live state.
	 */
