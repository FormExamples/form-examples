...
/**
 * Total Wells PE score — numeric 0..12.5 (may be fractional, e.g. 4.5), or null
 * when not yet scored.
 *
...
/**
 * Recommended next diagnostic step, derived from the two-level band.
 *
 * @typedef {'ctpa' | 'd-dimer'} RecommendedPathway
 */
 ...
 * `forms/wells-score-for-pulmonary-embolism/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {WellsScore} wellsScore     - total Wells PE score (0..12.5) or null
 * @property {TwoLevelBand} twoLevelBand - derived two-level band
 * @property {RecommendedPathway} recommendedPathway - derived next step
...
// before they read `window.WellsScoreForPulmonaryEmbolismDashboard`.
})();
