...
Server-side Rust JSON API for the Wells Score for Pulmonary Embolism form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`wells_score_for_pulmonary_embolism/`](wells_score_for_pulmonary_embolism/) — one migration, SeaORM
