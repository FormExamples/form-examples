...
static welcome: Dir<'_> = include_dir!("src/wells_score_for_pulmonary_embolism/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/wells_score_for_pulmonary_embolism/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/wells_score_for_pulmonary_embolism/mailers/auth/magic_link");
