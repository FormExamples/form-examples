# Wells Score for Pulmonary Embolism — tasks
...
- [x] Scoring engine (`types.ts`, `utils.ts`, `wells-pe-rules.ts`,
      `wells-pe-grader.ts`, `flagged-issues.ts`) + Vitest tests.
...
- [ ] `bin/test-form wells-score-for-pulmonary-embolism` passes
