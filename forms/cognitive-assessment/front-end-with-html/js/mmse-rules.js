// MMSE (Mini-Mental State Examination) scoring item definitions.
//
...
/**
 * @typedef {Object} MMSERuleDefinition
 * @property {string} id
...
/**
 * Maximum points per high-level domain (for the breakdown table).
 * @type {Record<string, number>}
 */
const mmseDomainMaxScores = {
  'Orientation': 10,
  'Registration': 3,
