...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/cognitive-assessment/" class="text-lg font-bold text-base-content">Cognitive Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/cognitive-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/cognitive-assessment/cognitive-assessments/new" class={navClass('/cognitive-assessments/new')}>New assessment</a>
				<a href="/cognitive-assessment/cognitive-assessments" class={navClass('/cognitive-assessments')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
