//! Cognitive Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Cognitive Assessment** medical form, built on the
...
//!
//! ```
//! use cognitive_assessment_loco_crate::engine::types::AssessmentData;
//!
