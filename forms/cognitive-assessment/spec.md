# Cognitive Assessment — specification
...
- `bin/test-form cognitive-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check cognitive-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cognitive-assessment.front-end-form-with-html.v1` (HTML)
  - `cognitive-assessment.front-end-form-with-svelte.v1` (SvelteKit)
