//! United Kingdom Statement of Fitness for Work — Loco JSON API back-end.
//!
//! Server-side JSON API for the **United Kingdom Statement of Fitness for Work** medical form, built on the
