...
static welcome: Dir<'_> = include_dir!("src/united_kingdom_statement_of_fitness_for_work/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/united_kingdom_statement_of_fitness_for_work/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/united_kingdom_statement_of_fitness_for_work/mailers/auth/magic_link");
