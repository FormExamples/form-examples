...
#[tokio::test]
#[serial]
async fn can_get_united_kingdom_statement_of_fitness_for_work_grade_rules() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/united_kingdom_statement_of_fitness_for_work_grade_rules").await;
