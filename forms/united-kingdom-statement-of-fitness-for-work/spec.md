...
- LocalStorage key `united-kingdom-statement-of-fitness-for-work.front-end-form-with-html.v1` (HTML) and
  `united-kingdom-statement-of-fitness-for-work.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
