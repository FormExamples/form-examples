...
<svelte:head>
	<title>UK Statement of Fitness for Work</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-statement-of-fitness-for-work/" class="text-lg font-bold text-base-content">UK Statement of Fitness for Work</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-statement-of-fitness-for-work/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-statement-of-fitness-for-work/{plural}/new" class={navClass(`/${plural}/new`)}>New fit note</a>
				<a href="/united-kingdom-statement-of-fitness-for-work/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
