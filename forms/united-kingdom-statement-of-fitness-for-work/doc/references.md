# References — Statement of Fitness for Work
...
- HMRC — Statutory Sick Pay (employer guide).
  <https://www.gov.uk/employers-sick-pay>
- HMRC — SC2 employee self-certification of sickness.
...
- Statutory Sick Pay (Medical Evidence) Regulations 1985 (SI 1985/1604).
...
- Equality Act 2010 (c. 15), in particular sections 20–22 (reasonable
  adjustments) and Schedule 1 (disability).
...
- Health and Care Professions Council (HCPC) — occupational therapists
...
- ISO/IEC/IEEE 26514:2022 — Design and development of information for
  users. <https://www.iso.org/standard/77451.html>
- MDCG 2019-11 Rev.1 — Software qualification and classification under
  MDR / IVDR.
