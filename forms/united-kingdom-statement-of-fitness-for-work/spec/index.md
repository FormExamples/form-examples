...
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-statement-of-fitness-for-work.front-end-with-html.v1` (HTML)
  - `united-kingdom-statement-of-fitness-for-work.front-end-with-svelte.v1` (SvelteKit)
