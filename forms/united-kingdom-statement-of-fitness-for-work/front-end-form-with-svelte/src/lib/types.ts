/**
 * UK Statement of Fitness for Work — TypeScript types.
 *
 * Port of `../front-end-form-with-html/js/types.js`. Field names use
 * camelCase and mirror the SQL schema (snake_case) and the Rust structs
