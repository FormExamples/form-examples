...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/anion-gap-calculator/" class="text-lg font-bold text-base-content">Anion gap</a>
			<div class="flex items-center gap-1">
				<a href="/anion-gap-calculator/" class={navClass('/')}>Welcome</a>
				<a
					href="/anion-gap-calculator/anion-gap-calculators/new"
					class={navClass('/anion-gap-calculators/new')}>New calculation</a
				>
				<a href="/anion-gap-calculator/anion-gap-calculators" class={navClass('/anion-gap-calculators')}>Dashboard</a>
