...
<svelte:head>
	<title>Encounter Satisfaction</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/encounter-satisfaction/" class="text-lg font-bold text-base-content">Encounter Satisfaction</a>
			<div class="flex items-center gap-1">
				<a href="/encounter-satisfaction/" class={navClass('/')}>Welcome</a>
				<a href="/encounter-satisfaction/encounter-satisfactions/new" class={navClass('/encounter-satisfactions/new')}>New survey</a>
				<a href="/encounter-satisfaction/encounter-satisfactions" class={navClass('/encounter-satisfactions')}>Dashboard</a>
