// 19 Encounter Satisfaction Score (ESS) questions across 6 domains.
// Each question is rated on a 5-point Likert scale (1=Very Dissatisfied
// ... 5=Very Satisfied). Section names match the keys on AssessmentData.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} SatisfactionQuestion
 * @property {string} id
 * @property {string} domain      Display label of the domain
 * @property {string} section     Key on AssessmentData
 * @property {string} field       Property within the section
