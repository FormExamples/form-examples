use encounter_satisfaction_loco_crate::engine::satisfaction_grader::calculate_satisfaction;
use encounter_satisfaction_loco_crate::engine::satisfaction_rules::all_rules;
use encounter_satisfaction_loco_crate::engine::types::*;
