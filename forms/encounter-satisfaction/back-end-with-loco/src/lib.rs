//! Encounter Satisfaction — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Encounter Satisfaction** medical form, built on the
...
//!
//! ```
//! use encounter_satisfaction_loco_crate::engine::types::AssessmentData;
//!
