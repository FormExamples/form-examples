...
static welcome: Dir<'_> = include_dir!("src/encounter_satisfaction/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/encounter_satisfaction/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/encounter_satisfaction/mailers/auth/magic_link");
