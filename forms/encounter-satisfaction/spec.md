...
- LocalStorage key `encounter-satisfaction.front-end-form-with-html.v1` (HTML) and
  `encounter-satisfaction.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
