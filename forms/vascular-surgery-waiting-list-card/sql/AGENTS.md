# Vascular Surgery Waiting List Card — PostgreSQL migrations
...
Child `vasc_surgery_waiting_list_card_*` tables reference
`vasc_surgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
