-- Practitioner who places the patient on a vascular surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a vascular surgery waiting list card on behalf of the patient.';
