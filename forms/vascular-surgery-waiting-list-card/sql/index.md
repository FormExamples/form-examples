# vascular-surgery-waiting-list-card — sql
...
- `vasc_surgery_waiting_list_card` — top-level waiting list card.
- `vasc_surgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `vasc_surgery_waiting_list_card_grade` — computed grading result.
- `vasc_surgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `vasc_surgery_waiting_list_card_grade_flag` — safety / operational flags fired
