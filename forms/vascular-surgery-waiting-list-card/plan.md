# Plan: Vascular Surgery Waiting List Card
...
months later. The Vascular Surgery Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form vascular-surgery-waiting-list-card`.
