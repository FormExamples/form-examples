# Tasks: Vascular Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/vascular-surgery-waiting-list-card/`.
...
- [x] `cargo loco new vascular-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form vascular-surgery-waiting-list-card` exits cleanly.
