# Vascular Surgery Waiting List Card — specification
...
vascular surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form vascular-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check vascular-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `vascular-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `vascular-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
