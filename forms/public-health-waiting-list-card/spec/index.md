# Public Health Waiting List Card — specification
...
public health waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form public-health-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check public-health-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `public-health-waiting-list-card.front-end-with-html.v1` (HTML)
  - `public-health-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form public-health-waiting-list-card
```
