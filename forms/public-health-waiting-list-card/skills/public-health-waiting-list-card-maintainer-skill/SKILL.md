...
bin/test-sql-apply public-health-waiting-list-card
bin/test-personas public-health-waiting-list-card
bin/test-e2e --html public-health-waiting-list-card
```
