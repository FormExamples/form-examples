# Plan: Public Health Waiting List Card
...
months later. The Public Health Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form public-health-waiting-list-card`.
