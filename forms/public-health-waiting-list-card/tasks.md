# Tasks: Public Health Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/public-health-waiting-list-card/`.
...
- [x] `cargo loco new public-health-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form public-health-waiting-list-card` exits cleanly.
