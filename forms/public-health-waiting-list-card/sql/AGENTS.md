# Public Health Waiting List Card — PostgreSQL migrations
...
Child `public_health_waiting_list_card_*` tables reference
`public_health_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
