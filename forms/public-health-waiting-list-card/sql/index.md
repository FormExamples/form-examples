# public-health-waiting-list-card — sql
...
- `public_health_waiting_list_card` — top-level waiting list card.
- `public_health_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `public_health_waiting_list_card_grade` — computed grading result.
- `public_health_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `public_health_waiting_list_card_grade_flag` — safety / operational flags fired
