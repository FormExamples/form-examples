-- Practitioner who places the patient on a public health waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a public health waiting list card on behalf of the patient.';
