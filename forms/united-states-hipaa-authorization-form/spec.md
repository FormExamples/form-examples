...
- LocalStorage key `united-states-hipaa-authorization-form.front-end-form-with-html.v1` (HTML) and
  `united-states-hipaa-authorization-form.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
