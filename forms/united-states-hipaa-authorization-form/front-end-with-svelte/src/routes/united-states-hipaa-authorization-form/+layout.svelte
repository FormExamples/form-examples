...
<svelte:head>
	<title>United States HIPAA Authorization Form</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-states-hipaa-authorization-form/" class="text-lg font-bold text-base-content">US HIPAA Authorization</a>
			<div class="flex items-center gap-1">
				<a href="/united-states-hipaa-authorization-form/" class={navClass('/')}>Welcome</a>
				<a
					href="/united-states-hipaa-authorization-form/united-states-hipaa-authorization-forms/new"
					class={navClass('/united-states-hipaa-authorization-forms/new')}>New authorization</a
				>
				<a
					href="/united-states-hipaa-authorization-form/united-states-hipaa-authorization-forms"
					class={navClass('/united-states-hipaa-authorization-forms')}>Dashboard</a
				>
