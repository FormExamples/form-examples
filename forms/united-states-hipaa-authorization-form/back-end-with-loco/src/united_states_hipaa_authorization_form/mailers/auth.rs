...
static welcome: Dir<'_> = include_dir!("src/united_states_hipaa_authorization_form/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/united_states_hipaa_authorization_form/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/united_states_hipaa_authorization_form/mailers/auth/magic_link");
