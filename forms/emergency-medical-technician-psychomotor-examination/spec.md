...
- LocalStorage key `emergency-medical-technician-psychomotor-examination.front-end-form-with-html.v1` (HTML) and
  `emergency-medical-technician-psychomotor-examination.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
