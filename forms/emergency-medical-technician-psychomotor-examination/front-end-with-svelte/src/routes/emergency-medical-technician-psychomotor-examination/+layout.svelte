...
<svelte:head>
	<title>Emergency Medical Technician Psychomotor Examination</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/emergency-medical-technician-psychomotor-examination/" class="text-lg font-bold text-base-content">EMT Psychomotor Examination</a>
			<div class="flex items-center gap-1">
				<a href="/emergency-medical-technician-psychomotor-examination/" class={navClass('/')}>Welcome</a>
				<a href="/emergency-medical-technician-psychomotor-examination/{plural}/new" class={navClass(`/${plural}/new`)}>New examination</a>
				<a href="/emergency-medical-technician-psychomotor-examination/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
