//! Emergency Medical Technician Psychomotor Examination — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Emergency Medical Technician Psychomotor Examination** medical form, built on the
...
//!
//! ```
//! use emergency_medical_technician_psychomotor_examination_loco_crate::engine::types::AssessmentData;
//!
