...
static welcome: Dir<'_> = include_dir!("src/emergency_medical_technician_psychomotor_examination/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/emergency_medical_technician_psychomotor_examination/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/emergency_medical_technician_psychomotor_examination/mailers/auth/magic_link");
