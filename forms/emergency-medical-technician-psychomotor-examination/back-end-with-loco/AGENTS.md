# Emergency Medical Technician Psychomotor Examination — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the Emergency Medical Technician Psychomotor Examination form, built with axum + Loco +
...
- [`emergency_medical_technician_psychomotor_examination/`](./emergency_medical_technician_psychomotor_examination/) — the Loco crate: `src/emergency_medical_technician_psychomotor_examination/` holds `app.rs`
...
`src/emergency_medical_technician_psychomotor_examination/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd emergency_medical_technician_psychomotor_examination && cargo check --all-targets && cargo test
```
