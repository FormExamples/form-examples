 ...
 * `forms/ct-scan-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {BodyRegion} bodyRegion                        - examined body region
...
// namespace, `window.CtScanTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.CtScanTestResultDashboard`.
})();
