// CT Scan Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.CtScanTestResultDashboard`; display labels come
// from the form namespace `window.CtScanTestResult` (js/types.js). The
...
const {
  fetchReports,
  sampleReports
} = window.CtScanTestResultDashboard;
const {
  bodyRegionLabel,
  reportStatusLabel,
