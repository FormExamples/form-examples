...
<Fieldset legend="4. Findings">
	...
	<Field label="Structured findings">
		<CheckboxGroup label="Structured findings">
			<label><CheckboxInput label="Acute finding" bind:checked={d.acuteFinding} /> Acute finding</label>
	...
	{#if d.haemorrhage || d.infarct}
		<Alert type="error" heading="Critical finding selected">
			<p>
				A haemorrhage or infarct auto-escalates the follow-up urgency to a critical alert. Ensure
