 ...
 */
export function hasCriticalFinding(r: CtScanResult): boolean {
	return r.haemorrhage || r.infarct;
}

/** Whether any structured abnormal finding is present. */
export function hasAnyAbnormalFinding(r: CtScanResult): boolean {
	return (
		r.acuteFinding ||
		r.massOrLesion ||
		r.haemorrhage ||
...
export function hasOnlyIncidentalFinding(r: CtScanResult): boolean {
