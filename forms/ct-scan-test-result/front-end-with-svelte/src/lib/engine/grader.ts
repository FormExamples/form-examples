import type { CtScanResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a CT scan result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (haemorrhage or infarct) auto-escalates Axis D
 ...
 */
export function calculateGrade(result: CtScanResult): GradingResult {
