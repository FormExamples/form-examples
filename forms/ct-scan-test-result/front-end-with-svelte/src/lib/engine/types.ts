// ──────────────────────────────────────────────
// CT Scan Test Result — core data types
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_ct_scan_test_result.sql and
...
export type ContrastUsed = 'none' | 'iv-iodinated' | 'oral' | 'both' | '';
...
export interface StructuredFindings {
	acuteFinding: boolean;
	massOrLesion: boolean;
	haemorrhage: boolean;
	infarct: boolean;
	fracture: boolean;
	infectionInflammation: boolean;
	obstruction: boolean;
