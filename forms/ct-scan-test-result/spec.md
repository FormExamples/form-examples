# CT Scan Test Result — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (0 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
| Subdirectory | Role |
| --- | --- |
| `sql-migrations` | source of truth — not implemented |
| `xml-representations` | generated — not implemented |
| `fhir-r5` | generated — not implemented |
| `protobuf` | generated |
| `openapi` | generated — not implemented |
| `front-end-form-with-html` | Lily contract — not implemented |
| `front-end-form-with-svelte` | SvelteKit — not implemented |
| `front-end-dashboard-with-html` | Lily contract — not implemented |
| `front-end-dashboard-with-svelte` | SvelteKit + SVAR — not implemented |
...
- `bin/test-form ct-scan-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check ct-scan-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `ct-scan-test-result.front-end-form-with-html.v1` (HTML)
  - `ct-scan-test-result.front-end-form-with-svelte.v1` (SvelteKit)
