<script lang="ts">
	...
	import Step3History from '#lib/components/steps/Step3History.svelte';
	import Step4Mobility from '#lib/components/steps/Step4Mobility.svelte';
	import Step5Cardiorespiratory from '#lib/components/steps/Step5Cardiorespiratory.svelte';
	import Step6Metabolic from '#lib/components/steps/Step6Metabolic.svelte';
	import Step7Bleeding from '#lib/components/steps/Step7Bleeding.svelte';
	...
	function submit() {
		...
		assessment.result = calculatePaduaGrade(assessment.data);
		goto(`/padua-venous-thromboembolism-risk-assessment/padua-venous-thromboembolism-risk-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New Padua VTE assessment' : `Padua VTE assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the eight sections; the Padua score and risk band are computed on submit.
	</p>
	...
	<Form label="Padua VTE assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3History />
		<Step4Mobility />
		<Step5Cardiorespiratory />
		<Step6Metabolic />
		<Step7Bleeding />
		<Step8Summary />
