...
<svelte:head>
	<title>Padua Venous Thromboembolism Risk Assessment (Padua Prediction Score)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/padua-venous-thromboembolism-risk-assessment/" class="text-lg font-bold text-base-content">Padua VTE</a>
			<div class="flex items-center gap-1">
				<a href="/padua-venous-thromboembolism-risk-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/padua-venous-thromboembolism-risk-assessment/padua-venous-thromboembolism-risk-assessments/new"
					class={navClass('/padua-venous-thromboembolism-risk-assessments/new')}>New assessment</a
				>
				<a
					href="/padua-venous-thromboembolism-risk-assessment/padua-venous-thromboembolism-risk-assessments"
					class={navClass('/padua-venous-thromboembolism-risk-assessments')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
