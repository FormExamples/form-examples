...
<Fieldset legend="Step 1 of 8 — Assessment context">
	<p class="hint">Who is assessing, when, where, and the reason for admission.</p>
	...
	<Field label="Reason for admission" inputId="context-admissionReason">
		<TextInput
			id="context-admissionReason"
			label="Reason for admission"
			placeholder="e.g. Community-acquired pneumonia"
			bind:value={c.admissionReason}
		/>
	</Field>
</Fieldset>
