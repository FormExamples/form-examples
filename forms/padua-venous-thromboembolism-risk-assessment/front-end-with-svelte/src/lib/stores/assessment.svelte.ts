...
function storageKey(id: string): string {
	return `padua-venous-thromboembolism-risk-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Padua assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Padua assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.history`) stay bound to live state.
	 */
