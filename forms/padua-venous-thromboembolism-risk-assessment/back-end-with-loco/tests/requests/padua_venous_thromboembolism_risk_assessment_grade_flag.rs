...
#[tokio::test]
#[serial]
async fn can_get_padua_venous_thromboembolism_risk_assessment_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/padua_venous_thromboembolism_risk_assessment_grade_flags").await;
