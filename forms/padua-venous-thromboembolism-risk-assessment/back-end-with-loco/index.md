...
Server-side Rust JSON API for the Padua Venous Thromboembolism Risk Assessment (Padua Prediction Score) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`padua_venous_thromboembolism_risk_assessment/`](padua_venous_thromboembolism_risk_assessment/) — one migration, SeaORM
