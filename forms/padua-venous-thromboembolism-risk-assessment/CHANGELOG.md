# Changelog — Padua Venous Thromboembolism Risk Assessment (Padua Prediction Score)
...
file only records changes scoped to the **Padua Venous Thromboembolism Risk Assessment (Padua Prediction Score)** form.
