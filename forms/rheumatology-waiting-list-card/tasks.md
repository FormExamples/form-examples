# Tasks: Rheumatology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/rheumatology-waiting-list-card/`.
...
- [x] `cargo loco new rheumatology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form rheumatology-waiting-list-card` exits cleanly.
