# Rheumatology Waiting List Card — specification
...
rheumatology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form rheumatology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check rheumatology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `rheumatology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `rheumatology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
