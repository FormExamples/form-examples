-- Practitioner who places the patient on a rheumatology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a rheumatology waiting list card on behalf of the patient.';
