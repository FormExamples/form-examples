# rheumatology-waiting-list-card — sql
...
- `rheumatology_waiting_list_card` — top-level waiting list card.
- `rheumatology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `rheumatology_waiting_list_card_grade` — computed grading result.
- `rheumatology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `rheumatology_waiting_list_card_grade_flag` — safety / operational flags fired
