# Rheumatology Waiting List Card — PostgreSQL migrations
...
Child `rheumatology_waiting_list_card_*` tables reference
`rheumatology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
