# Rheumatology Waiting List Card — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the Rheumatology Waiting List Card form, built with axum + Loco +
...
- [`rheumatology_waiting_list_card/`](./rheumatology_waiting_list_card/) — the Loco crate: `src/rheumatology_waiting_list_card/` holds `app.rs`
...
`/metrics`. The registered domain controllers are:
  ...
  - `rheumatology_waiting_list_card`
  - `rheumatology_waiting_list_card_appointment`
  - `rheumatology_waiting_list_card_grade`
  - `rheumatology_waiting_list_card_grade_flag`
  - `rheumatology_waiting_list_card_grade_rule`
  - `patient`
  - `practitioner`

## Engine

`src/rheumatology_waiting_list_card/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd rheumatology_waiting_list_card && cargo check --all-targets && cargo test
```
