# Plan: Rheumatology Waiting List Card
...
months later. The Rheumatology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form rheumatology-waiting-list-card`.
