// Backend API client for the MRI scan vetting dashboard.
//
...
window.MriScanTestRequestDashboard.fetchRequests = fetchRequests;
window.MriScanTestRequestDashboard.API_BASE = API_BASE;
})();
