//! Who Emergency Unit Trauma Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Emergency Unit Trauma Form** medical form, built on the
...
//!
//! ```
//! use who_emergency_unit_trauma_form_loco_crate::engine::types::AssessmentData;
//!
