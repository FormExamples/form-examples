...
>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-gray-800">Mechanism of injury</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-gray-800">Prehospital care</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-gray-800">Details</h3>
	<RadioGroup
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-gray-800">Fasting and substance use</h3>
