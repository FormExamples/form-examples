...
>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Bleeding controlled</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Vascular access — Line 1</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Vascular access — Line 2</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Blood</h3>
