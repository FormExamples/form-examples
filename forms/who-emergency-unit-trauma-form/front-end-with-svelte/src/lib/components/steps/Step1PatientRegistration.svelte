...
>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Contact person</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Arrival</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Residence and injury location</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Vaccinations</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Pregnancy</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Substance use</h3>
