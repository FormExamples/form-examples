<script lang="ts">
	...
	import type { LabEntry, ImagingEntry } from '#lib/engine/types.js';
...
>
	<h3 class="mb-2 text-base font-semibold text-base-content">Labs ordered</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Imaging ordered</h3>
