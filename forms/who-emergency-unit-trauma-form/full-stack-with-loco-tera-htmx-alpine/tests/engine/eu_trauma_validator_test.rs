use who_emergency_unit_trauma_form_tera_crate::engine::eu_trauma_validator::validate_eu_trauma;
...
fn rule_ids_are_unique() {
    use who_emergency_unit_trauma_form_tera_crate::engine::eu_trauma_rules::eu_trauma_rules;
