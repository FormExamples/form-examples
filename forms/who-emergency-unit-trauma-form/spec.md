# WHO Emergency Unit Form: Trauma — specification
...
- `bin/test-form who-emergency-unit-trauma-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-emergency-unit-trauma-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-emergency-unit-trauma-form.front-end-form-with-html.v1` (HTML)
  - `who-emergency-unit-trauma-form.front-end-form-with-svelte.v1` (SvelteKit)
