# Tasks: Cardiology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/cardiology-waiting-list-card/`.
...
- [x] `cargo loco new cardiology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form cardiology-waiting-list-card` exits cleanly.
