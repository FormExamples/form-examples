# Cardiology Waiting List Card — specification
...
cardiology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form cardiology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check cardiology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cardiology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `cardiology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
