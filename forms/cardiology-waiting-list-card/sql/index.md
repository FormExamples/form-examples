# cardiology-waiting-list-card — sql
...
- `cardiology_waiting_list_card` — top-level waiting list card.
- `cardiology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `cardiology_waiting_list_card_grade` — computed grading result.
- `cardiology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `cardiology_waiting_list_card_grade_flag` — safety / operational flags fired
