# Cardiology Waiting List Card — PostgreSQL migrations
...
Child `cardiology_waiting_list_card_*` tables reference
`cardiology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
