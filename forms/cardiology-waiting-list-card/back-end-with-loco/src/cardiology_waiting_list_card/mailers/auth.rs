...
static welcome: Dir<'_> = include_dir!("src/cardiology_waiting_list_card/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/cardiology_waiting_list_card/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/cardiology_waiting_list_card/mailers/auth/magic_link");
