# Plan: Cardiology Waiting List Card
...
months later. The Cardiology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form cardiology-waiting-list-card`.
