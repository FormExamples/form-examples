# Child Psychiatry Waiting List Card — specification
...
child psychiatry waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form child-psychiatry-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check child-psychiatry-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `child-psychiatry-waiting-list-card.front-end-with-html.v1` (HTML)
  - `child-psychiatry-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
