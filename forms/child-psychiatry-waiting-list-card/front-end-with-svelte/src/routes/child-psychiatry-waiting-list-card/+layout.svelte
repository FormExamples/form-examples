...
<svelte:head>
	<title>Child Psychiatry Waiting List Card</title>
</svelte:head>
	...
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			...
			<div class="flex items-center gap-1">
				...
				>
				<a href="/child-psychiatry-waiting-list-card/child-psychiatry-waiting-list-cards" class={navClass('/child-psychiatry-waiting-list-cards')}
					>Dashboard</a
				>
				<LocalePicker
					label="Language"
