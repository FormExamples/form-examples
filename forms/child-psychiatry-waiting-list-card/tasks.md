# Tasks: Child Psychiatry Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/child-psychiatry-waiting-list-card/`.
...
- [x] `cargo loco new child-psychiatry-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form child-psychiatry-waiting-list-card` exits cleanly.
