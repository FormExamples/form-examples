# Plan: Child Psychiatry Waiting List Card
...
months later. The Child Psychiatry Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form child-psychiatry-waiting-list-card`.
