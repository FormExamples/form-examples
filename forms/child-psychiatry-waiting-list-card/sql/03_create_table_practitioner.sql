-- Practitioner who places the patient on a child psychiatry waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a child psychiatry waiting list card on behalf of the patient.';
