# Child Psychiatry Waiting List Card — PostgreSQL migrations
...
Child `child_psych_waiting_list_card_*` tables reference
`child_psych_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
