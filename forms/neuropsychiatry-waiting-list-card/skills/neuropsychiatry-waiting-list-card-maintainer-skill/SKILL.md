...
```sh
bin/test-form neuropsychiatry-waiting-list-card
bin/test-sql-apply neuropsychiatry-waiting-list-card
bin/test-personas neuropsychiatry-waiting-list-card
bin/test-e2e --html neuropsychiatry-waiting-list-card
```
