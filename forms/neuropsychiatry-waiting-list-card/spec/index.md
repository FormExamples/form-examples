# Neuropsychiatry Waiting List Card — specification
...
neuropsychiatry waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form neuropsychiatry-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check neuropsychiatry-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `neuropsychiatry-waiting-list-card.front-end-with-html.v1` (HTML)
  - `neuropsychiatry-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
