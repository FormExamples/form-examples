# neuropsychiatry-waiting-list-card — sql
...
- `neuropsych_waiting_list_card` — top-level waiting list card.
- `neuropsych_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `neuropsych_waiting_list_card_grade` — computed grading result.
- `neuropsych_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `neuropsych_waiting_list_card_grade_flag` — safety / operational flags fired
