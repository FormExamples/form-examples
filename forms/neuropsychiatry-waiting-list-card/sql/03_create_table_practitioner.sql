-- Practitioner who places the patient on a neuropsychiatry waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a neuropsychiatry waiting list card on behalf of the patient.';
