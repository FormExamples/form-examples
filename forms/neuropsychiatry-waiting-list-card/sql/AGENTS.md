# Neuropsychiatry Waiting List Card — PostgreSQL migrations
...
Child `neuropsych_waiting_list_card_*` tables reference
`neuropsych_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
