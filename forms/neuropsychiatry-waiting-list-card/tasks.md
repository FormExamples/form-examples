# Tasks: Neuropsychiatry Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/neuropsychiatry-waiting-list-card/`.
...
- [x] `cargo loco new neuropsychiatry-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form neuropsychiatry-waiting-list-card` exits cleanly.
