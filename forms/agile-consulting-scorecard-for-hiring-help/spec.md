# Agile consulting scorecard for hiring help — specification
...
- `bin/test-form agile-consulting-scorecard-for-hiring-help` exits cleanly.
...
- `bin/lily-html-refactor --check agile-consulting-scorecard-for-hiring-help` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `agile-consulting-scorecard-for-hiring-help.front-end-form-with-html.v1` (HTML)
  - `agile-consulting-scorecard-for-hiring-help.front-end-form-with-svelte.v1` (SvelteKit)
