...
static welcome: Dir<'_> = include_dir!("src/agile_consulting_scorecard_for_hiring_help/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/agile_consulting_scorecard_for_hiring_help/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/agile_consulting_scorecard_for_hiring_help/mailers/auth/magic_link");
