# Agile consulting scorecard for hiring help — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the Agile consulting scorecard for hiring help form, built with axum + Loco +
...
- [`agile_consulting_scorecard_for_hiring_help/`](./agile_consulting_scorecard_for_hiring_help/) — the Loco crate: `src/agile_consulting_scorecard_for_hiring_help/` holds `app.rs`
...
`src/agile_consulting_scorecard_for_hiring_help/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd agile_consulting_scorecard_for_hiring_help && cargo check --all-targets && cargo test
```
