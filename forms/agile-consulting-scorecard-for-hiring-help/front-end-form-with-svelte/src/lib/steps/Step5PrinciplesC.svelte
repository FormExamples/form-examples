...
<section>
	<h2 class="text-lg font-semibold text-slate-800">Step 5 — Principles 9–12</h2>

	<ChecklistItem
		bind:item={assessment.data.principles.p9}
		name="p9"
	...
	/>
	<ChecklistItem
		bind:item={assessment.data.principles.p10}
		name="p10"
