...
<section>
	<h2 class="text-lg font-semibold text-base-content">Step 4 — Principles 5–8</h2>

	<ChecklistItem
		bind:item={assessment.data.principles.p5}
		name="p5"
	...
	/>
	<ChecklistItem
		bind:item={assessment.data.principles.p6}
		name="p6"
	...
	/>
	<ChecklistItem
		bind:item={assessment.data.principles.p7}
		name="p7"
	...
	/>
	<ChecklistItem
		bind:item={assessment.data.principles.p8}
		name="p8"
