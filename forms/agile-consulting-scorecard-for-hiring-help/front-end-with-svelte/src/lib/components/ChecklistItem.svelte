...
<div class="mt-4">
	<h3 class="text-base font-semibold text-base-content">{heading}</h3>
	<p class="text-sm text-base-content/70 mt-1">{prompt}</p>
	...
	<label class="block text-xs text-base-content/60 mt-2">
		Evidence (optional)
		<textarea
			class="w-full mt-1 rounded border border-base-300 p-1.5 text-sm"
			rows="2"
