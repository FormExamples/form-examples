...
<Fieldset legend="2. Agile Manifesto (4 items)">
	<p class="hint">Score one point per item your organization can demonstrably tick today.</p>

	<ChecklistField
		bind:item={d.manifesto.m1}
		name="m1"
