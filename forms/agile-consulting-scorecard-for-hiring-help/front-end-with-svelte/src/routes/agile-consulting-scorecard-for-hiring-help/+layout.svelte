...
<svelte:head>
	<title>Agile Consulting Scorecard for Hiring Help</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/agile-consulting-scorecard-for-hiring-help/" class="text-lg font-bold text-base-content">Agile Consulting Scorecard</a>
			<div class="flex items-center gap-1">
				<a href="/agile-consulting-scorecard-for-hiring-help/" class={navClass('/')}>Welcome</a>
				<a href="/agile-consulting-scorecard-for-hiring-help/{plural}/new" class={navClass(`/${plural}/new`)}>New scorecard</a>
				<a href="/agile-consulting-scorecard-for-hiring-help/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
