...
<Fieldset legend="Treatments Refused - Life-Sustaining">
	...
	<div class="mb-4 rounded-lg border border-error/40 bg-error/10 p-4 text-sm text-error">
	...
	<div class="space-y-6">
		<div class="rounded-lg border-2 border-error/40 p-4">
			...
			{#if ls.cpr.refused === 'yes'}
				<div class="ml-4 mt-2 rounded border border-error/30 bg-error/10 p-3">
	...
	<div class="mt-6">
		<h3 class="mb-3 text-sm font-semibold text-base-content/80">Other Life-Sustaining Treatments to Refuse</h3>
		{#each ls.otherLifeSustaining as other, i}
			<div class="mb-3 rounded-lg border-2 border-error/40 bg-error/10 p-3">
		...
		<button
			type="button"
			onclick={addOther}
			class="rounded-lg border-2 border-dashed border-error/40 px-4 py-2 text-sm text-error transition-colors hover:border-error hover:text-error"
		>
