<script lang="ts">
	import { DateInput, RadioGroup, TextAreaInput, TextInput } from "@lilydesignsystem/svelte-headless";
...
<Fieldset legend="Legal Signatures">
	...
	<div class="rounded-lg border border-base-300 p-4">
		<h3 class="mb-3 font-semibold text-base-content">Patient Signature</h3>
	...
	<div class="mt-4 rounded-lg border border-base-300 p-4">
		<h3 class="mb-3 font-semibold text-base-content">Witness</h3>
	...
	{#if hasLS}
		<div class="mt-4 rounded-lg border-2 border-error/40 bg-error/10 p-4">
			<h3 class="mb-3 font-bold text-error">Additional Requirements for Life-Sustaining Treatment Refusal</h3>
