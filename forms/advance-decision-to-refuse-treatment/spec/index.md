# Advance Decision to Refuse Treatment — specification
...
- `bin/test-form advance-decision-to-refuse-treatment` exits cleanly.
...
- `bin/lily-html-refactor --check advance-decision-to-refuse-treatment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `advance-decision-to-refuse-treatment.front-end-form-with-html.v1` (HTML)
  - `advance-decision-to-refuse-treatment.front-end-form-with-svelte.v1` (SvelteKit)
