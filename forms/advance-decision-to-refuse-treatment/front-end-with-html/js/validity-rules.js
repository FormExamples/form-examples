...
// indicating that something is MISSING or WRONG.
//
// Under the UK Mental Capacity Act 2005:
// - An ADRT refusing life-sustaining treatment MUST be in writing,
//   signed, and witnessed.
// - It MUST include a written statement that the decision applies
//   "even if life is at risk".
// - Without these, the ADRT is not legally valid for life-sustaining
//   treatments.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} ValidityRule
 * @property {string} id
