...
- LocalStorage key `advance-decision-to-refuse-treatment.front-end-form-with-html.v1` (HTML) and
  `advance-decision-to-refuse-treatment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
