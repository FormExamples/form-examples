# Advance Decision To Refuse Treatment — back-end-with-loco spec

JSON API contract for the Advance Decision To Refuse Treatment back-end. This file is the living
