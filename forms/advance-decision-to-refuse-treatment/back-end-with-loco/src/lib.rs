//! Advance Decision to Refuse Treatment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Advance Decision to Refuse Treatment** medical form, built on the
...
//!
//! ```
//! use advance_decision_loco_crate::engine::types::AssessmentData;
//!
