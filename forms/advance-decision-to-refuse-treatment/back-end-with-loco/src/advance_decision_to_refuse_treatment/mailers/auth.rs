...
static welcome: Dir<'_> = include_dir!("src/advance_decision_to_refuse_treatment/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/advance_decision_to_refuse_treatment/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/advance_decision_to_refuse_treatment/mailers/auth/magic_link");
