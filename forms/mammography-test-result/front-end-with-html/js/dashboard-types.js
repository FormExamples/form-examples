 ...
 * `forms/mammography-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {ExamType} examType                            - performed exam type
 * @property {Laterality} laterality                        - examined side
 * @property {BiRadsCategory} biRadsCategory                - BI-RADS final assessment
...
// namespace, `window.MammographyTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.MammographyTestResultDashboard`.
})();
