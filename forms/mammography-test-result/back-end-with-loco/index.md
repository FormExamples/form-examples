...
Server-side Rust JSON API for the Mammography Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`mammography_test_result/`](mammography_test_result/) — one migration, SeaORM
