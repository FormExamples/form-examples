# Mammography Test Result — specification
...
- `bin/test-form mammography-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check mammography-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `mammography-test-result.front-end-with-html.v1` (HTML)
  - `mammography-test-result.front-end-with-svelte.v1` (SvelteKit)
