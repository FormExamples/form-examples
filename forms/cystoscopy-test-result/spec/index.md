# Cystoscopy Test Result — specification
...
- `bin/test-form cystoscopy-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check cystoscopy-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cystoscopy-test-result.front-end-with-html.v1` (HTML)
  - `cystoscopy-test-result.front-end-with-svelte.v1` (SvelteKit)
