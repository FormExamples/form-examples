import type { CystoscopyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a cystoscopy result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (bladder tumour or suspicious lesion)
 ...
 */
export function calculateGrade(result: CystoscopyResult): GradingResult {
