 ...
 */
export function hasCriticalFinding(r: CystoscopyResult): boolean {
	return r.bladderTumour;
}

/** Whether any structured abnormal finding is present. */
export function hasAnyAbnormalFinding(r: CystoscopyResult): boolean {
	return (
		r.bladderTumour ||
 ...
 * finding present.
 */
export function hasOnlyMinorFinding(r: CystoscopyResult): boolean {
