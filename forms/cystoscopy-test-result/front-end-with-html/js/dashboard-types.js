 ...
 * `forms/cystoscopy-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.CystoscopyTestResultDashboard`.

// No runtime exports; types are JSDoc-only. Touch the namespace so this file
// is unambiguously side-effecting and other files can rely on it loading
// before they read `window.CystoscopyTestResultDashboard`.
