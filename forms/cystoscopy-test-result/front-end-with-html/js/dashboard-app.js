...
// Cystoscopy Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.CystoscopyTestResultDashboard`; display labels come
// from the form namespace `window.CystoscopyTestResult` (js/types.js). The
