...
4. `03_create_table_clinician.sql` — operating / reporting clinician (cystoscopy operator).
5. `04_create_table_cystoscopy_test_result.sql` — main result/report record.
6. `05_create_table_cystoscopy_test_result_grade.sql` — four-axis interpretation grade.
7. `06_create_table_cystoscopy_test_result_grade_rule.sql` — fired-rule audit trail.
8. `07_create_table_cystoscopy_test_result_grade_flag.sql` — safety-critical flags.
