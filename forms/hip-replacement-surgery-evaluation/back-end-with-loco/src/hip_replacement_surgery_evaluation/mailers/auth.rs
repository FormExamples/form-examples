...
static welcome: Dir<'_> = include_dir!("src/hip_replacement_surgery_evaluation/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/hip_replacement_surgery_evaluation/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/hip_replacement_surgery_evaluation/mailers/auth/magic_link");
