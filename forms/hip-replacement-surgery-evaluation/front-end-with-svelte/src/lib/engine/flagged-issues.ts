...
// suppressed by a clinician override — see doc/safety-case-notes.md. Flag IDs
// are stable and identical across every front-end and the back-end.

import type { AdditionalFlag, FlagCategory, FlagPriority, HipReplacementSurgeryEvaluation } from './types';
...
/** Detect safety flags for a hip-replacement surgery evaluation, most severe first. */
