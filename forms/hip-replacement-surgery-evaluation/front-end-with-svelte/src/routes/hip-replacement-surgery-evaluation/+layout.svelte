...
<svelte:head>
    <title>Hip Replacement Surgery Evaluation</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/hip-replacement-surgery-evaluation/"
                class="text-lg font-bold text-base-content"
                >Hip Replacement Surgery Evaluation</a
            >
            <div class="flex items-center gap-1">
                <a href="/hip-replacement-surgery-evaluation/" class={navClass("/")}>Welcome</a>
                <a
                    href="/hip-replacement-surgery-evaluation/hip-replacement-surgery-evaluations/new"
                    class={navClass("/hip-replacement-surgery-evaluations/new")}>New evaluation</a
                >
                <a
                    href="/hip-replacement-surgery-evaluation/hip-replacement-surgery-evaluations"
                    class={navClass("/hip-replacement-surgery-evaluations")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
