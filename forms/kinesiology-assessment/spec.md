# Kinesiology Assessment — specification
...
- `bin/test-form kinesiology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check kinesiology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `kinesiology-assessment.front-end-form-with-html.v1` (HTML)
  - `kinesiology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
