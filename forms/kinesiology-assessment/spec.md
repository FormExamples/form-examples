...
- LocalStorage key `kinesiology-assessment.front-end-form-with-html.v1` (HTML) and
  `kinesiology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
