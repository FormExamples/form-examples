...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/kinesiology-assessment/"
                class="text-lg font-bold text-base-content"
                >Kinesiology Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/kinesiology-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/kinesiology-assessment/kinesiology-assessments/new"
                    class={navClass("/kinesiology-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/kinesiology-assessment/kinesiology-assessments"
                    class={navClass("/kinesiology-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
