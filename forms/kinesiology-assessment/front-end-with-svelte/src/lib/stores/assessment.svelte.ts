...
function storageKey(id: string): string {
	return `kinesiology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}
...
/** A blank kinesiology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the kinesiology assessment, with localStorage
