...
<Fieldset legend="Rotary Stability">
	<p class="hint">
	...
	<div class="field-grid">
		<Field label="Left Side Score" required>
			<RadioGroup label="Rotary Stability Left Side Score">
		...
		<Field label="Right Side Score" required>
			<RadioGroup label="Rotary Stability Right Side Score">
				{#each scoreOptions as opt (opt.value)}
					<label>
						<input
							type="radio"
	...
	<Field label="Asymmetry Notes / Observations" inputId="rotaryStabilityNotes">
		<TextAreaInput
			id="rotaryStabilityNotes"
