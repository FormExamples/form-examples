use kinesiology_assessment_loco_crate::engine::kinesiology_grader::calculate_impairment;
use kinesiology_assessment_loco_crate::engine::kinesiology_rules::all_rules;
use kinesiology_assessment_loco_crate::engine::types::*;
