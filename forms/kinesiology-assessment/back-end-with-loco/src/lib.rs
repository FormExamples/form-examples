//! Kinesiology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Kinesiology Assessment** medical form, built on the
...
//!
//! ```
//! use kinesiology_assessment_loco_crate::engine::types::AssessmentData;
//!
