// Functional Movement Screen (FMS) rule definitions.
//
// The 7 FMS movement patterns. Each pattern is scored 0-3:
...
//
// For bilateral tests, the lower of left/right scores is used.
// Total score range: 0-21.
//
// FMS-01: Deep Squat
// FMS-02: Hurdle Step
// FMS-03: In-Line Lunge
// FMS-04: Shoulder Mobility
// FMS-05: Active Straight Leg Raise
// FMS-06: Trunk Stability Push-Up
// FMS-07: Rotary Stability

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} FMSRuleDefinition
 * @property {string} id
 * @property {number} patternNumber
...
/** FMS score response options (0-3). */
const fmsScoreOptions = [
...
/** Compact bilateral-test labels (used in left/right side score columns). */
const fmsScoreOptionsCompact = [
