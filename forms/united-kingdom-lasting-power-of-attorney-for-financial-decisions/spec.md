...
- LocalStorage key `united-kingdom-lasting-power-of-attorney-for-financial-decisions.front-end-form-with-html.v1` (HTML) and
  `united-kingdom-lasting-power-of-attorney-for-financial-decisions.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
