...
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-lasting-power-of-attorney-for-financial-decisions.front-end-with-html.v1` (HTML)
  - `united-kingdom-lasting-power-of-attorney-for-financial-decisions.front-end-with-svelte.v1` (SvelteKit)
