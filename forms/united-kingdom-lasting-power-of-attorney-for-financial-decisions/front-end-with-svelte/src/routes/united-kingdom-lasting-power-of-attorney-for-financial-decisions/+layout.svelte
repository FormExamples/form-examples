<script lang="ts">
    ...
    const plural =
        "united-kingdom-lasting-powers-of-attorney-for-financial-decisions";
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/united-kingdom-lasting-power-of-attorney-for-financial-decisions/"
                class="text-lg font-bold text-base-content"
                >UK LPA — Financial (LP1F)</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(`/${plural}/new`)}>New LPA</a
                >
                <a
