...
<svelte:head>
	<title>UK Lasting Power of Attorney for Financial Decisions</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-lasting-power-of-attorney-for-financial-decisions/" class="text-lg font-bold text-base-content">UK LPA — Financial (LP1F)</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-lasting-power-of-attorney-for-financial-decisions/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-lasting-power-of-attorney-for-financial-decisions/{plural}/new" class={navClass(`/${plural}/new`)}>New LPA</a>
				<a href="/united-kingdom-lasting-power-of-attorney-for-financial-decisions/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
