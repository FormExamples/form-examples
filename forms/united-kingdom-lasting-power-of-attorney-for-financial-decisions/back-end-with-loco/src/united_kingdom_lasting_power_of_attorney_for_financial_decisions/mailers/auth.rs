...
static welcome: Dir<'_> = include_dir!("src/united_kingdom_lasting_power_of_attorney_for_financial_decisions/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/united_kingdom_lasting_power_of_attorney_for_financial_decisions/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/united_kingdom_lasting_power_of_attorney_for_financial_decisions/mailers/auth/magic_link");
