//! United Kingdom Lasting Power of Attorney for Financial Decisions — Loco JSON API back-end.
//!
//! Server-side JSON API for the **United Kingdom Lasting Power of Attorney for Financial Decisions** medical form, built on the
