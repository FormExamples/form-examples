 ...
 * `forms/dexa-bone-density-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {ScanRegion} scanRegion                        - examined scan region
 * @property {ReportStatus} reportStatus                    - report lifecycle status
 * @property {string} reportedDate                          - ISO date (yyyy-mm-dd)
 * @property {number | null} lowestTScore                   - lowest (most negative) T-score
 * @property {WhoClassification} whoClassification          - WHO densitometric class
...
// namespace, `window.DexaBoneDensityTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.DexaBoneDensityTestResultDashboard`.
})();
