...
Server-side Rust JSON API for the DEXA Bone Density Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`dexa_bone_density_test_result/`](dexa_bone_density_test_result/) — one migration, SeaORM
