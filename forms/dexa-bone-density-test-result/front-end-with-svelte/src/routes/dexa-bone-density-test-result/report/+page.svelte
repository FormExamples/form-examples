<script lang="ts">
	...
	import Step4QuantitativeFindings from '$lib/components/steps/Step4QuantitativeFindings.svelte';
	import Step5FractureRiskComparison from '$lib/components/steps/Step5FractureRiskComparison.svelte';
	...
	function validate(): boolean {
		...
		if (d.scanRegion === '') {
			found.push({ id: 'scanRegion', message: 'Scan region is required.' });
		}
	...
	function submit() {
		...
		goto('/dexa-bone-density-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New DEXA bone-density report</h1>
	...
	<Form label="DEXA bone density test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2ExaminationDetails />
		<Step3ClinicalHistory />
		<Step4QuantitativeFindings />
		<Step5FractureRiskComparison />
		<Step6Impression />
