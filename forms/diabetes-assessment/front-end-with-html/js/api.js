...
// http://localhost:5350 (Loco / axum); the dashboard endpoint returns a
...
window.DiabetesAssessmentDashboard.fetchPatients = fetchPatients;
window.DiabetesAssessmentDashboard.API_BASE = API_BASE;
})();
