...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/diabetes-assessment/"
                class="text-lg font-bold text-base-content"
                >Diabetes Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/diabetes-assessment/" class={navClass("/")}>Welcome</a
                >
                <a
                    href="/diabetes-assessment/diabetes-assessments/new"
                    class={navClass("/diabetes-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/diabetes-assessment/diabetes-assessments"
                    class={navClass("/diabetes-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
