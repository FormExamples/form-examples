//! Diabetes Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Diabetes Assessment** medical form, built on the
...
//!
//! ```
//! use diabetes_assessment_loco_crate::engine::types::AssessmentData;
//!
