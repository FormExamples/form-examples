...
static welcome: Dir<'_> = include_dir!("src/bhutani_bilirubin_nomogram/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/bhutani_bilirubin_nomogram/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/bhutani_bilirubin_nomogram/mailers/auth/magic_link");
