...
Server-side Rust JSON API for the Bhutani Bilirubin Nomogram form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`bhutani_bilirubin_nomogram/`](bhutani_bilirubin_nomogram/) — one migration, SeaORM
