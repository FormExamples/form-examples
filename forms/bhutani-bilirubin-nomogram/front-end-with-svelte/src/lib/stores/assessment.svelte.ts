...
function storageKey(id: string): string {
	return `bhutani-bilirubin-nomogram.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Bhutani assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Bhutani assessment, with localStorage
