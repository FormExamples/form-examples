...
<svelte:head>
	<title>Bhutani Bilirubin Nomogram</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/bhutani-bilirubin-nomogram/" class="text-lg font-bold text-base-content">Bhutani nomogram</a>
			<div class="flex items-center gap-1">
				<a href="/bhutani-bilirubin-nomogram/" class={navClass('/')}>Welcome</a>
				<a
					href="/bhutani-bilirubin-nomogram/bhutani-bilirubin-nomograms/new"
					class={navClass('/bhutani-bilirubin-nomograms/new')}>New assessment</a
				>
				<a
					href="/bhutani-bilirubin-nomogram/bhutani-bilirubin-nomograms"
					class={navClass('/bhutani-bilirubin-nomograms')}>Dashboard</a
				>
