# Workplace Stress Assessment — specification
...
- `bin/test-form workplace-stress-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check workplace-stress-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `workplace-stress-assessment.front-end-form-with-html.v1` (HTML)
  - `workplace-stress-assessment.front-end-form-with-svelte.v1` (SvelteKit)
