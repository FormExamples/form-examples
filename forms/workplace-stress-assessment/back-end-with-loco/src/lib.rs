//! Workplace Stress Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Workplace Stress Assessment** medical form, built on the
...
//!
//! ```
//! use workplace_stress_assessment_loco_crate::engine::types::AssessmentData;
//!
