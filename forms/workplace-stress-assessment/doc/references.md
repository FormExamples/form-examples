# References — workplace stress assessment

## HSE Management Standards (primary authority)
...
- HSE — Indicator Tool (35-item questionnaire).
...
## Related scales (cross-references)

- Karasek, R., et al. (1998). The Job Content Questionnaire (JCQ).
...
- Siegrist, J. (1996). Adverse health effects of high-effort/low-reward
  ...
  27-41. doi:10.1037/1076-8998.1.1.27
- Burr, H., et al. (2019). The third version of the Copenhagen
  Psychosocial Questionnaire. *Safety and Health at Work*, 10(4):
  482-503. doi:10.1016/j.shaw.2019.10.002
- Tennant, R., et al. (2007). Warwick-Edinburgh Mental Wellbeing Scale
  (WEMWBS). *Health and Quality of Life Outcomes*, 5: 63.
