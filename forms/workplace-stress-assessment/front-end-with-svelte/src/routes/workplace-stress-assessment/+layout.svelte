...
<svelte:head>
	<title>Workplace Stress Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/workplace-stress-assessment/" class="text-lg font-bold text-base-content">Workplace Stress Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/workplace-stress-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/workplace-stress-assessment/workplace-stress-assessments/new"
					class={navClass('/workplace-stress-assessments/new')}>New survey</a
				>
				<a href="/workplace-stress-assessment/workplace-stress-assessments" class={navClass('/workplace-stress-assessments')}
					>Dashboard</a
				>
				<LocaleChooser
					label="Language"
