<script lang="ts">
	...
	const d = assessment.data.environment as unknown as Record<string, LikertValue>;
	const items = surveyItems.filter((it) => it.domain === 'environment');
</script>

<Fieldset legend="Environment & Resources">
	<p class="hint">
