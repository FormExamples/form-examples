<script lang="ts">
	...
	const d = assessment.data.management as unknown as Record<string, LikertValue>;
	const items = surveyItems.filter((it) => it.domain === 'management');
</script>

<Fieldset legend="Management & Leadership">
	<p class="hint">
