<script lang="ts">
	...
	const d = assessment.data.culture as unknown as Record<string, LikertValue>;
	const items = surveyItems.filter((it) => it.domain === 'culture');
</script>

<Fieldset legend="Culture & Inclusion">
	<p class="hint">
