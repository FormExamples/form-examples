<script lang="ts">
	...
	const d = assessment.data.growth as unknown as Record<string, LikertValue>;
	const items = surveyItems.filter((it) => it.domain === 'growth');
</script>

<Fieldset legend="Growth & Development">
	<p class="hint">
