<script lang="ts">
	...
	const d = assessment.data.workload as unknown as Record<string, LikertValue>;
	const items = surveyItems.filter((it) => it.domain === 'workload');
</script>

<Fieldset legend="Workload & Work-Life Balance">
	<p class="hint">
