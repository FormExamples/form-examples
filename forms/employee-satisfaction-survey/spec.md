# Employee Satisfaction Survey — specification
...
- `bin/test-form employee-satisfaction-survey` exits cleanly.
...
- `bin/lily-html-refactor --check employee-satisfaction-survey` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `employee-satisfaction-survey.front-end-form-with-html.v1` (HTML)
  - `employee-satisfaction-survey.front-end-form-with-svelte.v1` (SvelteKit)
