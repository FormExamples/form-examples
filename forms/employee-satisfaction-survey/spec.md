...
- LocalStorage key `employee-satisfaction-survey.front-end-form-with-html.v1` (HTML) and
  `employee-satisfaction-survey.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
