//! Employee Satisfaction Survey — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Employee Satisfaction Survey** medical form, built on the
...
//!
//! ```
//! use employee_satisfaction_survey_loco_crate::engine::types::AssessmentData;
//!
