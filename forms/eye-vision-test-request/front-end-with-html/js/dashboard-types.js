...
/**
 * Appropriateness band emitted by the engine's Axis A (RCOphth / NICE 1-9).
 ...
 * @property {string} laterality      - Eye(s) to be examined (kebab-case)
...
// before they read `window.EyeVisionTestRequestDashboard`.
