...
// Eye Vision Test Request — vetting dashboard (vanilla classic-script app).
//
...
// attach their exports to `window.EyeVisionTestRequestDashboard`. The whole
...
function compareRows(a, b) {
  ...
  // Default: string compare (nhs, patient, testType, indication, laterality,
