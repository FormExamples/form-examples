...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "eye_vision_test_requests",
            ...
            ("symptom_reduced_vision", ColType::BooleanWithDefault(false)),
            ("symptom_sudden_loss", ColType::BooleanWithDefault(false)),
            ("symptom_flashes_floaters", ColType::BooleanWithDefault(false)),
            ("symptom_eye_pain", ColType::BooleanWithDefault(false)),
            ("symptom_red_eye", ColType::BooleanWithDefault(false)),
            ("diabetes", ColType::BooleanWithDefault(false)),
            ("known_glaucoma", ColType::BooleanWithDefault(false)),
