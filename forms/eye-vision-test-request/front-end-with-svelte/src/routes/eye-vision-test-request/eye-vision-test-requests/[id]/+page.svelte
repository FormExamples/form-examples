<script lang="ts">
	...
	import Step4History from '#lib/components/steps/Step4History.svelte';
	...
	function submit() {
		...
		goto(`/eye-vision-test-request/eye-vision-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New eye vision test request' : `Eye vision test request ${id}`}
	</h1>
	...
	<Form label="Eye vision test request" onsubmit={submit}>
