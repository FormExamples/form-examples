// Backend API client for the eye vision test request vetting dashboard.
//
...
window.EyeVisionTestRequestDashboard.fetchRequests = fetchRequests;
window.EyeVisionTestRequestDashboard.API_BASE = API_BASE;
})();
