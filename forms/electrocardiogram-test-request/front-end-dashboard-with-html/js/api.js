// Backend API client for the electrocardiogram (ECG) vetting dashboard.
//
...
window.ElectrocardiogramTestRequestDashboard.fetchRequests = fetchRequests;
window.ElectrocardiogramTestRequestDashboard.API_BASE = API_BASE;
})();
