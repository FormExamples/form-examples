<script lang="ts">
	...
	// dashboard. The collection routes (`/electrocardiogram-test-requests` and
	// `/electrocardiogram-test-requests/new`) hold the actual functionality.
	const plural = 'electrocardiogram-test-requests';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		...
		<h1 class="mt-2 text-3xl font-bold text-base-content">
			Electrocardiogram (ECG) test request / referral
		</h1>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/electrocardiogram-test-request/{plural}/new"
		...
		<a
			href="/electrocardiogram-test-request/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse incoming ECG requests with their computed four-axis grades, and filter by triage
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with AHA/ACC ECG-use guidance, NICE chest pain (CG95), and acute coronary
					syndromes (NG185), and the NHS referral-vetting model.
				</dd>
			</div>
		</dl>
	</section>
