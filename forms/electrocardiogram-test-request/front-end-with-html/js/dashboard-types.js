...
/**
 * Appropriateness band emitted by the engine's Axis A (AHA/ACC 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Triage tier emitted by Axis B (red-flag escalation, NICE CG95 / ACS).
 ...
 * @property {string} ecgType         - Requested ECG type (kebab-case)
...
// before they read `window.ElectrocardiogramTestRequestDashboard`.
