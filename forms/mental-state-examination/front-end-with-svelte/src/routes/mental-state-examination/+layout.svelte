...
<svelte:head>
	<title>Mental State Examination (MSE)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/mental-state-examination/" class="text-lg font-bold text-base-content">MSE</a>
			<div class="flex items-center gap-1">
				<a href="/mental-state-examination/" class={navClass('/')}>Welcome</a>
				<a
					href="/mental-state-examination/mental-state-examinations/new"
					class={navClass('/mental-state-examinations/new')}>New examination</a
				>
				<a
					href="/mental-state-examination/mental-state-examinations"
					class={navClass('/mental-state-examinations')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
