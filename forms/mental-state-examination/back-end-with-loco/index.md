...
Server-side Rust JSON API for the Mental State Examination (MSE) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`mental_state_examination/`](mental_state_examination/) — one migration, SeaORM
