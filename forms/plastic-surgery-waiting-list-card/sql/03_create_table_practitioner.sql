-- Practitioner who places the patient on a plastic surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a plastic surgery waiting list card on behalf of the patient.';
