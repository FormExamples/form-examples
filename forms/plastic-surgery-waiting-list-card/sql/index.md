# plastic-surgery-waiting-list-card — sql
...
- `plastic_surg_waiting_list_card` — top-level waiting list card.
- `plastic_surg_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `plastic_surg_waiting_list_card_grade` — computed grading result.
- `plastic_surg_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `plastic_surg_waiting_list_card_grade_flag` — safety / operational flags fired
