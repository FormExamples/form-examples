# Plastic Surgery Waiting List Card — PostgreSQL migrations
...
Child `plastic_surg_waiting_list_card_*` tables reference
`plastic_surg_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
