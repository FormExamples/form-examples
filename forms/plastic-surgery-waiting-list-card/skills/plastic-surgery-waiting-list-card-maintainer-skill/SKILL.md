...
```sh
bin/test-form plastic-surgery-waiting-list-card
bin/test-sql-apply plastic-surgery-waiting-list-card
bin/test-personas plastic-surgery-waiting-list-card
bin/test-e2e --html plastic-surgery-waiting-list-card
```
