# Tasks: Plastic Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/plastic-surgery-waiting-list-card/`.
...
- [x] `cargo loco new plastic-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form plastic-surgery-waiting-list-card` exits cleanly.
