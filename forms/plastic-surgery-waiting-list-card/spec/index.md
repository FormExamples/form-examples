# Plastic Surgery Waiting List Card — specification
...
plastic surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form plastic-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check plastic-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `plastic-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `plastic-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
