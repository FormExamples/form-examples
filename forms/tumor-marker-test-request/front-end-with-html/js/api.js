// Backend API client for the tumour-marker vetting dashboard.
//
...
window.TumorMarkerTestRequestDashboard.fetchRequests = fetchRequests;
window.TumorMarkerTestRequestDashboard.API_BASE = API_BASE;
})();
