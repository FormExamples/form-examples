# Urology Waiting List Card — specification
...
urology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form urology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check urology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `urology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `urology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
