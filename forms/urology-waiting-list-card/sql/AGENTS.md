# Urology Waiting List Card — PostgreSQL migrations
...
Child `urology_waiting_list_card_*` tables reference
`urology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
