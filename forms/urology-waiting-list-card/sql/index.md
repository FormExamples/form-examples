...
- `urology_waiting_list_card` — top-level waiting list card.
- `urology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `urology_waiting_list_card_grade` — computed grading result.
- `urology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `urology_waiting_list_card_grade_flag` — safety / operational flags fired
