# Tasks: Urology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/urology-waiting-list-card/`.
...
- [x] `cargo loco new urology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form urology-waiting-list-card` exits cleanly.
