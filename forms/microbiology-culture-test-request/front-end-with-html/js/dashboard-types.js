// Plain-JavaScript / JSDoc type definitions for the microbiology culture
// vetting dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (UKHSA SMI 1-9).
...
/**
 * Triage tier emitted by Axis D (NICE NG51 sepsis escalation).
 ...
 * @property {string} specimenType       - Specimen type (kebab-case)
 * @property {string} indication         - Primary clinical indication (kebab-case)
 * @property {string[]} tests            - Selected test field keys (camelCase)
...
// before they read `window.MicrobiologyCultureTestRequestDashboard`.
