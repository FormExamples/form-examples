...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/microbiology-culture-test-request/"
                class="text-lg font-bold text-base-content"
                >Microbiology Culture Test Request</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/microbiology-culture-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/microbiology-culture-test-request/microbiology-culture-test-requests"
                    class={navClass("/microbiology-culture-test-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
