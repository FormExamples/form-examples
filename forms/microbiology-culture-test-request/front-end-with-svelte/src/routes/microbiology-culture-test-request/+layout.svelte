...
<svelte:head>
	<title>Microbiology Culture Test Request</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/microbiology-culture-test-request/" class="text-lg font-bold text-base-content">Microbiology Culture Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/microbiology-culture-test-request/" class={navClass('/')}>Welcome</a>
				<a
					href="/microbiology-culture-test-request/microbiology-culture-test-requests/new"
					class={navClass('/microbiology-culture-test-requests/new')}>New request</a
				>
				<a
					href="/microbiology-culture-test-request/microbiology-culture-test-requests"
					class={navClass('/microbiology-culture-test-requests')}>Vetting dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
