<script lang="ts">
	...
	const plural = 'microbiology-culture-test-requests';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/microbiology-culture-test-request/{plural}/new"
		...
		<a
			href="/microbiology-culture-test-request/{plural}"
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					...
					the safety-critical flag rules. The same engine grades both the form and the dashboard.
				</dd>
			</div>
			<div>
				<dt class="font-semibold text-base-content">Documentation</dt>
				<dd class="mt-1 text-base-content/70">
					Aligned with the UKHSA / RCPath Standards for Microbiology Investigations (SMI), NICE NG51
					(suspected sepsis: blood cultures before antibiotics), and the NHS England blood-culture
					pathway.
				</dd>
			</div>
		</dl>
