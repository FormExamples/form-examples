...
<Fieldset legend="6. Triage">
	<p class="hint">Requested urgency, setting, and notes. Suspected sepsis is auto-escalated to stat (NICE NG51).</p>
	...
	<Field label="Notes" inputId="notes">
		<TextAreaInput
			...
			label="Notes"
			rows={3}
			placeholder="Any additional information for the laboratory…"
			bind:value={d.notes}
		/>
	</Field>
</Fieldset>
