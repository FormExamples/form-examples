 ...
 * `forms/nuclear-medicine-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {ScanType} scanType                            - radionuclide scan type
...
// namespace, `window.NuclearMedicineTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.NuclearMedicineTestResultDashboard`.
})();
