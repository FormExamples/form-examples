...
// `src/lib/engine/types.ts` data model for the Nuclear Medicine Test Result form.
//
// The camelCase property names mirror the snake_case SQL columns in
// `sql/04_create_table_nuclear_medicine_test_result.sql` and
// `sql/05_create_table_nuclear_medicine_test_result_grade.sql`. This file
// builds and exports the canonical empty NuclearMedicineResult shape used by
 ...
 * @typedef {'bone-scan' | 'myocardial-perfusion' | 'vq-lung-scan' |
 *           'thyroid-uptake' | 'renal-dmsa' | 'renal-mag3' |
 *           'gallium-octreotide' | 'white-cell-scan' | 'sentinel-node' |
 *           'other' | ''} ScanType
 */
 ...
 * `NuclearMedicineResult` in `front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} NuclearMedicineResult
 ...
 * @property {number | null} injectedActivityMbq - MBq; null when unanswered
 ...
 * @property {boolean} abnormalUptake
 * @property {boolean} metastaticPattern
 * @property {boolean} perfusionDefect
 * @property {boolean} photopenicArea
 * @property {boolean} noSignificantAbnormality
 * @property {boolean} incidentalFinding
 * @property {number | null} ejectionFractionPercent    - %; null when unanswered
 * @property {number | null} splitFunctionLeftPercent   - %; null when unanswered
 * @property {number | null} splitFunctionRightPercent  - %; null when unanswered
...
// namespace, `window.NuclearMedicineTestResult`.

/**
 * Build a fresh, fully-blank nuclear medicine test result.
 * Strings default to `''`; structured-findings booleans default to `false`;
 * numeric measurements default to `null` (unanswered).
 * @returns {NuclearMedicineResult}
 */
...
function scanTypeLabel(value) {
  switch (value) {
    case 'bone-scan': return 'Bone scan';
    case 'myocardial-perfusion': return 'Myocardial perfusion';
    case 'vq-lung-scan': return 'V/Q lung scan';
    case 'thyroid-uptake': return 'Thyroid uptake';
    case 'renal-dmsa': return 'Renal DMSA';
    case 'renal-mag3': return 'Renal MAG3';
    case 'gallium-octreotide': return 'Gallium / octreotide';
    case 'white-cell-scan': return 'White-cell scan';
    case 'sentinel-node': return 'Sentinel node';
...
export { emptyResult, resultClassificationLabel, abnormalitySeverityLabel, followUpUrgencyLabel, scanTypeLabel, reportStatusLabel, examinationAdequacyLabel, recommendationLabel, priorityLabel, resultClassificationClass, abnormalitySeverityClass, followUpUrgencyClass };
