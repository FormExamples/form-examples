<script lang="ts">
	...
	function submit() {
		...
		goto('/nuclear-medicine-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New nuclear medicine report</h1>
	...
	<Form label="Nuclear medicine test result" onsubmit={submit}>
