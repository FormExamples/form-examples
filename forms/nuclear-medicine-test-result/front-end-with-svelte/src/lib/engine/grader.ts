import type { NuclearMedicineResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a nuclear medicine result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (high-probability PE on V/Q, or a widespread
 * metastatic pattern) auto-escalates Axis D to critical-alert and raises the
 ...
 */
export function calculateGrade(result: NuclearMedicineResult): GradingResult {
