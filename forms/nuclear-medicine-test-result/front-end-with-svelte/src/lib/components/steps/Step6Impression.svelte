...
<Fieldset legend="6. Impression">
	<p class="hint">The summary impression, structured reporting category, and recommended follow-up.</p>
	...
	<Field
		...
		description="Structured-reporting category, e.g. a V/Q PE probability (normal / very-low / intermediate / high-probability) or a bone-scan pattern."
	>
		<TextInput
