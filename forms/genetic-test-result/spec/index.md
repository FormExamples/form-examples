# Genetic Test Result — specification
...
- `bin/test-form genetic-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check genetic-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `genetic-test-result.front-end-with-html.v1` (HTML)
  - `genetic-test-result.front-end-with-svelte.v1` (SvelteKit)
