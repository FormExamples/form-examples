// Genetic Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.GeneticTestResultDashboard`; display labels come
// from the form namespace `window.GeneticTestResult` (js/types.js). The whole
