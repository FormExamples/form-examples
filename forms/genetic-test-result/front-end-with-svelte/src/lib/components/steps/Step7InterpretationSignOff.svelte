...
<Fieldset legend="7. Interpretation & Sign-off">
	...
	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a pathogenic / likely-pathogenic actionable variant. Communicate the
				result directly to the referrer, arrange urgent genetics MDT / counselling, and record it
	...
	<Field label="Critical-result communication">
		<CheckboxGroup label="Critical-result communication">
			<label>
				...
				/> Critical / actionable result communicated to referrer
			</label>
		</CheckboxGroup>
	</Field>
