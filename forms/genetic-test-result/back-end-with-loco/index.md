...
Server-side Rust JSON API for the Genetic Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`genetic_test_result/`](genetic_test_result/) — one migration, SeaORM
