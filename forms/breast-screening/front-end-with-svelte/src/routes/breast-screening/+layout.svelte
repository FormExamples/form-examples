...
<svelte:head>
	<title>Breast Screening Record</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/breast-screening/" class="text-lg font-bold text-base-content">Breast Screening</a>
			<div class="flex items-center gap-1">
				<a href="/breast-screening/" class={navClass('/')}>Welcome</a>
				<a href="/breast-screening/breast-screenings/new" class={navClass('/breast-screenings/new')}
					>New record</a
				>
				<a href="/breast-screening/breast-screenings" class={navClass('/breast-screenings')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
