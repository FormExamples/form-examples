    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                ...
                class="text-lg font-bold text-base-content">Breast Screening</a
            >
            <div class="flex items-center gap-1">
                <a href="/breast-screening/" class={navClass("/")}>Welcome</a>
                <a
                    href="/breast-screening/breast-screenings/new"
                    class={navClass("/breast-screenings/new")}>New record</a
                >
                <a
                    href="/breast-screening/breast-screenings"
                    class={navClass("/breast-screenings")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
