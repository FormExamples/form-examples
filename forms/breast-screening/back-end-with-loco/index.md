...
Server-side Rust JSON API for the Breast Screening Record (NHS Breast Screening Programme) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`breast_screening/`](breast_screening/) — one migration, SeaORM
