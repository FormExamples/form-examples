...
function storageKey(id: string): string {
	return `caprini-venous-thromboembolism-risk-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Caprini assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Caprini assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.onePoint`) stay bound to live state.
	 */
