// Backend API client for the CT scan vetting dashboard.
//
...
window.CtScanTestRequestDashboard.fetchRequests = fetchRequests;
window.CtScanTestRequestDashboard.API_BASE = API_BASE;
})();
