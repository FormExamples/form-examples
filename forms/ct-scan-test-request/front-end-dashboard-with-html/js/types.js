// Plain-JavaScript / JSDoc type definitions for the CT scan vetting dashboard.
//
...
/**
 * Contrast-safety band emitted by Axis B.
 * @typedef {'safe' | 'caution' | 'contraindicated'} ContrastSafetyBand
 */

/**
 * Estimated radiation-dose band emitted by Axis B.
 * @typedef {'low' | 'moderate' | 'high'} DoseBand
 */
 ...
 * @property {string} bodyRegion      - Requested CT body region (kebab-case)
 ...
 * @property {ContrastSafetyBand} contrastSafetyBand - Axis B contrast band
 * @property {DoseBand} estimatedDoseBand - Axis B estimated radiation dose
...
// before they read `window.CtScanTestRequestDashboard`.
})();
