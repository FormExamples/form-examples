...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/ct-scan-test-request/"
                class="text-lg font-bold text-base-content"
                >CT Scan Test Request</a
            >
            <div class="flex items-center gap-1">
                <a href="/ct-scan-test-request/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/ct-scan-test-request/ct-scan-test-requests/new"
                    class={navClass("/ct-scan-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/ct-scan-test-request/ct-scan-test-requests"
                    class={navClass("/ct-scan-test-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
