...
<Fieldset legend="7. Triage and Setting">
	<p class="hint">Requested urgency, care setting, and the requested-by date. Some indications auto-escalate the triage tier.</p>
