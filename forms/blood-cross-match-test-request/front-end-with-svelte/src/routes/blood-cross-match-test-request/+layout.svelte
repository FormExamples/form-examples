...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/blood-cross-match-test-request/"
                class="text-lg font-bold text-base-content"
                >Blood Cross-Match Test Request</a
            >
            <div class="flex items-center gap-1">
                <a href="/blood-cross-match-test-request/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/blood-cross-match-test-request/blood-cross-match-test-requests/new"
                    class={navClass("/blood-cross-match-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/blood-cross-match-test-request/blood-cross-match-test-requests"
                    class={navClass("/blood-cross-match-test-requests")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
