// Backend API client for the blood cross-match vetting dashboard.
//
...
window.BloodCrossMatchTestRequestDashboard.fetchRequests = fetchRequests;
window.BloodCrossMatchTestRequestDashboard.API_BASE = API_BASE;
})();
