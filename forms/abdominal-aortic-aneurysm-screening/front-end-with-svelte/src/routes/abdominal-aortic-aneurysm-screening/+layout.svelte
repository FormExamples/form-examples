...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/abdominal-aortic-aneurysm-screening/" class="text-lg font-bold text-base-content">AAA screening</a>
			<div class="flex items-center gap-1">
				<a href="/abdominal-aortic-aneurysm-screening/" class={navClass('/')}>Welcome</a>
				<a
					href="/abdominal-aortic-aneurysm-screening/abdominal-aortic-aneurysm-screenings/new"
					class={navClass('/abdominal-aortic-aneurysm-screenings/new')}>New scan</a
				>
				<a
					href="/abdominal-aortic-aneurysm-screening/abdominal-aortic-aneurysm-screenings"
					class={navClass('/abdominal-aortic-aneurysm-screenings')}>Dashboard</a
				>
