...
Server-side Rust JSON API for the Abdominal Aortic Aneurysm (AAA) Screening form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`abdominal_aortic_aneurysm_screening/`](abdominal_aortic_aneurysm_screening/) — one migration, SeaORM
