//! Heart Health Check — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Heart Health Check** medical form, built on the
...
//!
//! ```
//! use heart_health_check_loco_crate::engine::types::AssessmentData;
//!
