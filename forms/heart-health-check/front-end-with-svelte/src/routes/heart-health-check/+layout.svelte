...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/heart-health-check/" class="text-lg font-bold text-base-content">Heart Health Check</a>
			<div class="flex items-center gap-1">
				<a href="/heart-health-check/" class={navClass('/')}>Welcome</a>
				<a href="/heart-health-check/heart-health-checks/new" class={navClass('/heart-health-checks/new')}>New check</a>
				<a href="/heart-health-check/heart-health-checks" class={navClass('/heart-health-checks')}>Dashboard</a>
