...
<svelte:head>
	<title>Lumbar Puncture Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/lumbar-puncture-test-request/" class="text-lg font-bold text-base-content">Lumbar Puncture Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/lumbar-puncture-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/lumbar-puncture-test-request/lumbar-puncture-test-requests/new" class={navClass('/lumbar-puncture-test-requests/new')}>New request</a>
				<a href="/lumbar-puncture-test-request/lumbar-puncture-test-requests" class={navClass('/lumbar-puncture-test-requests')}>Vetting dashboard</a>
