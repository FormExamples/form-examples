// Backend API client for the lumbar puncture vetting dashboard.
//
...
window.LumbarPunctureTestRequestDashboard.fetchRequests = fetchRequests;
window.LumbarPunctureTestRequestDashboard.API_BASE = API_BASE;
})();
