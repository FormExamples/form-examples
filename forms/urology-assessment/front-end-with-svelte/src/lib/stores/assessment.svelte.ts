...
function storageKey(id: string): string {
	return `urology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank urology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the urology assessment, with localStorage
