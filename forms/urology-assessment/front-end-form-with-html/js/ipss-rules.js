// IPSS (International Prostate Symptom Score) question and response rules.
//
// The 7 IPSS questions, each scored 0-5:
//   0 = Not at all
...
// Categories: 0-7 = Mild, 8-19 = Moderate, 20-35 = Severe.
//
// The Quality of Life (QoL) item is scored 0-6 (Delighted -> Terrible).

/**
 * @typedef {Object} IPSSRuleDefinition
 * @property {string} id
