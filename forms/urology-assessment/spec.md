# Urology Assessment — specification
...
- `bin/test-form urology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check urology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `urology-assessment.front-end-form-with-html.v1` (HTML)
  - `urology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
