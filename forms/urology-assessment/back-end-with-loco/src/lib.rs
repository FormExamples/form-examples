//! Urology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Urology Assessment** medical form, built on the
...
//!
//! ```
//! use urology_assessment_loco_crate::engine::types::AssessmentData;
//!
