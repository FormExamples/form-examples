...
- LocalStorage key `dermatology-assessment.front-end-form-with-html.v1` (HTML) and
  `dermatology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
