use dermatology_assessment_loco_crate::engine::dermatology_grader::calculate_severity;
use dermatology_assessment_loco_crate::engine::dermatology_rules::all_rules;
use dermatology_assessment_loco_crate::engine::types::*;
