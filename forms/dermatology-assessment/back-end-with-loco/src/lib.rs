//! Dermatology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Dermatology Assessment** medical form, built on the
...
//!
//! ```
//! use dermatology_assessment_loco_crate::engine::types::AssessmentData;
//!
