# Dermatology Assessment — specification
...
- `bin/test-form dermatology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check dermatology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `dermatology-assessment.front-end-form-with-html.v1` (HTML)
  - `dermatology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
