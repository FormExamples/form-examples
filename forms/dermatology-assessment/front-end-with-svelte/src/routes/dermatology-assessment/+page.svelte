<script lang="ts">
	const plural = 'dermatology-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/dermatology-assessment/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-primary-content/80">
				Open the step-by-step assessment form. One continuous single-page wizard that scores the DLQI
				as you complete it.
			</p>
			<span class="mt-4 inline-block text-sm font-semibold">Open the form →</span>
		</a>
		<a
			href="/dermatology-assessment/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed DLQI score and quality-of-life impact category.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the DLQI scoring engine, and the
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the Dermatology Life Quality Index (DLQI), a validated 10-item instrument scored 0–30.
				</dd>
			</div>
		</dl>
	</section>
