# Tasks: Medical Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/medical-waiting-list-card/`.
...
- [x] `cargo loco new medical-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form medical-waiting-list-card` exits cleanly.
