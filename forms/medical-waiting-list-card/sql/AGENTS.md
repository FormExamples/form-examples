# Medical Waiting List Card — PostgreSQL migrations
...
Child `medical_waiting_list_card_*` tables reference
`medical_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
