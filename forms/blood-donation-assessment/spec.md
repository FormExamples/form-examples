# Blood Donation Assessment — specification
...
- `bin/test-form blood-donation-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check blood-donation-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `blood-donation-assessment.front-end-form-with-html.v1` (HTML)
  - `blood-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit)
