...
- LocalStorage key `blood-donation-assessment.front-end-form-with-html.v1` (HTML) and
  `blood-donation-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
