...
function storageKey(id: string): string {
	return `blood-donation-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank blood donation assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the blood donation assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.donorDemographics`) stay bound to live state.
	 */
