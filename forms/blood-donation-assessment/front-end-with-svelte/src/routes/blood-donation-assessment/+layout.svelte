...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/blood-donation-assessment/" class="text-lg font-bold text-base-content">Blood Donation Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/blood-donation-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/blood-donation-assessment/blood-donation-assessments/new" class={navClass('/blood-donation-assessments/new')}>New assessment</a>
				<a href="/blood-donation-assessment/blood-donation-assessments" class={navClass('/blood-donation-assessments')}>Dashboard</a>
