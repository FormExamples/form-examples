//! Blood Donation Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Blood Donation Assessment** medical form, built on the
...
//!
//! ```
//! use blood_donation_assessment_loco_crate::engine::types::AssessmentData;
//!
