...
Server-side Rust JSON API for the Centor Score for Streptococcal Pharyngitis form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`centor_score_for_streptococcal_pharyngitis/`](centor_score_for_streptococcal_pharyngitis/) — one migration, SeaORM
