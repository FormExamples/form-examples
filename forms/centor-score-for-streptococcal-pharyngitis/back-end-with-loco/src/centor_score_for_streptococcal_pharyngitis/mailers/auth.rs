...
static welcome: Dir<'_> = include_dir!("src/centor_score_for_streptococcal_pharyngitis/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/centor_score_for_streptococcal_pharyngitis/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/centor_score_for_streptococcal_pharyngitis/mailers/auth/magic_link");
