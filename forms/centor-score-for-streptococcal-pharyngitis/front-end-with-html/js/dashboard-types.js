...
/**
 * Modified McIsaac score — integer -1 to 5, or null when not yet scored.
 *
 * @typedef {number | null} McIsaacScore
 */
 ...
 * `forms/centor-score-for-streptococcal-pharyngitis/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {number | null} centorScore  - Centor total (0-4) or null
 * @property {McIsaacScore} mcIsaacScore  - modified McIsaac score (-1..5) or null
 * @property {RiskBand} riskBand         - derived risk band
 * @property {boolean} redFlag           - true when any airway / quinsy red flag is present
...
// namespace, `window.CentorScoreForStreptococcalPharyngitisDashboard`.

// No runtime exports; types are JSDoc-only. Touch the namespace so this file
// is unambiguously side-effecting and other files can rely on it loading
// before they read `window.CentorScoreForStreptococcalPharyngitisDashboard`.
