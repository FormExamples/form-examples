...
function storageKey(id: string): string {
	return `centor-score-for-streptococcal-pharyngitis.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Centor assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Centor assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.exudate`) stay bound to live state.
	 */
