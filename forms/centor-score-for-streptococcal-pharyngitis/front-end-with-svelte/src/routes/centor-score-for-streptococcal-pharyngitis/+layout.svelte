...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/centor-score-for-streptococcal-pharyngitis/" class="text-lg font-bold text-base-content">Centor / McIsaac</a>
			<div class="flex items-center gap-1">
				<a href="/centor-score-for-streptococcal-pharyngitis/" class={navClass('/')}>Welcome</a>
				<a href="/centor-score-for-streptococcal-pharyngitis/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/centor-score-for-streptococcal-pharyngitis/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
