# Mast Cell Activation Syndrome (MCAS) Assessment — specification
...
- `bin/test-form mast-cell-activation-syndrome-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check mast-cell-activation-syndrome-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `mast-cell-activation-syndrome-assessment.front-end-form-with-html.v1` (HTML)
  - `mast-cell-activation-syndrome-assessment.front-end-form-with-svelte.v1` (SvelteKit)
