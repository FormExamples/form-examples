...
- LocalStorage key `mast-cell-activation-syndrome-assessment.front-end-form-with-html.v1` (HTML) and
  `mast-cell-activation-syndrome-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
