...
<svelte:head>
	<title>Mast Cell Activation Syndrome Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/mast-cell-activation-syndrome-assessment/" class="text-lg font-bold text-base-content">Mast Cell Activation Syndrome Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/mast-cell-activation-syndrome-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/mast-cell-activation-syndrome-assessment/mast-cell-activation-syndrome-assessments/new"
					class={navClass('/mast-cell-activation-syndrome-assessments/new')}>New assessment</a
				>
				<a
					href="/mast-cell-activation-syndrome-assessment/mast-cell-activation-syndrome-assessments"
					class={navClass('/mast-cell-activation-syndrome-assessments')}>Dashboard</a
				>
