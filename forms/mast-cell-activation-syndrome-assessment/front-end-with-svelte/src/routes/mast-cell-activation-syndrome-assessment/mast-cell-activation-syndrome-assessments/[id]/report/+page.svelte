<script lang="ts">
	...
	import { mcasScoreColor, calculateAge } from '#lib/engine/utils.js';
	...
	$effect(() => {
		if (!assessment.result) {
			goto(`/mast-cell-activation-syndrome-assessment/mast-cell-activation-syndrome-assessments/${id}`);
		}
	});
		...
		<div class="mx-auto flex max-w-4xl items-center justify-between px-4 py-4">
			...
			<div class="flex items-center gap-3">
				...
				<Button
					...
					onclick={() => goto(`/mast-cell-activation-syndrome-assessment/mast-cell-activation-syndrome-assessments/${id}`)}>Edit</Button
				>
			</div>
		</div>
	</header>
