...
function storageKey(id: string): string {
	return `mast-cell-activation-syndrome-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}
...
/** A blank MCAS assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the MCAS assessment, with localStorage
