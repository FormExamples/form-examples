//! Mast Cell Activation Syndrome Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Mast Cell Activation Syndrome Assessment** medical form, built on the
...
//!
//! ```
//! use mcas_assessment_loco_crate::engine::types::AssessmentData;
//!
