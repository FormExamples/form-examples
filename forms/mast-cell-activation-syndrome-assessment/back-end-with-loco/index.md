# Mast Cell Activation Syndrome Assessment: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Mast Cell Activation Syndrome Assessment form. Pure back-end: no HTML
