# Changelog — Rockall Score for Upper Gastrointestinal Bleeding
...
file only records changes scoped to the **Rockall Score for Upper Gastrointestinal Bleeding** form.
