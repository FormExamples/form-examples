...
Server-side Rust JSON API for the Rockall Score for Upper Gastrointestinal Bleeding form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`rockall_score_for_upper_gastrointestinal_bleeding/`](rockall_score_for_upper_gastrointestinal_bleeding/) — one migration, SeaORM
