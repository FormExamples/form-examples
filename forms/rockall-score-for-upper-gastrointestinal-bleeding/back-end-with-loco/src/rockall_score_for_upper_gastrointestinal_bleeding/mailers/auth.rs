...
static welcome: Dir<'_> = include_dir!("src/rockall_score_for_upper_gastrointestinal_bleeding/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/rockall_score_for_upper_gastrointestinal_bleeding/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/rockall_score_for_upper_gastrointestinal_bleeding/mailers/auth/magic_link");
