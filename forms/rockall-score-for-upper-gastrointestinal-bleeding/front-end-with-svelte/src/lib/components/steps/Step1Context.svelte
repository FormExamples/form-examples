...
<Fieldset legend="Step 1 of 6 — Assessment context">
	...
	<Field
		...
		description="e.g. haematemesis, melaena, coffee-ground vomiting."
		inputId="context-presentingComplaint"
	>
		<TextAreaInput
			id="context-presentingComplaint"
			label="Presenting complaint"
			rows={2}
			placeholder="Brief description of the presenting upper GI bleed."
