...
function storageKey(id: string): string {
	return `rockall-score-for-upper-gastrointestinal-bleeding.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Rockall assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Rockall assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.shock`) stay bound to live state.
	 */
