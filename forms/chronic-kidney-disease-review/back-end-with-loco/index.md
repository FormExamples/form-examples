...
Server-side Rust JSON API for the Chronic Kidney Disease Annual Review form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`chronic_kidney_disease_review/`](chronic_kidney_disease_review/) — one migration, SeaORM
