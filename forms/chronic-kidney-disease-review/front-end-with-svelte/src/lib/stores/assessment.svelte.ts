...
function storageKey(id: string): string {
	return `chronic-kidney-disease-review.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank CKD annual review with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the CKD annual review, with localStorage
