...
<svelte:head>
	<title>Chronic Kidney Disease Annual Review</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/chronic-kidney-disease-review/" class="text-lg font-bold text-base-content">CKD review</a>
			<div class="flex items-center gap-1">
				<a href="/chronic-kidney-disease-review/" class={navClass('/')}>Welcome</a>
				<a
					href="/chronic-kidney-disease-review/chronic-kidney-disease-reviews/new"
					class={navClass('/chronic-kidney-disease-reviews/new')}>New review</a
				>
				<a href="/chronic-kidney-disease-review/chronic-kidney-disease-reviews" class={navClass('/chronic-kidney-disease-reviews')}
					>Dashboard</a
				>
