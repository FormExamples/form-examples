# Nephrology Waiting List Card — specification
...
nephrology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form nephrology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check nephrology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `nephrology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `nephrology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
