# Tasks: Nephrology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/nephrology-waiting-list-card/`.
...
- [x] `cargo loco new nephrology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form nephrology-waiting-list-card` exits cleanly.
