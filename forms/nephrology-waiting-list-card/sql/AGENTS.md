# Nephrology Waiting List Card — PostgreSQL migrations
...
Child `nephrology_waiting_list_card_*` tables reference
`nephrology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
