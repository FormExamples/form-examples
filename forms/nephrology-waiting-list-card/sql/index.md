# nephrology-waiting-list-card — sql
...
- `nephrology_waiting_list_card` — top-level waiting list card.
- `nephrology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `nephrology_waiting_list_card_grade` — computed grading result.
- `nephrology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `nephrology_waiting_list_card_grade_flag` — safety / operational flags fired
