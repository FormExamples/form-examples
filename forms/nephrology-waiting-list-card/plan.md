# Plan: Nephrology Waiting List Card
...
months later. The Nephrology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form nephrology-waiting-list-card`.
