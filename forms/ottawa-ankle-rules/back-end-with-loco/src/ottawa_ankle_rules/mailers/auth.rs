...
static welcome: Dir<'_> = include_dir!("src/ottawa_ankle_rules/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/ottawa_ankle_rules/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/ottawa_ankle_rules/mailers/auth/magic_link");
