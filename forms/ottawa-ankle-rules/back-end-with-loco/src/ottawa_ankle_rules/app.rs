...
impl Hooks for App {
    ...
    async fn seed(ctx: &AppContext, _base: &Path) -> Result<()> {
        ...
        loco_rs::db::seed::<crate::models::_entities::ottawa_ankle_rules_grade_flags::ActiveModel>(
            &ctx.db,
            &format!("{}/src/ottawa_ankle_rules/fixtures/ottawa_ankle_rules_grade_flags.yaml", env!("CARGO_MANIFEST_DIR")),
        )
        .await?;
        loco_rs::db::seed::<crate::models::_entities::ottawa_ankle_rules_grade_rules::ActiveModel>(
            &ctx.db,
            &format!("{}/src/ottawa_ankle_rules/fixtures/ottawa_ankle_rules_grade_rules.yaml", env!("CARGO_MANIFEST_DIR")),
        )
        .await?;
