...
Server-side Rust JSON API for the Ottawa Ankle Rules (and Ottawa Foot Rules) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`ottawa_ankle_rules/`](ottawa_ankle_rules/) — one migration, SeaORM
