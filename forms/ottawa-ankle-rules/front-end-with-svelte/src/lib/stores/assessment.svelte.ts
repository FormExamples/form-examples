...
function storageKey(id: string): string {
	return `ottawa-ankle-rules.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Ottawa Ankle / Foot Rules assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Ottawa Ankle / Foot Rules assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.painZones`) stay bound to live state.
	 */
