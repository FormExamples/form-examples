...
Domain spec for the Pregnancy Ultrasound Test Request form. See `index.md` for the full description.
...
- LocalStorage keys preserve draft state across reloads:
  - `pregnancy-ultrasound-test-request.front-end-form-with-html.v1` (HTML)
  - `pregnancy-ultrasound-test-request.front-end-form-with-svelte.v1` (SvelteKit)
