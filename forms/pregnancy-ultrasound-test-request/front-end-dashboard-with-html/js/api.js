// Backend API client for the obstetric ultrasound vetting dashboard.
//
...
window.PregnancyUltrasoundTestRequestDashboard.fetchRequests = fetchRequests;
window.PregnancyUltrasoundTestRequestDashboard.API_BASE = API_BASE;
})();
