...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "pregnancy_ultrasound_test_request_grades",
            &[
            ...
            ("gestational_age_window_fit", ColType::StringWithDefault(String::new())),
            ("recommended_scan_type", ColType::StringWithDefault(String::new())),
