<script lang="ts">
	...
	import Step5CardiacContext from '#lib/components/steps/Step5CardiacContext.svelte';
	...
	function submit() {
		...
		goto(`/holter-monitor-test-request/holter-monitor-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New Holter monitor request' : `Holter monitor request ${id}`}
	</h1>
	...
	<Form label="Holter monitor test request" onsubmit={submit}>
