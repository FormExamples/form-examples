// Backend API client for the Holter monitor vetting dashboard.
//
...
window.HolterMonitorTestRequestDashboard.fetchRequests = fetchRequests;
window.HolterMonitorTestRequestDashboard.API_BASE = API_BASE;
})();
