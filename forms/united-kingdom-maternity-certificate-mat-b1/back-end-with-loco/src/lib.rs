//! United Kingdom Maternity Certificate Mat B1 — Loco JSON API back-end.
//!
//! Server-side JSON API for the **United Kingdom Maternity Certificate Mat B1** medical form, built on the
...
//!
//! ```
//! use united_kingdom_maternity_certificate_mat_b1_loco_crate::engine::types::AssessmentData;
//!
