...
- LocalStorage key `united-kingdom-maternity-certificate-mat-b1.front-end-form-with-html.v1` (HTML) and
  `united-kingdom-maternity-certificate-mat-b1.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
