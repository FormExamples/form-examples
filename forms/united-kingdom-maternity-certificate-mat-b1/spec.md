# United Kingdom Maternity Certificate MAT B1 — specification
...
- `bin/test-form united-kingdom-maternity-certificate-mat-b1` exits cleanly.
...
- `bin/lily-html-refactor --check united-kingdom-maternity-certificate-mat-b1` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-maternity-certificate-mat-b1.front-end-form-with-html.v1` (HTML)
  - `united-kingdom-maternity-certificate-mat-b1.front-end-form-with-svelte.v1` (SvelteKit)
