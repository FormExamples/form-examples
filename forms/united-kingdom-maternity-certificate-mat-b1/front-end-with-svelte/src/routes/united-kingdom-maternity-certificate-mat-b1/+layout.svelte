...
<svelte:head>
	<title>UK Maternity Certificate MAT B1</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-maternity-certificate-mat-b1/" class="text-lg font-bold text-base-content">UK Maternity Certificate MAT B1</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-maternity-certificate-mat-b1/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-maternity-certificate-mat-b1/{plural}/new" class={navClass(`/${plural}/new`)}>New certificate</a>
				<a href="/united-kingdom-maternity-certificate-mat-b1/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
