<script lang="ts">
	...
	import Step2SpecimenHistory from '$lib/components/steps/Step2SpecimenHistory.svelte';
	import Step3ResultValues from '$lib/components/steps/Step3ResultValues.svelte';
	...
	function submit() {
		...
		goto('/toxicology-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New toxicology report</h1>
	...
	<Form label="Toxicology test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2SpecimenHistory />
		<Step3ResultValues />
		<Step4Interpretation />
		<Step5Impression />
