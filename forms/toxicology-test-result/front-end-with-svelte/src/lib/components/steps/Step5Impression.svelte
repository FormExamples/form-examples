...
<Fieldset legend="5. Impression">
	<p class="hint">The summary impression, reporting category, and recommended follow-up.</p>
	...
	<Field
		...
		description="Structured-reporting label (e.g. a nomogram band or therapeutic / toxic descriptor)."
	>
		<TextInput
