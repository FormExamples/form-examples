...
<Fieldset legend="7. Interpretation & Sign-off">
	<p class="hint">Live four-axis interpretation grade and sign-off.</p>

	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a toxic level. Communicate the result directly to the requester and
				start the appropriate antidote (N-acetylcysteine / NAC for paracetamol) before signing.
			</p>
		</Alert>
	{/if}
