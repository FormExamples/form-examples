 ...
 * `forms/hearing-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.HearingTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.HearingTestResultDashboard`.
})();
