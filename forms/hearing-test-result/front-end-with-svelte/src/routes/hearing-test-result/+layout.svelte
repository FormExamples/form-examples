...
<svelte:head>
	<title>Hearing Test Result</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hearing-test-result/" class="text-lg font-bold text-base-content">Hearing Test Result</a>
			<div class="flex items-center gap-1">
				<a href="/hearing-test-result/" class={navClass('/')}>Welcome</a>
				<a href="/hearing-test-result/report" class={navClass('/report')}>New report</a>
				<a href="/hearing-test-result/reports" class={navClass('/reports')}>Reports</a>
				<LocalePicker
					label="Language"
					class="ml-2"
