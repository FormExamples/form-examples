<script lang="ts">
	...
	import Step4AudiometryInterpretation from '$lib/components/steps/Step4AudiometryInterpretation.svelte';
	...
	function submit() {
		...
		goto('/hearing-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New hearing test report</h1>
	...
	<Form label="Hearing test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2TestDetails />
		<Step3ClinicalHistory />
		<Step4AudiometryInterpretation />
		<Step5Findings />
		<Step6Impression />
