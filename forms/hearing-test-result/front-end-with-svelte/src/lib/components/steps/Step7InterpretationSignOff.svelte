...
<Fieldset legend="7. Interpretation & Sign-off">
	...
	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a critical finding (sudden sensorineural hearing loss or marked
				asymmetry). Communicate the result directly to the referrer and record it below before
				signing.
			</p>
		</Alert>
	{/if}
