import type { HearingResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a hearing test result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (sudden sensorineural hearing loss or marked
 * asymmetry suggesting retrocochlear pathology) auto-escalates Axis D to
 ...
 */
export function calculateGrade(result: HearingResult): GradingResult {
