//! First Responder Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **First Responder Assessment** medical form, built on the
...
//!
//! ```
//! use first_responder_assessment_loco_crate::engine::types::AssessmentData;
//!
