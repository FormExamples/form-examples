...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/first-responder-assessment/"
                class="text-lg font-bold text-base-content"
                >First Responder Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/first-responder-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/first-responder-assessment/first-responder-assessments/new"
                    class={navClass("/first-responder-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/first-responder-assessment/first-responder-assessments"
                    class={navClass("/first-responder-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
