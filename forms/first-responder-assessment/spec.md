# First Responder Assessment — specification
...
- `bin/test-form first-responder-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check first-responder-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `first-responder-assessment.front-end-form-with-html.v1` (HTML)
  - `first-responder-assessment.front-end-form-with-svelte.v1` (SvelteKit)
