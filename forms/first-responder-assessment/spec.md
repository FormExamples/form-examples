...
- LocalStorage key `first-responder-assessment.front-end-form-with-html.v1` (HTML) and
  `first-responder-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
