// Flagged-issue detection. Independent of the rule-based grading: this
// module raises clinician-facing safety flags that the assessor should see
// regardless of overall competency. Ported directly from
// `flagged-issues.ts`.
