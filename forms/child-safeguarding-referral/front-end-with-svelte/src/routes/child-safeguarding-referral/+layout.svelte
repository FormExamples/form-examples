...
<svelte:head>
	<title>Child Safeguarding Referral</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/child-safeguarding-referral/" class="text-lg font-bold text-base-content">Child Safeguarding Referral</a>
			<div class="flex items-center gap-1">
				<a href="/child-safeguarding-referral/" class={navClass('/')}>Welcome</a>
				<a href="/child-safeguarding-referral/child-safeguarding-referrals/new" class={navClass('/child-safeguarding-referrals/new')}>New referral</a>
				<a href="/child-safeguarding-referral/child-safeguarding-referrals" class={navClass('/child-safeguarding-referrals')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
