...
static welcome: Dir<'_> = include_dir!("src/child_safeguarding_referral/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/child_safeguarding_referral/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/child_safeguarding_referral/mailers/auth/magic_link");
