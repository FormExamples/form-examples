...
Server-side Rust JSON API for the Child Safeguarding Referral form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`child_safeguarding_referral/`](child_safeguarding_referral/) — one migration, SeaORM
