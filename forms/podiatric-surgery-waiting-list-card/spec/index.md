# Podiatric Surgery Waiting List Card — specification
...
podiatric surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form podiatric-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check podiatric-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `podiatric-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `podiatric-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
