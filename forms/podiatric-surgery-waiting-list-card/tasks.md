# Tasks: Podiatric Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/podiatric-surgery-waiting-list-card/`.
...
- [x] `cargo loco new podiatric-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form podiatric-surgery-waiting-list-card` exits cleanly.
