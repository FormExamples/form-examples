# Plan: Podiatric Surgery Waiting List Card
...
months later. The Podiatric Surgery Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form podiatric-surgery-waiting-list-card`.
