-- Practitioner who places the patient on a podiatric surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a podiatric surgery waiting list card on behalf of the patient.';
