# podiatric-surgery-waiting-list-card — sql
...
- `podiatric_surg_waiting_list_card` — top-level waiting list card.
- `podiatric_surg_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `podiatric_surg_waiting_list_card_grade` — computed grading result.
- `podiatric_surg_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `podiatric_surg_waiting_list_card_grade_flag` — safety / operational flags fired
