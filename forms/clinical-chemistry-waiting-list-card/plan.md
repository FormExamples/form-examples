# Plan: Clinical Chemistry Waiting List Card
...
months later. The Clinical Chemistry Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form clinical-chemistry-waiting-list-card`.
