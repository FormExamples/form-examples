# Clinical Chemistry Waiting List Card — specification
...
clinical chemistry waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form clinical-chemistry-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check clinical-chemistry-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `clinical-chemistry-waiting-list-card.front-end-with-html.v1` (HTML)
  - `clinical-chemistry-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
