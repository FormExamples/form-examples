...
<svelte:head>
	<title>Clinical Chemistry Waiting List Card</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/clinical-chemistry-waiting-list-card/" class="text-lg font-bold text-base-content">Clinical Chemistry Waiting List Card</a>
			<div class="flex items-center gap-1">
				<a href="/clinical-chemistry-waiting-list-card/" class={navClass('/')}>Welcome</a>
				<a
					href="/clinical-chemistry-waiting-list-card/clinical-chemistry-waiting-list-cards/new"
					class={navClass('/clinical-chemistry-waiting-list-cards/new')}>New card</a
				>
				<a href="/clinical-chemistry-waiting-list-card/clinical-chemistry-waiting-list-cards" class={navClass('/clinical-chemistry-waiting-list-cards')}
					>Dashboard</a
				>
				<LocaleChooser
					label="Language"
