# Tasks: Clinical Chemistry Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/clinical-chemistry-waiting-list-card/`.
...
- [x] `cargo loco new clinical-chemistry-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form clinical-chemistry-waiting-list-card` exits cleanly.
