# clinical-chemistry-waiting-list-card — sql
...
- `clin_chem_waiting_list_card` — top-level waiting list card.
- `clin_chem_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `clin_chem_waiting_list_card_grade` — computed grading result.
- `clin_chem_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `clin_chem_waiting_list_card_grade_flag` — safety / operational flags fired
