# Clinical Chemistry Waiting List Card — PostgreSQL migrations
...
Child `clin_chem_waiting_list_card_*` tables reference
`clin_chem_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
