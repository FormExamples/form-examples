-- Practitioner who places the patient on a clinical chemistry waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a clinical chemistry waiting list card on behalf of the patient.';
