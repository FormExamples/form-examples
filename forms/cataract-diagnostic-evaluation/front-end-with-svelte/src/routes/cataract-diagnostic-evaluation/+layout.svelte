...
<svelte:head>
    <title>Cataract Diagnostic Evaluation</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/cataract-diagnostic-evaluation/"
                class="text-lg font-bold text-base-content"
                >Cataract Diagnostic Evaluation</a
            >
            <div class="flex items-center gap-1">
                <a href="/cataract-diagnostic-evaluation/" class={navClass("/")}>Welcome</a>
                <a
                    href="/cataract-diagnostic-evaluation/cataract-diagnostic-evaluations/new"
                    class={navClass("/cataract-diagnostic-evaluations/new")}>New evaluation</a
                >
                <a
                    href="/cataract-diagnostic-evaluation/cataract-diagnostic-evaluations"
                    class={navClass("/cataract-diagnostic-evaluations")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
