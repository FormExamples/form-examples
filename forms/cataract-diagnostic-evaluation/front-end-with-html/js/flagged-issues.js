// Safety-flag detection for the Cataract Diagnostic Evaluation engine.
//
...
import { num } from './locs-rules.js';

/**
 * Detect safety flags for a cataract diagnostic evaluation.
 *
 * @param {object} data - the evaluation data model from emptyEvaluation()
 * @param {object} context - { severityRight, severityLeft, age }
