<script lang="ts">
	...
	import { gradeShortLabel, dispositionLabel } from '#lib/engine/utils.js';
	import type { ClavienDindoGradeKey, DispositionLocation } from '#lib/engine/types.js';
