# Post-Operative Report — specification
...
- `bin/test-form post-operative-report` exits cleanly.
...
- `bin/lily-html-refactor --check post-operative-report` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `post-operative-report.front-end-form-with-html.v1` (HTML)
  - `post-operative-report.front-end-form-with-svelte.v1` (SvelteKit)
