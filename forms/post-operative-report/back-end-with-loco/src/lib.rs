//! Post Operative Report — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Post Operative Report** medical form, built on the
...
//!
//! ```
//! use post_operative_report_loco_crate::engine::types::AssessmentData;
//!
