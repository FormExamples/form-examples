...
static welcome: Dir<'_> = include_dir!("src/post_operative_report/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/post_operative_report/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/post_operative_report/mailers/auth/magic_link");
