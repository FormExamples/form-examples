...
- LocalStorage key `post-operative-report.front-end-form-with-html.v1` (HTML) and
  `post-operative-report.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
