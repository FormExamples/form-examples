...
// configured so the page is usable standalone. Identical to
// front-end-with-svelte/src/lib/data/sample-reports.ts so both front-ends
// show the same data.
