// Safety-flag detection. Ports
// front-end-with-svelte/src/lib/engine/flagged-issues.ts line for line.
//
...
/**
 * Detect safety flags for a health screening questionnaire, most severe
 * first.
 *
 * @param {object} data
 * @param {{parqPlusClearance: string, auditCScore: number|null, auditCBand: string, age: number|null}} context
 */
