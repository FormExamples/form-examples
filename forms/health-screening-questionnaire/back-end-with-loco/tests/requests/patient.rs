...
async fn can_create_and_read_back_patient() {
    request::<App, _, _>(|request, _ctx| async move {
        let new_patient = serde_json::json!({
            ...
            "sex": "female",
            "identifierType": "nhs-number",
            "identifierValue": "Test identifierValue",
        ...
        assert_eq!(fetched["identifierType"], "nhs-number");
        assert_eq!(fetched["identifierValue"], "Test identifierValue");
