...
<svelte:head>
    <title>Health Screening Questionnaire</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/health-screening-questionnaire/"
                class="text-lg font-bold text-base-content"
                >Health Screening Questionnaire</a
            >
            <div class="flex items-center gap-1">
                <a href="/health-screening-questionnaire/" class={navClass("/")}>Welcome</a>
                <a
                    href="/health-screening-questionnaire/health-screening-questionnaires/new"
                    class={navClass("/health-screening-questionnaires/new")}>New screening</a
                >
                <a
                    href="/health-screening-questionnaire/health-screening-questionnaires"
                    class={navClass("/health-screening-questionnaires")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
