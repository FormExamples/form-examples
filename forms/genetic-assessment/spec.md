# Genetic Assessment — specification
...
- `bin/test-form genetic-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check genetic-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `genetic-assessment.front-end-form-with-html.v1` (HTML)
  - `genetic-assessment.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form genetic-assessment
```
