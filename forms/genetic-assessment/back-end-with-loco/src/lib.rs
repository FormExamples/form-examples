//! Genetic Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Genetic Assessment** medical form, built on the
...
//!
//! ```
//! use genetic_assessment_loco_crate::engine::types::AssessmentData;
//!
