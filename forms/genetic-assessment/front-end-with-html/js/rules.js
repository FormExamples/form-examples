// Genetic Assessment risk-rule definitions.
//
// Each rule has a weight that contributes to the overall risk score; the
// risk-grader fires rules based on the patient's responses.
//
// Risk Stratification:
//   0-2  = Low Risk
//   3-5  = Moderate Risk
...
// `forms/genetic-assessment/front-end-form-with-svelte/src/lib/engine/risk-rules.ts`.
