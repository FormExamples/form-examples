# Colonoscopy Test Result — specification
...
- `bin/test-form colonoscopy-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check colonoscopy-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `colonoscopy-test-result.front-end-with-html.v1` (HTML)
  - `colonoscopy-test-result.front-end-with-svelte.v1` (SvelteKit)
