<script lang="ts">
	...
	import Step5PolypsTissue from '$lib/components/steps/Step5PolypsTissue.svelte';
	...
	function submit() {
		...
		goto('/colonoscopy-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New colonoscopy report</h1>
	...
	<Form label="Colonoscopy test result" onsubmit={submit}>
