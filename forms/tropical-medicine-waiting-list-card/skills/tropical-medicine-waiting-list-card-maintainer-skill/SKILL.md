...
bin/test-sql-apply tropical-medicine-waiting-list-card
bin/test-personas tropical-medicine-waiting-list-card
bin/test-e2e --html tropical-medicine-waiting-list-card
```
