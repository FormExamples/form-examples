# Tasks: Tropical Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/tropical-medicine-waiting-list-card/`.
...
- [x] `cargo loco new tropical-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form tropical-medicine-waiting-list-card` exits cleanly.
