# Plan: Tropical Medicine Waiting List Card
...
months later. The Tropical Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form tropical-medicine-waiting-list-card`.
