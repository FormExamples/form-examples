-- Practitioner who places the patient on a tropical medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a tropical medicine waiting list card on behalf of the patient.';
