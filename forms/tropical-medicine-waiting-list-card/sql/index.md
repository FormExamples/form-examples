# tropical-medicine-waiting-list-card — sql
...
- `trop_med_waiting_list_card` — top-level waiting list card.
- `trop_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `trop_med_waiting_list_card_grade` — computed grading result.
- `trop_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `trop_med_waiting_list_card_grade_flag` — safety / operational flags fired
