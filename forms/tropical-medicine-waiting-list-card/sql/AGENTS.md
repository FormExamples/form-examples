# Tropical Medicine Waiting List Card — PostgreSQL migrations
...
Child `trop_med_waiting_list_card_*` tables reference
`trop_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
