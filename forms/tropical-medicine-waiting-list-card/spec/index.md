# Tropical Medicine Waiting List Card — specification
...
- `bin/test-form tropical-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check tropical-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `tropical-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `tropical-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
