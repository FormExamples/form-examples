...
static welcome: Dir<'_> = include_dir!("src/curb_65_pneumonia_severity_score/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/curb_65_pneumonia_severity_score/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/curb_65_pneumonia_severity_score/mailers/auth/magic_link");
