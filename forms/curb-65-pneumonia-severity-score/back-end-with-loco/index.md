...
Server-side Rust JSON API for the CURB-65 Pneumonia Severity Score form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`curb_65_pneumonia_severity_score/`](curb_65_pneumonia_severity_score/) — one migration, SeaORM
