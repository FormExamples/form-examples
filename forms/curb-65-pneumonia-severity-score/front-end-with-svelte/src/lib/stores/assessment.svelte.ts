...
function storageKey(id: string): string {
	return `curb-65-pneumonia-severity-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank CURB-65 assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the CURB-65 assessment, with localStorage
