...
<svelte:head>
	<title>CURB-65 Pneumonia Severity Score</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/curb-65-pneumonia-severity-score/" class="text-lg font-bold text-base-content">CURB-65</a>
			<div class="flex items-center gap-1">
				<a href="/curb-65-pneumonia-severity-score/" class={navClass('/')}>Welcome</a>
				<a
					href="/curb-65-pneumonia-severity-score/curb-65-pneumonia-severity-scores/new"
					class={navClass('/curb-65-pneumonia-severity-scores/new')}>New assessment</a
				>
				<a
					href="/curb-65-pneumonia-severity-score/curb-65-pneumonia-severity-scores"
					class={navClass('/curb-65-pneumonia-severity-scores')}>Dashboard</a
				>
