...
for the CURB-65 specification and scoring engine. Lily Svelte headless
conventions: [`../../AGENTS-front-end-svelte.md`](../../AGENTS-front-end-svelte.md).

## Layout

- `src/lib/engine/` — pure scoring engine (`types.ts`, `utils.ts`,
  `curb65-rules.ts`, `curb65-grader.ts`, `flagged-issues.ts`) +
...
- `src/routes/curb-65-pneumonia-severity-scores/` — RESTful routes:
