# Plan: CURB-65 — SvelteKit front-end (form + dashboard)

## Current status

Complete. Greenfield SvelteKit consolidation mirroring the greenfield qSOFA
front-end (generic shared scaffold), which itself mirrors the gold
`cardiology-assessment` front-end.

- [x] Pure scoring engine ported from the HTML front-end (`src/lib/engine/`)
- [x] Vitest tests covering each threshold boundary, totals 0-5, and CRB-65 fallback
