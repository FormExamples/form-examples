...
// Cardiac Stress Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.CardiacStressTestResultDashboard`; display labels
// come from the form namespace `window.CardiacStressTestResult` (js/types.js).
