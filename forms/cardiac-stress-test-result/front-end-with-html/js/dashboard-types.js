 ...
 * `forms/cardiac-stress-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.CardiacStressTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.CardiacStressTestResultDashboard`.
})();
