...
Server-side Rust JSON API for the Cardiac Stress Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`cardiac_stress_test_result/`](cardiac_stress_test_result/) — one migration, SeaORM
