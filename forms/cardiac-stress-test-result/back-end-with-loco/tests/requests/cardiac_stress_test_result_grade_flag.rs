use cardiac_stress_test_result::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_cardiac_stress_test_result_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/cardiac_stress_test_result_grade_flags").await;
