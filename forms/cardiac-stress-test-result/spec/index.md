# Cardiac Stress Test Result — specification
...
- `bin/test-form cardiac-stress-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check cardiac-stress-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cardiac-stress-test-result.front-end-with-html.v1` (HTML)
  - `cardiac-stress-test-result.front-end-with-svelte.v1` (SvelteKit)
