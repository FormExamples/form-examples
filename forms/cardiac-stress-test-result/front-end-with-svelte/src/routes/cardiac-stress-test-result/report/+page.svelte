<script lang="ts">
	...
	function submit() {
		...
		goto('/cardiac-stress-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New cardiac stress test report</h1>
	...
	<Form label="Cardiac stress test result" onsubmit={submit}>
