...
<Fieldset legend="6. Impression">
	<p class="hint">The summary impression, risk category, and recommended follow-up.</p>
	...
	<Field
		...
		description="Structured risk-category label (e.g. low / intermediate / high risk)."
	>
		<TextInput
