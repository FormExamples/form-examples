# Clinical Microbiology Waiting List Card — PostgreSQL migrations
...
Child `clin_micro_waiting_list_card_*` tables reference
`clin_micro_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
