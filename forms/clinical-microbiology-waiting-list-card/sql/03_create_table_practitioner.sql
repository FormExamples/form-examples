-- Practitioner who places the patient on a clinical microbiology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a clinical microbiology waiting list card on behalf of the patient.';
