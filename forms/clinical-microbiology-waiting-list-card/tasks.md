# Tasks: Clinical Microbiology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/clinical-microbiology-waiting-list-card/`.
...
- [x] `cargo loco new clinical-microbiology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form clinical-microbiology-waiting-list-card` exits cleanly.
