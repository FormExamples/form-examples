# Plan: Clinical Microbiology Waiting List Card
...
months later. The Clinical Microbiology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form clinical-microbiology-waiting-list-card`.
