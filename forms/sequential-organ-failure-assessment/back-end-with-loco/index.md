...
Server-side Rust JSON API for the Sequential Organ Failure Assessment (SOFA) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`sequential_organ_failure_assessment/`](sequential_organ_failure_assessment/) — one migration, SeaORM
