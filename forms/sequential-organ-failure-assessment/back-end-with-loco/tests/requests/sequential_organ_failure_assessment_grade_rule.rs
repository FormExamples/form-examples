use sequential_organ_failure_assessment::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_sequential_organ_failure_assessment_grade_rules() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/sequential_organ_failure_assessment_grade_rules").await;
