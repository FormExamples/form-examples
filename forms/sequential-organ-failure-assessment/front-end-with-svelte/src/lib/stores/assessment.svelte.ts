...
function storageKey(id: string): string {
	return `sequential-organ-failure-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank SOFA assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the SOFA assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.respiration`) stay bound to live state.
	 */
