...
<svelte:head>
	<title>Sequential Organ Failure Assessment (SOFA)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/sequential-organ-failure-assessment/" class="text-lg font-bold text-base-content">SOFA</a>
			<div class="flex items-center gap-1">
				<a href="/sequential-organ-failure-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/sequential-organ-failure-assessment/sequential-organ-failure-assessments/new"
					class={navClass('/sequential-organ-failure-assessments/new')}>New assessment</a
				>
				<a
					href="/sequential-organ-failure-assessment/sequential-organ-failure-assessments"
					class={navClass('/sequential-organ-failure-assessments')}>Dashboard</a
				>
