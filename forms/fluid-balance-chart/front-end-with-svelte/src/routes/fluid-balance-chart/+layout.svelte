...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/fluid-balance-chart/"
                class="text-lg font-bold text-base-content"
                >Fluid Balance Chart</a
            >
            <div class="flex items-center gap-1">
                <a href="/fluid-balance-chart/" class={navClass("/")}>Welcome</a
                >
                <a
                    href="/fluid-balance-chart/fluid-balance-charts/new"
                    class={navClass("/fluid-balance-charts/new")}>New chart</a
                >
                <a
                    href="/fluid-balance-chart/fluid-balance-charts"
                    class={navClass("/fluid-balance-charts")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
