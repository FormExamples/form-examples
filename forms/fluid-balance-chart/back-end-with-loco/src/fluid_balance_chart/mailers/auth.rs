...
static welcome: Dir<'_> = include_dir!("src/fluid_balance_chart/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/fluid_balance_chart/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/fluid_balance_chart/mailers/auth/magic_link");
