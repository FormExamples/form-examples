...
static welcome: Dir<'_> = include_dir!("src/patient_reported_outcome_measures/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/patient_reported_outcome_measures/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/patient_reported_outcome_measures/mailers/auth/magic_link");
