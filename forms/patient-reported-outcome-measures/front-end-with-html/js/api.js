import { SAMPLE_PATIENT_REPORTED_OUTCOME_MEASURES } from './data.js';

const API_BASE = '/api/patient-reported-outcome-measures';
const CACHE_KEY = 'patient-reported-outcome-measures-dashboard:cache:v1';
 ...
 */
export const fetchPatientReportedOutcomeMeasures = function () {
  return fetch(API_BASE)
    ...
    .catch(function () {
      ...
      return { source: 'sample', rows: SAMPLE_PATIENT_REPORTED_OUTCOME_MEASURES };
    });
};

export { clearCache as clearPatientReportedOutcomeMeasuresCache };
