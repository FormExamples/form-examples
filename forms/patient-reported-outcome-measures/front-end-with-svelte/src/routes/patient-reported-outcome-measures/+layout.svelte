...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/patient-reported-outcome-measures/" class="text-lg font-bold text-base-content"
				>PRO Measures</a
			>
			<div class="flex items-center gap-1">
				<a href="/patient-reported-outcome-measures/" class={navClass('/')}>Welcome</a>
				<a
					href="/patient-reported-outcome-measures/patient-reported-outcome-measure-visits/new"
					class={navClass('/patient-reported-outcome-measure-visits/new')}>New visit</a
				>
				<a
					href="/patient-reported-outcome-measures/patient-reported-outcome-measure-visits"
					class={navClass('/patient-reported-outcome-measure-visits')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
