# Plan: Venereology Waiting List Card
...
months later. The Venereology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form venereology-waiting-list-card`.
