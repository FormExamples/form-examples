# venereology-waiting-list-card — sql
...
- `venereology_waiting_list_card` — top-level waiting list card.
- `venereology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `venereology_waiting_list_card_grade` — computed grading result.
- `venereology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `venereology_waiting_list_card_grade_flag` — safety / operational flags fired
