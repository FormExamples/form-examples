# Venereology Waiting List Card — PostgreSQL migrations
...
Child `venereology_waiting_list_card_*` tables reference
`venereology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
