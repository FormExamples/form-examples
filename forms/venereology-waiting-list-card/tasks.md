# Tasks: Venereology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/venereology-waiting-list-card/`.
...
- [x] `cargo loco new venereology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form venereology-waiting-list-card` exits cleanly.
