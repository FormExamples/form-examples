# Venereology Waiting List Card — specification
...
venereology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form venereology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check venereology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `venereology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `venereology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
