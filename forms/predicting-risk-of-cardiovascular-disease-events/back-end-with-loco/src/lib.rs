//! Predicting Risk of Cardiovascular Disease Events — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Predicting Risk of Cardiovascular Disease Events** medical form, built on the
...
//!
//! ```
//! use prevent_cvd_loco_crate::engine::types::AssessmentData;
//!
