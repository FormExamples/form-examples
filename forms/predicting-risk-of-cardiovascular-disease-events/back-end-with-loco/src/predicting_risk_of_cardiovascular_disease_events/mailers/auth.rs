...
static welcome: Dir<'_> = include_dir!("src/predicting_risk_of_cardiovascular_disease_events/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/predicting_risk_of_cardiovascular_disease_events/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/predicting_risk_of_cardiovascular_disease_events/mailers/auth/magic_link");
