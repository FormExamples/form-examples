# Predicting Risk Of Cardiovascular Disease Events: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Predicting Risk Of Cardiovascular Disease Events form. Pure back-end: no HTML
