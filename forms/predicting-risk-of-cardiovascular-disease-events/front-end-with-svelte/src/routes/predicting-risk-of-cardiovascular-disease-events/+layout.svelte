...
<svelte:head>
	<title>Predicting Risk of Cardiovascular Disease Events</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/predicting-risk-of-cardiovascular-disease-events/" class="text-lg font-bold text-base-content">Predicting Risk of Cardiovascular Disease Events</a>
			<div class="flex items-center gap-1">
				<a href="/predicting-risk-of-cardiovascular-disease-events/" class={navClass('/')}>Welcome</a>
				<a href="/predicting-risk-of-cardiovascular-disease-events/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/predicting-risk-of-cardiovascular-disease-events/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
