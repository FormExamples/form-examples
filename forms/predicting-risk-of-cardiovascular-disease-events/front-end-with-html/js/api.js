...
// http://localhost:5210 (Loco / axum); the dashboard endpoint returns a
...
window.PredictingRiskOfCardiovascularDiseaseEventsDashboard.fetchPatients =
  fetchPatients;
window.PredictingRiskOfCardiovascularDiseaseEventsDashboard.API_BASE =
  API_BASE;
})();
