# Predicting Risk of Cardiovascular Disease Events (PREVENT) — specification
...
- `bin/test-form predicting-risk-of-cardiovascular-disease-events` exits cleanly.
...
- `bin/lily-html-refactor --check predicting-risk-of-cardiovascular-disease-events` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `predicting-risk-of-cardiovascular-disease-events.front-end-form-with-html.v1` (HTML)
  - `predicting-risk-of-cardiovascular-disease-events.front-end-form-with-svelte.v1` (SvelteKit)
