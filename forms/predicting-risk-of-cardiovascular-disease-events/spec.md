...
- LocalStorage key `predicting-risk-of-cardiovascular-disease-events.front-end-form-with-html.v1` (HTML) and
  `predicting-risk-of-cardiovascular-disease-events.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
