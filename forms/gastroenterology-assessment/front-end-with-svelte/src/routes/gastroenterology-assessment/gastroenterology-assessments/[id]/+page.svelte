<script lang="ts">
	...
	function submit() {
		...
		goto(`/gastroenterology-assessment/gastroenterology-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New gastroenterology assessment' : `Gastroenterology assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the ten sections; the GI severity score and level are computed on submit.
	</p>
	...
	<Form label="Gastroenterology assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2ChiefComplaint />
