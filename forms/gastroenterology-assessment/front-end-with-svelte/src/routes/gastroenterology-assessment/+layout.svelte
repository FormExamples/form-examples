...
<svelte:head>
	<title>Gastroenterology Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/gastroenterology-assessment/" class="text-lg font-bold text-base-content">Gastroenterology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/gastroenterology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/gastroenterology-assessment/gastroenterology-assessments/new" class={navClass('/gastroenterology-assessments/new')}>New assessment</a>
				<a href="/gastroenterology-assessment/gastroenterology-assessments" class={navClass('/gastroenterology-assessments')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
