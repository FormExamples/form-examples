...
function storageKey(id: string): string {
	return `gastroenterology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank gastroenterology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the gastroenterology assessment, with localStorage
