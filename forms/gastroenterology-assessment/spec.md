# Gastroenterology Assessment — specification
...
- `bin/test-form gastroenterology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check gastroenterology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `gastroenterology-assessment.front-end-form-with-html.v1` (HTML)
  - `gastroenterology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
