...
- LocalStorage key `gastroenterology-assessment.front-end-form-with-html.v1` (HTML) and
  `gastroenterology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
