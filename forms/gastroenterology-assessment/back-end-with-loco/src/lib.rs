//! Gastroenterology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Gastroenterology Assessment** medical form, built on the
...
//!
//! ```
//! use gastroenterology_assessment_loco_crate::engine::types::AssessmentData;
//!
