...
- LocalStorage key `agile-principles-assessment.front-end-form-with-html.v1` (HTML) and
  `agile-principles-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
