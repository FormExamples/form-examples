...
<section>
  ...
  <p class="text-sm text-base-content/70 mb-4">{principle.description}</p>

  <fieldset class="mb-4">
    <legend class="block text-sm font-medium text-base-content/70 mb-2">
  ...
  <label class="block">
    <span class="block text-sm font-medium text-base-content/70 mb-1">Comment (optional)</span>
    <textarea
      rows="3"
      class="w-full border border-base-300 rounded px-2 py-1 text-sm"
