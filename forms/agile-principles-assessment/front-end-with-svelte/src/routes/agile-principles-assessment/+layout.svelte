    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            ...
            <div class="flex items-center gap-1">
                <a href="/agile-principles-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/agile-principles-assessment/agile-principles-assessments/new"
                    class={navClass("/agile-principles-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/agile-principles-assessment/agile-principles-assessments"
                    class={navClass("/agile-principles-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
