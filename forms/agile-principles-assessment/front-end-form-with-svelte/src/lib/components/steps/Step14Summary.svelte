...
<section>
  ...
  <details class="mb-4 bg-white border border-slate-200 rounded p-4">
    <summary class="cursor-pointer text-sm font-medium">
      Customise weights
      {#if r.weightsCustomised}
        <span class="text-xs text-brand-700">(active)</span>
      {/if}
    </summary>
