...
- `bin/lily-html-refactor --check genetics-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `genetics-assessment.front-end-form-with-html.v1` (HTML)
  - `genetics-assessment.front-end-form-with-svelte.v1` (SvelteKit)
