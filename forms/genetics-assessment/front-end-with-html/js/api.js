// Backend API client for the Genetics Assessment clinician dashboard.
//
...
(function () {
'use strict';
window.GeneticsAssessmentDashboard = window.GeneticsAssessmentDashboard || {};
...
window.GeneticsAssessmentDashboard.fetchPatients = fetchPatients;
window.GeneticsAssessmentDashboard.API_BASE = API_BASE;
})();
