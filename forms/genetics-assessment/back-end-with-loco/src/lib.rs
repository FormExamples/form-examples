//! Genetics Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Genetics Assessment** medical form, built on the
...
//!
//! ```
//! use genetics_assessment_loco_crate::engine::types::AssessmentData;
//!
