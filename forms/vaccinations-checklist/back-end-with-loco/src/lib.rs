//! Vaccinations Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Vaccinations Checklist** medical form, built on the
...
//!
//! ```
//! use vaccinations_checklist_loco_crate::engine::types::AssessmentData;
//!
