...
<svelte:head>
	<title>Vaccinations Checklist</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/vaccinations-checklist/" class="text-lg font-bold text-base-content">Vaccinations Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/vaccinations-checklist/" class={navClass('/')}>Welcome</a>
				<a href="/vaccinations-checklist/vaccinations-checklists/new" class={navClass('/vaccinations-checklists/new')}>New checklist</a>
				<a href="/vaccinations-checklist/vaccinations-checklists" class={navClass('/vaccinations-checklists')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
