...
- LocalStorage key `vaccinations-checklist.front-end-form-with-html.v1` (HTML) and
  `vaccinations-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
