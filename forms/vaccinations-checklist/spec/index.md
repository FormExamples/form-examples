# Vaccinations Checklist — specification
...
- `bin/test-form vaccinations-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check vaccinations-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `vaccinations-checklist.front-end-form-with-html.v1` (HTML)
  - `vaccinations-checklist.front-end-form-with-svelte.v1` (SvelteKit)
