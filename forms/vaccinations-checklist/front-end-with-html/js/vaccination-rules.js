// Vaccination compliance rules.
//
// Each rule evaluates patient assessment data and returns true when the
// condition is present. Grade values: 1 = low concern, 2 = moderate,
// 3 = significant, 4 = critical. Ported 1:1 from the SvelteKit reference
// engine `vaccination-rules.ts`.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} VaccinationRule
 * @property {string} id
...
const vaccinationRules = [
  // ─── CHILDHOOD IMMUNISATIONS ──────────────────────────────
  {
    ...
    evaluate: (d) =>
      ...
      d.childhoodImmunisations.mmrDose1 === 'unknown'
  },
  {
    id: 'CH-002',
    category: 'Childhood',
    ...
    grade: 2,
    evaluate: (d) =>
      d.childhoodImmunisations.mmrDose2 === 'no' ||
      d.childhoodImmunisations.mmrDose2 === 'unknown'
  },
  {
    id: 'CH-003',
    category: 'Childhood',
    ...
    grade: 3,
    evaluate: (d) =>
      d.childhoodImmunisations.dtpPrimaryCourse === 'no' ||
      d.childhoodImmunisations.dtpPrimaryCourse === 'unknown'
  },
  {
    id: 'CH-004',
    category: 'Childhood',
    ...
    grade: 2,
    evaluate: (d) =>
      d.childhoodImmunisations.dtpBooster === 'no' ||
      d.childhoodImmunisations.dtpBooster === 'unknown'
  },
  {
    id: 'CH-005',
    category: 'Childhood',
    ...
    grade: 3,
    evaluate: (d) =>
      d.childhoodImmunisations.polioPrimaryCourse === 'no' ||
      d.childhoodImmunisations.polioPrimaryCourse === 'unknown'
  },
  {
    id: 'CH-006',
    category: 'Childhood',
    ...
    grade: 2,
    evaluate: (d) =>
      d.childhoodImmunisations.polioBooster === 'no' ||
      d.childhoodImmunisations.polioBooster === 'unknown'
  },
  ...
  // ─── OCCUPATIONAL VACCINES ────────────────────────────────
  {
    ...
    evaluate: (d) =>
      ...
      (d.occupationalVaccines.hepatitisBCourse === 'no' ||
        d.occupationalVaccines.hepatitisBCourse === 'unknown')
  },
  {
    id: 'OCC-002',
    category: 'Occupational',
  ...
  },
  {
    ...
    evaluate: (d) =>
      (d.demographics.occupationCategory === 'healthcare' ||
        d.demographics.occupationCategory === 'social-care') &&
      (d.occupationalVaccines.bcgVaccine === 'no' ||
        d.occupationalVaccines.bcgVaccine === 'unknown')
  },
  ...
  // ─── COVID-19 ─────────────────────────────────────────────
  {
    ...
    evaluate: (d) =>
      ...
      d.covid19Vaccination.covidPrimaryCourse === 'unknown'
  },
  {
    id: 'COV-002',
    category: 'COVID-19',
