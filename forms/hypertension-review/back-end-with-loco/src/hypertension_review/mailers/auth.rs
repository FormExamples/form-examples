...
static welcome: Dir<'_> = include_dir!("src/hypertension_review/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/hypertension_review/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/hypertension_review/mailers/auth/magic_link");
