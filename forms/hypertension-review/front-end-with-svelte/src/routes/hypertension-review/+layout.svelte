...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/hypertension-review/"
                class="text-lg font-bold text-base-content"
                >Hypertension review</a
            >
            <div class="flex items-center gap-1">
                <a href="/hypertension-review/" class={navClass("/")}>Welcome</a
                >
                <a
                    href="/hypertension-review/hypertension-reviews/new"
                    class={navClass("/hypertension-reviews/new")}>New review</a
                >
                <a
                    href="/hypertension-review/hypertension-reviews"
                    class={navClass("/hypertension-reviews")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
