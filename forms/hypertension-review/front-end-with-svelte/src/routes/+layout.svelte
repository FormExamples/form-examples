...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/" class="text-lg font-bold text-base-content">Hypertension review</a>
			<div class="flex items-center gap-1">
				<a href="/" class={navClass('/')}>Welcome</a>
				<a href="/hypertension-reviews/new" class={navClass('/hypertension-reviews/new')}
					>New review</a
				>
				<a href="/hypertension-reviews" class={navClass('/hypertension-reviews')}>Dashboard</a>
