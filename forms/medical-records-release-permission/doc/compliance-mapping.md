...
authorization requirements at 45 CFR § 164.508.
...
| 5 | Authorization Period | Art. 7(3), Art. 13(2)(a) | § 164.508(c)(1)(v) expiration | Sets time-bounded authorization |
| 6 | Restrictions & Limitations | Art. 7(2) granular | n/a explicit, but supports compound authorization rules | Captures partial exclusions |
...
| --- | --- | --- |
| 7(1) | Demonstrate that the data subject has consented | Signed authorization record retained with controller |
...
- (ii) Identity of the person authorized to make the disclosure (the
...
- Statement that treatment, payment, enrolment, or eligibility cannot be
  conditioned on the authorization — Step 7.
...
<https://ico.org.uk/for-organizations/uk-gdpr-guidance-and-resources/lawful-basis/a-guide-to-lawful-basis/consent/right-to-withdraw-consent/>
...
consent). In US flows, the form captures separate authorizations where
required for:
