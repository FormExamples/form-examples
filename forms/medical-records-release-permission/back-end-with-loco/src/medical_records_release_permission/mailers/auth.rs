...
static welcome: Dir<'_> = include_dir!("src/medical_records_release_permission/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medical_records_release_permission/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medical_records_release_permission/mailers/auth/magic_link");
