//! Medical Records Release Permission — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Medical Records Release Permission** medical form, built on the
...
//!
//! ```
//! use medical_records_release_loco_crate::engine::types::AssessmentData;
//!
