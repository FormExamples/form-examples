...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/medical-records-release-permission/" class="text-lg font-bold text-base-content">Medical Records Release Permission</a>
			<div class="flex items-center gap-1">
				<a href="/medical-records-release-permission/" class={navClass('/')}>Welcome</a>
				<a
					href="/medical-records-release-permission/medical-records-release-permissions/new"
					class={navClass('/medical-records-release-permissions/new')}>New form</a
				>
				<a
					href="/medical-records-release-permission/medical-records-release-permissions"
					class={navClass('/medical-records-release-permissions')}>Dashboard</a
				>
