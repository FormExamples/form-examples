# Medical Records Release Permission — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (16 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form medical-records-release-permission` exits cleanly.
...
- `bin/lily-html-refactor --check medical-records-release-permission` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `medical-records-release-permission.front-end-form-with-html.v1` (HTML)
  - `medical-records-release-permission.front-end-form-with-svelte.v1` (SvelteKit)
