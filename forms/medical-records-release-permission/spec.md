...
- LocalStorage key `medical-records-release-permission.front-end-form-with-html.v1` (HTML) and
  `medical-records-release-permission.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
