//! Stroke Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Stroke Assessment** medical form, built on the
...
//!
//! ```
//! use stroke_assessment_loco_crate::engine::types::AssessmentData;
//!
