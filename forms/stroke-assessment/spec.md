# Stroke Assessment — specification
...
- `bin/test-form stroke-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check stroke-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `stroke-assessment.front-end-form-with-html.v1` (HTML)
  - `stroke-assessment.front-end-form-with-svelte.v1` (SvelteKit)
