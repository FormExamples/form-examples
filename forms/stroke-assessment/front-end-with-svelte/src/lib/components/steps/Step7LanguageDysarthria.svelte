<script lang="ts">
	...
	const ld = assessment.data.languageDysarthria;
</script>

<Fieldset title="Language & Dysarthria" description="NIHSS Items 9 and 10">
	<RadioGroup
		...
		bind:value={ld.bestLanguage as any}
		required
	/>
	...
	<RadioGroup
		...
		bind:value={ld.dysarthria as any}
		required
	/>
</Fieldset>
