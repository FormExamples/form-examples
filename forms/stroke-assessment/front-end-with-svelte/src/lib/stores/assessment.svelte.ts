...
function storageKey(id: string): string {
	return `stroke-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank stroke assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the stroke assessment, with localStorage
