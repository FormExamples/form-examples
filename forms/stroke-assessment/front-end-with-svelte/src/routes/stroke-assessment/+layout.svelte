...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/stroke-assessment/"
                class="text-lg font-bold text-base-content">Stroke Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/stroke-assessment/" class={navClass("/")}>Welcome</a>
                <a
                    href="/stroke-assessment/stroke-assessments/new"
                    class={navClass("/stroke-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/stroke-assessment/stroke-assessments"
                    class={navClass("/stroke-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
