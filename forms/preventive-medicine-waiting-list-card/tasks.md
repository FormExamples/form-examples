# Tasks: Preventive Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/preventive-medicine-waiting-list-card/`.
...
- [x] `cargo loco new preventive-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form preventive-medicine-waiting-list-card` exits cleanly.
