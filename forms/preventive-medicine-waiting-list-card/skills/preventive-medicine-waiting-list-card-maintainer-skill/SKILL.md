---
name: preventive-medicine-waiting-list-card-maintainer-skill
description: "Implementation workflow for maintaining and extending the Preventive Medicine Waiting List Card form (forms/preventive-medicine-waiting-list-card/) — editing its spec, schema, or engine, regenerating derived artefacts, and running its verify gates. Use when implementing a change to this form's spec, SQL schema, front-end, back-end, or personas. For the repo-wide workflow, use form-examples-maintainer-skill instead."
---

# Preventive Medicine Waiting List Card — Maintainer Skill

Implementation-facing companion to `preventive-medicine-waiting-list-card-skill` (this form's end-user concepts skill) and to `form-examples-maintainer-skill` (the repo-wide maintainer skill — read that one first for the golden rule, generators, and the full verify-gate catalogue). This skill is the one-form-scoped map.

## Directory layout

`forms/preventive-medicine-waiting-list-card/` contains:
...
```sh
bin/test-form preventive-medicine-waiting-list-card
bin/test-sql-apply preventive-medicine-waiting-list-card
bin/test-personas preventive-medicine-waiting-list-card
bin/test-e2e --html preventive-medicine-waiting-list-card
```
