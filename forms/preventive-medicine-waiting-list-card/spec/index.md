# Preventive Medicine Waiting List Card — specification
...
preventive medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form preventive-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check preventive-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `preventive-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `preventive-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
