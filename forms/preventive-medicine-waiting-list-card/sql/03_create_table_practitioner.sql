-- Practitioner who places the patient on a preventive medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a preventive medicine waiting list card on behalf of the patient.';
