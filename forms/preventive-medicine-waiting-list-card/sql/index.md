# preventive-medicine-waiting-list-card — sql
...
- `prev_med_waiting_list_card` — top-level waiting list card.
- `prev_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `prev_med_waiting_list_card_grade` — computed grading result.
- `prev_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `prev_med_waiting_list_card_grade_flag` — safety / operational flags fired
