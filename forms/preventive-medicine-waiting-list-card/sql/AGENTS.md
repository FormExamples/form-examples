# Preventive Medicine Waiting List Card — PostgreSQL migrations
...
Child `prev_med_waiting_list_card_*` tables reference
`prev_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
