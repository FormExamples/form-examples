// Cystoscopy Test Request — vetting dashboard (vanilla classic-script app).
//
...
// attach their exports to `window.CystoscopyTestRequestDashboard`.
...
function renderTriageCell(row) {
  ...
  const tww = row.twoWeekWaitEligible
    ? ` <span class="twoww-badge">2WW</span>`
    : '';
  return tier + tww;
}
