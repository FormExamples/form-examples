# Cystoscopy Test Request — agent instructions

Cystoscopy (bladder endoscopy) request (referral). A clinician completes a
...
identical across every front-end and the back-end. Red flags (visible
haematuria meeting the NICE NG12 2WW threshold, suspected bladder tumour, active
UTI, high bleeding risk on anticoagulation) auto-escalate the triage tier or
defer the procedure. Choose the least-alarming band only when no rule fires.
