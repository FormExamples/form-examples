// Backend API client for the cystoscopy vetting dashboard.
//
...
window.CystoscopyTestRequestDashboard.fetchRequests = fetchRequests;
window.CystoscopyTestRequestDashboard.API_BASE = API_BASE;
})();
