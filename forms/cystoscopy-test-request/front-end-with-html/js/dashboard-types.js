// Plain-JavaScript / JSDoc type definitions for the cystoscopy vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (NICE NG12 / BAUS 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Cancer-pathway triage tier emitted by Axis B.
 ...
 * @property {boolean} twoWeekWaitEligible - Axis B NICE NG12 2WW eligibility
...
// before they read `window.CystoscopyTestRequestDashboard`.
