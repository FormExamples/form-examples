# Cystoscopy Test Request — specification
...
- `bin/test-form cystoscopy-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check cystoscopy-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cystoscopy-test-request.front-end-form-with-html.v1` (HTML)
  - `cystoscopy-test-request.front-end-form-with-svelte.v1` (SvelteKit)
