// ──────────────────────────────────────────────
// Core screening data types (Diabetes Eye Screening record)
//
// Diabetes eye screening is a *classification* pathway, not a numeric-score
...
// `sql/04_create_table_diabetes_eye_screening.sql`.
// ──────────────────────────────────────────────
...
/** The full diabetes-eye-screening data model. */
...
/** A diabetes-eye-screening classification rule (gated, first-match). */
