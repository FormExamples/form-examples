<script lang="ts">
	...
	function submit() {
		...
		goto(`/diabetes-eye-screening/diabetes-eye-screenings/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New diabetes eye screening' : `Diabetes eye screening ${id}`}
	</h1>
	...
	<Form label="Diabetes eye screening" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3RightEye />
		<Step4LeftEye />
