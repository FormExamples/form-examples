<script lang="ts">
	...
	import { outcomeLabel, referralLabel, retinopathyLabel, maculopathyLabel } from '#lib/engine/utils.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/diabetes-eye-screening/diabetes-eye-screenings/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-base-content">Diabetes eye screening dashboard</h1>
		...
		<a href="/diabetes-eye-screening/diabetes-eye-screenings/new" class="button" data-variant="primary">New screening</a>
	</div>
