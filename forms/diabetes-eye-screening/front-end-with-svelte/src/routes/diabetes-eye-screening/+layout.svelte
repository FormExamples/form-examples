...
<svelte:head>
	<title>Diabetes Eye Screening record</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/diabetes-eye-screening/" class="text-lg font-bold text-base-content">Diabetes Eye Screening</a>
			<div class="flex items-center gap-1">
				<a
					href="/diabetes-eye-screening/"
					class={navClass('/')}
				>Welcome</a>

				<a
					href="/diabetes-eye-screening/diabetes-eye-screenings/new"
					class={navClass('/diabetes-eye-screenings/new')}>New screening</a
				>
				<a href="/diabetes-eye-screening/diabetes-eye-screenings" class={navClass('/diabetes-eye-screenings')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
