# Diabetes Eye Screening record — plan
...
5. **Front-ends** — consolidated `front-end-with-html` (Lily wizard + dashboard)
   and `front-end-with-svelte` (Lily; RESTful `/diabetes-eye-screenings/` list +
   `/diabetes-eye-screenings/[id]` form).
6. **Back-end** — `back-end-with-loco` Rust axum + Loco JSON API, relational
   per-table schema.
7. **Verify** — `bin/test-form diabetes-eye-screening`, Lily drift checks, spec
