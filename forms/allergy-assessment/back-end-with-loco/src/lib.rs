//! Allergy Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Allergy Assessment** medical form, built on the
...
//!
//! ```
//! use allergy_assessment_loco_crate::engine::types::AssessmentData;
//!
