<script lang="ts">
	const plural = 'allergy-assessments';
</script>
...
<main class="mx-16 px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/allergy-assessment/{plural}/new"
		...
		<a
			href="/allergy-assessment/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed allergy severity, burden score, allergen count,
				and anaphylaxis flag.
			</p>
		...
		<dl class="mt-4 space-y-4 text-sm">
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Capture a structured allergy profile and produce a graded report — severity level, burden
					score, and flagged issues — to support allergist review.
				</dd>
			</div>
			<div>
				<dt class="font-semibold text-base-content">Specification</dt>
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the severity grading engine, and
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Covers drug, food, and environmental allergies with anaphylaxis risk assessment and a
