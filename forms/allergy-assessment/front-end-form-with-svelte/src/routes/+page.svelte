	...
	<div class="w-full max-w-lg text-center">
		<div class="mb-8">
			...
			<p class="mt-3 text-gray-600">
				Complete this questionnaire to generate an allergy severity classification. Your responses
				will be used to calculate an allergy severity level, allergy burden score, and identify any
