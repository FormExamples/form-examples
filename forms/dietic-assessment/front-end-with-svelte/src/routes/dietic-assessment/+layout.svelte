...
<svelte:head>
    <title>Dietetic Assessment</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/dietic-assessment/"
                class="text-lg font-bold text-base-content"
                >Dietetic Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/dietic-assessment/" class={navClass("/")}>Welcome</a>
                <a
                    href="/dietic-assessment/dietic-assessments/new"
                    class={navClass("/dietic-assessments/new")}>New assessment</a
                >
                <a
                    href="/dietic-assessment/dietic-assessments"
                    class={navClass("/dietic-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
