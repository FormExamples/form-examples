// Back-end API client for the Dietetic Assessment dashboard.
//
// The back-end lives at http://localhost:5150 (Loco / axum); the dashboard
// endpoint returns either a bare JSON array of `AssessmentRow` objects or an
...
const ASSESSMENTS_PATH = '/api/dietic_assessments';
