import type { BloodCrossMatchResult, GradingResult, Recommendation, FiredRule } from './types';
 ...
 */
export function calculateGrade(result: BloodCrossMatchResult): GradingResult {
