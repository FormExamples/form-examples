...
Server-side Rust JSON API for the Blood Cross-Match Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`blood_cross_match_test_result/`](blood_cross_match_test_result/) — one migration, SeaORM
