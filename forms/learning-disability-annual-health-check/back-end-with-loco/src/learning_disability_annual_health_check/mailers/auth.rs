...
static welcome: Dir<'_> = include_dir!("src/learning_disability_annual_health_check/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/learning_disability_annual_health_check/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/learning_disability_annual_health_check/mailers/auth/magic_link");
