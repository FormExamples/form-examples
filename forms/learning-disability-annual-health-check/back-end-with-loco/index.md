...
Server-side Rust JSON API for the Learning Disability Annual Health Check form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`learning_disability_annual_health_check/`](learning_disability_annual_health_check/) — one migration, SeaORM
