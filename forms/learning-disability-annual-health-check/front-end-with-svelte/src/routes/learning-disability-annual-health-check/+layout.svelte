...
<svelte:head>
	<title>Learning Disability Annual Health Check</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/learning-disability-annual-health-check/" class="text-lg font-bold text-base-content">LD Annual Health Check</a>
			<div class="flex items-center gap-1">
				<a href="/learning-disability-annual-health-check/" class={navClass('/')}>Welcome</a>
				<a
					href="/learning-disability-annual-health-check/learning-disability-annual-health-checks/new"
					class={navClass('/learning-disability-annual-health-checks/new')}>New check</a
				>
				<a
					href="/learning-disability-annual-health-check/learning-disability-annual-health-checks"
					class={navClass('/learning-disability-annual-health-checks')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
