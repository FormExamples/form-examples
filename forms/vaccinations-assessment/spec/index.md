# Vaccinations Assessment — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql/` (20 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form vaccinations-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check vaccinations-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `vaccinations-assessment.front-end-with-html.v1` (HTML)
  - `vaccinations-assessment.front-end-with-svelte.v1` (SvelteKit)
