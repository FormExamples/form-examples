//! Vaccinations Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Vaccinations Assessment** medical form, built on the
...
//!
//! ```
//! use vaccinations_assessment_loco_crate::engine::types::AssessmentData;
//!
