...
- LocalStorage key `vaccinations-assessment.front-end-form-with-html.v1` (HTML) and
  `vaccinations-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
