...
<Fieldset title="Clinical Review" description="Record post-vaccination observations and clinical follow-up plan.">
	...
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
		...
		<TextAreaInput label="If yes, describe reaction" name="reactionDetails" bind:value={cr.reactionDetails} placeholder="Describe any immediate reaction..." />
	</div>
	...
	<TextAreaInput label="Clinician Notes" name="clinicianNotes" bind:value={cr.clinicianNotes} rows={4} placeholder="Additional clinical notes..." />
