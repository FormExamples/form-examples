...
use crate::{
    models::_entities::patients::{ActiveModel, Column, Entity, Model},
    views,
};
...
pub async fn update(
    ...
    format::render().redirect_with_header_key("HX-Redirect", "/patients")
}
