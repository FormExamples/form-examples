...
use crate::{
    models::_entities::clinicians::{ActiveModel, Column, Entity, Model},
    views,
};
...
pub async fn update(
    ...
    format::render().redirect_with_header_key("HX-Redirect", "/clinicians")
}
