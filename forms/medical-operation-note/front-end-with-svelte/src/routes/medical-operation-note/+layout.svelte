...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/medical-operation-note/"
                class="text-lg font-bold text-base-content"
                >Medical Operation Note</a
            >
            <div class="flex items-center gap-1">
                <a href="/medical-operation-note/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/medical-operation-note/medical-operation-notes/new"
                    class={navClass("/medical-operation-notes/new")}>New note</a
                >
                <a
                    href="/medical-operation-note/medical-operation-notes"
                    class={navClass("/medical-operation-notes")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
