...
static welcome: Dir<'_> = include_dir!("src/medical_operation_note/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medical_operation_note/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medical_operation_note/mailers/auth/magic_link");
