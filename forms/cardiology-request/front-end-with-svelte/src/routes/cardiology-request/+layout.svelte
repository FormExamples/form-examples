...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/cardiology-request/"
                class="text-lg font-bold text-base-content"
                >Cardiology Request</a
            >
            <div class="flex items-center gap-1">
                <a href="/cardiology-request/" class={navClass("/")}>Welcome</a>
                <a
                    href="/cardiology-request/cardiology-requests/new"
                    class={navClass("/cardiology-requests/new")}>New referral</a
                >
                <a
                    href="/cardiology-request/cardiology-requests"
                    class={navClass("/cardiology-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
