...
Numbered PostgreSQL migrations defining the fluoroscopy / contrast-study result
(report) schema: patient, reporting clinician, the main
`fluoroscopy_test_result` report, and the four-axis interpretation grade with
