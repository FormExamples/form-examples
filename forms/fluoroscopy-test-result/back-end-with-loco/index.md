...
Server-side Rust JSON API for the Fluoroscopy Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`fluoroscopy_test_result/`](fluoroscopy_test_result/) — one migration, SeaORM
