# Fluoroscopy Test Result — agent instructions

Fluoroscopy / contrast-study result (report). A reporting clinician completes a
...
This is the **result/report counterpart** to `fluoroscopy-test-request` (a
...
referral. The source-of-truth record is `fluoroscopy_test_result`; the clinician
...
A **critical finding** (perforation or contrast leak, high-grade obstruction)
