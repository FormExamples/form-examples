import type { FluoroscopyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a fluoroscopy result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (perforation / leak or high-grade obstruction)
 ...
 */
export function calculateGrade(result: FluoroscopyResult): GradingResult {
