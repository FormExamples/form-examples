// ──────────────────────────────────────────────
// Fluoroscopy Test Result — core data types
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_fluoroscopy_test_result.sql and
...
export type ContrastUsed = 'barium' | 'water-soluble-iodinated' | 'none' | '';
...
export interface StructuredFindings {
	...
	reflux: boolean;
	obstruction: boolean;
	perforationOrLeak: boolean;
	fistula: boolean;
	fillingDefect: boolean;
	dysmotility: boolean;
	normalStudy: boolean;
 ...
 */
export interface FluoroscopyResult {
	...
	screeningTimeMinutes: number | null;
