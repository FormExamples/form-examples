 ...
 */
export function hasCriticalFinding(r: FluoroscopyResult): boolean {
	return r.perforationOrLeak || r.obstruction;
}

/** Whether any structured abnormal finding is present. */
export function hasAnyAbnormalFinding(r: FluoroscopyResult): boolean {
	return (
		r.stricture ||
		r.reflux ||
		r.obstruction ||
...
export function hasOnlyIncidentalFinding(r: FluoroscopyResult): boolean {
...
export function studyTypeLabel(value: StudyType | string): string {
	switch (value) {
		case 'barium-swallow':
			return 'Barium swallow';
		case 'barium-meal':
			return 'Barium meal';
		case 'barium-follow-through':
			return 'Barium follow-through';
		case 'barium-enema':
			return 'Barium enema';
		case 'water-soluble-contrast-swallow':
			return 'Water-soluble contrast swallow';
		case 'defecating-proctogram':
			return 'Defecating proctogram';
		case 'hysterosalpingogram':
			return 'Hysterosalpingogram';
		case 'micturating-cystourethrogram':
			return 'Micturating cystourethrogram';
		case 'arthrogram':
			return 'Arthrogram';
		case 'fluoroscopy-guided-procedure':
			return 'Fluoroscopy-guided procedure';
		case 'other':
			return 'Other';
		default:
			return 'Unspecified';
