 ...
 * `forms/fluoroscopy-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.FluoroscopyTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.FluoroscopyTestResultDashboard`.
})();
