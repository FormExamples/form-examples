// Backend API client for the PET-CT vetting dashboard.
//
...
window.PetScanTestRequestDashboard.fetchRequests = fetchRequests;
window.PetScanTestRequestDashboard.API_BASE = API_BASE;
})();
