// Plain-JavaScript / JSDoc type definitions for the PET-CT vetting dashboard.
//
...
/**
 * Preparation-safety band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'contraindicated'} PrepSafetyBand
 */

/**
 * Radiation-dose band emitted by Axis B.
 * @typedef {'low' | 'moderate' | 'high'} RadiationDoseBand
 */

/**
 * Triage tier emitted by Axis D.
 ...
 * @property {string} scanType        - Requested scan type / tracer (kebab-case)
 ...
 * @property {RadiationDoseBand} radiationDoseBand - Axis B radiation-dose band
...
// before they read `window.PetScanTestRequestDashboard`.
