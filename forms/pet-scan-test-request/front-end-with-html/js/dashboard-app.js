...
// PET Scan Test Request — vetting dashboard (vanilla classic-script app).
//
...
// preparation-safety dropdown + safety-flags dropdown).
//
// Sibling modules loaded as plain `<script>` tags (in dependency order)
// attach their exports to `window.PetScanTestRequestDashboard`. The whole file
