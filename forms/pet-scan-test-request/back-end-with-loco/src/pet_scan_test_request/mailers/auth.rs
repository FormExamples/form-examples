...
static welcome: Dir<'_> = include_dir!("src/pet_scan_test_request/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/pet_scan_test_request/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/pet_scan_test_request/mailers/auth/magic_link");
