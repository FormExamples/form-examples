-- Practitioner who places the patient on a radiation oncology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a radiation oncology waiting list card on behalf of the patient.';
