# Radiation Oncology Waiting List Card — PostgreSQL migrations
...
Child `rad_onc_waiting_list_card_*` tables reference
`rad_onc_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
