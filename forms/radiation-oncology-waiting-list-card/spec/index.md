# Radiation Oncology Waiting List Card — specification
...
radiation oncology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form radiation-oncology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check radiation-oncology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `radiation-oncology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `radiation-oncology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
