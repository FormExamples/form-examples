# Plan: Radiation Oncology Waiting List Card
...
months later. The Radiation Oncology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form radiation-oncology-waiting-list-card`.
