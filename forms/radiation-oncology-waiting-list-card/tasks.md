# Tasks: Radiation Oncology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/radiation-oncology-waiting-list-card/`.
...
- [x] `cargo loco new radiation-oncology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form radiation-oncology-waiting-list-card` exits cleanly.
