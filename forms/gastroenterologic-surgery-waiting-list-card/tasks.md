# Tasks: Gastroenterologic Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/gastroenterologic-surgery-waiting-list-card/`.
...
- [x] `cargo loco new gastroenterologic-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form gastroenterologic-surgery-waiting-list-card` exits cleanly.
