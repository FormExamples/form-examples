# Plan: Gastroenterologic Surgery Waiting List Card
...
months later. The Gastroenterologic Surgery Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form gastroenterologic-surgery-waiting-list-card`.
