# Gastroenterologic Surgery Waiting List Card — PostgreSQL migrations
...
Child `gi_surgery_waiting_list_card_*` tables reference
`gi_surgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
