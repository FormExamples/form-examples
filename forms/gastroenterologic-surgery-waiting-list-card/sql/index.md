# gastroenterologic-surgery-waiting-list-card — sql
...
- `gi_surgery_waiting_list_card` — top-level waiting list card.
- `gi_surgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `gi_surgery_waiting_list_card_grade` — computed grading result.
- `gi_surgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `gi_surgery_waiting_list_card_grade_flag` — safety / operational flags fired
