-- Practitioner who places the patient on a gastroenterologic surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a gastroenterologic surgery waiting list card on behalf of the patient.';
