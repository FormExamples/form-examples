...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/gastroenterologic-surgery-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >Gastroenterologic Surgery Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/gastroenterologic-surgery-waiting-list-cards/new",
                    )}>New card</a
                >
                <a
                    href="/gastroenterologic-surgery-waiting-list-card/gastroenterologic-surgery-waiting-list-cards"
                    class={navClass(
                        "/gastroenterologic-surgery-waiting-list-cards",
                    )}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
