# Gastroenterologic Surgery Waiting List Card — Agent Instructions

A practitioner-completed administrative card that places a patient on a
gastroenterologic surgery waiting list and gives the patient a transparent view of their
