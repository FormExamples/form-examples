# Gastroenterologic Surgery Waiting List Card — specification
...
gastroenterologic surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form gastroenterologic-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check gastroenterologic-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `gastroenterologic-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `gastroenterologic-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
