# Obstetrics and Gynaecology Waiting List Card — back-end-with-loco spec

JSON API contract for the Obstetrics and Gynaecology Waiting List Card back-end. This file is the living
