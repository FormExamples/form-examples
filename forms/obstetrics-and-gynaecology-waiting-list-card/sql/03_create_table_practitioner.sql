-- Practitioner who places the patient on a obstetrics and gynaecology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a obstetrics and gynaecology waiting list card on behalf of the patient.';
