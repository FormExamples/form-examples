# Obstetrics and Gynaecology Waiting List Card — PostgreSQL migrations
...
Child `obgyn_waiting_list_card_*` tables reference
`obgyn_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
