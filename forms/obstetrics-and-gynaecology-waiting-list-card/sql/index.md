# obstetrics-and-gynaecology-waiting-list-card — sql
...
- `obgyn_waiting_list_card` — top-level waiting list card.
- `obgyn_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `obgyn_waiting_list_card_grade` — computed grading result.
- `obgyn_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `obgyn_waiting_list_card_grade_flag` — safety / operational flags fired
