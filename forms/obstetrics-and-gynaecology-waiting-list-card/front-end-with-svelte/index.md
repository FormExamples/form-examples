# Obstetrics and Gynaecology Waiting List Card — SvelteKit practitioner form

Single-page wizard for practitioners (GPs, consultants, referral
co-ordinators) to place a patient on a obstetrics and gynaecology waiting list. SvelteKit 2.x
