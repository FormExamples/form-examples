# Tasks: Obstetrics and Gynaecology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/obstetrics-and-gynaecology-waiting-list-card/`.
...
- [x] `cargo loco new obstetrics-and-gynaecology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form obstetrics-and-gynaecology-waiting-list-card` exits cleanly.
