# Obstetrics and Gynaecology Waiting List Card — specification
...
obstetrics and gynaecology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form obstetrics-and-gynaecology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check obstetrics-and-gynaecology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `obstetrics-and-gynaecology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `obstetrics-and-gynaecology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
