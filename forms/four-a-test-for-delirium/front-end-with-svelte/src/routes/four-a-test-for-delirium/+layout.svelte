...
<svelte:head>
	<title>4AT — Rapid Delirium and Cognitive-Impairment Screen</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/four-a-test-for-delirium/" class="text-lg font-bold text-base-content">4AT</a>
			<div class="flex items-center gap-1">
				<a href="/four-a-test-for-delirium/" class={navClass('/')}>Welcome</a>
				<a
					href="/four-a-test-for-delirium/four-a-test-for-deliriums/new"
					class={navClass('/four-a-test-for-deliriums/new')}>New assessment</a
				>
				<a
					href="/four-a-test-for-delirium/four-a-test-for-deliriums"
					class={navClass('/four-a-test-for-deliriums')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
