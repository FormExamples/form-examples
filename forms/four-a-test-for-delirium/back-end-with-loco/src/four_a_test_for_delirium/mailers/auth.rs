...
static welcome: Dir<'_> = include_dir!("src/four_a_test_for_delirium/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/four_a_test_for_delirium/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/four_a_test_for_delirium/mailers/auth/magic_link");
