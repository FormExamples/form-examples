...
Server-side Rust JSON API for the 4AT — Rapid Delirium and Cognitive-Impairment Screen form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`four_a_test_for_delirium/`](four_a_test_for_delirium/) — one migration, SeaORM
