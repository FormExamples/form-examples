# Plan: Pharmacology Waiting List Card
...
months later. The Pharmacology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form pharmacology-waiting-list-card`.
