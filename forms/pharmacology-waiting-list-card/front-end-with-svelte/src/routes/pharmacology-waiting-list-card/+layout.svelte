...
<svelte:head>
	<title>Pharmacology Waiting List Card</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/pharmacology-waiting-list-card/" class="text-lg font-bold text-base-content">Pharmacology Waiting List Card</a>
			<div class="flex items-center gap-1">
				<a href="/pharmacology-waiting-list-card/" class={navClass('/')}>Welcome</a>
				<a
					href="/pharmacology-waiting-list-card/pharmacology-waiting-list-cards/new"
					class={navClass('/pharmacology-waiting-list-cards/new')}>New card</a
				>
				<a href="/pharmacology-waiting-list-card/pharmacology-waiting-list-cards" class={navClass('/pharmacology-waiting-list-cards')}
					>Dashboard</a
				>
