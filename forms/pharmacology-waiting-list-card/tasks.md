# Tasks: Pharmacology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/pharmacology-waiting-list-card/`.
...
- [x] `cargo loco new pharmacology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form pharmacology-waiting-list-card` exits cleanly.
