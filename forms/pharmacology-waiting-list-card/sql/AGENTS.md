# Pharmacology Waiting List Card — PostgreSQL migrations
...
Child `pharmacology_waiting_list_card_*` tables reference
`pharmacology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
