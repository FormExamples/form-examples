# pharmacology-waiting-list-card — sql
...
- `pharmacology_waiting_list_card` — top-level waiting list card.
- `pharmacology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `pharmacology_waiting_list_card_grade` — computed grading result.
- `pharmacology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `pharmacology_waiting_list_card_grade_flag` — safety / operational flags fired
