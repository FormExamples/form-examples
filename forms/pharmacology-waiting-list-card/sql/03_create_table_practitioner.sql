-- Practitioner who places the patient on a pharmacology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a pharmacology waiting list card on behalf of the patient.';
