# Family and General Medicine Waiting List Card — specification
...
family and general medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form family-and-general-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check family-and-general-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `family-and-general-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `family-and-general-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
