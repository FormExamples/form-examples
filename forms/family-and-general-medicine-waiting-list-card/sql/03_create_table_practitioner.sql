-- Practitioner who places the patient on a family and general medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a family and general medicine waiting list card on behalf of the patient.';
