# Family and General Medicine Waiting List Card — PostgreSQL migrations
...
Child `family_general_waiting_list_card_*` tables reference
`family_general_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
