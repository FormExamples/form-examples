# family-and-general-medicine-waiting-list-card — sql
...
- `family_general_waiting_list_card` — top-level waiting list card.
- `family_general_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `family_general_waiting_list_card_grade` — computed grading result.
- `family_general_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `family_general_waiting_list_card_grade_flag` — safety / operational flags fired
