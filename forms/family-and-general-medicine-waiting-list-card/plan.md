# Plan: Family and General Medicine Waiting List Card
...
months later. The Family and General Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form family-and-general-medicine-waiting-list-card`.
