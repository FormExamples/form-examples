# Family and General Medicine Waiting List Card — back-end-with-loco spec

JSON API contract for the Family and General Medicine Waiting List Card back-end. This file is the living
