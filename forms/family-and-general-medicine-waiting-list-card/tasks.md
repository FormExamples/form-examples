# Tasks: Family and General Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/family-and-general-medicine-waiting-list-card/`.
...
- [x] `cargo loco new family-and-general-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form family-and-general-medicine-waiting-list-card` exits cleanly.
