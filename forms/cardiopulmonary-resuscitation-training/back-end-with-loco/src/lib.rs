//! Cardiopulmonary Resuscitation Training — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Cardiopulmonary Resuscitation Training** medical form, built on the
...
//!
//! ```
//! use cardiopulmonary_resuscitation_training_loco_crate::engine::types::AssessmentData;
//!
