...
static welcome: Dir<'_> = include_dir!("src/cardiopulmonary_resuscitation_training/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/cardiopulmonary_resuscitation_training/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/cardiopulmonary_resuscitation_training/mailers/auth/magic_link");
