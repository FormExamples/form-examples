...
- LocalStorage key `cardiopulmonary-resuscitation-training.front-end-form-with-html.v1` (HTML) and
  `cardiopulmonary-resuscitation-training.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
