# Cardiopulmonary Resuscitation Training — specification
...
- `bin/test-form cardiopulmonary-resuscitation-training` exits cleanly.
...
- `bin/lily-html-refactor --check cardiopulmonary-resuscitation-training` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cardiopulmonary-resuscitation-training.front-end-form-with-html.v1` (HTML)
  - `cardiopulmonary-resuscitation-training.front-end-form-with-svelte.v1` (SvelteKit)
