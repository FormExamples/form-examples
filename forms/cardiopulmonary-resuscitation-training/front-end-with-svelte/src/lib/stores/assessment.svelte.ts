...
function storageKey(id: string): string {
	return `cardiopulmonary-resuscitation-training.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank BLS skills-verification assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the BLS skills-verification assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.sceneSafety`) stay bound to live state.
	 */
