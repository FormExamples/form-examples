...
function storageKey(id: string): string {
	return `estimated-glomerular-filtration-rate-calculator.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank eGFR assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the eGFR assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.creatinine`) stay bound to live state.
	 */
