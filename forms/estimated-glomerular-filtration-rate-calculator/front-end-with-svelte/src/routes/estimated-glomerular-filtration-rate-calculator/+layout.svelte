...
<svelte:head>
	<title>Estimated Glomerular Filtration Rate (eGFR) Calculator</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/estimated-glomerular-filtration-rate-calculator/" class="text-lg font-bold text-base-content">eGFR calculator</a>
			<div class="flex items-center gap-1">
				<a href="/estimated-glomerular-filtration-rate-calculator/" class={navClass('/')}>Welcome</a>
				<a
					href="/estimated-glomerular-filtration-rate-calculator/estimated-glomerular-filtration-rate-calculators/new"
					class={navClass('/estimated-glomerular-filtration-rate-calculators/new')}
					>New calculation</a
				>
				<a
					href="/estimated-glomerular-filtration-rate-calculator/estimated-glomerular-filtration-rate-calculators"
					class={navClass('/estimated-glomerular-filtration-rate-calculators')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
