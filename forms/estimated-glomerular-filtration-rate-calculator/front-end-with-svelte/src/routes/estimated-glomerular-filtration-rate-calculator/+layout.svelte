...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/estimated-glomerular-filtration-rate-calculator/"
                class="text-lg font-bold text-base-content">eGFR calculator</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/estimated-glomerular-filtration-rate-calculators/new",
                    )}>New calculation</a
                >
                <a
