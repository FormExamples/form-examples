<script lang="ts">
	...
	import Step3SerumCreatinine from '$lib/components/steps/Step3SerumCreatinine.svelte';
	...
	function submit() {
		...
		assessment.result = calculateEgfr(assessment.data);
		goto(`/estimated-glomerular-filtration-rate-calculator/estimated-glomerular-filtration-rate-calculators/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New eGFR calculation' : `eGFR ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the four sections; the eGFR and CKD G-stage are computed on submit.
	</p>
	...
	<Form label="eGFR calculation" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3SerumCreatinine />
		<Step4Summary />
