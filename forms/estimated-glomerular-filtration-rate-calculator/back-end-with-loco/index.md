...
Server-side Rust JSON API for the Estimated Glomerular Filtration Rate (eGFR) Calculator form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`estimated_glomerular_filtration_rate_calculator/`](estimated_glomerular_filtration_rate_calculator/) — one migration, SeaORM
