...
static welcome: Dir<'_> = include_dir!("src/estimated_glomerular_filtration_rate_calculator/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/estimated_glomerular_filtration_rate_calculator/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/estimated_glomerular_filtration_rate_calculator/mailers/auth/magic_link");
