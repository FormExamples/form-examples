# Tasks: Pathology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/pathology-waiting-list-card/`.
...
- [x] `cargo loco new pathology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form pathology-waiting-list-card` exits cleanly.
