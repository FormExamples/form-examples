# Pathology Waiting List Card — specification
...
pathology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form pathology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check pathology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `pathology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `pathology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
