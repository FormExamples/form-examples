# Pathology Waiting List Card — PostgreSQL migrations
...
Child `pathology_waiting_list_card_*` tables reference
`pathology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
