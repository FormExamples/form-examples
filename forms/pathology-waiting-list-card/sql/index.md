# pathology-waiting-list-card — sql
...
- `pathology_waiting_list_card` — top-level waiting list card.
- `pathology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `pathology_waiting_list_card_grade` — computed grading result.
- `pathology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `pathology_waiting_list_card_grade_flag` — safety / operational flags fired
