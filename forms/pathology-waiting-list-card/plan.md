# Plan: Pathology Waiting List Card
...
months later. The Pathology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form pathology-waiting-list-card`.
