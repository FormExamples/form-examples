...
function storageKey(id: string): string {
	return `model-for-end-stage-liver-disease-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank MELD assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the MELD assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.renal`) stay bound to live state.
	 */
