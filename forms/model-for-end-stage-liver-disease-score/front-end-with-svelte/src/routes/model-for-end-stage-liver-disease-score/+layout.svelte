...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/model-for-end-stage-liver-disease-score/" class="text-lg font-bold text-base-content">MELD score</a>
			<div class="flex items-center gap-1">
				<a href="/model-for-end-stage-liver-disease-score/" class={navClass('/')}>Welcome</a>
				<a
					href="/model-for-end-stage-liver-disease-score/model-for-end-stage-liver-disease-scores/new"
					class={navClass('/model-for-end-stage-liver-disease-scores/new')}>New calculation</a
				>
				<a
					href="/model-for-end-stage-liver-disease-score/model-for-end-stage-liver-disease-scores"
					class={navClass('/model-for-end-stage-liver-disease-scores')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
