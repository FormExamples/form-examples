# Medical Language Speaking Assessment for Cymraeg — specification
...
- `bin/test-form medical-language-speaking-assessment-for-cymraeg` exits cleanly.
...
- `bin/lily-html-refactor --check medical-language-speaking-assessment-for-cymraeg` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `medical-language-speaking-assessment-for-cymraeg.front-end-form-with-html.v1` (HTML)
  - `medical-language-speaking-assessment-for-cymraeg.front-end-form-with-svelte.v1` (SvelteKit)
