...
- LocalStorage key `medical-language-speaking-assessment-for-cymraeg.front-end-form-with-html.v1` (HTML) and
  `medical-language-speaking-assessment-for-cymraeg.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
