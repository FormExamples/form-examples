...
static welcome: Dir<'_> = include_dir!("src/medical_language_speaking_assessment_for_cymraeg/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medical_language_speaking_assessment_for_cymraeg/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medical_language_speaking_assessment_for_cymraeg/mailers/auth/magic_link");
