//! Medical Language Speaking Assessment for Cymraeg — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Medical Language Speaking Assessment for Cymraeg** medical form, built on the
...
//!
//! ```
//! use medical_language_speaking_assessment_for_cymraeg_loco_crate::engine::types::AssessmentData;
//!
