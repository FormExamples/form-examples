...
function storageKey(id: string): string {
	return `medical-language-speaking-assessment-for-cymraeg.front-end-with-svelte.${id || 'new'}.v1`;
}
...
/**
 * Svelte 5 reactive store for the Cymraeg clinical-speaking assessment, with
...
class AssessmentStore {
	 ...
	 * `const d = assessment.data.candidate`) stay bound to live state.
	 */
