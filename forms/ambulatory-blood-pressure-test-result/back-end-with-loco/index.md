...
Server-side Rust JSON API for the Ambulatory Blood Pressure Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`ambulatory_blood_pressure_test_result/`](ambulatory_blood_pressure_test_result/) — one migration, SeaORM
