...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "ambulatory_blood_pressure_test_result_grades",
            &[
            ...
            &[
            ("ambulatory_blood_pressure_test_result", ""),
            ]
        ).await
    }

    async fn down(&self, m: &SchemaManager) -> Result<(), DbErr> {
        drop_table(m, "ambulatory_blood_pressure_test_result_grades").await
    }
}
