...
<Fieldset legend="3. Clinical History">
	<p class="hint">The clinical question and any comparison with previous monitoring.</p>
	...
	<Field label="Comparison with previous monitoring" inputId="comparisonWithPrevious">
		<TextAreaInput
