...
- LocalStorage key `contraception-assessment.front-end-form-with-html.v1` (HTML) and
  `contraception-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
