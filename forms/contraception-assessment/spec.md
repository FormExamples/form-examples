# Contraception Assessment — specification
...
- `bin/test-form contraception-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check contraception-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `contraception-assessment.front-end-form-with-html.v1` (HTML)
  - `contraception-assessment.front-end-form-with-svelte.v1` (SvelteKit)
