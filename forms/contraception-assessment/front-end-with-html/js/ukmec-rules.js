...
//
// Each rule maps a clinical condition to a UKMEC category (1-4) for a
// specific contraceptive method. Matches the SvelteKit reference engine
// in `src/lib/engine/ukmec-rules.ts`.
//
// Categories:
...
const ukmecRules = [
  ...
  // Copper IUD: generally safe (UKMEC 1) for most conditions; not modelled here
];

/** Display labels for each contraceptive method. */
const methodLabels = {
