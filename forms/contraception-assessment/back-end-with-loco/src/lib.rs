//! Contraception Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Contraception Assessment** medical form, built on the
...
//!
//! ```
//! use contraception_assessment_loco_crate::engine::types::AssessmentData;
//!
