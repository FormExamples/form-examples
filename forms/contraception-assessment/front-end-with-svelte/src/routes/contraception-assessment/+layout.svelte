...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/contraception-assessment/"
                class="text-lg font-bold text-base-content"
                >Contraception Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/contraception-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/contraception-assessment/contraception-assessments/new"
                    class={navClass("/contraception-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/contraception-assessment/contraception-assessments"
                    class={navClass("/contraception-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
