...
function storageKey(id: string): string {
	return `contraception-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank contraception assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the contraception assessment, with localStorage
