use pre_anaesthesia_assessment::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_pre_anaesthesia_assessment_grades() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/pre_anaesthesia_assessment_grades").await;
