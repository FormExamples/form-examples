...
<svelte:head>
	<title>Pre-Anaesthesia Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/pre-anaesthesia-assessment/" class="text-lg font-bold text-base-content">Pre-Anaesthesia Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/pre-anaesthesia-assessment/" class={navClass('/')}>Welcome</a>
				<a
					href="/pre-anaesthesia-assessment/pre-anaesthesia-assessments/new"
					class={navClass('/pre-anaesthesia-assessments/new')}>New assessment</a
				>
				<a
					href="/pre-anaesthesia-assessment/pre-anaesthesia-assessments"
					class={navClass('/pre-anaesthesia-assessments')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
