...
export const STEPS: StepDef[] = [
  ...
  },
  {
    number: 3,
    slug: "vitals",
    title: "Vital signs and anthropometrics",
    short: "Vitals",
  },
  ...
  {
    number: 17,
    slug: "proforma-history",
    title: "Pre-anaesthesia proforma: header and history",
    short: "Proforma history",
  },
  {
    number: 18,
    slug: "past-medical-history",
    title: "Past medical history",
    short: "PMH",
  },
  {
    number: 19,
    slug: "airway-vitals-exam",
