...
function lowRisk(): ClinicianAssessment {
  ...
  d.anaesthesiaPlan = {
    ...d.anaesthesiaPlan,
    technique: "ga",
    airwayPlan: "supraglottic",
    postOpDisposition: "day-case",
  };
  return d;
}
...
function moderateRisk(): ClinicianAssessment {
  ...
  d.functionalCapacity = {
    ...d.functionalCapacity,
    metsEstimate: 5,
    clinicalFrailtyScale: 3,
  };
  d.anaesthesiaPlan = {
    ...d.anaesthesiaPlan,
    technique: "ga",
    airwayPlan: "ett",
    postOpDisposition: "ward",
  };
  return d;
}
...
function highRisk(): ClinicianAssessment {
  ...
  d.functionalCapacity = {
    ...d.functionalCapacity,
    metsEstimate: 3,
    clinicalFrailtyScale: 5,
  };
  d.anaesthesiaPlan = {
    ...d.anaesthesiaPlan,
    technique: "combined-ga-regional",
    airwayPlan: "ett",
    monitoringLevel: "invasive-arterial",
    postOpDisposition: "enhanced-care",
  };
  return d;
}
...
export const sampleAssessmentRows: DashboardRow[] = sampleAssessments.map(
  (s) => {
