# Tasks: Immunology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/immunology-waiting-list-card/`.
...
- [x] `cargo loco new immunology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form immunology-waiting-list-card` exits cleanly.
