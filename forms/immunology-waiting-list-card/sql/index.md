# immunology-waiting-list-card — sql
...
- `immunology_waiting_list_card` — top-level waiting list card.
- `immunology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `immunology_waiting_list_card_grade` — computed grading result.
- `immunology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `immunology_waiting_list_card_grade_flag` — safety / operational flags fired
