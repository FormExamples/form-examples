# Immunology Waiting List Card — PostgreSQL migrations
...
Child `immunology_waiting_list_card_*` tables reference
`immunology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
