...
## RTT and elective care

- NHS England. *Referral to Treatment (RTT) waiting times.*
  <https://www.england.nhs.uk/statistics/statistical-work-areas/rtt-waiting-times/>
- NHS England. *Recording and Reporting RTT Rules Suite (current
  version PDF).*
...
- HL7 FHIR. *ServiceRequest resource.* <http://hl7.org/fhir/servicerequest.html>
