# Immunology Waiting List Card — specification
...
immunology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form immunology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check immunology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `immunology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `immunology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
