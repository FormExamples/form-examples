...
use crate::engine::oocg_grader;
use crate::engine::types::AssessmentData;
use crate::engine::utils::grade_label;
...
/// GET /assessment/{id} -- render the single-page outpatient-outcome wizard.
#[debug_handler]
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "prom_eq5d5l" => "promEq5d5l",
        "prom_grc" => "promGrc",
        "prom_promis" => "promPromis",
        "prem_fft" => "premFft",
...
async fn show_report(
    ...
    let grade = oocg_grader::grade_oocg(&assessment_data);
    ...
    context.insert("overall_grade_label", &grade_label(&grade.overall_grade));
    context.insert("clinical_grade", &grade.clinical_grade);
    context.insert("clinical_grade_label", &grade_label(&grade.clinical_grade));
    context.insert("prom_grade", &grade.prom_grade);
    context.insert("prom_grade_label", &grade_label(&grade.prom_grade));
    context.insert("prem_grade", &grade.prem_grade);
    context.insert("prem_grade_label", &grade_label(&grade.prem_grade));
    context.insert("operational_grade", &grade.operational_grade);
    context.insert(
        "operational_grade_label",
        &grade_label(&grade.operational_grade),
    );
