...
static welcome: Dir<'_> = include_dir!("src/outpatient_outcome/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/outpatient_outcome/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/outpatient_outcome/mailers/auth/magic_link");
