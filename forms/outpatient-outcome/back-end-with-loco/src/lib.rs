//! Outpatient Outcome — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Outpatient Outcome** medical form, built on the
...
//!
//! ```
//! use outpatient_outcome_loco_crate::engine::types::AssessmentData;
//!
