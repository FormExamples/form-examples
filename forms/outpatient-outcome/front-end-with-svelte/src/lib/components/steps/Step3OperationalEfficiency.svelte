<script lang="ts">
	...
	import { calcWaitDays } from '#lib/engine/utils.js';
...
<Fieldset title="Operational Efficiency" description="Referral and appointment timing">
	...
	<div class="mb-4">
		<span class="mb-1 block text-sm font-medium text-base-content/80">Wait Time (days)</span>
		{#if d.waitTimeDays !== null}
			...
			<p class="mt-1 text-xs text-base-content/50">Auto-calculated from dates above</p>
		{:else}
