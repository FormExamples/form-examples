# Ottawa Knee Rule: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Ottawa Knee Rule form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`ottawa_knee_rule/`](ottawa_knee_rule/) — one migration, SeaORM
