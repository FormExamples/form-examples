...
static welcome: Dir<'_> = include_dir!("src/ottawa_knee_rule/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/ottawa_knee_rule/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/ottawa_knee_rule/mailers/auth/magic_link");
