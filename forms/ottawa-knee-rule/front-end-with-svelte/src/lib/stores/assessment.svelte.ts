...
function storageKey(id: string): string {
	return `ottawa-knee-rule.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Ottawa Knee Rule assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Ottawa Knee Rule assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.tenderness`) stay bound to live state.
	 */
