# Tasks: Neurology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/neurology-waiting-list-card/`.
...
- [x] `cargo loco new neurology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form neurology-waiting-list-card` exits cleanly.
