# Neurology Waiting List Card — specification
...
neurology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form neurology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check neurology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `neurology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `neurology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
