# Neurology Waiting List Card — PostgreSQL migrations
...
Child `neurology_waiting_list_card_*` tables reference
`neurology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
