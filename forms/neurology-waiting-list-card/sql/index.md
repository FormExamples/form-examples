# neurology-waiting-list-card — sql
...
- `neurology_waiting_list_card` — top-level waiting list card.
- `neurology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `neurology_waiting_list_card_grade` — computed grading result.
- `neurology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `neurology_waiting_list_card_grade_flag` — safety / operational flags fired
