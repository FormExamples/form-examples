//! Medical Information Form for Air Travel — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Medical Information Form for Air Travel** medical form, built on the
...
//!
//! ```
//! use medical_information_form_for_air_travel_loco_crate::engine::types::AssessmentData;
//!
