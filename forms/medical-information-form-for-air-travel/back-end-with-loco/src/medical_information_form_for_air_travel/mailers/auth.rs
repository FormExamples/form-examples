...
static welcome: Dir<'_> = include_dir!("src/medical_information_form_for_air_travel/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medical_information_form_for_air_travel/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medical_information_form_for_air_travel/mailers/auth/magic_link");
