# Medical Information Form For Air Travel: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Medical Information Form For Air Travel form. Pure back-end: no HTML
