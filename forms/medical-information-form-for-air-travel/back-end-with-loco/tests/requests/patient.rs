...
async fn can_create_and_read_back_patient() {
    request::<App, _, _>(|request, _ctx| async move {
        let new_patient = serde_json::json!({
            ...
            "sexAtBirth": "female",
            "nationalityAsIso31661Alpha2": "Test nationalityAsIso31661Alpha2",
            "passportNumber": "Test passportNumber",
            "unitedKingdomNhsNumber": "9434765919",
            "nationalHealthId": "Test nationalHealthId",
            "email": "test.patient@example.com",
            "phone": "+441234567890",
            "postalAddressAsFullText": "10 Downing Street, London",
            "countryAsIso31661Alpha2": "GB",
            "postcode": "SW1A 2AA",
            "emergencyContactName": "Test emergencyContactName",
            "emergencyContactRelationship": "Test emergencyContactRelationship",
            "emergencyContactPhone": "+441234567890",
            "weightAsKg": 70.4,
            "heightAsCm": 170.2
        });
        ...
        assert_eq!(fetched["sexAtBirth"], "female");
        assert_eq!(fetched["nationalityAsIso31661Alpha2"], "Test nationalityAsIso31661Alpha2");
        assert_eq!(fetched["passportNumber"], "Test passportNumber");
        assert_eq!(fetched["unitedKingdomNhsNumber"], "9434765919");
        assert_eq!(fetched["nationalHealthId"], "Test nationalHealthId");
        ...
        assert_eq!(fetched["emergencyContactName"], "Test emergencyContactName");
        assert_eq!(fetched["emergencyContactRelationship"], "Test emergencyContactRelationship");
        assert_eq!(fetched["emergencyContactPhone"], "+441234567890");
