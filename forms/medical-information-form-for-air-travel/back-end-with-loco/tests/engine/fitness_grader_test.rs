...
use medical_information_form_for_air_travel_loco_crate::engine::fitness_grader::{
...
fn rule_ids_are_unique() {
    use medical_information_form_for_air_travel_loco_crate::engine::fitness_rules::RULE_IDS;
...
fn flag_ids_are_unique() {
    use medical_information_form_for_air_travel_loco_crate::engine::flagged_issues::FLAG_IDS;
