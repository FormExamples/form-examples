...
- LocalStorage key `medical-information-form-for-air-travel.front-end-form-with-html.v1` (HTML) and
  `medical-information-form-for-air-travel.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
