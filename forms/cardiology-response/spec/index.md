# Cardiology Response — specification
...
- `bin/test-form cardiology-response` exits cleanly.
...
- `bin/lily-html-refactor --check cardiology-response` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cardiology-response.front-end-with-html.v1` (HTML)
  - `cardiology-response.front-end-with-svelte.v1` (SvelteKit)
