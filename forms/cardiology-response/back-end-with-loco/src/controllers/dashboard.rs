...
use crate::models::_entities::cardiology_response_grades;
use crate::models::_entities::cardiology_responses;
...
async fn dashboard(
    ...
    let rows = cardiology_response_grades::Entity::find()
        .find_also_related(cardiology_responses::Entity)
        .order_by_desc(cardiology_response_grades::Column::GradedAt)
        .limit(limit)
        .all(&ctx.db)
        .await?;
