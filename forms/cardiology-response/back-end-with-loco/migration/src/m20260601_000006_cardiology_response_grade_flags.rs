...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        m.create_table(
            Table::create()
                .table(Alias::new("cardiology_response_grade_flags"))
                .if_not_exists()
                .col(
                ...
                .foreign_key(
                    ForeignKey::create()
                        .name("fk_cardiology_response_grade_flags_grade_id")
                        .from(
                            Alias::new("cardiology_response_grade_flags"),
        ...
        m.create_index(
            Index::create()
                .if_not_exists()
                .name("index_cardiology_response_grade_flag_grade_id")
                .table(Alias::new("cardiology_response_grade_flags"))
