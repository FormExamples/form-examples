// Safety-flag detection for the Perioperative Optimization engine.
//
...
function detectFlags(data, context) {
  const flags = [];
  const push = (flagId, category, priority, domain, description, suggestedAction) =>
