...
static welcome: Dir<'_> = include_dir!("src/perioperative_optimization/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/perioperative_optimization/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/perioperative_optimization/mailers/auth/magic_link");
