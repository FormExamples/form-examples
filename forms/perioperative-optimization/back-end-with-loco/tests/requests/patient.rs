...
async fn can_create_and_read_back_patient() {
    request::<App, _, _>(|request, _ctx| async move {
        let new_patient = serde_json::json!({
            ...
            "bodyMassIndex": 24.2,
            "waistAsCm": 85.0,
            "midUpperArmCircumferenceAsCm": 1.0,
            "calfCircumferenceAsCm": 1.0,
        ...
        assert_eq!(fetched["midUpperArmCircumferenceAsCm"].as_f64(), Some(1.0));
        assert_eq!(fetched["calfCircumferenceAsCm"].as_f64(), Some(1.0));
        assert_eq!(fetched["preferredLanguage"], "Test preferredLanguage");
        assert_eq!(fetched["ethnicity"], "Test ethnicity");
