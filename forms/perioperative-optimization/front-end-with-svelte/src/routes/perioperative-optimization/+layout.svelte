...
<svelte:head>
    <title>Perioperative Optimization</title>
</svelte:head>
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/perioperative-optimization/"
                class="text-lg font-bold text-base-content"
                >Perioperative Optimization</a
            >
            <div class="flex items-center gap-1">
                <a href="/perioperative-optimization/" class={navClass("/")}>Welcome</a>
                <a
                    href="/perioperative-optimization/perioperative-optimizations/new"
                    class={navClass("/perioperative-optimizations/new")}>New assessment</a
                >
                <a
                    href="/perioperative-optimization/perioperative-optimizations"
                    class={navClass("/perioperative-optimizations")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
