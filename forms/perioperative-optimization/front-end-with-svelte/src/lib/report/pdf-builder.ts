    ...
    },
    {
      table: {
        ...
        body: [
          [
            "MUST",
            result.mustScore === null
              ? "—"
              : `${result.mustScore} / 6 (${titleCase(result.mustRisk)})`,
          ],
          [
            "AUDIT-C",
          ...
          [
            "STOP-BANG",
            result.stopBangScore === null ? "—" : `${result.stopBangScore} / 8`,
          ],
          [
            "Duke Activity Status Index",
            result.dukeActivityStatusIndex === null
              ? "—"
              : String(result.dukeActivityStatusIndex),
          ],
          [
            "Clinical Frailty Scale",
            result.clinicalFrailtyScale === null
              ? "—"
              : `${result.clinicalFrailtyScale} / 9`,
          ],
          [
            "Body mass index",
            result.bmi === null ? "—" : `${result.bmi} kg/m²`,
          ],
        ],
      },
      layout: "lightHorizontalLines",
