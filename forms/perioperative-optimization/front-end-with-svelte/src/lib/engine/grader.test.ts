...
describe("Anaemia domain, and the 4 vs 8 week lead time", () => {
  ...
  }
  {
    ...
    it("raises the gating flag", () => {
      expect(
        r.flags.some((f) => f.category === "insufficient-time-to-optimize"),
      ).toEqual(true);
    });
  }
  {
...
describe("Sex-specific haemoglobin thresholds", () => {
  {
    ...
    it("Hb 125 male is anaemic", () => {
      expect(domain(calculateOptimization(a), "anaemia").triggered).toEqual(
        true,
      );
    });
    const b = dated(20);
    b.patient.sex = "female";
    b.anaemia.haemoglobinGPerL = 125;
    it("Hb 125 female is not", () => {
      expect(domain(calculateOptimization(b), "anaemia").triggered).toEqual(
        false,
      );
    });
  }
...
describe("Iron deficiency without anaemia", () => {
  {
    const a = dated(20);
    a.patient.sex = "male";
    a.anaemia.haemoglobinGPerL = 145;
  ...
  }
  {
    ...
    a.patient.sex = "male";
    a.anaemia.haemoglobinGPerL = 145;
    a.anaemia.ferritinUgPerL = 60;
    a.anaemia.transferrinSaturationPercent = 15;
    const r = calculateOptimization(a);
...
describe("Severe anaemia forces deferral regardless of time", () => {
  {
    const a = dated(52);
    a.patient.sex = "male";
    a.anaemia.haemoglobinGPerL = 75;
    const r = calculateOptimization(a);
    it("Hb 75 defers even with a year available", () => {
      expect(r.computedReadiness).toEqual("defer-surgery");
    });
    it("severe-anaemia flag", () => {
      expect(r.flags.some((f) => f.category === "severe-anaemia")).toEqual(
        true,
      );
    });
  }
...
describe("Glycaemic control", () => {
  {
    const a = dated(20);
    a.glycaemic.hba1cMmolPerMol = 55;
    a.glycaemic.diabetesType = "type-2";
    const r = calculateOptimization(a);
  ...
  {
    const a = dated(52);
    a.glycaemic.hba1cMmolPerMol = 75;
    a.glycaemic.diabetesType = "type-2";
    const r = calculateOptimization(a);
    ...
    it("hba1c flag", () => {
      expect(
        r.flags.some((f) => f.category === "hba1c-above-threshold"),
      ).toEqual(true);
    });
  }
  {
    const a = dated(20);
    a.glycaemic.hba1cMmolPerMol = 47;
    a.glycaemic.diabetesType = "type-2";
    it("HbA1c 47 below threshold", () => {
      expect(
        domain(calculateOptimization(a), "glycaemic-control").triggered,
      ).toEqual(false);
    });
    const b = dated(20);
    b.glycaemic.hba1cMmolPerMol = 48;
    b.glycaemic.diabetesType = "type-2";
    it("HbA1c 48 at threshold triggers", () => {
      expect(
        domain(calculateOptimization(b), "glycaemic-control").triggered,
      ).toEqual(true);
    });
  }
  {
    ...
    it("raised HbA1c with no diagnosis flags", () => {
      expect(
        r.flags.some((f) => f.category === "undiagnosed-diabetes"),
      ).toEqual(true);
    });
  }
  {
    ...
    it("no diabetes -> glycaemic not-applicable", () => {
      expect(
        domain(calculateOptimization(a), "glycaemic-control").status,
...
describe("Smoking gate boundary", () => {
  {
    ...
    it("exactly 4w meets the 4w lead time", () => {
      expect(domain(calculateOptimization(a), "smoking").status).toEqual(
        "action-required",
      );
    });
    const b = dated(3);
    b.smoking.smokingStatus = "current";
    it("3w is short", () => {
      expect(domain(calculateOptimization(b), "smoking").status).toEqual(
        "insufficient-time",
      );
    });
    it("shortfall 1", () => {
      expect(
        domain(calculateOptimization(b), "smoking").weeksShortfall,
      ).toEqual(1);
    });
  }
  {
    const a = dated(20);
    a.smoking.smokingStatus = "never";
    ...
    const b = dated(20);
    b.smoking.smokingStatus = "former";
  ...
  }
  {
    ...
    it("current smoker + major surgery flags", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "active-smoker-major-surgery",
        ),
      ).toEqual(true);
    });
  }
...
describe("Alcohol / AUDIT-C", () => {
  {
    const a = dated(20);
    a.patient.sex = "male";
    a.alcohol.auditCFrequency = 2;
    a.alcohol.auditCTypicalQuantity = 2;
    a.alcohol.auditCBingeFrequency = 1;
    const r = calculateOptimization(a);
    ...
    const b = dated(20);
    b.patient.sex = "female";
    b.alcohol.auditCFrequency = 2;
    b.alcohol.auditCTypicalQuantity = 1;
    b.alcohol.auditCBingeFrequency = 1;
  ...
  {
    const a = dated(20);
    a.alcohol.alcoholUnitsPerWeek = 20;
    it("20 units triggers", () => {
      expect(domain(calculateOptimization(a), "alcohol").triggered).toEqual(
        true,
      );
    });
    const b = dated(20);
    b.alcohol.alcoholUnitsPerWeek = 14;
    it("14 units does not", () => {
      expect(domain(calculateOptimization(b), "alcohol").triggered).toEqual(
        false,
      );
    });
  }
  {
    const a = dated(20);
    a.patient.sex = "male";
    a.alcohol.auditCFrequency = 4;
    a.alcohol.auditCTypicalQuantity = 4;
    a.alcohol.auditCBingeFrequency = 2;
    it("AUDIT-C 10 flags dependence risk", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "alcohol-dependence-risk",
        ),
      ).toEqual(true);
    });
  }
...
describe("Nutrition / MUST", () => {
  {
    const a = dated(20);
    a.nutrition.heightAsCm = 170;
    a.nutrition.weightAsKg = 50; // BMI 17.3 -> 2
    ...
    it("malnutrition flag", () => {
      expect(
        r.flags.some((f) => f.category === "high-malnutrition-risk"),
      ).toEqual(true);
    });
  }
  {
    const a = dated(20);
    a.nutrition.heightAsCm = 170;
    a.nutrition.weightAsKg = 75; // BMI 26 -> 0
...
describe("Physical fitness", () => {
  {
    const a = dated(20);
    a.fitness.metabolicEquivalents = 3;
    const r = calculateOptimization(a);
    it("METs 3 triggers", () => {
    ...
    it("poor capacity flag", () => {
      expect(
        r.flags.some((f) => f.category === "poor-functional-capacity"),
      ).toEqual(true);
    });
    const b = dated(20);
    b.fitness.metabolicEquivalents = 4;
    it("METs 4 does not trigger", () => {
      expect(
        domain(calculateOptimization(b), "physical-fitness").triggered,
      ).toEqual(false);
    });
  }
  {
    const a = dated(20);
    a.fitness.metabolicEquivalents = 3;
    a.fitness.prehabilitationEnrolled = "yes";
    it("enrolled -> in-progress", () => {
      expect(
        domain(calculateOptimization(a), "physical-fitness").status,
      ).toEqual("in-progress");
    });
  }
});
...
describe("Medication", () => {
  {
    const a = dated(20);
    a.medication.takesAnticoagulant = "yes";
    const r = calculateOptimization(a);
    ...
    it("anticoag flag", () => {
      expect(
        r.flags.some((f) => f.category === "anticoagulation-plan-missing"),
      ).toEqual(true);
    });
    ...
    it("plan agreed clears the flag", () => {
      expect(
        r2.flags.some((f) => f.category === "anticoagulation-plan-missing"),
      ).toEqual(false);
    });
  }
  {
    const a = dated(20);
    a.medication.takesSglt2Inhibitor = "yes";
    it("SGLT2 with no plan flags", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "sglt2-inhibitor-not-held",
        ),
      ).toEqual(true);
    });
  }
  {
    ...
    it("GLP-1 flags even with a plan agreed", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "glp1-agonist-aspiration-risk",
        ),
      ).toEqual(true);
    });
  }
  {
    ...
    it("no medicines -> medication not-applicable", () => {
      expect(domain(calculateOptimization(a), "medication").status).toEqual(
        "not-applicable",
      );
    });
  }
...
describe("Fried Frailty Phenotype", () => {
  {
    const a = dated(20);
    a.frailty.friedWeakness = "no";
    a.frailty.friedSlowness = "no";
    a.frailty.friedLowPhysicalActivity = "no";
    a.frailty.friedExhaustion = "no";
  ...
  {
    const a = dated(20);
    a.frailty.friedWeakness = "yes";
    a.frailty.friedSlowness = "yes";
    a.frailty.friedLowPhysicalActivity = "yes";
    a.frailty.friedExhaustion = "no";
    a.frailty.friedUnintentionalWeightLoss = "no";
    const r = calculateOptimization(a);
...
describe("Frailty x GLP-1 intersecting risks", () => {
  {
    ...
    it("CFS >= 5 without Mini-Cog flags cognitive-assessment-indicated", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "cognitive-assessment-indicated",
        ),
      ).toEqual(true);
    });
  }
  ...
  }
  {
    ...
    it("frail + GLP-1 + GI symptoms flags dehydration-aki-risk", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "dehydration-aki-risk",
        ),
      ).toEqual(true);
    });
  }
  {
    ...
    it("held GLP-1 + insulin flags rebound-glycaemic-risk", () => {
      expect(
        calculateOptimization(a).flags.some(
          (f) => f.category === "rebound-glycaemic-risk",
        ),
      ).toEqual(true);
    });
  }
...
describe("Cardiorespiratory", () => {
  {
    const a = dated(20);
    a.cardioresp.systolicBp = 185;
    a.cardioresp.diastolicBp = 95;
    const r = calculateOptimization(a);
    it("SBP 185 triggers", () => {
    ...
    it("hypertension flag", () => {
      expect(
        r.flags.some((f) => f.category === "uncontrolled-hypertension"),
      ).toEqual(true);
    });
    const b = dated(20);
    b.cardioresp.systolicBp = 179;
    b.cardioresp.diastolicBp = 109;
    it("179/109 does not trigger", () => {
      expect(
        domain(calculateOptimization(b), "cardiorespiratory").triggered,
      ).toEqual(false);
    });
  }
  {
    ...
    it("osa flag", () => {
      expect(r.flags.some((f) => f.category === "osa-unassessed")).toEqual(
        true,
      );
    });
    ...
    it("diagnosed OSA clears it", () => {
      expect(
        domain(calculateOptimization(a), "cardiorespiratory").triggered,
      ).toEqual(false);
    });
  }
});
...
describe("Ungated (no surgery date)", () => {
  {
    ...
    a.assessment.assessmentDate = "2026-09-01";
    a.smoking.smokingStatus = "current";
    a.anaemia.haemoglobinGPerL = 100;
    a.patient.sex = "female";
    const r = calculateOptimization(a);
...
describe("recommendedEarliestSurgeryDate", () => {
  {
    const a = dated(2);
    a.patient.sex = "female";
    a.anaemia.haemoglobinGPerL = 110; // 8w lead, 6 short
    const r = calculateOptimization(a);
    it("shortfall 6", () => {
...
describe("Override changes the band but never the flags", () => {
  {
    ...
    a.signoff.overrideReason =
      "Cancer resection; delay carries the greater risk.";
    ...
    it("gating flag survives the override", () => {
      expect(
        after.flags.some((f) => f.category === "insufficient-time-to-optimize"),
      ).toEqual(true);
    });
  }
  {
...
describe("Paediatric and pregnancy", () => {
  {
    ...
    it("paediatric flag", () => {
      expect(
        calculateOptimization(a).flags.some((f) => f.category === "paediatric"),
      ).toEqual(true);
    });
  }
  {
    const a = dated(20);
    a.history.pregnancyStatus = "pregnant";
    it("pregnancy flag", () => {
      expect(
        calculateOptimization(a).flags.some((f) => f.category === "pregnancy"),
      ).toEqual(true);
    });
  }
});
...
describe("Determinism", () => {
  {
    ...
    a.anaemia.haemoglobinGPerL = 110;
    it("deterministic", () => {
      expect(JSON.stringify(calculateOptimization(a))).toEqual(
        JSON.stringify(calculateOptimization(a)),
      );
    });
  }
});
