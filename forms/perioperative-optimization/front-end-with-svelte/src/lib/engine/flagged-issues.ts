...
export function detectFlags(
  ...
  if (short.length > 0) {
    ...
    push(
      "F-INSUFFICIENT-TIME-TO-OPTIMIZE-001",
  ...
  if (
    ferritin !== null &&
    ferritin < 30 &&
    data.anaemia.anaemiaTreatmentStarted !== "yes"
  ) {
    push(
      "F-IRON-DEFICIENCY-UNTREATED-001",
  ...
  if (
    data.medication.takesSglt2Inhibitor === "yes" &&
    data.medication.medicationHoldPlanAgreed !== "yes"
  ) {
    push(
      "F-SGLT2-INHIBITOR-NOT-HELD-001",
  ...
  if (
    onGlp1 &&
    (data.medication.glp1GiSymptoms === "yes" || glp1NotHeldOrConfirmed)
  ) {
    push(
      "F-GLP1-AGONIST-ASPIRATION-RISK-001",
  ...
  if (
    (data.medication.takesAnticoagulant === "yes" ||
      data.medication.takesAntiplatelet === "yes") &&
    data.medication.medicationHoldPlanAgreed !== "yes"
  ) {
    const which =
      data.medication.takesAnticoagulant === "yes"
        ...
        : "An antiplatelet";
    push(
      "F-ANTICOAGULATION-PLAN-MISSING-001",
  ...
  // --- Smoking ---------------------------------------------------------------
  if (
    data.smoking.smokingStatus === "current" &&
    ["major", "major-plus"].includes(data.procedure.surgicalSeverity)
  ) {
    push(
      "F-ACTIVE-SMOKER-MAJOR-SURGERY-001",
  ...
  if (
    ...
    push(
      "F-POOR-FUNCTIONAL-CAPACITY-001",
  ...
  if (cfs !== null && cfs >= 5 && data.frailty.miniCogPerformed !== "yes") {
    push(
      "F-COGNITIVE-ASSESSMENT-INDICATED-001",
  ...
  if ((sbp !== null && sbp >= 180) || (dbp !== null && dbp >= 110)) {
    push(
      "F-UNCONTROLLED-HYPERTENSION-001",
  ...
  if (ef !== null && ef < 40) {
    push(
      "F-CARDIAC-OPTIMIZATION-REQUIRED-001",
  ...
  if (
    ...
    push(
      "F-RESPIRATORY-OPTIMIZATION-REQUIRED-001",
  ...
  if (egfr !== null && egfr < 30) {
    push(
      "F-RENAL-OPTIMIZATION-REQUIRED-001",
  ...
  // --- Anaesthetic history ------------------------------------------------------------
  if (
    data.history.previousAnaestheticComplication === "yes" ||
    data.history.malignantHyperthermiaHistory === "yes"
  ) {
    push(
      "F-PRIOR-ANAESTHETIC-COMPLICATION-001",
  ...
  if (
    ["moderate", "severe"].includes(data.social.anxietyLevel) ||
    data.social.depressionScreen === "positive"
  ) {
    push(
      "F-PSYCHOLOGICAL-SUPPORT-REQUIRED-001",
  ...
  if (
    ...
    data.social.supportAfterDischarge === "none"
  ) {
    push(
      "F-SOCIAL-SUPPORT-GAP-001",
      "social-support-gap",
      "medium",
      "",
      data.social.transportHomeArranged === "no"
  ...
  const priorityOrder: Record<FlagPriority, number> = {
    high: 0,
    medium: 1,
    low: 2,
  };
