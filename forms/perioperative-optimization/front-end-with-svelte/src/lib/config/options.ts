...
export const OPTIONS: Record<string, Option[]> = {
  role: [
    {
      value: "preoperative-assessment-nurse",
      label: "Pre-operative assessment nurse",
    },
  ...
  surgicalSeverity: [
    ...
    { value: "major-plus", label: "Major plus" },
  ],
  laterality: [
  ...
  auditCQuantity: [
    { value: "0", label: "0 — 1 or 2" },
    { value: "1", label: "1 — 3 or 4" },
    { value: "2", label: "2 — 5 or 6" },
    { value: "3", label: "3 — 7 to 9" },
    { value: "4", label: "4 — 10 or more" },
  ],
  auditCBinge: [
    { value: "0", label: "0 — Never" },
    { value: "1", label: "1 — Less than monthly" },
  ...
  gateDecision: [
    ...
    {
      value: "proceed-with-prehabilitation",
      label: "Proceed with prehabilitation",
    },
