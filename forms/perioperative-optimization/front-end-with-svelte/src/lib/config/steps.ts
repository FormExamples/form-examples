...
export const steps: StepConfig[] = [
  ...
  {
    number: 2,
    title: "Patient and Procedural Demographics",
    shortTitle: "Procedure",
  },
  ...
  {
    number: 11,
    title: "Functional Capacity and Physical Fitness",
    shortTitle: "Fitness",
  },
  { number: 12, title: "Frailty, Cognition and Falls", shortTitle: "Frailty" },
  {
    number: 13,
    title: "Cardiorespiratory Optimization",
    shortTitle: "Cardioresp",
  },
  {
    number: 14,
    title: "Psychological Readiness and Social Support",
    shortTitle: "Readiness",
  },
  { number: 15, title: "Optimization Plan by Domain", shortTitle: "Plan" },
  {
    number: 16,
    title: "Readiness Summary and Sign-off",
    shortTitle: "Sign-off",
  },
];
