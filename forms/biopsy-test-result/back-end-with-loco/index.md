...
Server-side Rust JSON API for the Biopsy Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`biopsy_test_result/`](biopsy_test_result/) — one migration, SeaORM
