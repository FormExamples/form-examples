<script lang="ts">
	...
	import Step2SpecimenProcedure from '#lib/components/steps/Step2SpecimenProcedure.svelte';
	import Step3ClinicalHistory from '#lib/components/steps/Step3ClinicalHistory.svelte';
	import Step4Description from '#lib/components/steps/Step4Description.svelte';
	import Step5DiagnosisGrading from '#lib/components/steps/Step5DiagnosisGrading.svelte';
	...
	function validate(): boolean {
		...
		if (d.biopsySite === '') {
			found.push({ id: 'biopsySite', message: 'Biopsy site is required.' });
		}
	...
	function submit() {
		...
		goto('/biopsy-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New biopsy report</h1>
	...
	<Form label="Biopsy test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2SpecimenProcedure />
		<Step3ClinicalHistory />
		<Step4Description />
		<Step5DiagnosisGrading />
		<Step6Impression />
