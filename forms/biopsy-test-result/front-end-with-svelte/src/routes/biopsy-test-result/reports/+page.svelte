...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-gray-900">Graded biopsy reports</h1>
			<p class="mt-1 text-sm text-gray-600">
				Four-axis interpretation grades for completed biopsy histopathology reports.
			</p>
		</div>
		<a href="/biopsy-test-result/report" class="button" data-variant="primary">New report</a>
	</div>
			...
			<tbody>
				{#each rows as r (r.id)}
					<tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50">
						...
						<td class="px-4 py-3 text-gray-700">{biopsySiteLabel(r.biopsySite)}</td>
