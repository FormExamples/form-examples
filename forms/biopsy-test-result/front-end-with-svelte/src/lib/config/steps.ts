...
export const steps: StepConfig[] = [
	...
	{ number: 2, title: 'Specimen & Procedure', shortTitle: 'Specimen' },
	{ number: 3, title: 'Clinical History', shortTitle: 'History' },
	{ number: 4, title: 'Description', shortTitle: 'Description' },
	{ number: 5, title: 'Diagnosis & Grading', shortTitle: 'Diagnosis' },
