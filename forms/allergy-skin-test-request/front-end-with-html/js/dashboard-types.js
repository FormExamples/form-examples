// Plain-JavaScript / JSDoc type definitions for the allergy testing vetting
// dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (BSACI / EAACI 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Validity-and-safety band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'contraindicated'} ValiditySafetyBand
 */
 ...
 * @property {string[]} allergens     - Selected allergen panels (kebab-case)
 ...
 * @property {ValiditySafetyBand} validitySafetyBand   - Axis B band
...
// before they read `window.AllergySkinTestRequestDashboard`.
