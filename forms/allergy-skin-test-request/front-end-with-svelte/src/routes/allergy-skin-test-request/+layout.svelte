...
<svelte:head>
	<title>Allergy Skin Test Request</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/allergy-skin-test-request/" class="text-lg font-bold text-base-content">Allergy Skin Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/allergy-skin-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/allergy-skin-test-request/allergy-skin-test-requests/new" class={navClass('/allergy-skin-test-requests/new')}>New request</a>
				<a href="/allergy-skin-test-request/allergy-skin-test-requests" class={navClass('/allergy-skin-test-requests')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
