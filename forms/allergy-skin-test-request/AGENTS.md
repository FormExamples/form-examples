# Allergy Skin Test Request — agent instructions

Allergy testing request (referral) for skin-prick, intradermal, patch,
specific-IgE blood, or drug-provocation testing. A clinician completes a
single-page wizard; the engine computes a **four-axis grading**
(appropriateness, validity and safety, request completeness, triage priority)
...
`{ appropriatenessScore (1–9) + appropriatenessBand, validitySafetyBand,
...
back-end. **Antihistamines invalidate skin-prick / intradermal tests** (validity
axis); a **beta-blocker with anaphylaxis history** and **active skin disease**
raise caution / contraindication. Choose the least-alarming band only when no
rule fires.
