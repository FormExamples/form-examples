import type { LumbarPunctureResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a lumbar puncture / CSF result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical CSF result (bacterial meningitis pattern, suggested
 * subarachnoid haemorrhage, or positive culture) auto-escalates Axis D to
 ...
 */
export function calculateGrade(result: LumbarPunctureResult): GradingResult {
