 ...
 * `forms/lumbar-puncture-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {string} reportingCategory                     - structured CSF pattern label
...
// namespace, `window.LumbarPunctureTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.LumbarPunctureTestResultDashboard`.
})();
