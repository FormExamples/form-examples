...
Server-side Rust JSON API for the Lumbar Puncture Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`lumbar_puncture_test_result/`](lumbar_puncture_test_result/) — one migration, SeaORM
