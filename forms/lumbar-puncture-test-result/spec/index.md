# Lumbar Puncture Test Result — specification
...
- `bin/test-form lumbar-puncture-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check lumbar-puncture-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `lumbar-puncture-test-result.front-end-with-html.v1` (HTML)
  - `lumbar-puncture-test-result.front-end-with-svelte.v1` (SvelteKit)
