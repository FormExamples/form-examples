...
function storageKey(id: string): string {
	return `prenatal-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank prenatal assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the prenatal assessment, with localStorage
