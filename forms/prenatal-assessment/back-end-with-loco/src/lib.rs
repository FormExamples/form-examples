//! Prenatal Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Prenatal Assessment** medical form, built on the
...
//!
//! ```
//! use prenatal_assessment_loco_crate::engine::types::AssessmentData;
//!
