# Prenatal Assessment — specification
...
- `bin/test-form prenatal-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check prenatal-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `prenatal-assessment.front-end-form-with-html.v1` (HTML)
  - `prenatal-assessment.front-end-form-with-svelte.v1` (SvelteKit)
