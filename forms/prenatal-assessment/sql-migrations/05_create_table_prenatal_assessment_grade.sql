...
COMMENT ON COLUMN grade.risk_score IS
    'Aggregate risk score across all domains.';
COMMENT ON COLUMN grade.obstetric_risk IS
    'Risk level from obstetric history: low, moderate, high, or empty.';
COMMENT ON COLUMN grade.medical_risk IS
    'Risk level from medical history: low, moderate, high, or empty.';
COMMENT ON COLUMN grade.mental_health_risk IS
