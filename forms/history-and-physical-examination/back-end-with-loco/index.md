...
Server-side Rust JSON API for the History and Physical Examination (H&P) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`history_and_physical_examination/`](history_and_physical_examination/) — one migration, SeaORM
