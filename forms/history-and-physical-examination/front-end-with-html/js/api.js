...
/**
 * Fetch the clerking list from the backend.
 *
...
async function fetchAssessments() {
  ...
  if (!res.ok) {
    throw new Error(
      `Failed to fetch clerkings: ${res.status} ${res.statusText}`
    );
  }
...
window.HistoryAndPhysicalExaminationDashboard.fetchAssessments = fetchAssessments;
window.HistoryAndPhysicalExaminationDashboard.API_BASE = API_BASE;
})();
