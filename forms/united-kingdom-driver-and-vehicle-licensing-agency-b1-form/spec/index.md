...
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-driver-and-vehicle-licensing-agency-b1-form.front-end-with-html.v1` (HTML)
  - `united-kingdom-driver-and-vehicle-licensing-agency-b1-form.front-end-with-svelte.v1` (SvelteKit)
