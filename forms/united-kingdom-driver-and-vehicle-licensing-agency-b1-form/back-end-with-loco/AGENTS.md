# United Kingdom Driver and Vehicle Licensing Agency B1 Form — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the United Kingdom Driver and Vehicle Licensing Agency B1 Form form, built with axum + Loco +
...
- [`united_kingdom_driver_and_vehicle_licensing_agency_b1_form/`](./united_kingdom_driver_and_vehicle_licensing_agency_b1_form/) — the Loco crate: `src/united_kingdom_driver_and_vehicle_licensing_agency_b1_form/` holds `app.rs`
...
`src/united_kingdom_driver_and_vehicle_licensing_agency_b1_form/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd united_kingdom_driver_and_vehicle_licensing_agency_b1_form && cargo check --all-targets && cargo test
```
