//! United Kingdom Driver and Vehicle Licensing Agency B1 Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **United Kingdom Driver and Vehicle Licensing Agency B1 Form** medical form, built on the
...
//!
//! ```
//! use united_kingdom_driver_and_vehicle_licensing_agency_b1_form_loco_crate::engine::types::AssessmentData;
//!
