...
<svelte:head>
	<title>X-Ray Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/x-ray-test-request/" class="text-lg font-bold text-base-content">X-Ray Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/x-ray-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/x-ray-test-request/x-ray-test-requests/new" class={navClass('/x-ray-test-requests/new')}>New request</a>
				<a href="/x-ray-test-request/x-ray-test-requests" class={navClass('/x-ray-test-requests')}>Vetting dashboard</a>
