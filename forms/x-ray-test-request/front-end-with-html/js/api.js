// Backend API client for the X-ray vetting dashboard.
//
...
window.XRayTestRequestDashboard.fetchRequests = fetchRequests;
window.XRayTestRequestDashboard.API_BASE = API_BASE;
})();
