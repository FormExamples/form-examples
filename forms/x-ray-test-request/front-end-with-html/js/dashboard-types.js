// Plain-JavaScript / JSDoc type definitions for the X-ray vetting dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (ACR / RCR iRefer 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Radiation-safety band emitted by Axis B (IR(ME)R 2017).
 * @typedef {'safe' | 'caution' | 'contraindicated'} RadiationSafetyBand
 */

/**
 * Relative effective-dose band emitted by Axis B.
 * @typedef {'low' | 'moderate' | 'high'} RadiationDoseBand
 */
 ...
 * @property {string} laterality      - Laterality (left / right / bilateral / not-applicable)
 ...
 * @property {RadiationSafetyBand} radiationSafetyBand - Axis B safety band
 * @property {RadiationDoseBand} radiationDoseBand     - Axis B dose band
