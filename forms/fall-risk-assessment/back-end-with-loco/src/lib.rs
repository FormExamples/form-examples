//! Fall Risk Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Fall Risk Assessment** medical form, built on the
...
//!
//! ```
//! use fall_risk_assessment_loco_crate::engine::types::AssessmentData;
//!
