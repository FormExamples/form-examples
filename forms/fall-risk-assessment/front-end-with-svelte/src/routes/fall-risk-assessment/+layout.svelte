...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/fall-risk-assessment/" class="text-lg font-bold text-base-content">Fall Risk Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/fall-risk-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/fall-risk-assessment/fall-risk-assessments/new" class={navClass('/fall-risk-assessments/new')}>New assessment</a>
				<a href="/fall-risk-assessment/fall-risk-assessments" class={navClass('/fall-risk-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
