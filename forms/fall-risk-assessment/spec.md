# Fall Risk Assessment — specification
...
- `bin/test-form fall-risk-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check fall-risk-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `fall-risk-assessment.front-end-form-with-html.v1` (HTML)
  - `fall-risk-assessment.front-end-form-with-svelte.v1` (SvelteKit)
