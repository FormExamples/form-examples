...
static welcome: Dir<'_> = include_dir!("src/hospital_discharge/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/hospital_discharge/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/hospital_discharge/mailers/auth/magic_link");
