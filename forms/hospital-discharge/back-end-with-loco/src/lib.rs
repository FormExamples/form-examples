//! Hospital Discharge — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Hospital Discharge** medical form, built on the
...
//!
//! ```
//! use hospital_discharge_loco_crate::engine::types::AssessmentData;
//!
