    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            ...
            <div class="flex items-center gap-1">
                ...
                <a
                    href="/hospital-discharge/hospital-discharges/new"
                    class={navClass("/hospital-discharges/new")}>New summary</a
                >
                <a
                    href="/hospital-discharge/hospital-discharges"
                    class={navClass("/hospital-discharges")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
