...
import type { AssessmentData, ValidationRule } from './types';
...
export const validationRules: ValidationRule[] = [
	// ─── Patient identification (mandatory) ─────────────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.patientDetails.firstName)
	},
	{
		id: 'NG27-M-002',
		category: 'Patient Details',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.patientDetails.lastName)
	},
	{
		id: 'NG27-M-003',
		category: 'Patient Details',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.patientDetails.dateOfBirth)
	},
	{
		id: 'NG27-M-004',
		category: 'Patient Details',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.patientDetails.nhsNumber)
	},
	{
		id: 'NG27-M-005',
		category: 'Patient Details',
	...
	// ─── Admission summary (mandatory) ──────────────────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.admissionSummary.admissionDate)
	},
	{
		id: 'NG27-M-007',
		category: 'Admission Summary',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.admissionSummary.dischargeDate)
	},
	{
		id: 'NG27-M-008',
		category: 'Admission Summary',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.admissionSummary.consultant)
	},
	{
		id: 'NG27-M-009',
		category: 'Admission Summary',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.admissionSummary.reasonForAdmission)
	},
	...
	// ─── Diagnoses (mandatory) ──────────────────────────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) =>
			d.diagnoses.diagnoses.some((x) => x.type === 'primary' && nonEmpty(x.description))
	},
	...
	},
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => d.dischargeMedications.reconciliationCompleted === 'yes'
	},
	{
		id: 'NG27-M-014',
		category: 'Discharge Medications',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => d.dischargeMedications.allergiesReviewed === 'yes'
	},
	...
	// ─── Community care (mandatory) ────────────────────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.communityCareInstructions.dischargeDestination)
	},
	{
		id: 'NG27-M-018',
		category: 'Community Care',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.communityCareInstructions.careResponsibility)
	},
	...
	// ─── Warning signs / safety-netting (mandatory) ────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.warningSigns.whenToSeekHelp)
	},
	{
		id: 'NG27-M-020',
		category: 'Warning Signs',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => d.warningSigns.safetyNetingProvided === 'yes'
	},
	...
	// ─── Clinician sign-off (mandatory) ────────────────────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.clinicianSignoff.clinicianName)
	},
	{
		id: 'NG27-M-022',
		category: 'Clinician Sign-off',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.clinicianSignoff.clinicianRole)
	},
	{
		id: 'NG27-M-023',
		category: 'Clinician Sign-off',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => nonEmpty(d.clinicianSignoff.signoffDate)
	},
	...
	// ─── Patient / carer acknowledgement (mandatory) ───────────────
	{
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => d.patientAcknowledgement.patientUnderstandsPlan === 'yes'
	},
	{
		id: 'NG27-M-025',
		category: 'Patient Acknowledgement',
		...
		mandatory: true,
		evaluate: (d: AssessmentData) => d.patientAcknowledgement.medicationsExplained === 'yes'
	},
	...
	},
	{
		...
		mandatory: false,
		evaluate: (d: AssessmentData) =>
			nonEmpty(d.patientDetails.nextOfKinName) && nonEmpty(d.patientDetails.nextOfKinPhone)
	},
	{
		id: 'NG27-O-003',
		category: 'Admission Summary',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) => nonEmpty(d.admissionSummary.clinicalNarrative)
	},
	{
		id: 'NG27-O-004',
		category: 'Diagnoses',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) =>
			d.diagnoses.diagnoses.some((x) => x.type === 'primary' && nonEmpty(x.icd10))
	},
	{
		id: 'NG27-O-005',
		category: 'Follow-up',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) =>
			d.followupArrangements.appointments.some((a) => nonEmpty(a.provider) && nonEmpty(a.date))
	},
	{
		id: 'NG27-O-006',
		category: 'Warning Signs',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) => d.warningSigns.writtenInfoGiven === 'yes'
	},
	{
		id: 'NG27-O-007',
		category: 'Patient Acknowledgement',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) => d.patientAcknowledgement.writtenSummaryProvided === 'yes'
	},
	{
		id: 'NG27-O-008',
		category: 'Patient Acknowledgement',
		...
		mandatory: false,
		evaluate: (d: AssessmentData) => d.patientAcknowledgement.questionsAnswered === 'yes'
	}
];
