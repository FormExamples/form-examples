# Hospital Discharge — specification
...
- `bin/test-form hospital-discharge` exits cleanly.
...
- `bin/lily-html-refactor --check hospital-discharge` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `hospital-discharge.front-end-form-with-html.v1` (HTML)
  - `hospital-discharge.front-end-form-with-svelte.v1` (SvelteKit)
