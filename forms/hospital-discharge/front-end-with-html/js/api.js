// Backend API client for the Hospital Discharge clinician dashboard.
//
...
window.HospitalDischargeDashboard.fetchPatients = fetchPatients;
window.HospitalDischargeDashboard.API_BASE = API_BASE;
})();
