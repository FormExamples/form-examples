...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/nursing-care-plan/"
                class="text-lg font-bold text-base-content">Nursing Care Plan</a
            >
            <div class="flex items-center gap-1">
                <a href="/nursing-care-plan/" class={navClass("/")}>Welcome</a>
                <a
                    href="/nursing-care-plan/nursing-care-plans/new"
                    class={navClass("/nursing-care-plans/new")}>New care plan</a
                >
                <a
                    href="/nursing-care-plan/nursing-care-plans"
                    class={navClass("/nursing-care-plans")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
