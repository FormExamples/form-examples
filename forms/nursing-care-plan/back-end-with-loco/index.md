# Nursing Care Plan: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Nursing Care Plan form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`nursing_care_plan/`](nursing_care_plan/) — one migration, SeaORM
