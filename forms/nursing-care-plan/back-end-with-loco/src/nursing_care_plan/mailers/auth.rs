...
static welcome: Dir<'_> = include_dir!("src/nursing_care_plan/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/nursing_care_plan/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/nursing_care_plan/mailers/auth/magic_link");
