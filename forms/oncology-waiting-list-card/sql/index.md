# oncology-waiting-list-card — sql
...
- `oncology_waiting_list_card` — top-level waiting list card.
- `oncology_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `oncology_waiting_list_card_grade` — computed grading result.
- `oncology_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `oncology_waiting_list_card_grade_flag` — safety / operational flags fired
