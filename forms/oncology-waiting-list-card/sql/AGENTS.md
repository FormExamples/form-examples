# Oncology Waiting List Card — PostgreSQL migrations
...
Child `oncology_waiting_list_card_*` tables reference
`oncology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
