# Tasks: Oncology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/oncology-waiting-list-card/`.
...
- [x] `cargo loco new oncology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form oncology-waiting-list-card` exits cleanly.
