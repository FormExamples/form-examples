<script lang="ts">
  ...
  const items = itemsForSection(11);
...
<Fieldset legend="Step 12 — Section 11 — House Keeping (8 checkpoints)">
  <p class="hint">Housekeeping across OPD, wards, OT/ICU, labour room, premises, drainages, and toilets.</p>
