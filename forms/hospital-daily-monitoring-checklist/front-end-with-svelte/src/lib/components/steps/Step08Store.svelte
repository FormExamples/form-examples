...
<Fieldset legend="Step 8 — Section 7 — Store (4 checkpoints)">
  <p class="hint">Drug store staffing, storage order/cleanliness, security, and expiry (FEFO) checks.</p>
