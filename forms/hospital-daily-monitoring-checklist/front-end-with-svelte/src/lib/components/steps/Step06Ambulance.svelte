...
<Fieldset legend="Step 6 — Section 5 — Ambulance (3 checkpoints)">
  <p class="hint">Ambulance availability, driver coverage, and log-book verification.</p>
