<script lang="ts">
  ...
  const items = itemsForSection(16);
...
<Fieldset legend="Step 17 — Section 16 — Fire Fighting Equipment (1 checkpoint)">
  <p class="hint">Fire-fighting equipment availability and condition.</p>
