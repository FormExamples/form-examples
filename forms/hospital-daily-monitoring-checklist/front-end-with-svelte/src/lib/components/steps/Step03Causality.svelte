...
<Fieldset legend="Step 3 — Section 2 — Causality (4 checkpoints)">
  <p class="hint">Emergency (casualty) readiness: staff duty roster, emergency tray, emergency ward status, and life-saving skill/equipment.</p>
