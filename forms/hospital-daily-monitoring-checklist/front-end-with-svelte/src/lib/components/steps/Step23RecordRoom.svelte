<script lang="ts">
  ...
  const items = itemsForSection(22);
...
<Fieldset legend="Step 23 — Section 22 — Record Room (2 checkpoints)">
  <p class="hint">Record room cleanliness/pest control and proper filing/stocking.</p>
