<script lang="ts">
  ...
  const items = itemsForSection(13);
...
<Fieldset legend="Step 14 — Section 13 — Electric Supply (3 checkpoints)">
  <p class="hint">General electrical fittings, generator status, and electrician availability.</p>
