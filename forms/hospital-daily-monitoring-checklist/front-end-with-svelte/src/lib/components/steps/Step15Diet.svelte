<script lang="ts">
  ...
  const items = itemsForSection(14);
...
<Fieldset legend="Step 15 — Section 14 — Diet (6 checkpoints)">
  <p class="hint">Diet staffing, food items/timings, utensils, food trolley, water supply, and cleanliness.</p>
