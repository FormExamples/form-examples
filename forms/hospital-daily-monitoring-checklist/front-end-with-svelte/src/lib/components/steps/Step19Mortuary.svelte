<script lang="ts">
  ...
  const items = itemsForSection(18);
...
<Fieldset legend="Step 19 — Section 18 — Mortuary (1 checkpoint)">
  <p class="hint">Care of the dead, mortuary arrangements, and post-mortem process.</p>
