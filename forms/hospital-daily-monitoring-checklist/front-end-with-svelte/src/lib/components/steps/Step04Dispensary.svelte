...
<Fieldset legend="Step 4 — Section 3 — Dispensary (3 checkpoints)">
  <p class="hint">Drug stock, stock-book/expenditure entries, and dispensing practice.</p>
