<script lang="ts">
  ...
  const items = itemsForSection(12);
...
<Fieldset legend="Step 13 — Section 12 — Water Supply (6 checkpoints)">
  <p class="hint">Drinking water, water cooler, overhead tanks, taps/fittings, washroom, and washbasins.</p>
