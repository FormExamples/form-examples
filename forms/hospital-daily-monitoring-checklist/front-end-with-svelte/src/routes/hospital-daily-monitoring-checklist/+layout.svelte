...
<svelte:head>
	<title>Hospital Daily Monitoring Checklist</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hospital-daily-monitoring-checklist/" class="text-lg font-bold text-base-content">Hospital Daily Monitoring Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/hospital-daily-monitoring-checklist/" class={navClass('/')}>Welcome</a>
				<a
					href="/hospital-daily-monitoring-checklist/hospital-daily-monitoring-checklists/new"
					class={navClass('/hospital-daily-monitoring-checklists/new')}>New round</a
				>
				<a
					href="/hospital-daily-monitoring-checklist/hospital-daily-monitoring-checklists"
					class={navClass('/hospital-daily-monitoring-checklists')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
