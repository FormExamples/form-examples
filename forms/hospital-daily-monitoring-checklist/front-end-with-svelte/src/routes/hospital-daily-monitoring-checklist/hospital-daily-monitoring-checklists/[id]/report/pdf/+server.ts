...
import type { ChecklistSummaryResult, HospitalDailyMonitoringChecklist } from '$lib/engine/types';
			...
			resolve(
				new Response(pdfBuffer, {
					headers: {
						...
						'Content-Disposition': `attachment; filename="hospital-daily-monitoring-checklist.pdf"`
					}
				})
			);
		});
