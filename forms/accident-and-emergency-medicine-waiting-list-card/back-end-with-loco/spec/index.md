# Accident and Emergency Medicine Waiting List Card — back-end-with-loco spec

JSON API contract for the Accident and Emergency Medicine Waiting List Card back-end. This file is the living
