# Accident and Emergency Medicine Waiting List Card — SvelteKit practitioner form

Single-page wizard for practitioners (GPs, consultants, referral
co-ordinators) to place a patient on a accident and emergency medicine waiting list. SvelteKit 2.x
