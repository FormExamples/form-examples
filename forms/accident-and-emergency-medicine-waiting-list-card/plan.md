# Plan: Accident and Emergency Medicine Waiting List Card
...
months later. The Accident and Emergency Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form accident-and-emergency-medicine-waiting-list-card`.
