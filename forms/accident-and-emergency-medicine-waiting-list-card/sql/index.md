# accident-and-emergency-medicine-waiting-list-card — sql
...
- `ae_medicine_waiting_list_card` — top-level waiting list card.
- `ae_medicine_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `ae_medicine_waiting_list_card_grade` — computed grading result.
- `ae_medicine_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `ae_medicine_waiting_list_card_grade_flag` — safety / operational flags fired
