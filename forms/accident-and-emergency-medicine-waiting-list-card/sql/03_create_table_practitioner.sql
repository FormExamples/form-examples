-- Practitioner who places the patient on a accident and emergency medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a accident and emergency medicine waiting list card on behalf of the patient.';
