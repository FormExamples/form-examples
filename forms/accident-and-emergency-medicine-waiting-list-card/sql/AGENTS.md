# Accident and Emergency Medicine Waiting List Card — PostgreSQL migrations
...
Child `ae_medicine_waiting_list_card_*` tables reference
`ae_medicine_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
