# Tasks: Accident and Emergency Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/accident-and-emergency-medicine-waiting-list-card/`.
...
- [x] `cargo loco new accident-and-emergency-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form accident-and-emergency-medicine-waiting-list-card` exits cleanly.
