# Accident and Emergency Medicine Waiting List Card — Agent Instructions

A practitioner-completed administrative card that places a patient on a
accident and emergency medicine waiting list and gives the patient a transparent view of their
