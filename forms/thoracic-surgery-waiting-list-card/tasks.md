# Tasks: Thoracic Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/thoracic-surgery-waiting-list-card/`.
...
- [x] `cargo loco new thoracic-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form thoracic-surgery-waiting-list-card` exits cleanly.
