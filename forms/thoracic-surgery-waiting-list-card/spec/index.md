# Thoracic Surgery Waiting List Card — specification
...
thoracic surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form thoracic-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check thoracic-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `thoracic-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `thoracic-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
