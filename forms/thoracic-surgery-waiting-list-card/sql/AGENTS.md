# Thoracic Surgery Waiting List Card — PostgreSQL migrations
...
Child `thoracic_surg_waiting_list_card_*` tables reference
`thoracic_surg_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
