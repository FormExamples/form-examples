-- Practitioner who places the patient on a thoracic surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a thoracic surgery waiting list card on behalf of the patient.';
