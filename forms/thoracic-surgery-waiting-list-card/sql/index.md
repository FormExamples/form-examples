# thoracic-surgery-waiting-list-card — sql
...
- `thoracic_surg_waiting_list_card` — top-level waiting list card.
- `thoracic_surg_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `thoracic_surg_waiting_list_card_grade` — computed grading result.
- `thoracic_surg_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `thoracic_surg_waiting_list_card_grade_flag` — safety / operational flags fired
