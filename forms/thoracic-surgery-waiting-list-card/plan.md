# Plan: Thoracic Surgery Waiting List Card
...
months later. The Thoracic Surgery Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form thoracic-surgery-waiting-list-card`.
