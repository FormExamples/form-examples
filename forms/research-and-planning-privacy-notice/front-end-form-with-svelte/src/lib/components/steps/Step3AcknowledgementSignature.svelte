...
<Fieldset legend="Step 3 — Opt-Out Preference, Acknowledgement & Signature">
  ...
  <Field label="Type 1 opt-out (from this practice)">
    <RadioGroup label="Type 1 opt-out">
      <label>
        <input
          type="radio"
          class="radio-input"
  ...
  <Field label="NHS National Data Opt-Out">
    <RadioGroup label="NHS National Data Opt-Out">
      <label>
        <input
          type="radio"
          class="radio-input"
  ...
  <Field label="Acknowledgement" required>
    <label class="ack-label">
      <CheckboxInput label="I confirm I have read and understood the notice" bind:checked={ack.agreed} />
