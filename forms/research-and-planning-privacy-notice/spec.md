...
- LocalStorage key `research-and-planning-privacy-notice.front-end-form-with-html.v1` (HTML) and
  `research-and-planning-privacy-notice.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
