# Research and Planning Privacy Notice — specification
...
- `bin/test-form research-and-planning-privacy-notice` exits cleanly.
...
- `bin/lily-html-refactor --check research-and-planning-privacy-notice` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `research-and-planning-privacy-notice.front-end-form-with-html.v1` (HTML)
  - `research-and-planning-privacy-notice.front-end-form-with-svelte.v1` (SvelteKit)
