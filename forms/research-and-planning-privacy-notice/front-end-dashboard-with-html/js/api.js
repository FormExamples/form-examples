// Backend API client for the Research and Planning Privacy Notice
// compliance dashboard.
//
// Mirrors the SvelteKit dashboard's `src/lib/api.ts` (forthcoming). The
// backend lives at http://localhost:5150 (Loco / axum); the dashboard
// endpoint returns a `DashboardPatientsResponse`. When the fetch fails
