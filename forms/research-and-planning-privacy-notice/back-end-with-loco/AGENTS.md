# Research and Planning Privacy Notice — Back-end with Rust Axum Loco (JSON API)

Pure JSON API back-end for the Research and Planning Privacy Notice form, built with axum + Loco +
...
- [`research_and_planning_privacy_notice/`](./research_and_planning_privacy_notice/) — the Loco crate: `src/research_and_planning_privacy_notice/` holds `app.rs`
...
`src/research_and_planning_privacy_notice/` also carries the form-specific scoring engine (types + a grader
...
```sh
cd research_and_planning_privacy_notice && cargo check --all-targets && cargo test
```
