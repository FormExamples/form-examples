//! Research and Planning Privacy Notice — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Research and Planning Privacy Notice** medical form, built on the
...
//!
//! ```
//! use research_and_planning_privacy_notice_loco_crate::engine::types::AssessmentData;
//!
