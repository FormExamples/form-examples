...
// `src/lib/engine/types.ts` data model for the Research and Planning
// Privacy Notice form.
//
 ...
 * @property {string} recipientNhsNumber
 * @property {string} recipientDob
 */

/**
 * @typedef {Object} AcknowledgementSignature
 * @property {boolean} agreed
 * @property {'opt-in' | 'opt-out' | ''} type1OptOut
 * @property {'opt-in' | 'opt-out' | ''} nationalDataOptOut
 ...
 * opt-out preferences default to `''` (un-selected).
