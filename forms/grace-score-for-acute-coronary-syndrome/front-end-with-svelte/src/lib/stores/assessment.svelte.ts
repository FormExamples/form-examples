...
function storageKey(id: string): string {
	return `grace-score-for-acute-coronary-syndrome.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank GRACE assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the GRACE assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.haemodynamics`) stay bound to live state.
	 */
