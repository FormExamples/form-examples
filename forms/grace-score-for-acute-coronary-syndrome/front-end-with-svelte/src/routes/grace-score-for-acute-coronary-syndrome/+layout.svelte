...
<svelte:head>
	<title>GRACE Score for Acute Coronary Syndrome</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/grace-score-for-acute-coronary-syndrome/" class="text-lg font-bold text-base-content">GRACE ACS</a>
			<div class="flex items-center gap-1">
				<a href="/grace-score-for-acute-coronary-syndrome/" class={navClass('/')}>Welcome</a>
				<a
					href="/grace-score-for-acute-coronary-syndrome/grace-scores-for-acute-coronary-syndrome/new"
					class={navClass('/grace-scores-for-acute-coronary-syndrome/new')}>New assessment</a
				>
				<a
					href="/grace-score-for-acute-coronary-syndrome/grace-scores-for-acute-coronary-syndrome"
					class={navClass('/grace-scores-for-acute-coronary-syndrome')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
