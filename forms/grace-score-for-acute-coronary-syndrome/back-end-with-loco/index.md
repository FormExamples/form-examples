...
Server-side Rust JSON API for the GRACE Score for Acute Coronary Syndrome form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`grace_score_for_acute_coronary_syndrome/`](grace_score_for_acute_coronary_syndrome/) — one migration, SeaORM
