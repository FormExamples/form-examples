...
function storageKey(id: string): string {
	return `ophthalmology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank ophthalmology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the ophthalmology assessment, with localStorage
