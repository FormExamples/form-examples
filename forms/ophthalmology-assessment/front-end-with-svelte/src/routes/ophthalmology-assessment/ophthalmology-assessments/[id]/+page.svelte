<script lang="ts">
	...
	function submit() {
		...
		goto(`/ophthalmology-assessment/ophthalmology-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New ophthalmology assessment' : `Ophthalmology assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the ten sections; the visual acuity grade and flagged issues are computed on submit.
	</p>
	...
	<Form label="Ophthalmology assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2ChiefComplaint />
		<Step3VisualAcuity />
		<Step4OcularHistory />
