# Ophthalmology Assessment — specification
...
- `bin/test-form ophthalmology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check ophthalmology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `ophthalmology-assessment.front-end-form-with-html.v1` (HTML)
  - `ophthalmology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
