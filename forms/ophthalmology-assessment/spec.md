...
- LocalStorage key `ophthalmology-assessment.front-end-form-with-html.v1` (HTML) and
  `ophthalmology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
