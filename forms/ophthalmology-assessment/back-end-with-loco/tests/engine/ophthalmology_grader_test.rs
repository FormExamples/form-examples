use ophthalmology_assessment_loco_crate::engine::ophthalmology_grader::calculate_impairment;
use ophthalmology_assessment_loco_crate::engine::ophthalmology_rules::all_rules;
use ophthalmology_assessment_loco_crate::engine::types::*;
