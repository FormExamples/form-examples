//! Ophthalmology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Ophthalmology Assessment** medical form, built on the
...
//!
//! ```
//! use ophthalmology_assessment_loco_crate::engine::types::AssessmentData;
//!
