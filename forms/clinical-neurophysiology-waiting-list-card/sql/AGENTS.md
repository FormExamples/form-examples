# Clinical Neurophysiology Waiting List Card — PostgreSQL migrations
...
Child `clin_neurophys_waiting_list_card_*` tables reference
`clin_neurophys_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
