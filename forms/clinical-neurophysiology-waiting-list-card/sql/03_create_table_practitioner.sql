-- Practitioner who places the patient on a clinical neurophysiology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a clinical neurophysiology waiting list card on behalf of the patient.';
