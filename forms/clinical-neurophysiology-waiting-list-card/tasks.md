# Tasks: Clinical Neurophysiology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/clinical-neurophysiology-waiting-list-card/`.
...
- [x] `cargo loco new clinical-neurophysiology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form clinical-neurophysiology-waiting-list-card` exits cleanly.
