# Plan: Clinical Neurophysiology Waiting List Card
...
months later. The Clinical Neurophysiology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form clinical-neurophysiology-waiting-list-card`.
