# Clinical Neurophysiology Waiting List Card — specification
...
clinical neurophysiology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form clinical-neurophysiology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check clinical-neurophysiology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `clinical-neurophysiology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `clinical-neurophysiology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
