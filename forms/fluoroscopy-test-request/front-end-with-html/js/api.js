// Backend API client for the fluoroscopy / contrast-study vetting dashboard.
//
...
window.FluoroscopyTestRequestDashboard.fetchRequests = fetchRequests;
window.FluoroscopyTestRequestDashboard.API_BASE = API_BASE;
})();
