...
<svelte:head>
	<title>Fluoroscopy Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/fluoroscopy-test-request/" class="text-lg font-bold text-base-content">Fluoroscopy Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/fluoroscopy-test-request/" class={navClass('/')}>Welcome</a>
				<a href="/fluoroscopy-test-request/fluoroscopy-test-requests/new" class={navClass('/fluoroscopy-test-requests/new')}>
					New request
				</a>
				<a href="/fluoroscopy-test-request/fluoroscopy-test-requests" class={navClass('/fluoroscopy-test-requests')}>
					Vetting dashboard
				</a>
