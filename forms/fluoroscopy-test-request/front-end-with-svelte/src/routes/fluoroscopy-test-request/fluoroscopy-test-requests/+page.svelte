<script lang="ts">
	...
	function init(api: {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/fluoroscopy-test-request/fluoroscopy-test-requests/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/fluoroscopy-test-request/fluoroscopy-test-requests/new" class="button" data-variant="primary">New request</a>
	</div>
