<script lang="ts">
	...
	import Step4SafetyAndRadiation from '#lib/components/steps/Step4SafetyAndRadiation.svelte';
	...
	function submit() {
		...
		goto(`/fluoroscopy-test-request/fluoroscopy-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New fluoroscopy request' : `Fluoroscopy request ${id}`}
	</h1>
