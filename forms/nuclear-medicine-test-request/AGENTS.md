# Nuclear Medicine Test Request — agent instructions

Nuclear medicine (radionuclide imaging) request (referral). A clinician
completes a single-page wizard; the engine computes a **four-axis grading**
(appropriateness, preparation & radiation safety, request completeness, triage
...
front-end and the back-end. Confirmed / possible pregnancy and breastfeeding
with a long-retention radiopharmaceutical drive the prep-safety band toward
caution / contraindicated; high-acuity indications auto-escalate the triage
tier. Choose the least-alarming band only when no rule fires.
