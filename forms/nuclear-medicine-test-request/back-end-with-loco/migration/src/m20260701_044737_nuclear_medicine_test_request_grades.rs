...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "nuclear_medicine_test_request_grades",
            &[
            ...
            ("prep_safety_band", ColType::StringWithDefault(String::new())),
            ("radiation_dose_band", ColType::StringWithDefault(String::new())),
            ...
            &[
            ("nuclear_medicine_test_request", ""),
            ]
        ).await
    }

    async fn down(&self, m: &SchemaManager) -> Result<(), DbErr> {
        drop_table(m, "nuclear_medicine_test_request_grades").await
    }
}
