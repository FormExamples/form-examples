...
<Fieldset legend="Requesting clinician">
	...
	<div class="field-grid">
		...
		<Field label="Supervising consultant" inputId="clinicianSupervisingConsultant">
			<TextInput id="clinicianSupervisingConsultant" label="Supervising consultant" bind:value={d.supervisingConsultant} />
		</Field>
	</div>
