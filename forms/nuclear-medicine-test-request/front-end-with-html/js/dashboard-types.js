// Plain-JavaScript / JSDoc type definitions for the nuclear medicine vetting
// dashboard.
//
...
/**
 * Preparation & radiation-safety band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'contraindicated'} PrepSafetyBand
 */

/**
 * Radiation effective-dose band emitted by Axis B.
 ...
 * @property {PrepSafetyBand} prepSafetyBand - Axis B preparation & safety band
 * @property {RadiationDoseBand} radiationDoseBand - Axis B effective-dose band
...
// before they read `window.NuclearMedicineTestRequestDashboard`.
})();
