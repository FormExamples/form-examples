// Backend API client for the nuclear medicine vetting dashboard.
//
...
window.NuclearMedicineTestRequestDashboard.fetchRequests = fetchRequests;
window.NuclearMedicineTestRequestDashboard.API_BASE = API_BASE;
})();
