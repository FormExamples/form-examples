//! Provider Transfer Request — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Provider Transfer Request** medical form, built on the
...
//!
//! ```
//! use provider_transfer_request_loco_crate::engine::types::AssessmentData;
//!
