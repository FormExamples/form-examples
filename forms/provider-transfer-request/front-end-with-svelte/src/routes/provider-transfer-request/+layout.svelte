...
<svelte:head>
	<title>Provider Transfer Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/provider-transfer-request/" class="text-lg font-bold text-base-content">Provider Transfer Request</a>
			<div class="flex items-center gap-1">
				<a href="/provider-transfer-request/" class={navClass('/')}>Welcome</a>
				<a href="/provider-transfer-request/provider-transfer-requests/new" class={navClass('/provider-transfer-requests/new')}>New transfer</a>
				<a href="/provider-transfer-request/provider-transfer-requests" class={navClass('/provider-transfer-requests')}>Dashboard</a>
