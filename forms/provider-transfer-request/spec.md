...
- LocalStorage key `provider-transfer-request.front-end-form-with-html.v1` (HTML) and
  `provider-transfer-request.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
