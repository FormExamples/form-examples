# Provider Transfer Request — specification
...
- `bin/test-form provider-transfer-request` exits cleanly.
...
- `bin/lily-html-refactor --check provider-transfer-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `provider-transfer-request.front-end-form-with-html.v1` (HTML)
  - `provider-transfer-request.front-end-form-with-svelte.v1` (SvelteKit)
