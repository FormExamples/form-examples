...
Server-side Rust JSON API for the Epilepsy Annual Review form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`epilepsy_review/`](epilepsy_review/) — one migration, SeaORM
