...
<svelte:head>
	<title>Epilepsy Annual Review</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/epilepsy-review/" class="text-lg font-bold text-base-content">Epilepsy review</a>
			<div class="flex items-center gap-1">
				<a href="/epilepsy-review/" class={navClass('/')}>Welcome</a>
				<a href="/epilepsy-review/epilepsy-reviews/new" class={navClass('/epilepsy-reviews/new')}>New review</a>
				<a href="/epilepsy-review/epilepsy-reviews" class={navClass('/epilepsy-reviews')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
