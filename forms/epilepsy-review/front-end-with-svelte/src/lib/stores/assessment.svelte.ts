...
function storageKey(id: string): string {
	return `epilepsy-review.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank epilepsy review with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the epilepsy review, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const s = assessment.data.seizures`) stay bound to live state.
	 */
