...
Server-side Rust JSON API for the Waterlow Pressure Ulcer Risk Assessment form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`waterlow_pressure_ulcer_risk_assessment/`](waterlow_pressure_ulcer_risk_assessment/) — one migration, SeaORM
