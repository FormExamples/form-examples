...
function storageKey(id: string): string {
	return `waterlow-pressure-ulcer-risk-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Waterlow assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Waterlow assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const c = assessment.data.core`) stay bound to live state.
	 */
