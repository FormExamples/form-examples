# Changelog — UK NHS England Medical Exemption Certificate (FP92A)
...
file only records changes scoped to the **UK NHS England Medical Exemption Certificate (FP92A)** form.
