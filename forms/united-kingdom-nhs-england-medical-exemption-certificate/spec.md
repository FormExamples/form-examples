# UK NHS England Medical Exemption Certificate (FP92A) — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (10 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form united-kingdom-nhs-england-medical-exemption-certificate` exits cleanly.
...
- `bin/lily-html-refactor --check united-kingdom-nhs-england-medical-exemption-certificate` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-nhs-england-medical-exemption-certificate.front-end-form-with-html.v1` (HTML)
  - `united-kingdom-nhs-england-medical-exemption-certificate.front-end-form-with-svelte.v1` (SvelteKit)
