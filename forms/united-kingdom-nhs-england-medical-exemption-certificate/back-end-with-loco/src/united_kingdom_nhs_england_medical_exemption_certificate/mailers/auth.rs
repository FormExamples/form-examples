...
static welcome: Dir<'_> = include_dir!("src/united_kingdom_nhs_england_medical_exemption_certificate/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/united_kingdom_nhs_england_medical_exemption_certificate/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/united_kingdom_nhs_england_medical_exemption_certificate/mailers/auth/magic_link");
