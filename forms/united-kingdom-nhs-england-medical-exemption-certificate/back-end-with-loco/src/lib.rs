//! United Kingdom NHS England Medical Exemption Certificate — Loco JSON API back-end.
//!
//! Server-side JSON API for the **United Kingdom NHS England Medical Exemption Certificate** medical form, built on the
