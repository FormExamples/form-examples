# United Kingdom NHS England Medical Exemption Certificate: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the United Kingdom NHS England Medical Exemption Certificate form. Pure back-end: no HTML
