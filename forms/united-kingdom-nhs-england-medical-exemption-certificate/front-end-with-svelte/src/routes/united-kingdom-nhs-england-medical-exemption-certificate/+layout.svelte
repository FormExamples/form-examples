...
<svelte:head>
	<title>UK NHS England Medical Exemption Certificate</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-nhs-england-medical-exemption-certificate/" class="text-lg font-bold text-base-content">UK NHS England Medical Exemption Certificate</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-nhs-england-medical-exemption-certificate/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-nhs-england-medical-exemption-certificate/{plural}/new" class={navClass(`/${plural}/new`)}>New application</a>
				<a href="/united-kingdom-nhs-england-medical-exemption-certificate/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
