...
Server-side Rust JSON API for the Diabetic Eye Screening record form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`diabetic_eye_screening/`](diabetic_eye_screening/) — one migration, SeaORM
