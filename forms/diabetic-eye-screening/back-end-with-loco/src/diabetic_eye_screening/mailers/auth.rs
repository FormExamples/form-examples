...
static welcome: Dir<'_> = include_dir!("src/diabetic_eye_screening/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/diabetic_eye_screening/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/diabetic_eye_screening/mailers/auth/magic_link");
