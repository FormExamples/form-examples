...
function storageKey(id: string): string {
	return `diabetic-eye-screening.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank diabetic-eye-screening record with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the diabetic-eye-screening record, with
