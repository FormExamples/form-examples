...
import { calculateGrade } from './diabetic-eye-grader';
...
describe('diabetic-eye-screening worst-eye derivation', () => {
...
describe('diabetic-eye-screening classification engine', () => {
...
describe('diabetic-eye-screening flagged-issue detection', () => {
