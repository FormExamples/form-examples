//! Asthma Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Asthma Assessment** medical form, built on the
...
//!
//! ```
//! use asthma_assessment_loco_crate::engine::types::AssessmentData;
//!
