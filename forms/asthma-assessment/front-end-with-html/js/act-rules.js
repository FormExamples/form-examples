...
//
// Each rule maps a single 5-option response to a score of 1-5. The ACT total
// is the sum of all 5 questions (range 5-25). Unanswered items are returned
// as 0 by the rule and excluded from the total by the grader.
//
// ACT-001: Activity limitation (Q1)
// ACT-002: Shortness of breath frequency (Q2)
// ACT-003: Nighttime / early morning awakening (Q3)
...
const actRules = [
  {
    ...
    evaluate: (d) => {
      switch (d.symptomFrequency.activityLimitation) {
        case 'not-at-all': return 5;
        case 'a-little': return 4;
        case 'somewhat': return 3;
        case 'a-lot': return 2;
        case 'extremely': return 1;
        default: return 0;
      }
    }
  },
  {
    ...
    evaluate: (d) => {
      switch (d.symptomFrequency.daytimeSymptoms) {
        case 'not-at-all': return 5;
        case 'once-or-twice': return 4;
        case 'three-to-six': return 3;
        case 'once-a-day': return 2;
        case 'more-than-once-a-day': return 1;
        default: return 0;
      }
    }
  },
  {
    ...
    evaluate: (d) => {
      switch (d.symptomFrequency.nighttimeAwakening) {
        case 'not-at-all': return 5;
        case 'once-or-twice': return 4;
        case 'once-a-week': return 3;
        case 'two-to-three-nights': return 2;
        case 'four-or-more-nights': return 1;
        default: return 0;
      }
    }
  },
  {
    ...
    evaluate: (d) => {
      switch (d.symptomFrequency.rescueInhalerUse) {
        ...
        case 'three-to-six': return 3;
        case 'once-a-day': return 2;
        case 'two-or-more-times-a-day': return 1;
        default: return 0;
      }
    }
  },
  {
    ...
    evaluate: (d) => {
      switch (d.symptomFrequency.selfRatedControl) {
        case 'completely-controlled': return 5;
        case 'well-controlled': return 4;
        case 'somewhat-controlled': return 3;
        case 'poorly-controlled': return 2;
        case 'not-controlled-at-all': return 1;
        default: return 0;
      }
    }
  }
