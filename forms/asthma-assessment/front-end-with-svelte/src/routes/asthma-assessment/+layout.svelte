...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/asthma-assessment/"
                class="text-lg font-bold text-base-content">Asthma Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/asthma-assessment/" class={navClass("/")}>Welcome</a>
                <a
                    href="/asthma-assessment/asthma-assessments/new"
                    class={navClass("/asthma-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/asthma-assessment/asthma-assessments"
                    class={navClass("/asthma-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
