<script lang="ts">
	const plural = 'asthma-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/asthma-assessment/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed ACT score and asthma control level.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the ACT scoring engine, and the
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the Asthma Control Test (ACT), a validated 5-item instrument scored 5–25.
				</dd>
			</div>
		</dl>
	</section>
