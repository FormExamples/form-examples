# Asthma Assessment — specification
...
- `bin/test-form asthma-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check asthma-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `asthma-assessment.front-end-form-with-html.v1` (HTML)
  - `asthma-assessment.front-end-form-with-svelte.v1` (SvelteKit)
