// Patient Intake risk classification rules.
//
// Each rule evaluates patient data and returns true if the condition is
// present. The overall risk level is determined by the highest-level rule
// that fires; `low` is the default when no rules fire (healthy patient
// with minimal complexity).
//
// Mirrors `src/lib/engine/intake-rules.ts` from the SvelteKit reference.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {import('./types.js').RiskLevel} RiskLevel
 *
 * @typedef {Object} IntakeRule
 * @property {string} id
