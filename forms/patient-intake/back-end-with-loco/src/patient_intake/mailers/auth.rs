...
static welcome: Dir<'_> = include_dir!("src/patient_intake/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/patient_intake/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/patient_intake/mailers/auth/magic_link");
