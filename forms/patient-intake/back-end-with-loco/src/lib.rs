//! Patient Intake — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Patient Intake** medical form, built on the
...
//!
//! ```
//! use patient_intake_loco_crate::engine::types::AssessmentData;
//!
