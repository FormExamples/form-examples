...
- `bin/test-form patient-intake` exits cleanly.
...
- `bin/lily-html-refactor --check patient-intake` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `patient-intake.front-end-form-with-html.v1` (HTML)
  - `patient-intake.front-end-form-with-svelte.v1` (SvelteKit)
