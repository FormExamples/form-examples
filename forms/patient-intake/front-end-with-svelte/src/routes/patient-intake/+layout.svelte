...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/patient-intake/" class="text-lg font-bold text-base-content">Patient Intake</a>
			<div class="flex items-center gap-1">
				<a href="/patient-intake/" class={navClass('/')}>Welcome</a>
				<a href="/patient-intake/patient-intakes/new" class={navClass('/patient-intakes/new')}>New intake</a>
				<a href="/patient-intake/patient-intakes" class={navClass('/patient-intakes')}>Dashboard</a>
