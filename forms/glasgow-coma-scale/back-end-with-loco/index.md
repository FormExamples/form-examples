...
Server-side Rust JSON API for the Glasgow Coma Scale form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`glasgow_coma_scale/`](glasgow_coma_scale/) — one migration, SeaORM
