...
static welcome: Dir<'_> = include_dir!("src/glasgow_coma_scale/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/glasgow_coma_scale/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/glasgow_coma_scale/mailers/auth/magic_link");
