...
<svelte:head>
	<title>Glasgow Coma Scale (GCS)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/glasgow-coma-scale/" class="text-lg font-bold text-base-content">GCS</a>
			<div class="flex items-center gap-1">
				<a href="/glasgow-coma-scale/" class={navClass('/')}>Welcome</a>
				<a
					href="/glasgow-coma-scale/glasgow-coma-scales/new"
					class={navClass('/glasgow-coma-scales/new')}>New assessment</a
				>
				<a
					href="/glasgow-coma-scale/glasgow-coma-scales"
					class={navClass('/glasgow-coma-scales')}>Dashboard</a
				>
