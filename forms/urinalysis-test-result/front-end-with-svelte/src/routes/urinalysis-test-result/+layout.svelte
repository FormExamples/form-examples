...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/urinalysis-test-result/"
                class="text-lg font-bold text-base-content"
                >Urinalysis Test Result</a
            >
            <div class="flex items-center gap-1">
                <a href="/urinalysis-test-result/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/urinalysis-test-result/report"
                    class={navClass("/report")}>New report</a
                >
                <a
                    href="/urinalysis-test-result/reports"
