<script lang="ts">
	...
	import Step3Dipstick from '$lib/components/steps/Step3Dipstick.svelte';
	import Step4Microscopy from '$lib/components/steps/Step4Microscopy.svelte';
	import Step5Culture from '$lib/components/steps/Step5Culture.svelte';
	import Step6Interpretation from '$lib/components/steps/Step6Interpretation.svelte';
	...
	function submit() {
		...
		goto('/urinalysis-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New urinalysis report</h1>
	...
	<Form label="Urinalysis test result" onsubmit={submit}>
