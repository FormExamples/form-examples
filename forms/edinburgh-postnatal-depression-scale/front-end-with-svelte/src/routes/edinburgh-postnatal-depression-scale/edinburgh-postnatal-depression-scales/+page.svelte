<script lang="ts">
	...
	import { bandLabel, careSettingLabel } from '#lib/engine/utils.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/edinburgh-postnatal-depression-scale/edinburgh-postnatal-depression-scales/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/edinburgh-postnatal-depression-scale/edinburgh-postnatal-depression-scales/new" class="button" data-variant="primary"
			>New assessment</a
		>
	</div>
