...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/edinburgh-postnatal-depression-scale/" class="text-lg font-bold text-base-content">EPDS</a>
			<div class="flex items-center gap-1">
				<a href="/edinburgh-postnatal-depression-scale/" class={navClass('/')}>Welcome</a>
				<a
					href="/edinburgh-postnatal-depression-scale/edinburgh-postnatal-depression-scales/new"
					class={navClass('/edinburgh-postnatal-depression-scales/new')}>New assessment</a
				>
				<a
					href="/edinburgh-postnatal-depression-scale/edinburgh-postnatal-depression-scales"
					class={navClass('/edinburgh-postnatal-depression-scales')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
