...
function storageKey(id: string): string {
	return `edinburgh-postnatal-depression-scale.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank EPDS assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the EPDS assessment, with localStorage
