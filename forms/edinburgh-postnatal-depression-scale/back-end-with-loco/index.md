...
Server-side Rust JSON API for the Edinburgh Postnatal Depression Scale (EPDS) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`edinburgh_postnatal_depression_scale/`](edinburgh_postnatal_depression_scale/) — one migration, SeaORM
