# Plan: Psychiatry Waiting List Card
...
months later. The Psychiatry Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form psychiatry-waiting-list-card`.
