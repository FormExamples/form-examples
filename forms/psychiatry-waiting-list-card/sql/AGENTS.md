# Psychiatry Waiting List Card — PostgreSQL migrations
...
Child `psychiatry_waiting_list_card_*` tables reference
`psychiatry_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
