# psychiatry-waiting-list-card — sql
...
- `psychiatry_waiting_list_card` — top-level waiting list card.
- `psychiatry_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `psychiatry_waiting_list_card_grade` — computed grading result.
- `psychiatry_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `psychiatry_waiting_list_card_grade_flag` — safety / operational flags fired
