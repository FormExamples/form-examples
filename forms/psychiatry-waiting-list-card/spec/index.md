# Psychiatry Waiting List Card — specification
...
psychiatry waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form psychiatry-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check psychiatry-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `psychiatry-waiting-list-card.front-end-with-html.v1` (HTML)
  - `psychiatry-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
