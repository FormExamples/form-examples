# Prescription Request — specification
...
- `bin/test-form prescription-request` exits cleanly.
...
- `bin/lily-html-refactor --check prescription-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `prescription-request.front-end-form-with-html.v1` (HTML)
  - `prescription-request.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form prescription-request
```
