//! Prescription Request — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Prescription Request** medical form, built on the
...
//!
//! ```
//! use prescription_request_loco_crate::engine::types::AssessmentData;
//!
