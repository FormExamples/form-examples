...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/prescription-request/" class="text-lg font-bold text-base-content">Prescription Request</a>
			<div class="flex items-center gap-1">
				<a href="/prescription-request/" class={navClass('/')}>Welcome</a>
				<a href="/prescription-request/prescription-requests/new" class={navClass('/prescription-requests/new')}>New request</a>
				<a href="/prescription-request/prescription-requests" class={navClass('/prescription-requests')}>Dashboard</a>
