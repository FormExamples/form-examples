...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/corrected-calcium-calculator/"
                class="text-lg font-bold text-base-content">Corrected calcium</a
            >
            <div class="flex items-center gap-1">
                <a href="/corrected-calcium-calculator/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/corrected-calcium-calculator/corrected-calcium-calculators/new"
                    class={navClass("/corrected-calcium-calculators/new")}
                    >New calculation</a
                >
                <a
                    href="/corrected-calcium-calculator/corrected-calcium-calculators"
                    class={navClass("/corrected-calcium-calculators")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
