...
function storageKey(id: string): string {
	return `corrected-calcium-calculator.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank corrected-calcium assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the corrected-calcium assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.calcium`) stay bound to live state.
	 */
