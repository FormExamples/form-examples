...
<Fieldset legend="Step 1 of 6 — Assessment context">
	<p class="hint">Who is interpreting the result, when, where, and the laboratory sample reference.</p>
	...
	<Field label="Laboratory sample reference" inputId="context-sampleReference">
		<TextInput
			id="context-sampleReference"
			label="Laboratory sample reference"
			placeholder="e.g. LAB-100482-S1"
			bind:value={c.sampleReference}
		/>
	</Field>
</Fieldset>
