# Corrected Calcium Calculator: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Corrected Calcium Calculator form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`corrected_calcium_calculator/`](corrected_calcium_calculator/) — one migration, SeaORM
