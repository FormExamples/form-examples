...
- LocalStorage key `pulmonology-assessment.front-end-form-with-html.v1` (HTML) and
  `pulmonology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
