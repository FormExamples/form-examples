# Pulmonology Assessment — specification
...
- `bin/test-form pulmonology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check pulmonology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `pulmonology-assessment.front-end-form-with-html.v1` (HTML)
  - `pulmonology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
