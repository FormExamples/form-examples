//! Pulmonology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Pulmonology Assessment** medical form, built on the
...
//!
//! ```
//! use pulmonology_assessment_loco_crate::engine::types::AssessmentData;
//!
