// GOLD COPD staging rules.
//
// Each rule evaluates the assessment data and returns true if its condition
// is present. The final GOLD stage is the maximum stage among all firing
// rules; if no rules fire we default to GOLD I (mild).
//
// Mirrors `src/lib/engine/gold-rules.ts` from the SvelteKit reference.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {import('./types.js').GoldStage} GoldStage
 *
 * @typedef {Object} GoldRule
 * @property {string} id
