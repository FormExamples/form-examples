...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/pulmonology-assessment/"
                class="text-lg font-bold text-base-content"
                >Pulmonology Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/pulmonology-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/pulmonology-assessment/pulmonology-assessments/new"
                    class={navClass("/pulmonology-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/pulmonology-assessment/pulmonology-assessments"
                    class={navClass("/pulmonology-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
