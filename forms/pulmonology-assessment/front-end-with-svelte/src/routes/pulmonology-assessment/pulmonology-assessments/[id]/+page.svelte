<script lang="ts">
	...
	import { gradeAssessment } from '#lib/engine/gold-grader.js';
	...
	function submit() {
		...
		goto(`/pulmonology-assessment/pulmonology-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New pulmonology assessment' : `Pulmonology assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the ten sections; the GOLD stage and ABCD group are computed on submit.
	</p>
	...
	<Form label="Pulmonology assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2ChiefComplaint />
		<Step3Spirometry />
		...
		<div class="button-group">
			<Button type="submit" data-variant="primary">Compute stage &amp; view report</Button>
