...
function storageKey(id: string): string {
	return `pulmonology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank pulmonology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the pulmonology assessment, with localStorage
