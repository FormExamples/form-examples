...
export const SOAP_SECTIONS: { section: string; label: string }[] = [
...
export function sectionStatuses(presence: SectionPresence): SectionStatus[] {
 ...
 */
export function calculateSoapGrade(data: AssessmentData): GradingResult {
