...
/**
 * Care setting where the encounter was documented.
 *
 * @typedef {'general-practice' | 'outpatient' | 'ward' | 'emergency-department' | 'community' | 'telehealth' | 'other'} CareSetting
 */

/**
 * SOAP-note row displayed in the clinician dashboard.
 *
 * Mirrors `NoteRow` in
 * `forms/soap-note/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {CareSetting} careSetting           - where the encounter was documented
 ...
 * @property {string} encounteredAt              - ISO date of the encounter (yyyy-mm-dd)
 */
...
// namespace, `window.SoapNoteDashboard`.

// No runtime exports; types are JSDoc-only. Touch the namespace so this file
// is unambiguously side-effecting and other files can rely on it loading
// before they read `window.SoapNoteDashboard`.
