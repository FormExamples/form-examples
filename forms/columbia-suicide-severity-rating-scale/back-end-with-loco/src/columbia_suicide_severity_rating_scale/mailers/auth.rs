...
static welcome: Dir<'_> = include_dir!("src/columbia_suicide_severity_rating_scale/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/columbia_suicide_severity_rating_scale/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/columbia_suicide_severity_rating_scale/mailers/auth/magic_link");
