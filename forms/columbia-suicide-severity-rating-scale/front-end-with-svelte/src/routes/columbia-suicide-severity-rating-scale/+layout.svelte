...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/columbia-suicide-severity-rating-scale/" class="text-lg font-bold text-base-content">C-SSRS</a>
			<div class="flex items-center gap-1">
				<a href="/columbia-suicide-severity-rating-scale/" class={navClass('/')}>Welcome</a>
				<a
					href="/columbia-suicide-severity-rating-scale/columbia-suicide-severity-rating-scales/new"
					class={navClass('/columbia-suicide-severity-rating-scales/new')}>New assessment</a
				>
				<a
					href="/columbia-suicide-severity-rating-scale/columbia-suicide-severity-rating-scales"
					class={navClass('/columbia-suicide-severity-rating-scales')}>Dashboard</a
				>
