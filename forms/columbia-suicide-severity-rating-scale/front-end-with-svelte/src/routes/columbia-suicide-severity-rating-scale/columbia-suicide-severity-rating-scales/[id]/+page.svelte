<script lang="ts">
	...
	import { calculateCssrsGrade } from '#lib/engine/cssrs-grader.js';
	...
	function submit() {
		...
		goto(`/columbia-suicide-severity-rating-scale/columbia-suicide-severity-rating-scales/${id}/report`);
	}
