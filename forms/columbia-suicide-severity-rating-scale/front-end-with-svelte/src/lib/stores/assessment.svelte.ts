...
function storageKey(id: string): string {
	return `columbia-suicide-severity-rating-scale.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank C-SSRS assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the C-SSRS assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.ideation`) stay bound to live state.
	 */
