...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/post-traumatic-stress-assessment/"
                class="text-lg font-bold text-base-content"
                >Post-Traumatic Stress Assessment</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/post-traumatic-stress-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/post-traumatic-stress-assessment/post-traumatic-stress-assessments"
                    class={navClass("/post-traumatic-stress-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
