...
function storageKey(id: string): string {
	return `post-traumatic-stress-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank PCL-5 assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the PCL-5 assessment, with localStorage
