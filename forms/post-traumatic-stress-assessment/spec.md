# Post-Traumatic Stress Assessment — specification
...
- `bin/test-form post-traumatic-stress-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check post-traumatic-stress-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `post-traumatic-stress-assessment.front-end-form-with-html.v1` (HTML)
  - `post-traumatic-stress-assessment.front-end-form-with-svelte.v1` (SvelteKit)
