...
- LocalStorage key `post-traumatic-stress-assessment.front-end-form-with-html.v1` (HTML) and
  `post-traumatic-stress-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
