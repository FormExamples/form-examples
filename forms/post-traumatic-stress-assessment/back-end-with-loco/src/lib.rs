//! Post Traumatic Stress Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Post Traumatic Stress Assessment** medical form, built on the
...
//!
//! ```
//! use post_traumatic_stress_assessment_loco_crate::engine::types::AssessmentData;
//!
