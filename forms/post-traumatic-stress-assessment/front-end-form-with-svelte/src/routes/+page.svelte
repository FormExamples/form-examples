...
<div class="min-h-screen bg-gray-50">
	...
	<main class="mx-auto max-w-2xl px-4 py-8">
		...
		{:else}
			<Form label="Post-Traumatic Stress Assessment" onsubmit={submitForm}>
				<Step1Demographics />
				...
				<div class="button-group">
					<Button type="submit" data-variant="primary">Calculate PCL-5 Score</Button>
				</div>
			</Form>
