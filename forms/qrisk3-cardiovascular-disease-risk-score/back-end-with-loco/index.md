...
Server-side Rust JSON API for the QRISK3 Cardiovascular Disease Risk Score form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`qrisk3_cardiovascular_disease_risk_score/`](qrisk3_cardiovascular_disease_risk_score/) — one migration, SeaORM
