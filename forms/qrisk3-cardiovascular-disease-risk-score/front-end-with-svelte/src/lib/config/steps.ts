...
export const steps: StepConfig[] = [
	...
	{ number: 4, title: 'Lifestyle', shortTitle: 'Lifestyle', section: 'lifestyle' },
	{
		number: 5,
		title: 'Cardiometabolic measurements',
		shortTitle: 'Cardiometabolic',
		section: 'cardiometabolic'
	},
	{ number: 6, title: 'Comorbidity history', shortTitle: 'Comorbidities', section: 'comorbidities' },
	{ number: 7, title: 'Medication', shortTitle: 'Medication', section: 'medication' },
	{ number: 8, title: 'Summary and score', shortTitle: 'Summary', section: 'note' }
];

export function getVisibleSteps(_data: AssessmentData): StepConfig[] {
	// All steps are always visible in the QRISK3 assessment.
	return steps;
}
