...
function storageKey(id: string): string {
	return `qrisk3-cardiovascular-disease-risk-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank QRISK3 assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the QRISK3 assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.lifestyle`) stay bound to live state.
	 */
