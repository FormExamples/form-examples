...
static welcome: Dir<'_> = include_dir!("src/has_bled_score_for_major_bleeding_risk/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/has_bled_score_for_major_bleeding_risk/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/has_bled_score_for_major_bleeding_risk/mailers/auth/magic_link");
