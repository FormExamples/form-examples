...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/has-bled-score-for-major-bleeding-risk/"
                class="text-lg font-bold text-base-content">HAS-BLED</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(
                        "/has-bled-score-for-major-bleeding-risks/new",
                    )}>New assessment</a
                >
                <a
                    href="/has-bled-score-for-major-bleeding-risk/has-bled-score-for-major-bleeding-risks"
                    class={navClass("/has-bled-score-for-major-bleeding-risks")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
