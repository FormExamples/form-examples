...
<svelte:head>
	<title>HAS-BLED Score for Major Bleeding Risk</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/has-bled-score-for-major-bleeding-risk/" class="text-lg font-bold text-base-content">HAS-BLED</a>
			<div class="flex items-center gap-1">
				<a href="/has-bled-score-for-major-bleeding-risk/" class={navClass('/')}>Welcome</a>
				<a
					href="/has-bled-score-for-major-bleeding-risk/has-bled-score-for-major-bleeding-risks/new"
					class={navClass('/has-bled-score-for-major-bleeding-risks/new')}>New assessment</a
				>
				<a
					href="/has-bled-score-for-major-bleeding-risk/has-bled-score-for-major-bleeding-risks"
					class={navClass('/has-bled-score-for-major-bleeding-risks')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
