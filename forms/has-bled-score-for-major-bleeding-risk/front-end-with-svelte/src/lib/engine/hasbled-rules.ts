import type { HasBledRule } from './types';
 ...
 * positive; the grader (`hasbled-grader.ts`) sums the points into the total
 * HAS-BLED score (0-9) and derives the risk band. Rows mirror the
 * `has_bled_score_for_major_bleeding_risk_grade_rule` SQL table.
 */
export const hasBledRules: HasBledRule[] = [
	// ─── H: HYPERTENSION ─────────────────────────────────────────
	{
	...
	// ─── A: ABNORMAL RENAL FUNCTION ──────────────────────────────
	{
		...
		category: 'has-bled-criterion',
		description:
			'Abnormal renal function — dialysis, transplant, or serum creatinine >= 200 umol/L',
	...
	// ─── A: ABNORMAL LIVER FUNCTION ──────────────────────────────
	{
		...
		category: 'has-bled-criterion',
		description:
			'Abnormal liver function — chronic hepatic disease (e.g. cirrhosis) or bilirubin > 2x ULN with AST/ALT/ALP > 3x ULN',
	...
	// ─── B: BLEEDING HISTORY OR PREDISPOSITION ───────────────────
	{
		...
		category: 'has-bled-criterion',
		description:
			'Bleeding history or predisposition — prior major bleeding, bleeding diathesis, or anaemia',
	...
	// ─── E: ELDERLY (derived from age) ───────────────────────────
	{
		...
		evaluate: (d) => d.identification.ageYears !== null && d.identification.ageYears > 65
	},
	...
	// ─── D: ALCOHOL ──────────────────────────────────────────────
	{
		...
		evaluate: (d) =>
			d.drugsAlcohol.alcoholUnitsPerWeek !== null && d.drugsAlcohol.alcoholUnitsPerWeek >= 8
	}
];
