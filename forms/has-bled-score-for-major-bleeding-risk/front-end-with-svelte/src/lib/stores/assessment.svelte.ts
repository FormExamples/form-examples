...
function storageKey(id: string): string {
	return `has-bled-score-for-major-bleeding-risk.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank HAS-BLED assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the HAS-BLED assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.hypertension`) stay bound to live state.
	 */
