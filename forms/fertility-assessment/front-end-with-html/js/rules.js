...
// condition is met. The grader sums fired rules to derive a Low / Moderate
// / High concern level. Rules cover: maternal age, duration trying,
// cycle regularity, ovarian reserve (AMH, AFC, FSH), prior pregnancy
// outcomes, BMI extremes, partner semen analysis (WHO 2021), known tubal
// or uterine factors, and partner age.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} FertilityRule
 * @property {string} id
...
const fertilityRules = [
  // ─── Age ───────────────────────────────────────────────────
  {
    ...
    weight: 2,
    evaluate: (d) => {
      const age = ageInYears(d.demographics.patientDateOfBirth);
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => {
      const partnerDob = d.demographics.partnerDateOfBirth;
      const direct = d.partnerSemen.partnerAgeYears;
      const age = direct ?? ageInYears(partnerDob);
  ...
  // ─── Duration trying ──────────────────────────────────────
  {
    ...
    weight: 1,
    evaluate: (d) => d.reproductiveHistory.durationTryingMonths !== null &&
  ...
  },
  {
    ...
    evaluate: (d) => {
      const age = ageInYears(d.demographics.patientDateOfBirth);
      return d.reproductiveHistory.durationTryingMonths !== null &&
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => d.menstrualCycle.cycleLengthDays !== null &&
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => d.hormoneProfile.amh !== null &&
      d.hormoneProfile.amh >= 5.4 && d.hormoneProfile.amh < 15.0
  },
  {
    id: 'FERT-OR-003',
    category: 'Ovarian Reserve',
  ...
  },
  {
    ...
    weight: 2,
    evaluate: (d) => d.investigations.antralFollicleCount !== null &&
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => d.hormoneProfile.tsh !== null &&
  ...
  },
  {
    ...
    weight: 2,
    evaluate: (d) => d.hormoneProfile.progesteroneDay21 !== null &&
  ...
  // ─── Reproductive history ─────────────────────────────────
  {
    ...
    weight: 2,
    evaluate: (d) => d.reproductiveHistory.priorMiscarriages !== null &&
  ...
  },
  {
    ...
    weight: 2,
    evaluate: (d) => d.reproductiveHistory.priorEctopic !== null &&
      d.reproductiveHistory.priorEctopic >= 1
  },
  ...
  // ─── Tubal investigations ─────────────────────────────────
  {
    ...
    weight: 3,
    evaluate: (d) => d.investigations.hysterosalpingogramDone === 'yes' &&
  ...
  },
  {
    ...
    weight: 2,
    evaluate: (d) => d.investigations.laparoscopyDone === 'yes' &&
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => d.investigations.hysteroscopyDone === 'yes' &&
  ...
  // ─── Semen analysis (WHO 2021 lower reference limits) ────
  {
    ...
    weight: 1,
    evaluate: (d) => d.partnerSemen.semenAnalysisDone === 'yes' &&
      d.partnerSemen.semenVolumeMl !== null && d.partnerSemen.semenVolumeMl < 1.4
  },
  {
    id: 'FERT-SEM-002',
    category: 'Semen Analysis',
  ...
  },
  {
    ...
    weight: 1,
    evaluate: (d) => d.lifestyleFactors.recreationalDrugs === 'yes'
  }
];
