//! Fertility Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Fertility Assessment** medical form, built on the
...
//!
//! ```
//! use fertility_assessment_loco_crate::engine::types::AssessmentData;
//!
