# Fertility Assessment — specification
...
- `bin/test-form fertility-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check fertility-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `fertility-assessment.front-end-form-with-html.v1` (HTML)
  - `fertility-assessment.front-end-form-with-svelte.v1` (SvelteKit)
