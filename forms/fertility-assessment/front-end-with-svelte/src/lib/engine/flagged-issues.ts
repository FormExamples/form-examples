...
// abnormal hormone results, severe semen abnormalities, modifiable lifestyle
// factors, and prior pelvic disease.
...
export function detectAdditionalFlags(data: AssessmentData): AdditionalFlag[] {
	...
	const femaleAge = calculateAge(data.demographics.patientDateOfBirth);
	...
	if (
		data.reproductiveHistory.priorEctopic !== null &&
		data.reproductiveHistory.priorEctopic >= 1
	) {
		flags.push({
			id: 'FLAG-RH-002',
			category: 'Reproductive History',
