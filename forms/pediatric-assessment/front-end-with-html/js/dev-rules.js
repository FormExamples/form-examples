// Declarative developmental screening rules. Each rule evaluates the
// child's assessment data and returns true if a concern is present. The
// overall result is determined by the worst domain result. Normal is the
// default when no rules fire (healthy child).
//
// Mirrors `src/lib/engine/dev-rules.ts` from the SvelteKit reference.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {import('./types.js').DomainResult} DomainResult
 *
 * @typedef {Object} DevScreenRule
 * @property {string} id
