// Flagged-issue detection. Independent of the developmental screen result,
// this module raises clinician-facing alerts for failure-to-thrive, low
// growth percentiles, missing immunizations, vaccine adverse reactions,
// developmental delays/concerns, safeguarding concerns, NICU history,
// preterm birth, low APGAR, birth complications, anaphylaxis-history
// allergies, chronic conditions, recurring infections, family genetic
// conditions, consanguinity, behavioural concerns, and excessive screen
// time.
//
...
function detectAdditionalFlags(data) {
  ...
  // ─── Allergy alerts ─────────────────────────────────────
  data.currentMedications.allergies.forEach((allergy, i) => {
