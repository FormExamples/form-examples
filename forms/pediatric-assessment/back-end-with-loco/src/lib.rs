//! Pediatric Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Pediatric Assessment** medical form, built on the
...
//!
//! ```
//! use pediatric_assessment_loco_crate::engine::types::AssessmentData;
//!
