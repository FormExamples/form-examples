...
| H4 | Immunisation status incorrectly assumed up-to-date | Schedule compared against UKHSA Green Book complete schedule; missing doses listed explicitly |
...
- `dev-rules.ts` tests — coverage of every HCP, NG143, NG51, and Green
  Book trigger
- Reference vignettes (well 12-month-old, missed 1-year immunisations,
