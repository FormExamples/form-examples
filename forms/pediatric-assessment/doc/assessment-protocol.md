...
- Hospital paediatric assessment unit (PAU) clinicians

## Setting

UK primary care, community child-health clinic, school, or hospital PAU.

## Workflow

1. **Demographics** — child's name, DOB, age, sex, parent/guardian
   identifiers, GP, school, ethnicity, language.
2. **Birth history** — gestational age, birth weight, mode of delivery,
   resuscitation, neonatal unit admission, neonatal screening results
   (NIPE, hearing, heelprick), feeding history.
3. **Growth and nutrition** — current weight, length/height, head
   circumference plotted on UK-WHO charts; feeding (breast, formula,
   weaning, family diet); eating concerns; food refusal.
...
9. **Social and environmental** — household composition, parental mental
   health, parental smoking and alcohol/drug use, housing security,
   safeguarding concerns, school attendance and progress.
...
- Bayley-style developmental quotient assessment
- Autism diagnostic assessment (use autism-assessment form)
- ADHD diagnostic assessment (use attention-deficit-assessment form)
- Detailed acute respiratory or cardiac assessment (paediatric assessment
  unit)
- Adolescent mental-health diagnostic assessment (use mental-health-assessment
  form)
