...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/pediatric-assessment/"
                class="text-lg font-bold text-base-content"
                >Pediatric Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/pediatric-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/pediatric-assessment/pediatric-assessments/new"
                    class={navClass("/pediatric-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/pediatric-assessment/pediatric-assessments"
                    class={navClass("/pediatric-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
