...
function storageKey(id: string): string {
	return `pediatric-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank pediatric assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the pediatric assessment, with localStorage
