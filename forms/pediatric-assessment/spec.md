# Pediatric Assessment — specification
...
- `bin/test-form pediatric-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check pediatric-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `pediatric-assessment.front-end-form-with-html.v1` (HTML)
  - `pediatric-assessment.front-end-form-with-svelte.v1` (SvelteKit)
