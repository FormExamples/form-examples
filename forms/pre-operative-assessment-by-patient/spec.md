# Pre-operative Assessment — specification
...
- `bin/test-form pre-operative-assessment-by-patient` exits cleanly.
...
- `bin/lily-html-refactor --check pre-operative-assessment-by-patient` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `pre-operative-assessment-by-patient.front-end-form-with-html.v1` (HTML)
  - `pre-operative-assessment-by-patient.front-end-form-with-svelte.v1` (SvelteKit)
