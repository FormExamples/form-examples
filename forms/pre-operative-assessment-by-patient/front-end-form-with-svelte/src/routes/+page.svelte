	...
	<div class="w-full max-w-lg text-center">
		<div class="mb-8">
			...
			<p class="mt-3 text-gray-600">
				Complete this questionnaire to generate an anaesthetic risk assessment. Your responses will
				be used to calculate an ASA grade and identify any issues that need to be highlighted for
				the anaesthetist.
			</p>
		</div>
		...
		<p class="mt-4 text-xs text-gray-400">
			This tool is for clinical support only. All assessments must be reviewed by a qualified
			anaesthetist.
		</p>
	</div>
</div>
