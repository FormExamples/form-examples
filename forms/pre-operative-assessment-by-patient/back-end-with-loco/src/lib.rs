//! Pre Operative Assessment by Patient — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Pre Operative Assessment by Patient** medical form, built on the
...
//!
//! ```
//! use pre_op_assessment_loco_crate::engine::types::AssessmentData;
//!
