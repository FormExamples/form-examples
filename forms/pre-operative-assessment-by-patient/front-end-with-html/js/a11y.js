// Accessibility toolbar for the Pre-operative Assessment by Patient front-end.
//
// A patient-completed pre-operative questionnaire should be usable by the widest
// possible range of patients and carers. This module is self-contained: it
// injects its own toolbar, so a single `<script src="js/a11y.js">` include works
// on both the wizard (index.html) and the dashboard (dashboard.html). It layers
// on progressive enhancement — the page is fully usable if this script never
// runs.
//
...
var PREFS_KEY = 'pre-operative-assessment.a11y.v1';
