...
const asaRules = [
  ...
  },
  {
    ...
    evaluate: (d) =>
      d.cardiovascular.hypertension === 'yes' &&
      d.cardiovascular.hypertensionControlled === 'no'
  },
  {
    id: 'CV-003',
    system: 'Cardiovascular',
    ...
    grade: 2,
    evaluate: (d) =>
      d.cardiovascular.ischemicHeartDisease === 'yes' &&
  ...
  },
  {
    ...
    evaluate: (d) =>
      ...
      (d.cardiovascular.heartFailureNYHA === '1' ||
        d.cardiovascular.heartFailureNYHA === '2')
  },
  {
    id: 'CV-006',
    system: 'Cardiovascular',
    ...
    evaluate: (d) =>
      d.cardiovascular.heartFailure === 'yes' &&
      d.cardiovascular.heartFailureNYHA === '3'
  },
  {
    id: 'CV-007',
    system: 'Cardiovascular',
    ...
    evaluate: (d) =>
      d.cardiovascular.heartFailure === 'yes' &&
      d.cardiovascular.heartFailureNYHA === '4'
  },
  {
    id: 'CV-008',
    system: 'Cardiovascular',
  ...
  },
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.respiratory.copd === 'yes' && d.respiratory.copdSeverity === 'mild'
  },
  {
    id: 'RS-004',
    system: 'Respiratory',
    ...
    grade: 3,
    evaluate: (d) =>
      d.respiratory.copd === 'yes' && d.respiratory.copdSeverity === 'moderate'
  },
  {
    id: 'RS-005',
    system: 'Respiratory',
    ...
    grade: 3,
    evaluate: (d) =>
      d.respiratory.copd === 'yes' && d.respiratory.copdSeverity === 'severe'
  },
  {
    id: 'RS-006',
    system: 'Respiratory',
  ...
  },
  {
    ...
    evaluate: (d) =>
      d.renal.ckd === 'yes' &&
      (d.renal.ckdStage === '4' || d.renal.ckdStage === '5')
  },
  {
    id: 'RN-003',
    system: 'Renal',
  ...
  // ─── HEPATIC ─────────────────────────────────────────────
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.hepatic.liverDisease === 'yes' && d.hepatic.cirrhosis !== 'yes'
  },
  {
    id: 'HP-002',
    system: 'Hepatic',
    ...
    grade: 3,
    evaluate: (d) =>
      d.hepatic.cirrhosis === 'yes' && d.hepatic.childPughScore === 'A'
  },
  {
    id: 'HP-003',
    system: 'Hepatic',
  ...
  },
  {
    ...
    evaluate: (d) =>
      ...
      d.neurological.epilepsyControlled === 'yes'
  },
  {
    id: 'NR-003',
    system: 'Neurological',
    ...
    evaluate: (d) =>
      d.neurological.epilepsy === 'yes' &&
      d.neurological.epilepsyControlled === 'no'
  },
  {
    id: 'NR-004',
    system: 'Neurological',
  ...
  // ─── OBESITY ─────────────────────────────────────────────
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.demographics.bmi !== null &&
      d.demographics.bmi >= 30 &&
      d.demographics.bmi < 40
  },
  {
    id: 'OB-002',
    system: 'Obesity',
  ...
  // ─── FUNCTIONAL CAPACITY ─────────────────────────────────
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.functionalCapacity.estimatedMETs !== null &&
      d.functionalCapacity.estimatedMETs < 4
  },
