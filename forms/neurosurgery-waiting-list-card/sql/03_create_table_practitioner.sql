-- Practitioner who places the patient on a neurosurgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a neurosurgery waiting list card on behalf of the patient.';
