# neurosurgery-waiting-list-card — sql
...
- `neurosurgery_waiting_list_card` — top-level waiting list card.
- `neurosurgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `neurosurgery_waiting_list_card_grade` — computed grading result.
- `neurosurgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `neurosurgery_waiting_list_card_grade_flag` — safety / operational flags fired
