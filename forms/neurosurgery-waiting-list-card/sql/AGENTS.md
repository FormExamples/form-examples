# Neurosurgery Waiting List Card — PostgreSQL migrations
...
Child `neurosurgery_waiting_list_card_*` tables reference
`neurosurgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
