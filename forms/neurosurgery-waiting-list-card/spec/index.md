# Neurosurgery Waiting List Card — specification
...
neurosurgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form neurosurgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check neurosurgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `neurosurgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `neurosurgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
