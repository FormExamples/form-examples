# Tasks: Neurosurgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/neurosurgery-waiting-list-card/`.
...
- [x] `cargo loco new neurosurgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form neurosurgery-waiting-list-card` exits cleanly.
