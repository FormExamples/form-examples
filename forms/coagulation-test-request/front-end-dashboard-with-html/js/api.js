// Backend API client for the coagulation test request vetting dashboard.
//
...
window.CoagulationTestRequestDashboard.fetchRequests = fetchRequests;
window.CoagulationTestRequestDashboard.API_BASE = API_BASE;
})();
