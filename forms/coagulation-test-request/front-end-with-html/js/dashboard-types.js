...
/**
 * Appropriateness band emitted by the engine's Axis A (BSH 1-9).
...
/**
 * Triage tier emitted by Axis D (active-bleeding / DIC escalation).
 ...
 * @property {string[]} tests         - Selected coagulation tests (display labels)
 ...
 * @property {PreanalyticalBand} preanalyticalBand     - Axis B specimen-safety band
...
// before they read `window.CoagulationTestRequestDashboard`.
})();
