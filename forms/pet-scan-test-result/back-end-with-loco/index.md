...
Server-side Rust JSON API for the PET Scan Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`pet_scan_test_result/`](pet_scan_test_result/) — one migration, SeaORM
