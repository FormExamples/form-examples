// ──────────────────────────────────────────────
// PET Scan Test Result — core data types
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_pet_scan_test_result.sql and
...
export interface StructuredFindings {
	hypermetabolicLesion: boolean;
	nodalUptake: boolean;
	distantMetastasis: boolean;
	noAbnormalUptake: boolean;
	physiologicalUptakeOnly: boolean;
