import type { PetScanResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a PET scan result.
 *
 * Computes:
 * - Axis A: result classification (normal / abnormal / critical / inconclusive).
 * - Axis B: abnormality severity + structured reporting category (Deauville / PERCIST).
 ...
 *
 * Invariant: a critical finding (distant metastasis or progressive disease)
 ...
 */
export function calculateGrade(result: PetScanResult): GradingResult {
