...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-gray-900">Graded PET reports</h1>
			<p class="mt-1 text-sm text-gray-600">
				Four-axis interpretation grades for completed PET scan reports.
			</p>
		</div>
		<a href="/pet-scan-test-result/report" class="button" data-variant="primary">New report</a>
	</div>
