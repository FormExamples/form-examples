 ...
 * `forms/pet-scan-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {ScanType} scanType                            - PET tracer / scan type
...
// namespace, `window.PetScanTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.PetScanTestResultDashboard`.
})();
