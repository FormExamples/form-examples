...
// PET Scan Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.PetScanTestResultDashboard`; display labels come
// from the form namespace `window.PetScanTestResult` (js/types.js). The
