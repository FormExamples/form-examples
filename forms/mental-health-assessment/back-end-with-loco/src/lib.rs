//! Mental Health Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Mental Health Assessment** medical form, built on the
...
//!
//! ```
//! use mental_health_assessment_loco_crate::engine::types::AssessmentData;
//!
