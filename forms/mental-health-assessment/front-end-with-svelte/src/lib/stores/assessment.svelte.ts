...
function storageKey(id: string): string {
	return `mental-health-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank mental health assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the mental health assessment, with localStorage
