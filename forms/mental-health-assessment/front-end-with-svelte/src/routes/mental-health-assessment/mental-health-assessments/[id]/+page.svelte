<script lang="ts">
	...
	function submit() {
		...
		goto(`/mental-health-assessment/mental-health-assessments/${id}/report`);
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-base-content">
			{isNew ? 'New mental health assessment' : `Mental health assessment ${id}`}
		</h1>
		<p class="mt-1 text-sm text-base-content/70">
			Complete the nine sections; the PHQ-9 / GAD-7 scores and flagged issues are computed on submit.
		</p>
	...
	<Form label="Mental health assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2PhqDepression />
		<Step3GadAnxiety />
		<Step4MoodAffect />
