    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            ...
            <div class="flex items-center gap-1">
                <a href="/mental-health-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/mental-health-assessment/mental-health-assessments/new"
                    class={navClass("/mental-health-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/mental-health-assessment/mental-health-assessments"
                    class={navClass("/mental-health-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
