...
- LocalStorage key `mental-health-assessment.front-end-form-with-html.v1` (HTML) and
  `mental-health-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
