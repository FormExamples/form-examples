# Mental Health Assessment — specification
...
- `bin/test-form mental-health-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check mental-health-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `mental-health-assessment.front-end-form-with-html.v1` (HTML)
  - `mental-health-assessment.front-end-form-with-svelte.v1` (SvelteKit)
