//! Occupational Therapy Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Occupational Therapy Assessment** medical form, built on the
...
//!
//! ```
//! use occupational_therapy_assessment_loco_crate::engine::types::AssessmentData;
//!
