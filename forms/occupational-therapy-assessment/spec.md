...
- LocalStorage key `occupational-therapy-assessment.front-end-form-with-html.v1` (HTML) and
  `occupational-therapy-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
