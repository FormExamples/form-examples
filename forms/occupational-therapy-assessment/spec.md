# Occupational Therapy Assessment — specification
...
- `bin/test-form occupational-therapy-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check occupational-therapy-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `occupational-therapy-assessment.front-end-form-with-html.v1` (HTML)
  - `occupational-therapy-assessment.front-end-form-with-svelte.v1` (SvelteKit)
