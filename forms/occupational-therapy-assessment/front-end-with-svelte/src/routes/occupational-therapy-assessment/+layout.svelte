...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/occupational-therapy-assessment/"
            ...
            <div class="flex items-center gap-1">
                ...
                >
                <a
                    href="/occupational-therapy-assessment/occupational-therapy-assessments/new"
                    class={navClass("/occupational-therapy-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/occupational-therapy-assessment/occupational-therapy-assessments"
                    class={navClass("/occupational-therapy-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
