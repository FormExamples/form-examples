...
<svelte:head>
	<title>Occupational Therapy Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/occupational-therapy-assessment/" class="text-lg font-bold text-base-content">Occupational Therapy Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/occupational-therapy-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/occupational-therapy-assessment/occupational-therapy-assessments/new" class={navClass('/occupational-therapy-assessments/new')}>New assessment</a>
				<a href="/occupational-therapy-assessment/occupational-therapy-assessments" class={navClass('/occupational-therapy-assessments')}>Dashboard</a>
