<script lang="ts">
	...
	import Step4HeartRate from '$lib/components/steps/Step4HeartRate.svelte';
	import Step5Respiratory from '$lib/components/steps/Step5Respiratory.svelte';
	import Step6Temperature from '$lib/components/steps/Step6Temperature.svelte';
	import Step7Consciousness from '$lib/components/steps/Step7Consciousness.svelte';
	...
	function submit() {
		...
		assessment.result = gradeMews(assessment.data);
		goto(`/modified-early-warning-score/${plural}/${id}/report`);
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-base-content">
			{isNew ? 'New MEWS assessment' : `MEWS assessment ${id}`}
		</h1>
		<p class="mt-1 text-sm text-base-content/70">
			Complete the eight sections; the aggregate MEWS and risk band are computed on submit.
		</p>
	...
	<Form label="MEWS assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3BloodPressure />
		<Step4HeartRate />
