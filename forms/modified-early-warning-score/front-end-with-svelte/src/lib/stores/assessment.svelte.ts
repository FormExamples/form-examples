...
function storageKey(id: string): string {
	return `modified-early-warning-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank MEWS assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the MEWS assessment, with localStorage
