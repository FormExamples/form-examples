...
Server-side Rust JSON API for the Modified Early Warning Score (MEWS) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`modified_early_warning_score/`](modified_early_warning_score/) — one migration, SeaORM
