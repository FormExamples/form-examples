# Tasks: Geriatrics Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/geriatrics-waiting-list-card/`.
...
- [x] `cargo loco new geriatrics-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form geriatrics-waiting-list-card` exits cleanly.
