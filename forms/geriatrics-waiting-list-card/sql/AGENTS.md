# Geriatrics Waiting List Card — PostgreSQL migrations
...
Child `geriatrics_waiting_list_card_*` tables reference
`geriatrics_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
