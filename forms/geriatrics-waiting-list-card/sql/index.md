# geriatrics-waiting-list-card — sql
...
- `geriatrics_waiting_list_card` — top-level waiting list card.
- `geriatrics_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `geriatrics_waiting_list_card_grade` — computed grading result.
- `geriatrics_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `geriatrics_waiting_list_card_grade_flag` — safety / operational flags fired
