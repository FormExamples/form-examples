# Plan: Geriatrics Waiting List Card
...
months later. The Geriatrics Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form geriatrics-waiting-list-card`.
