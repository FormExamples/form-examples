# Geriatrics Waiting List Card — specification
...
geriatrics waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form geriatrics-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check geriatrics-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `geriatrics-waiting-list-card.front-end-with-html.v1` (HTML)
  - `geriatrics-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
