<script lang="ts">
	...
	import { riskLevelLabel, asaClassShort, mallampatiShort } from '#lib/engine/utils.js';
	import type { AsaClass, MallampatiClass, RiskLevel } from '#lib/engine/types.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/anesthesiology-assessment/anesthesiology-assessments/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/anesthesiology-assessment/anesthesiology-assessments/new" class="button" data-variant="primary">New assessment</a>
	</div>
