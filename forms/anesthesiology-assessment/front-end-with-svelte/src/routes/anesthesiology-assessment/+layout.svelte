...
<svelte:head>
	<title>Anesthesiology Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/anesthesiology-assessment/" class="text-lg font-bold text-base-content">Anesthesiology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/anesthesiology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/anesthesiology-assessment/anesthesiology-assessments/new" class={navClass('/anesthesiology-assessments/new')}>New assessment</a>
				<a href="/anesthesiology-assessment/anesthesiology-assessments" class={navClass('/anesthesiology-assessments')}>Dashboard</a>
