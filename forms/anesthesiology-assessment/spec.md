...
- LocalStorage key `anesthesiology-assessment.front-end-form-with-html.v1` (HTML) and
  `anesthesiology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
