# Anesthesiology Assessment — specification
...
See `doc/` for the full clinical grounding.
...
- `bin/test-form anesthesiology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check anesthesiology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `anesthesiology-assessment.front-end-with-html.v1` (HTML)
  - `anesthesiology-assessment.front-end-with-svelte.v1` (SvelteKit)
