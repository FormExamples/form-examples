...
function evaluateStopbang(d) {
  ...
  if (vs.bmi !== null && vs.bmi !== undefined && vs.bmi > 35) {
    score++;
    firedRules.push({
      id: 'SB-B',
      category: 'OSA',
      description: `BMI ${vs.bmi} (>35).`,
      riskLevel: 'medium'
    });
  }
  ...
  if (
    vs.neckCircumference !== null &&
    vs.neckCircumference !== undefined &&
    vs.neckCircumference > 40
  ) {
    score++;
    firedRules.push({
      id: 'SB-N',
