//! Anesthesiology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Anesthesiology Assessment** medical form, built on the
...
//!
//! ```
//! use anesthesiology_assessment_loco_crate::engine::types::AssessmentData;
//!
