    ...
    rows.forEach((row, idx) => {
      ...
      r.innerHTML = `
        <div class="list-grid med-grid">
          ...
          <label class="list-cell">
            <span>Route</span>
            <select class="select-input" data-key="route">
              <option value="">— Select —</option>
              ${routeOptionsHtml}
            </select>
          </label>
      ...
      r.innerHTML = `
        <div class="list-grid prev-op-grid">
          ...
          <label class="list-cell">
            ...
            <select class="select-input" data-key="anaesthesiaType">
              <option value="">— Select —</option>
          ...
          <button type="button" class="btn btn-icon" aria-label="Remove previous operation">&times;</button>
        </div>
      `;
      r.querySelectorAll('input, select').forEach((inp) => {
        const handler = () => {
