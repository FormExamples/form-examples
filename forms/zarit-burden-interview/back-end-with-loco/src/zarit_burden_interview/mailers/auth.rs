...
static welcome: Dir<'_> = include_dir!("src/zarit_burden_interview/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/zarit_burden_interview/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/zarit_burden_interview/mailers/auth/magic_link");
