...
Server-side Rust JSON API for the Zarit Burden Interview (ZBI) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`zarit_burden_interview/`](zarit_burden_interview/) — one migration, SeaORM
