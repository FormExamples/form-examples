...
<svelte:head>
	<title>Zarit Burden Interview (ZBI)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/zarit-burden-interview/" class="text-lg font-bold text-base-content">ZBI</a>
			<div class="flex items-center gap-1">
				<a href="/zarit-burden-interview/" class={navClass('/')}>Welcome</a>
				<a
					href="/zarit-burden-interview/zarit-burden-interviews/new"
					class={navClass('/zarit-burden-interviews/new')}>New assessment</a
				>
				<a
					href="/zarit-burden-interview/zarit-burden-interviews"
					class={navClass('/zarit-burden-interviews')}>Dashboard</a
				>
