...
function storageKey(id: string): string {
	return `attention-deficit-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank ADHD assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the ADHD assessment, with localStorage
