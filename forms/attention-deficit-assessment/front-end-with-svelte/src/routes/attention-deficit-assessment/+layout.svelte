...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/attention-deficit-assessment/"
                class="text-lg font-bold text-base-content"
                >Attention Deficit Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/attention-deficit-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/attention-deficit-assessment/attention-deficit-assessments/new"
                    class={navClass("/attention-deficit-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/attention-deficit-assessment/attention-deficit-assessments"
                    class={navClass("/attention-deficit-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
