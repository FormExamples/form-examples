//! Attention Deficit Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Attention Deficit Assessment** medical form, built on the
...
//!
//! ```
//! use attention_deficit_assessment_loco_crate::engine::types::AssessmentData;
//!
