...
- LocalStorage key `attention-deficit-assessment.front-end-form-with-html.v1` (HTML) and
  `attention-deficit-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
