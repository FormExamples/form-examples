# Attention Deficit Assessment — specification
...
- `bin/test-form attention-deficit-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check attention-deficit-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `attention-deficit-assessment.front-end-form-with-html.v1` (HTML)
  - `attention-deficit-assessment.front-end-form-with-svelte.v1` (SvelteKit)
