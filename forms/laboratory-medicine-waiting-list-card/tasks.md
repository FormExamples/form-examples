# Tasks: Laboratory Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/laboratory-medicine-waiting-list-card/`.
...
- [x] `cargo loco new laboratory-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form laboratory-medicine-waiting-list-card` exits cleanly.
