# Laboratory Medicine Waiting List Card — PostgreSQL migrations
...
Child `lab_med_waiting_list_card_*` tables reference
`lab_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
