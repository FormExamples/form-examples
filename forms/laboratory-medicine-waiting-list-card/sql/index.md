# laboratory-medicine-waiting-list-card — sql
...
- `lab_med_waiting_list_card` — top-level waiting list card.
- `lab_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `lab_med_waiting_list_card_grade` — computed grading result.
- `lab_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `lab_med_waiting_list_card_grade_flag` — safety / operational flags fired
