-- Practitioner who places the patient on a laboratory medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a laboratory medicine waiting list card on behalf of the patient.';
