use laboratory_medicine_waiting_list_card::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_lab_med_waiting_list_card_appointments() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/lab_med_waiting_list_card_appointments").await;
