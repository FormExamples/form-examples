# Plan: Laboratory Medicine Waiting List Card
...
months later. The Laboratory Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form laboratory-medicine-waiting-list-card`.
