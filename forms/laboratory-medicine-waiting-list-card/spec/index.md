# Laboratory Medicine Waiting List Card — specification
...
laboratory medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form laboratory-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check laboratory-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `laboratory-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `laboratory-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
