...
```sh
bin/test-form laboratory-medicine-waiting-list-card
bin/test-sql-apply laboratory-medicine-waiting-list-card
bin/test-personas laboratory-medicine-waiting-list-card
bin/test-e2e --html laboratory-medicine-waiting-list-card
```
