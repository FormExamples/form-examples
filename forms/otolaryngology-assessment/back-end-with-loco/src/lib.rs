//! Otolaryngology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Otolaryngology Assessment** medical form, built on the
...
//!
//! ```
//! use otolaryngology_assessment_loco_crate::engine::types::AssessmentData;
//!
