use otolaryngology_assessment_tera_crate::engine::snot22_grader::{classify_snot22_score, grade};
use otolaryngology_assessment_tera_crate::engine::snot22_rules::all_rules;
use otolaryngology_assessment_tera_crate::engine::types::*;
