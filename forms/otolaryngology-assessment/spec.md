...
- LocalStorage key `otolaryngology-assessment.front-end-form-with-html.v1` (HTML) and
  `otolaryngology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
