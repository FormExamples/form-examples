# Otolaryngology Assessment — specification
...
- `bin/test-form otolaryngology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check otolaryngology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `otolaryngology-assessment.front-end-form-with-html.v1` (HTML)
  - `otolaryngology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
