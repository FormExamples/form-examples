...
- LocalStorage key `workplace-safety-assessment.front-end-form-with-html.v1` (HTML) and
  `workplace-safety-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
