# Workplace Safety Assessment — specification
...
- `bin/test-form workplace-safety-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check workplace-safety-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `workplace-safety-assessment.front-end-form-with-html.v1` (HTML)
  - `workplace-safety-assessment.front-end-form-with-svelte.v1` (SvelteKit)
