...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/workplace-safety-assessment/"
                class="text-lg font-bold text-base-content"
                >Workplace Safety Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/workplace-safety-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/workplace-safety-assessment/workplace-safety-assessments/new"
                    class={navClass("/workplace-safety-assessments/new")}
                    >New audit</a
                >
                <a
                    href="/workplace-safety-assessment/workplace-safety-assessments"
                    class={navClass("/workplace-safety-assessments")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
