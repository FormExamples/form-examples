use workplace_safety_assessment_loco_crate::engine::rules::all_rules;
use workplace_safety_assessment_loco_crate::engine::safety_grader::{grade, highest_outcome};
