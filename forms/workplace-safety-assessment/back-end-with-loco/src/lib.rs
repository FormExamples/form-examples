//! Workplace Safety Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Workplace Safety Assessment** medical form, built on the
...
//!
//! ```
//! use workplace_safety_assessment_loco_crate::engine::types::AssessmentData;
//!
