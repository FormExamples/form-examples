...
static welcome: Dir<'_> = include_dir!("src/workplace_safety_assessment/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/workplace_safety_assessment/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/workplace_safety_assessment/mailers/auth/magic_link");
