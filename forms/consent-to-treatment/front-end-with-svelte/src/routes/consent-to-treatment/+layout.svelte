...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/consent-to-treatment/" class="text-lg font-bold text-base-content">Consent to Treatment</a>
			<div class="flex items-center gap-1">
				<a href="/consent-to-treatment/" class={navClass('/')}>Welcome</a>
				<a href="/consent-to-treatment/consents-to-treatment/new" class={navClass('/consents-to-treatment/new')}>New form</a>
				<a href="/consent-to-treatment/consents-to-treatment" class={navClass('/consents-to-treatment')}>Dashboard</a>
