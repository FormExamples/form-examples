//! Consent to Treatment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Consent to Treatment** medical form, built on the
...
//!
//! ```
//! use consent_to_treatment_loco_crate::engine::types::AssessmentData;
//!
