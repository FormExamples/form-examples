...
static welcome: Dir<'_> = include_dir!("src/consent_to_treatment/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/consent_to_treatment/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/consent_to_treatment/mailers/auth/magic_link");
