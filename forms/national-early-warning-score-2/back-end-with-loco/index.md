...
Server-side Rust JSON API for the National Early Warning Score 2 (NEWS2) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`national_early_warning_score_2/`](national_early_warning_score_2/) — one migration, SeaORM
