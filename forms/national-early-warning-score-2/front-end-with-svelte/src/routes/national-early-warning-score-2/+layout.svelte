...
<svelte:head>
	<title>National Early Warning Score 2 (NEWS2)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/national-early-warning-score-2/" class="text-lg font-bold text-base-content">NEWS2</a>
			<div class="flex items-center gap-1">
				<a href="/national-early-warning-score-2/" class={navClass('/')}>Welcome</a>
				<a href="/national-early-warning-score-2/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/national-early-warning-score-2/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
