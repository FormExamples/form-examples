...
function storageKey(id: string): string {
	return `national-early-warning-score-2.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank NEWS2 assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the NEWS2 assessment, with localStorage
