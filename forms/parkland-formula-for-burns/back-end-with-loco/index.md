...
Server-side Rust JSON API for the Parkland Formula for Burns form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`parkland_formula_for_burns/`](parkland_formula_for_burns/) — one migration, SeaORM
