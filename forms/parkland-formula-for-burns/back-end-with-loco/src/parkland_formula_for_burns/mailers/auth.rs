...
static welcome: Dir<'_> = include_dir!("src/parkland_formula_for_burns/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/parkland_formula_for_burns/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/parkland_formula_for_burns/mailers/auth/magic_link");
