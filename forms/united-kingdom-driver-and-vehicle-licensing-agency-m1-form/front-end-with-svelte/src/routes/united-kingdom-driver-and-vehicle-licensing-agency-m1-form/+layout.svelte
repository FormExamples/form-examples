<script lang="ts">
    ...
    const plural =
        "united-kingdom-driver-and-vehicle-licensing-agency-m1-forms";
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/united-kingdom-driver-and-vehicle-licensing-agency-m1-form/"
                class="text-lg font-bold text-base-content">UK DVLA M1 Form</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass(`/${plural}/new`)}>New form</a
                >
                <a
