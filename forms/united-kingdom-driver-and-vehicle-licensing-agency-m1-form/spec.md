# United Kingdom Driver and Vehicle Licensing Agency M1 Form — specification
...
- `bin/test-form united-kingdom-driver-and-vehicle-licensing-agency-m1-form` exits cleanly.
...
- `bin/lily-html-refactor --check united-kingdom-driver-and-vehicle-licensing-agency-m1-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-driver-and-vehicle-licensing-agency-m1-form.front-end-form-with-html.v1` (HTML)
  - `united-kingdom-driver-and-vehicle-licensing-agency-m1-form.front-end-form-with-svelte.v1` (SvelteKit)
