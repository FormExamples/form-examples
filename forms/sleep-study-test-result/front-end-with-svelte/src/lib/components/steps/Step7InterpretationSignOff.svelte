...
<Fieldset legend="7. Interpretation & Sign-off">
	...
	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a critical finding. Arrange an urgent CPAP / ventilation review,
				communicate the result directly to the referrer, and record it below before signing.
			</p>
		</Alert>
	{/if}
