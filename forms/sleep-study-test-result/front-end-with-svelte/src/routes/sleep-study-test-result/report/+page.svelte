<script lang="ts">
	...
	import Step4Metrics from '$lib/components/steps/Step4Metrics.svelte';
	...
	function submit() {
		...
		goto('/sleep-study-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New sleep-study report</h1>
	...
	<Form label="Sleep study test result" onsubmit={submit}>
