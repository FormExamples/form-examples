 ...
 * `forms/sleep-study-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.SleepStudyTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.SleepStudyTestResultDashboard`.
})();
