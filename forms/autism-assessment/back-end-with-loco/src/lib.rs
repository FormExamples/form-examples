//! Autism Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Autism Assessment** medical form, built on the
...
//!
//! ```
//! use autism_assessment_loco_crate::engine::types::AssessmentData;
//!
