...
function storageKey(id: string): string {
	return `autism-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank autism assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the autism assessment, with localStorage
