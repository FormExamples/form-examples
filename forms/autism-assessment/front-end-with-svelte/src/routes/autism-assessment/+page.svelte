<script lang="ts">
	const plural = 'autism-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/autism-assessment/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse screened patients with their computed AQ-10 score and screening category.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the AQ-10 scoring engine, and
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the AQ-10 (Autism Spectrum Quotient, 10-item), scored 0–10; a score of 6 or more
					suggests referral for diagnostic assessment.
				</dd>
			</div>
		</dl>
	</section>
