    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                ...
                class="text-lg font-bold text-base-content">Autism Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/autism-assessment/" class={navClass("/")}>Welcome</a>
                <a
                    href="/autism-assessment/autism-assessments/new"
                    class={navClass("/autism-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/autism-assessment/autism-assessments"
                    class={navClass("/autism-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
