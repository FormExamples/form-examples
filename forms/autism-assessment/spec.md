# Autism Assessment — specification
...
- `bin/test-form autism-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check autism-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `autism-assessment.front-end-form-with-html.v1` (HTML)
  - `autism-assessment.front-end-form-with-svelte.v1` (SvelteKit)
