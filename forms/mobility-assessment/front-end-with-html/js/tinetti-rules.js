// Tinetti Performance-Oriented Mobility Assessment (POMA) item definitions.
//
// 9 balance items (max 16 points) + 8 gait items (max 12 points) = 28-point total.
// Each item is scored 0-1 or 0-2 depending on the item.

/**
 * @typedef {Object} TinettiRuleDefinition
 * @property {string} id
 * @property {number} itemNumber
 * @property {'balance' | 'gait'} domain
