...
<Fieldset legend="Demographics">
	...
	<div class="field-grid">
		<Field label="Height" inputId="height">
			<TextInput id="height" label="Height" placeholder="e.g., 170 cm" bind:value={d.height} />
		</Field>
		<Field label="Weight" inputId="weight">
			<TextInput id="weight" label="Weight" placeholder="e.g., 75 kg" bind:value={d.weight} />
		</Field>
	</div>
</Fieldset>
