...
function storageKey(id: string): string {
	return `mobility-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank mobility assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the mobility assessment, with localStorage
