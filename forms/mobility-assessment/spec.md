# Mobility Assessment — specification
...
- `bin/test-form mobility-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check mobility-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `mobility-assessment.front-end-form-with-html.v1` (HTML)
  - `mobility-assessment.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form mobility-assessment
```
