//! Mobility Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Mobility Assessment** medical form, built on the
...
//!
//! ```
//! use mobility_assessment_loco_crate::engine::types::AssessmentData;
//!
