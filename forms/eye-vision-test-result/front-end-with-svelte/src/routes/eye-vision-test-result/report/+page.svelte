<script lang="ts">
	...
	import Step3Measurements from '$lib/components/steps/Step3Measurements.svelte';
	...
	function submit() {
		...
		goto('/eye-vision-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New eye vision report</h1>
	...
	<Form label="Eye vision test result" onsubmit={submit}>
