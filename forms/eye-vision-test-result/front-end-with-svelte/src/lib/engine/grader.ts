import type { EyeVisionResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for an eye vision test result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical ophthalmic finding (proliferative retinopathy, acutely
 ...
 */
export function calculateGrade(result: EyeVisionResult): GradingResult {
