...
export function hasAnyAbnormalFinding(r: EyeVisionResult): boolean {
	return (
		...
		// elevated raw IOP measurement, or a bilateral visual-field defect
		// result from their own dedicated fields — each independent of the
		// boolean checkboxes above — so Axis A must agree even when those
		// checkboxes are unset.
