...
Server-side Rust JSON API for the Eye Vision Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`eye_vision_test_result/`](eye_vision_test_result/) — one migration, SeaORM
