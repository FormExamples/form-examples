...
<svelte:head>
	<title>Endometriosis Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/endometriosis-assessment/" class="text-lg font-bold text-base-content">Endometriosis Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/endometriosis-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/endometriosis-assessment/endometriosis-assessments/new" class={navClass('/endometriosis-assessments/new')}>New assessment</a>
				<a href="/endometriosis-assessment/endometriosis-assessments" class={navClass('/endometriosis-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
