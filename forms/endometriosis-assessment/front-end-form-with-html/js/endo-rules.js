...
const endoRules = [
  ...
  },
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.menstrualHistory.daysOffWorkPerCycle !== null &&
      d.menstrualHistory.daysOffWorkPerCycle >= 3
  },
  {
    id: 'MH-005',
    category: 'Menstrual',
  ...
  },
  {
    ...
    evaluate: (d) =>
      d.painAssessment.hasPelvicPain === 'yes' &&
      d.painAssessment.pelvicPainTiming === 'constant'
  },
  {
    id: 'PAIN-004',
    category: 'Pain',
  ...
  },
  {
    ...
    evaluate: (d) => {
      let failed = 0;
      if (d.previousTreatments.combinedPillTried === 'yes' &&
          d.previousTreatments.combinedPillEffective === 'ineffective') failed++;
