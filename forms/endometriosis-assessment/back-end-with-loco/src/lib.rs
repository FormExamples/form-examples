//! Endometriosis Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Endometriosis Assessment** medical form, built on the
...
//!
//! ```
//! use endometriosis_assessment_loco_crate::engine::types::AssessmentData;
//!
