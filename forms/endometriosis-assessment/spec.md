# Endometriosis Assessment — specification
...
- `bin/test-form endometriosis-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check endometriosis-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `endometriosis-assessment.front-end-form-with-html.v1` (HTML)
  - `endometriosis-assessment.front-end-form-with-svelte.v1` (SvelteKit)
