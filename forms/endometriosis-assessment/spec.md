...
- LocalStorage key `endometriosis-assessment.front-end-form-with-html.v1` (HTML) and
  `endometriosis-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
