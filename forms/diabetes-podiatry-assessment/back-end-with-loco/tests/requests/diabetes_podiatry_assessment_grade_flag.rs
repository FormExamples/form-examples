use diabetes_podiatry_assessment::app::App;
use loco_rs::testing::prelude::*;
use serial_test::serial;

#[tokio::test]
#[serial]
async fn can_get_diabetes_podiatry_assessment_grade_flags() {
    request::<App, _, _>(|request, _ctx| async move {
        let res = request.get("/api/diabetes_podiatry_assessment_grade_flags").await;
