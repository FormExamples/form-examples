...
<svelte:head>
	<title>Diabetes Podiatry Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/diabetes-podiatry-assessment/" class="text-lg font-bold text-base-content"
				>Diabetes Podiatry Assessment</a
			>
			<div class="flex items-center gap-1">
				<a href="/diabetes-podiatry-assessment/" class={navClass('/')}>Welcome</a>

				<a
					href="/diabetes-podiatry-assessment/diabetes-podiatry-assessments/new"
					class={navClass('/diabetes-podiatry-assessments/new')}>New assessment</a
				>
				<a
					href="/diabetes-podiatry-assessment/diabetes-podiatry-assessments"
					class={navClass('/diabetes-podiatry-assessments')}>Dashboard</a
				>
				<PickerBar
					class="ml-2"
					labels={{
