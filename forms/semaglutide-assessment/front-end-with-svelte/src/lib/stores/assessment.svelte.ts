...
function storageKey(id: string): string {
	return `semaglutide-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank semaglutide assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the semaglutide assessment, with localStorage
