# Semaglutide Assessment — specification
...
- `bin/test-form semaglutide-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check semaglutide-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `semaglutide-assessment.front-end-form-with-html.v1` (HTML)
  - `semaglutide-assessment.front-end-form-with-svelte.v1` (SvelteKit)
