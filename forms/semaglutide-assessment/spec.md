...
- LocalStorage key `semaglutide-assessment.front-end-form-with-html.v1` (HTML) and
  `semaglutide-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
