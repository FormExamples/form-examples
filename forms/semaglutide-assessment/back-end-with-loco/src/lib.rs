//! Semaglutide Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Semaglutide Assessment** medical form, built on the
...
//!
//! ```
//! use semaglutide_assessment_loco_crate::engine::types::AssessmentData;
//!
