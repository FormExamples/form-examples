# Tasks: Occupational Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/occupational-medicine-waiting-list-card/`.
...
- [x] `cargo loco new occupational-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form occupational-medicine-waiting-list-card` exits cleanly.
