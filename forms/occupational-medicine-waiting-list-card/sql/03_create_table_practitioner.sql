-- Practitioner who places the patient on a occupational medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a occupational medicine waiting list card on behalf of the patient.';
