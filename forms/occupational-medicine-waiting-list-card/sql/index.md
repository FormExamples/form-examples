# occupational-medicine-waiting-list-card — sql
...
- `occ_med_waiting_list_card` — top-level waiting list card.
- `occ_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `occ_med_waiting_list_card_grade` — computed grading result.
- `occ_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `occ_med_waiting_list_card_grade_flag` — safety / operational flags fired
