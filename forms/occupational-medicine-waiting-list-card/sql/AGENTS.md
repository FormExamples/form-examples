# Occupational Medicine Waiting List Card — PostgreSQL migrations
...
Child `occ_med_waiting_list_card_*` tables reference
`occ_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
