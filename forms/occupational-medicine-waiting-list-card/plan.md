# Plan: Occupational Medicine Waiting List Card
...
months later. The Occupational Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form occupational-medicine-waiting-list-card`.
