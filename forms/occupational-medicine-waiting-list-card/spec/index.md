# Occupational Medicine Waiting List Card — specification
...
occupational medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form occupational-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check occupational-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `occupational-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `occupational-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
