...
describe('DAS28 Grading Engine', () => {
	...
	it('returns low disease activity for mild joint involvement', () => {
		const data = createHealthyPatient();
		data.jointAssessment.tenderJointCount28 = 2;
		data.jointAssessment.swollenJointCount28 = 1;
		data.laboratoryResults.esr = 12;
		data.jointAssessment.patientGlobalVAS = 20;
	...
	it('returns moderate disease activity for moderate joint involvement', () => {
		const data = createHealthyPatient();
		data.jointAssessment.tenderJointCount28 = 6;
		data.jointAssessment.swollenJointCount28 = 4;
		data.laboratoryResults.esr = 28;
