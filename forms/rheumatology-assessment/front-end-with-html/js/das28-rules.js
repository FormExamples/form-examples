// DAS28 declarative assessment rules.
// Mirrors the SvelteKit `src/lib/engine/das28-rules.ts` reference.
// Each rule fires (true/false) against an AssessmentData object and
// records a finding relevant to disease activity or treatment decisions
// in rheumatology.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} DAS28Rule
 * @property {string} id
...
const das28Rules = [
  // ─── JOINT ASSESSMENT ────────────────────────────────────
  {
    ...
    evaluate: (d) =>
      d.jointAssessment.tenderJointCount28 !== null &&
      d.jointAssessment.tenderJointCount28 > 5
  },
  {
    id: 'JA-002',
    category: 'Joint Assessment',
    ...
    evaluate: (d) =>
      d.jointAssessment.tenderJointCount28 !== null &&
      d.jointAssessment.tenderJointCount28 > 14
  },
  {
    id: 'JA-003',
    category: 'Joint Assessment',
    ...
    evaluate: (d) =>
      d.jointAssessment.swollenJointCount28 !== null &&
      d.jointAssessment.swollenJointCount28 > 5
  },
  {
    id: 'JA-004',
    category: 'Joint Assessment',
    ...
    evaluate: (d) =>
      d.jointAssessment.swollenJointCount28 !== null &&
      d.jointAssessment.swollenJointCount28 > 14
  },
  {
    id: 'JA-005',
    category: 'Joint Assessment',
    ...
    evaluate: (d) =>
      d.jointAssessment.painVAS !== null &&
      d.jointAssessment.painVAS > 60
  },
  ...
  // ─── DISEASE HISTORY ─────────────────────────────────────
  {
    ...
    evaluate: (d) =>
      d.diseaseHistory.diseaseDurationYears !== null &&
      d.diseaseHistory.diseaseDurationYears > 10
  },
  {
    id: 'DH-002',
    category: 'Disease History',
  ...
  // ─── FUNCTIONAL ASSESSMENT ───────────────────────────────
  {
    ...
    evaluate: (d) =>
      d.functionalAssessment.haqDiScore !== null &&
      d.functionalAssessment.haqDiScore > 1.5
  },
  {
    id: 'FA-002',
    category: 'Functional',
    ...
    evaluate: (d) =>
      d.functionalAssessment.haqDiScore !== null &&
      d.functionalAssessment.haqDiScore > 2.0
  },
  {
    id: 'FA-003',
    category: 'Functional',
  ...
  // ─── LABORATORY ABNORMALITIES ────────────────────────────
  {
    ...
    evaluate: (d) =>
      ...
      d.laboratoryResults.haemoglobin < 120
  },
  {
    id: 'LAB-010',
    category: 'Laboratory',
