//! Rheumatology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Rheumatology Assessment** medical form, built on the
...
//!
//! ```
//! use rheumatology_assessment_loco_crate::engine::types::AssessmentData;
//!
