...
- LocalStorage key `rheumatology-assessment.front-end-form-with-html.v1` (HTML) and
  `rheumatology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
