# Rheumatology Assessment — specification
...
- `bin/test-form rheumatology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check rheumatology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `rheumatology-assessment.front-end-form-with-html.v1` (HTML)
  - `rheumatology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
