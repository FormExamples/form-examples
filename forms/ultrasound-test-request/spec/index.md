# Ultrasound Test Request — specification
...
- `bin/test-form ultrasound-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check ultrasound-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `ultrasound-test-request.front-end-with-html.v1` (HTML)
  - `ultrasound-test-request.front-end-with-svelte.v1` (SvelteKit)
