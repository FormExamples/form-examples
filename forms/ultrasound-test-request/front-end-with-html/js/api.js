// Backend API client for the general (non-obstetric) ultrasound vetting
// dashboard.
//
...
window.UltrasoundTestRequestDashboard.fetchRequests = fetchRequests;
window.UltrasoundTestRequestDashboard.API_BASE = API_BASE;
})();
