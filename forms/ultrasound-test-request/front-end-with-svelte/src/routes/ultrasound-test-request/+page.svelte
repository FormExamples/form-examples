<script lang="ts">
	...
	// dashboard. The collection routes (`/ultrasound-test-requests` and
	// `/ultrasound-test-requests/new`) hold the actual functionality.
	const plural = 'ultrasound-test-requests';
</script>

<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		<p class="text-sm font-semibold uppercase tracking-wide text-primary">Ultrasound Test Request</p>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/ultrasound-test-request/{plural}/new"
		...
		<a
			href="/ultrasound-test-request/{plural}"
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with the ACR Appropriateness Criteria, the Royal College of Radiologists' iRefer
					referral guidelines, and BMUS / AIUM ultrasound preparation guidance.
				</dd>
			</div>
		</dl>
	</section>
