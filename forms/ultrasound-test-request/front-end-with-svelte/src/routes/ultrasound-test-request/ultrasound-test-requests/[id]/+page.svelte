<script lang="ts">
	...
	import Step5Preparation from '#lib/components/steps/Step5Preparation.svelte';
	...
	function submit() {
		...
		goto(`/ultrasound-test-request/ultrasound-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	...
	<Form label="Ultrasound test request" onsubmit={submit}>
