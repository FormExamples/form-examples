//! Care Privacy Notice — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Care Privacy Notice** medical form, built on the
...
//!
//! ```
//! use care_privacy_notice_loco_crate::engine::types::AssessmentData;
//!
