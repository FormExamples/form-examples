# Care Privacy Notice — specification
...
- `bin/test-form care-privacy-notice` exits cleanly.
...
- `bin/lily-html-refactor --check care-privacy-notice` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `care-privacy-notice.front-end-form-with-html.v1` (HTML)
  - `care-privacy-notice.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form care-privacy-notice
```
