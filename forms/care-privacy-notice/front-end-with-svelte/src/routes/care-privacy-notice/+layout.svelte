...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/care-privacy-notice/"
                class="text-lg font-bold text-base-content"
                >Care Privacy Notice</a
            >
            <div class="flex items-center gap-1">
                <a href="/care-privacy-notice/" class={navClass("/")}>Welcome</a
                >
                <a
                    href="/care-privacy-notice/care-privacy-notices/new"
                    class={navClass("/care-privacy-notices/new")}>New notice</a
                >
                <a
                    href="/care-privacy-notice/care-privacy-notices"
                    class={navClass("/care-privacy-notices")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
