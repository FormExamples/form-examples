...
The Care Privacy Notice is the patient-facing privacy notice that an NHS GP
practice (or equivalent provider) must give to data subjects under UK GDPR
Articles 13 and 14 in respect of the personal data the practice collects to
deliver direct patient care. The notice is read-and-acknowledge: it does not
itself constitute the lawful basis for processing — that basis is fixed by
statute — but it satisfies the practice's transparency obligation.
...
- **UK GDPR** — Retained Regulation (EU) 2016/679 as amended by the Data
  ...
  Exit) Regulations 2019. Indexed at:
...
UK GDPR requires the notice to state the lawful basis. For routine NHS
direct-care processing the cited bases are:

- UK GDPR Article 6(1)(e) — task carried out in the public interest or in
  the exercise of official authority vested in the controller.
- UK GDPR Article 9(2)(h) — processing necessary for the provision of
  health or social care, or treatment, or the management of health or
  social-care systems and services, on the basis of UK law (DPA 2018
...
The British Medical Association (BMA) maintains a model GP privacy notice
that satisfies the UK GDPR Articles 13/14 transparency requirements. This
form mirrors the structure of the BMA template:

- BMA — Privacy notices for GP practices:
  <https://www.bma.org.uk/advice-and-support/ethics/confidentiality-and-health-records/privacy-notices-for-gp-practices>
...
- General Medical Council. *Confidentiality: good practice in handling
  patient information* (2017) —
  <https://www.gmc-uk.org/professional-standards/professional-standards-for-doctors/confidentiality>

## Acknowledgment as audit evidence

The form's acknowledgment record (checkbox, full name, date) is *not* a
consent under UK GDPR Article 6(1)(a) or 9(2)(a). It is an audit record of
the controller having met its Article 13 transparency duty. The controller
retains this record under the Data Security and Protection Toolkit
retention guidance:
