# Infectious Diseases Waiting List Card — specification
...
infectious diseases waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/lily-html-refactor --check infectious-diseases-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `infectious-diseases-waiting-list-card.front-end-with-html.v1` (HTML)
  - `infectious-diseases-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
