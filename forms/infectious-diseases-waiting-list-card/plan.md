# Plan: Infectious Diseases Waiting List Card
...
months later. The Infectious Diseases Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form infectious-diseases-waiting-list-card`.
