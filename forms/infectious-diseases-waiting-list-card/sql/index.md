# infectious-diseases-waiting-list-card — sql
...
- `infect_dis_waiting_list_card` — top-level waiting list card.
- `infect_dis_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `infect_dis_waiting_list_card_grade` — computed grading result.
- `infect_dis_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `infect_dis_waiting_list_card_grade_flag` — safety / operational flags fired
