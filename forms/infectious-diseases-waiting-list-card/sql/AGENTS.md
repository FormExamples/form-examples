# Infectious Diseases Waiting List Card — PostgreSQL migrations
...
Child `infect_dis_waiting_list_card_*` tables reference
`infect_dis_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
