-- Practitioner who places the patient on a infectious diseases waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a infectious diseases waiting list card on behalf of the patient.';
