//! Dyslexia Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Dyslexia Assessment** medical form, built on the
...
//!
//! ```
//! use dyslexia_assessment_loco_crate::engine::types::AssessmentData;
//!
