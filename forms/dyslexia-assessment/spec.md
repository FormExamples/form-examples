# Dyslexia Assessment — specification
...
- `bin/test-form dyslexia-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check dyslexia-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `dyslexia-assessment.front-end-form-with-html.v1` (HTML)
  - `dyslexia-assessment.front-end-form-with-svelte.v1` (SvelteKit)
