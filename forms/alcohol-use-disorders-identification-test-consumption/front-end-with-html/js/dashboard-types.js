...
/**
 * Total AUDIT-C score — integer 0-12, or null when not yet scored.
 *
 * @typedef {number | null} AuditcScore
 */
 ...
 * `forms/alcohol-use-disorders-identification-test-consumption/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {AuditcScore} auditcScore   - total AUDIT-C score (0-12) or null
 * @property {RiskBand} riskBand         - derived risk band
 * @property {boolean} positiveScreen    - true when AUDIT-C >= 5 (positive screen)
...
// namespace, `window.AlcoholUseDisordersIdentificationTestConsumptionDashboard`.
