# Changelog — Alcohol Use Disorders Identification Test — Consumption (AUDIT-C)
...
file only records changes scoped to the **Alcohol Use Disorders Identification Test — Consumption (AUDIT-C)** form.
