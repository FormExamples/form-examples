...
<svelte:head>
	<title>Alcohol Use Disorders Identification Test — Consumption (AUDIT-C)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/alcohol-use-disorders-identification-test-consumption/" class="text-lg font-bold text-base-content">AUDIT-C</a>
			<div class="flex items-center gap-1">
				<a href="/alcohol-use-disorders-identification-test-consumption/" class={navClass('/')}>Welcome</a>
				<a href="/alcohol-use-disorders-identification-test-consumption/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/alcohol-use-disorders-identification-test-consumption/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
