...
function storageKey(id: string): string {
	return `alcohol-use-disorders-identification-test-consumption.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank AUDIT-C assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the AUDIT-C assessment, with localStorage
