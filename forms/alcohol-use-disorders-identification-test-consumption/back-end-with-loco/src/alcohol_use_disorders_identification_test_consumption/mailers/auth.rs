...
static welcome: Dir<'_> = include_dir!("src/alcohol_use_disorders_identification_test_consumption/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/alcohol_use_disorders_identification_test_consumption/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/alcohol_use_disorders_identification_test_consumption/mailers/auth/magic_link");
