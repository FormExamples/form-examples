...
Server-side Rust JSON API for the Medication Reconciliation form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`medication_reconciliation/`](medication_reconciliation/) — one migration, SeaORM
