...
static welcome: Dir<'_> = include_dir!("src/medication_reconciliation/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medication_reconciliation/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medication_reconciliation/mailers/auth/magic_link");
