    ...
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            ...
            <div class="flex items-center gap-1">
                <a href="/medication-reconciliation/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/medication-reconciliation/medication-reconciliations/new"
                    class={navClass("/medication-reconciliations/new")}
                    >New reconciliation</a
                >
                <a
                    href="/medication-reconciliation/medication-reconciliations"
                    class={navClass("/medication-reconciliations")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
