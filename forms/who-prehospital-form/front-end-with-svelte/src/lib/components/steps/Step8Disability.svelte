<script lang="ts">
	...
	import { gcsTotal } from '#lib/engine/utils.js';
...
>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">GCS</h3>
	...
	<p class="mb-3 text-sm text-base-content/70">
		GCS total: <span class="font-semibold text-base-content">{gcs ?? '—'}</span>
	</p>
