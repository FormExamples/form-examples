...
>
	{#if !cv.injury}
		<p class="mb-4 rounded-md bg-info/10 px-3 py-2 text-sm text-info">
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Mechanism</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Road traffic incident</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Safety equipment</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
