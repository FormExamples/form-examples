//! Who Prehospital Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Prehospital Form** medical form, built on the
...
//!
//! ```
//! use who_prehospital_form_loco_crate::engine::types::AssessmentData;
//!
