# WHO Prehospital Form — specification
...
- `bin/test-form who-prehospital-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-prehospital-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-prehospital-form.front-end-form-with-html.v1` (HTML)
  - `who-prehospital-form.front-end-form-with-svelte.v1` (SvelteKit)
