//! Tera context builders for the WHO Prehospital Form (SCF Prehospital) assessment.
...
use crate::engine::prehospital_validator::validate_prehospital;
...
pub fn build_report_context(data: &AssessmentData, id: Uuid) -> Context {
    let validation = validate_prehospital(data);
