<script lang="ts">
	...
	// dashboard. The collection routes (`/electroencephalogram-test-requests` and
	// `/electroencephalogram-test-requests/new`) hold the actual functionality.
	const plural = 'electroencephalogram-test-requests';
</script>
...
<main class="mx-16 px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/electroencephalogram-test-request/{plural}/new"
		...
		<a
			href="/electroencephalogram-test-request/{plural}"
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with NICE NG217 (epilepsies in children, young people and adults) and ILAE
					guidance: EEG supports an epilepsy diagnosis and helps classify seizure type / syndrome but
					must not be used to exclude epilepsy nor in isolation.
				</dd>
			</div>
		</dl>
	</section>
