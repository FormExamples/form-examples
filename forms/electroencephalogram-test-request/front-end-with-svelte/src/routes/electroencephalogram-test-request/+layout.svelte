...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/electroencephalogram-test-request/"
                class="text-lg font-bold text-base-content">EEG Test Request</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/electroencephalogram-test-requests/new")}
                    >New request</a
                >
                <a
                    href="/electroencephalogram-test-request/electroencephalogram-test-requests"
                    class={navClass("/electroencephalogram-test-requests")}
                    >Vetting dashboard</a
                >
                <LocalePicker
                    label="Language"
