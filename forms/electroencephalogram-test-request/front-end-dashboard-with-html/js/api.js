// Backend API client for the EEG vetting dashboard.
//
...
window.ElectroencephalogramTestRequestDashboard.fetchRequests = fetchRequests;
window.ElectroencephalogramTestRequestDashboard.API_BASE = API_BASE;
})();
