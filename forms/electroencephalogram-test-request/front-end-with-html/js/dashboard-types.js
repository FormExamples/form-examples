// Plain-JavaScript / JSDoc type definitions for the EEG vetting dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (NICE NG217 / ILAE 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Triage tier emitted by Axis B (urgency, red-flag escalation).
 ...
 * @property {string} eegType         - Requested EEG type (kebab-case)
 ...
 * @property {TriageTier} triageTier  - Axis B urgency tier
...
// before they read `window.ElectroencephalogramTestRequestDashboard`.
