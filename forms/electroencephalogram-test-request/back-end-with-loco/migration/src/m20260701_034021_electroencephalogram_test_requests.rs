...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "electroencephalogram_test_requests",
            &[
            ...
            ("first_seizure", ColType::Boolean),
            ("known_epilepsy", ColType::Boolean),
            ("current_antiepileptics", ColType::String),
            ("recent_seizure", ColType::Boolean),
            ("suspected_status_epilepticus", ColType::Boolean),
    ...
    async fn down(&self, m: &SchemaManager) -> Result<(), DbErr> {
        drop_table(m, "electroencephalogram_test_requests").await
    }
}
