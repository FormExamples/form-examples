...
Rust axum + Loco JSON API for the EEG test request. Generated scaffold is driven
by `../back-end-with-loco-setup` (one `cargo loco generate scaffold --api` per
SQL table, in FK-dependency order).
