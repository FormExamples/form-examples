# nuclear-medicine-waiting-list-card — sql
...
- `nuclear_med_waiting_list_card` — top-level waiting list card.
- `nuclear_med_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `nuclear_med_waiting_list_card_grade` — computed grading result.
- `nuclear_med_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `nuclear_med_waiting_list_card_grade_flag` — safety / operational flags fired
