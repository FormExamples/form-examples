-- Practitioner who places the patient on a nuclear medicine waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a nuclear medicine waiting list card on behalf of the patient.';
