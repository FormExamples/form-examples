# Nuclear Medicine Waiting List Card — PostgreSQL migrations
...
Child `nuclear_med_waiting_list_card_*` tables reference
`nuclear_med_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
