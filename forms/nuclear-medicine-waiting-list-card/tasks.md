# Tasks: Nuclear Medicine Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/nuclear-medicine-waiting-list-card/`.
...
- [x] `cargo loco new nuclear-medicine-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form nuclear-medicine-waiting-list-card` exits cleanly.
