# Nuclear Medicine Waiting List Card — specification
...
nuclear medicine waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form nuclear-medicine-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check nuclear-medicine-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `nuclear-medicine-waiting-list-card.front-end-with-html.v1` (HTML)
  - `nuclear-medicine-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
