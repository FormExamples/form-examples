# Plan: Nuclear Medicine Waiting List Card
...
months later. The Nuclear Medicine Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form nuclear-medicine-waiting-list-card`.
