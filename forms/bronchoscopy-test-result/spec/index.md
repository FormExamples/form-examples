# Bronchoscopy Test Result — specification
...
- `bin/test-form bronchoscopy-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check bronchoscopy-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `bronchoscopy-test-result.front-end-with-html.v1` (HTML)
  - `bronchoscopy-test-result.front-end-with-svelte.v1` (SvelteKit)
