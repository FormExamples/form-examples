import type { BronchoscopyResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a bronchoscopy result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (suspected endobronchial tumour, massive
 * haemoptysis, or procedural pneumothorax) auto-escalates Axis D to
 ...
 */
export function calculateGrade(result: BronchoscopyResult): GradingResult {
