<script lang="ts">
	...
	import Step5SamplesComplications from '$lib/components/steps/Step5SamplesComplications.svelte';
	...
	function submit() {
		...
		goto('/bronchoscopy-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New bronchoscopy report</h1>
	...
	<Form label="Bronchoscopy test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2ProcedureDetails />
		<Step3ClinicalHistory />
		<Step4Findings />
		<Step5SamplesComplications />
		<Step6Impression />
