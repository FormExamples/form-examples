...
// Bronchoscopy Test Result — clinician dashboard (vanilla classic-script app).
//
...
// their exports to `window.BronchoscopyTestResultDashboard`; display labels
// come from the form namespace `window.BronchoscopyTestResult` (js/types.js).
