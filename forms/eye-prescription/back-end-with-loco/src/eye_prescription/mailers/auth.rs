...
static welcome: Dir<'_> = include_dir!("src/eye_prescription/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/eye_prescription/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/eye_prescription/mailers/auth/magic_link");
