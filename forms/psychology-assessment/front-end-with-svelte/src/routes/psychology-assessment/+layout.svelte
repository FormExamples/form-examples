...
<svelte:head>
	<title>Psychology Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/psychology-assessment/" class="text-lg font-bold text-base-content">Psychology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/psychology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/psychology-assessment/psychology-assessments/new" class={navClass('/psychology-assessments/new')}>New assessment</a>
				<a href="/psychology-assessment/psychology-assessments" class={navClass('/psychology-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
