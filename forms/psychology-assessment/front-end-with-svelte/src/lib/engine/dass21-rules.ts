import type { DassRule } from './types';

/**
 * DASS-21 (Depression Anxiety Stress Scales — 21 item) rules.
 *
 * Each rule maps one questionnaire item to a 0–3 Likert response, or null when
 * the patient has not yet answered. The grader sums each subscale and doubles
 * the raw total so the score aligns with the DASS-42 normative cutoffs
 ...
 */
export const dass21Rules: DassRule[] = [
	// ── Depression ────────────────────────────────────
	{
		id: 'DASS-D-03',
		subscale: 'depression',
