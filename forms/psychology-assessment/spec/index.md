...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql/` (6 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- LocalStorage keys preserve draft state across reloads:
  - `psychology-assessment.front-end-with-html.v1` (HTML)
  - `psychology-assessment.front-end-with-svelte.v1` (SvelteKit)
