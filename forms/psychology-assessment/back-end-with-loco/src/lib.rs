//! Psychology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Psychology Assessment** medical form, built on the
...
//!
//! ```
//! use psychology_assessment_loco_crate::engine::types::AssessmentData;
//!
