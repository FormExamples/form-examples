# Psychology Assessment — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (5 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form psychology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check psychology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `psychology-assessment.front-end-form-with-html.v1` (HTML)
  - `psychology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
