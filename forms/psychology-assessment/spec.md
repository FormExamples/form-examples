...
- LocalStorage key `psychology-assessment.front-end-form-with-html.v1` (HTML) and
  `psychology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
