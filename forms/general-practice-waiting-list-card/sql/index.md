# general-practice-waiting-list-card — sql
...
- `gen_practice_waiting_list_card` — top-level waiting list card.
- `gen_practice_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `gen_practice_waiting_list_card_grade` — computed grading result.
- `gen_practice_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `gen_practice_waiting_list_card_grade_flag` — safety / operational flags fired
