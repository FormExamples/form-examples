-- Practitioner who places the patient on a general practice waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a general practice waiting list card on behalf of the patient.';
