# Tasks: General Practice Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/general-practice-waiting-list-card/`.
...
- [x] `cargo loco new general-practice-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form general-practice-waiting-list-card` exits cleanly.
