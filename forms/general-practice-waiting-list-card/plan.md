# Plan: General Practice Waiting List Card
...
months later. The General Practice Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form general-practice-waiting-list-card`.
