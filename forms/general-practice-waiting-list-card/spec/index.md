# General Practice Waiting List Card — specification
...
general practice waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form general-practice-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check general-practice-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `general-practice-waiting-list-card.front-end-with-html.v1` (HTML)
  - `general-practice-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
