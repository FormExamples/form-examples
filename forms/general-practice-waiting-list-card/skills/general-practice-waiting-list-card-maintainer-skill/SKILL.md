---
name: general-practice-waiting-list-card-maintainer-skill
description: "Implementation workflow for maintaining and extending the General Practice Waiting List Card form (forms/general-practice-waiting-list-card/) — editing its spec, schema, or engine, regenerating derived artefacts, and running its verify gates. Use when implementing a change to this form's spec, SQL schema, front-end, back-end, or personas. For the repo-wide workflow, use form-examples-maintainer-skill instead."
---

# General Practice Waiting List Card — Maintainer Skill

Implementation-facing companion to `general-practice-waiting-list-card-skill` (this form's end-user concepts skill) and to `form-examples-maintainer-skill` (the repo-wide maintainer skill — read that one first for the golden rule, generators, and the full verify-gate catalogue). This skill is the one-form-scoped map.

## Directory layout

`forms/general-practice-waiting-list-card/` contains:
...
```sh
bin/test-form general-practice-waiting-list-card
bin/test-sql-apply general-practice-waiting-list-card
bin/test-personas general-practice-waiting-list-card
bin/test-e2e --html general-practice-waiting-list-card
```
