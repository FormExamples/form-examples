# General Practice Waiting List Card — FHIR R5
...
- `ServiceRequest` — from `gen_practice_waiting_list_card`
- `Appointment` — from `gen_practice_waiting_list_card_appointment`
