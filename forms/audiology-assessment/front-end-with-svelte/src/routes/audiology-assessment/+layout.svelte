...
<svelte:head>
	<title>Audiology Assessment</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/audiology-assessment/" class="text-lg font-bold text-base-content">Audiology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/audiology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/audiology-assessment/audiology-assessments/new" class={navClass('/audiology-assessments/new')}>New assessment</a>
				<a href="/audiology-assessment/audiology-assessments" class={navClass('/audiology-assessments')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
