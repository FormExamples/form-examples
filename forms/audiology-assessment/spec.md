# Audiology Assessment — specification
...
- `bin/test-form audiology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check audiology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `audiology-assessment.front-end-form-with-html.v1` (HTML)
  - `audiology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
