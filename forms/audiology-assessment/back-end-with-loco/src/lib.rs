//! Audiology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Audiology Assessment** medical form, built on the
...
//!
//! ```
//! use audiology_assessment_loco_crate::engine::types::AssessmentData;
//!
