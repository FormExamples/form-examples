// ──────────────────────────────────────────────
// Ultrasound Test Result — core data types
//
// General (non-obstetric) ultrasound result (report).
//
// Field names are camelCase (front-end serde); they mirror the snake_case
// columns in sql/04_create_table_ultrasound_test_result.sql and
...
export type ExaminationAdequacy = 'adequate' | 'limited-body-habitus' | 'non-diagnostic' | '';
