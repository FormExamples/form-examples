 ...
 * `forms/ultrasound-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
...
// namespace, `window.UltrasoundTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.UltrasoundTestResultDashboard`.
})();
