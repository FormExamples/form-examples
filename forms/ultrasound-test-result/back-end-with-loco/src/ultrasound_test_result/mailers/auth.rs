...
static welcome: Dir<'_> = include_dir!("src/ultrasound_test_result/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/ultrasound_test_result/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/ultrasound_test_result/mailers/auth/magic_link");
