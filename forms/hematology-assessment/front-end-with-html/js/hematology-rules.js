...
// `src/lib/engine/hematology-rules.ts`.

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 * @typedef {import('./types.js').FiredRule} FiredRule
 *
 * @typedef {Object} HematologyRule
 * @property {string} id
...
function allRules() {
  return [
    // ─── HIGH CONCERN ─────────────────────────────────────
    {
      ...
      concernLevel: 'high',
      evaluate: (d) =>
        d.bloodCountAnalysis.hemoglobin !== null &&
        d.bloodCountAnalysis.hemoglobin < 7.0
    },
    {
      id: 'HEM-002',
      category: 'Blood Count',
      ...
      concernLevel: 'high',
      evaluate: (d) =>
        d.bloodCountAnalysis.plateletCount !== null &&
        d.bloodCountAnalysis.plateletCount < 20.0
    },
    {
      id: 'HEM-003',
      category: 'Blood Count',
      ...
      concernLevel: 'high',
      evaluate: (d) =>
        d.bloodCountAnalysis.whiteBloodCellCount !== null &&
        d.bloodCountAnalysis.whiteBloodCellCount > 30.0
    },
    {
      id: 'HEM-004',
      ...
      concernLevel: 'high',
      evaluate: (d) =>
        d.coagulationStudies.inr !== null &&
        d.coagulationStudies.inr > 4.0
    },
    {
      id: 'HEM-005',
      category: 'Coagulation',
      ...
      concernLevel: 'high',
      evaluate: (d) =>
        d.coagulationStudies.fibrinogen !== null &&
        d.coagulationStudies.fibrinogen < 100.0
    },
    // ─── MEDIUM CONCERN ───────────────────────────────────
    {
      id: 'HEM-006',
      ...
      evaluate: (d) =>
        d.bloodCountAnalysis.hemoglobin !== null &&
        d.bloodCountAnalysis.hemoglobin >= 7.0 &&
        d.bloodCountAnalysis.hemoglobin < 10.0
    },
    {
      id: 'HEM-007',
      category: 'Blood Count',
      ...
      evaluate: (d) =>
        d.bloodCountAnalysis.plateletCount !== null &&
        d.bloodCountAnalysis.plateletCount >= 20.0 &&
        d.bloodCountAnalysis.plateletCount < 50.0
    },
    {
      id: 'HEM-008',
      category: 'Blood Count',
      ...
      evaluate: (d) =>
        d.bloodCountAnalysis.whiteBloodCellCount !== null &&
        d.bloodCountAnalysis.whiteBloodCellCount < 4.0
    },
    {
      id: 'HEM-009',
      category: 'Blood Count',
      ...
      concernLevel: 'medium',
      evaluate: (d) =>
        d.bloodCountAnalysis.meanCorpuscularVolume !== null &&
        d.bloodCountAnalysis.meanCorpuscularVolume < 80.0
    },
    {
      id: 'HEM-010',
      category: 'Blood Count',
      ...
      evaluate: (d) =>
        d.bloodCountAnalysis.meanCorpuscularVolume !== null &&
        d.bloodCountAnalysis.meanCorpuscularVolume > 100.0
    },
    {
      id: 'HEM-011',
      category: 'Coagulation',
    ...
    },
    {
      ...
      concernLevel: 'medium',
      evaluate: (d) =>
        d.coagulationStudies.dDimer !== null &&
        d.coagulationStudies.dDimer > 2.0
    },
    {
      id: 'HEM-013',
      ...
      concernLevel: 'medium',
      evaluate: (d) =>
        d.ironStudies.serumFerritin !== null &&
        d.ironStudies.serumFerritin < 10.0
    },
    {
      id: 'HEM-014',
      category: 'Iron Studies',
      ...
      evaluate: (d) =>
        d.ironStudies.serumFerritin !== null &&
        d.ironStudies.serumFerritin > 500.0
    },
    {
      id: 'HEM-015',
      category: 'Blood Count',
    ...
    },
    {
      ...
      evaluate: (d) =>
        d.coagulationStudies.dDimer !== null &&
        d.coagulationStudies.dDimer > 0.5 &&
        d.coagulationStudies.dDimer <= 2.0
    },
    {
      id: 'HEM-020',
      ...
      concernLevel: 'low',
      evaluate: (d) =>
        d.bloodCountAnalysis.redCellDistributionWidth !== null &&
        d.bloodCountAnalysis.redCellDistributionWidth > 14.5
    }
  ];
}

/**
 * Evaluate every rule against the supplied data and return the rules that fire.
...
function evaluateRules(data) {
  ...
  for (const rule of allRules()) {
    try {
      ...
      console.warn(`Hematology rule ${rule.id} evaluation failed:`, e);
    }
  }
  return fired;
}
