...
function storageKey(id: string): string {
	return `hematology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank hematology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the hematology assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.bloodCountAnalysis`) stay bound to live state.
	 */
