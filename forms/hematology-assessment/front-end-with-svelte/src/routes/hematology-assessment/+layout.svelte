...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/hematology-assessment/" class="text-lg font-bold text-base-content">Hematology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/hematology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/hematology-assessment/hematology-assessments/new" class={navClass('/hematology-assessments/new')}>New assessment</a>
				<a href="/hematology-assessment/hematology-assessments" class={navClass('/hematology-assessments')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
