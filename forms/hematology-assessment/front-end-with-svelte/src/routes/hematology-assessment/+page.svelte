<script lang="ts">
	...
	// dashboard. The collection routes (`/hematology-assessments` and
	// `/hematology-assessments/new`) hold the actual functionality.
	const plural = 'hematology-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/hematology-assessment/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed abnormality classification and composite score,
				and filter by classification and specimen type.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the deviation-based scoring
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses reference ranges for the complete blood count, coagulation studies, and iron studies to
					derive a composite haematological abnormality classification.
				</dd>
			</div>
		</dl>
	</section>
