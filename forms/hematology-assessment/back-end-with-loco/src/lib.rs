//! Hematology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Hematology Assessment** medical form, built on the
...
//!
//! ```
//! use hematology_assessment_loco_crate::engine::types::AssessmentData;
//!
