...
- LocalStorage key `hematology-assessment.front-end-form-with-html.v1` (HTML) and
  `hematology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
