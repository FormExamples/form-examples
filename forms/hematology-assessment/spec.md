# Hematology Assessment — specification
...
- `bin/test-form hematology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check hematology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `hematology-assessment.front-end-form-with-html.v1` (HTML)
  - `hematology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form hematology-assessment
```
