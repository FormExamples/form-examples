// Plain-JavaScript / JSDoc type definitions for the DEXA bone-density
// vetting dashboard.
//
...
/**
 * Triage tier emitted by Axis D (high-acuity escalation).
 ...
 * @property {string} scanRegion      - Requested scan region (kebab-case)
 * @property {string} indication      - Primary clinical indication (kebab-case)
 * @property {number|null} fraxPercent - FRAX 10-year major-fracture probability
 * @property {AppropriatenessBand} appropriatenessBand - Axis A band
 * @property {DoseBand} radiationDoseBand - Axis B radiation dose band
...
// before they read `window.DexaBoneDensityTestRequestDashboard`.
