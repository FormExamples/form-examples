// Backend API client for the DEXA bone-density vetting dashboard.
//
...
window.DexaBoneDensityTestRequestDashboard.fetchRequests = fetchRequests;
window.DexaBoneDensityTestRequestDashboard.API_BASE = API_BASE;
})();
