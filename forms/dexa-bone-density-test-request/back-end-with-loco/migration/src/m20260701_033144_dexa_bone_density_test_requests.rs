...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "dexa_bone_density_test_requests",
            ...
            ("previous_fragility_fracture", ColType::BooleanWithDefault(false)),
            ("long_term_steroids", ColType::BooleanWithDefault(false)),
            ("menopause_status", ColType::StringWithDefault(String::new())),
            ("parental_hip_fracture", ColType::BooleanWithDefault(false)),
            ("weight_kg", ColType::DoubleNull),
            ("previous_dexa", ColType::StringWithDefault(String::new())),
