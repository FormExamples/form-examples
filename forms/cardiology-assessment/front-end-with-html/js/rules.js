...
// present. Rules contribute to both CCS/NYHA classification and the overall
// risk determination performed by `cardio-grader.js`.
//
...
const cardioRules = [
  ...
  },
  {
    ...
    evaluate: (d) =>
      ...
      d.chestPainAngina.anginaFrequency === 'daily'
  },
  {
    id: 'CP-007',
    system: 'Chest Pain',
  ...
  // ─── CARDIAC HISTORY ────────────────────────────────────────
  {
    ...
    grade: 2,
    evaluate: (d) =>
      d.cardiacHistory.previousMI === 'yes' &&
  ...
  // ─── RISK FACTORS ───────────────────────────────────────────
  {
    ...
    grade: 1,
    evaluate: (d) =>
      d.riskFactors.hypertension === 'yes' &&
      d.riskFactors.hypertensionControlled === 'yes'
  },
  {
    id: 'RF-002',
    system: 'Risk Factors',
    ...
    evaluate: (d) =>
      d.riskFactors.hypertension === 'yes' &&
      d.riskFactors.hypertensionControlled === 'no'
  },
  {
    id: 'RF-003',
    system: 'Risk Factors',
  ...
  // ─── FUNCTIONAL CAPACITY ────────────────────────────────────
  {
    ...
    grade: 3,
    evaluate: (d) =>
      d.socialFunctional.estimatedMETs !== null &&
      d.socialFunctional.estimatedMETs < 4
  },
