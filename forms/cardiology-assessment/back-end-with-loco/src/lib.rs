//! Cardiology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Cardiology Assessment** medical form, built on the
...
//!
//! ```
//! use cardiology_assessment_loco_crate::engine::types::AssessmentData;
//!
