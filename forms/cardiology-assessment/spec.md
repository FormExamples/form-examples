# Cardiology Assessment — specification
...
- `bin/test-form cardiology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check cardiology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `cardiology-assessment.front-end-form-with-html.v1` (HTML)
  - `cardiology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
