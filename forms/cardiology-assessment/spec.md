...
- LocalStorage key `cardiology-assessment.front-end-form-with-html.v1` (HTML) and
  `cardiology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
