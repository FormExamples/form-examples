...
function storageKey(id: string): string {
	return `cardiology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank cardiology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the cardiology assessment, with localStorage
