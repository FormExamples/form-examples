...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/cardiology-assessment/"
                class="text-lg font-bold text-base-content"
                >Cardiology Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/cardiology-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/cardiology-assessment/cardiology-assessments/new"
                    class={navClass("/cardiology-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/cardiology-assessment/cardiology-assessments"
                    class={navClass("/cardiology-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
