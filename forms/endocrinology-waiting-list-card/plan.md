# Plan: Endocrinology Waiting List Card
...
months later. The Endocrinology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form endocrinology-waiting-list-card`.
