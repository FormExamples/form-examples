# Tasks: Endocrinology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/endocrinology-waiting-list-card/`.
...
- [x] `cargo loco new endocrinology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form endocrinology-waiting-list-card` exits cleanly.
