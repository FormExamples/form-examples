...
```sh
bin/test-form endocrinology-waiting-list-card
bin/test-sql-apply endocrinology-waiting-list-card
bin/test-personas endocrinology-waiting-list-card
bin/test-e2e --html endocrinology-waiting-list-card
```
