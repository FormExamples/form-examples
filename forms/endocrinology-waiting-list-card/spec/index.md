# Endocrinology Waiting List Card — specification
...
endocrinology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form endocrinology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check endocrinology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `endocrinology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `endocrinology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
