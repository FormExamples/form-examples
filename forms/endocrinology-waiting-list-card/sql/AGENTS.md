# Endocrinology Waiting List Card — PostgreSQL migrations
...
Child `endocrinology_waiting_list_card_*` tables reference
`endocrinology_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
