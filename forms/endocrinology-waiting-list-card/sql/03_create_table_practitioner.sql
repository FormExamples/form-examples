-- Practitioner who places the patient on a endocrinology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a endocrinology waiting list card on behalf of the patient.';
