# Endoscopy Test Request — specification
...
- `bin/test-form endoscopy-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check endoscopy-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `endoscopy-test-request.front-end-form-with-html.v1` (HTML)
  - `endoscopy-test-request.front-end-form-with-svelte.v1` (SvelteKit)
