// Backend API client for the GI endoscopy vetting dashboard.
//
...
window.EndoscopyTestRequestDashboard.fetchRequests = fetchRequests;
window.EndoscopyTestRequestDashboard.API_BASE = API_BASE;
})();
