...
// Sleep Study Test Request — vetting dashboard (vanilla classic-script app).
//
...
// attach their exports to `window.SleepStudyTestRequestDashboard`. The whole
...
const columns = [
  ...
  { key: 'epworthScore',        label: 'Epworth' },
...
function renderTableBody() {
  ...
  for (const row of rows) {
    ...
    if (row.triageTier === 'urgent' && row.priorityBand === 'high') {
    ...
    tr.innerHTML = `
      ...
      <td class="data-table-td"><span class="numeric-cell">${esc(epworthDisplay(row.epworthScore))}</span></td>
