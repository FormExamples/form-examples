<script lang="ts">
	...
	import Step4SleepScores from '#lib/components/steps/Step4SleepScores.svelte';
	import Step5SymptomsAndRisk from '#lib/components/steps/Step5SymptomsAndRisk.svelte';
	...
	function submit() {
		...
		goto(`/sleep-study-test-request/sleep-study-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New sleep-study request' : `Sleep-study request ${id}`}
	</h1>
	...
	<Form label="Sleep study request" onsubmit={submit}>
		<Step1RequestingClinician />
		<Step2PatientIdentification />
		<Step3RequestedStudy />
		<Step4SleepScores />
		<Step5SymptomsAndRisk />
