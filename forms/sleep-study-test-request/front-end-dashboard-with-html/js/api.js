// Backend API client for the sleep study vetting dashboard.
//
...
window.SleepStudyTestRequestDashboard.fetchRequests = fetchRequests;
window.SleepStudyTestRequestDashboard.API_BASE = API_BASE;
})();
