...
- LocalStorage key `who-surgical-safety-checklist.front-end-form-with-html.v1` (HTML) and
  `who-surgical-safety-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
