...
- `bin/test-form who-surgical-safety-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check who-surgical-safety-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-surgical-safety-checklist.front-end-form-with-html.v1` (HTML)
  - `who-surgical-safety-checklist.front-end-form-with-svelte.v1` (SvelteKit)
