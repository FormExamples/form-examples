...
<svelte:head>
	<title>WHO Surgical Safety Checklist</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/who-surgical-safety-checklist/" class="text-lg font-bold text-base-content">WHO Surgical Safety Checklist</a>
			<div class="flex items-center gap-1">
				<a href="/who-surgical-safety-checklist/" class={navClass('/')}>Welcome</a>
				<a href="/who-surgical-safety-checklist/who-surgical-safety-checklists/new" class={navClass('/who-surgical-safety-checklists/new')}>New checklist</a>
				<a href="/who-surgical-safety-checklist/who-surgical-safety-checklists" class={navClass('/who-surgical-safety-checklists')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
