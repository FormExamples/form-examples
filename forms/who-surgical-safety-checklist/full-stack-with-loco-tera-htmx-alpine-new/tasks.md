...
- [ ] Run `../full-stack-with-loco-tera-htmx-alpine-setup` to scaffold all four resources
...
- [ ] Promote this crate to replace `../full-stack-with-loco-tera-htmx-alpine/` once at parity
