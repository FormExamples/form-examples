//! Who Surgical Safety Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Surgical Safety Checklist** medical form, built on the
...
//!
//! ```
//! use who_surgical_safety_checklist_loco_crate::engine::types::AssessmentData;
//!
