...
- LocalStorage key `architecture-decision-record.front-end-form-with-html.v1` (HTML) and
  `architecture-decision-record.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
