# Architecture Decision Record: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Architecture Decision Record form. Pure back-end: no HTML
