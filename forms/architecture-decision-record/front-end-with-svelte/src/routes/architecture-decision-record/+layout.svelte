...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/architecture-decision-record/"
                class="text-lg font-bold text-base-content"
                >Architecture Decision Record</a
            >
            <div class="flex items-center gap-1">
                <a href="/architecture-decision-record/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/architecture-decision-record/architecture-decision-records/new"
                    class={navClass("/architecture-decision-records/new")}
                    >New record</a
                >
                <a
                    href="/architecture-decision-record/architecture-decision-records"
                    class={navClass("/architecture-decision-records")}
                    >Register</a
                >
                <LocalePicker
                    label="Language"
