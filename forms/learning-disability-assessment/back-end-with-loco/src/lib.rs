//! Learning Disability Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Learning Disability Assessment** medical form, built on the
...
//!
//! ```
//! use learning_disability_assessment_loco_crate::engine::types::AssessmentData;
//!
