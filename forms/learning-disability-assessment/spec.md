# Learning Disability Assessment — specification
...
- `bin/test-form learning-disability-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check learning-disability-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `learning-disability-assessment.front-end-form-with-html.v1` (HTML)
  - `learning-disability-assessment.front-end-form-with-svelte.v1` (SvelteKit)
...
```sh
bin/test-form learning-disability-assessment
```
