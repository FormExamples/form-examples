...
- LocalStorage key `learning-disability-assessment.front-end-form-with-html.v1` (HTML) and
  `learning-disability-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
