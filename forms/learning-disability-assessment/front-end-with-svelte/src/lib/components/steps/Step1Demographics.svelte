...
<Fieldset legend="Demographics">
	...
	<Field label="Preferred name (what the person likes to be called)" inputId="preferredName">
		<TextInput id="preferredName" label="Preferred name" bind:value={d.preferredName} />
	</Field>
	...
	<div class="field-grid">
		...
		<Field label="NHS Number" inputId="nhsNumber">
			<TextInput id="nhsNumber" label="NHS Number" placeholder="000 000 0000" bind:value={d.nhsNumber} />
		</Field>
	</div>
