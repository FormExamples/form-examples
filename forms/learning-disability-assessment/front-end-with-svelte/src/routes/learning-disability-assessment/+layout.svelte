...
<svelte:head>
	<title>Learning Disability Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/learning-disability-assessment/" class="text-lg font-bold text-base-content">Learning Disability Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/learning-disability-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/learning-disability-assessment/learning-disability-assessments/new" class={navClass('/learning-disability-assessments/new')}>New assessment</a>
				<a href="/learning-disability-assessment/learning-disability-assessments" class={navClass('/learning-disability-assessments')}>Dashboard</a>
