# Electrocardiogram Test Result — specification
...
- `bin/test-form electrocardiogram-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check electrocardiogram-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `electrocardiogram-test-result.front-end-with-html.v1` (HTML)
  - `electrocardiogram-test-result.front-end-with-svelte.v1` (SvelteKit)
