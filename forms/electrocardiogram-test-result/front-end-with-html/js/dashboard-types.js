 ...
 * `forms/electrocardiogram-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {EcgType} ecgType                              - recorded ECG type
...
// namespace, `window.ElectrocardiogramTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.ElectrocardiogramTestResultDashboard`.
})();
