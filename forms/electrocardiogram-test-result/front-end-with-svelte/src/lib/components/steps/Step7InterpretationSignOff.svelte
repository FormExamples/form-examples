...
<Fieldset legend="7. Interpretation & Sign-off">
	...
	{#if preview.followUpUrgency === 'critical-alert'}
		<Alert type="error" heading="Critical-result alert">
			<p>
				This report contains a critical finding. Communicate the result directly to the responsible
				team (same hour) and record it below before signing.
			</p>
		</Alert>
	{/if}
	...
	<Field label="Critical-result communication">
		<CheckboxGroup label="Critical-result communication">
			<label>
				...
				/> Critical / urgent result communicated to responsible team
			</label>
		</CheckboxGroup>
	</Field>
