...
<Fieldset legend="2. Clinical History">
	<p class="hint">The clinical question and any comparison with previous ECGs.</p>
	...
	<Field label="Comparison with previous ECGs" inputId="comparisonWithPrevious">
		<TextAreaInput
