...
Server-side Rust JSON API for the Ward Round Note form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`ward_round_note/`](ward_round_note/) — one migration, SeaORM
