<script lang="ts">
	...
	import Step2SpecimenDetails from '$lib/components/steps/Step2SpecimenDetails.svelte';
	import Step3ClinicalHistory from '$lib/components/steps/Step3ClinicalHistory.svelte';
	import Step4ResultValues from '$lib/components/steps/Step4ResultValues.svelte';
	import Step5InterpretationSummary from '$lib/components/steps/Step5InterpretationSummary.svelte';
	...
	function submit() {
		...
		goto('/blood-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New blood test report</h1>
	...
	<Form label="Blood test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2SpecimenDetails />
		<Step3ClinicalHistory />
		<Step4ResultValues />
		<Step5InterpretationSummary />
		<Step6Impression />
