import type { BloodTestResult, FiredRule } from './types';
...
/**
 * The five mandatory report sections per RCPath actionable-reporting standards:
 * clinical history, results, comparison, findings, and impression.
 */
 ...
 */
export function gradeCompleteness(r: BloodTestResult): {
