 ...
 * `forms/blood-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {OverallResultStatus} overallResultStatus      - reporter's overall status
...
// namespace, `window.BloodTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.BloodTestResultDashboard`.
})();
