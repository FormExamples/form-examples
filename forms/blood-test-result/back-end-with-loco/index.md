...
Server-side Rust JSON API for the Blood Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`blood_test_result/`](blood_test_result/) — one migration, SeaORM
