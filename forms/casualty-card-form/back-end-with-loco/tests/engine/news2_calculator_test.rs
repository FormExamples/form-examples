use casualty_card_form_loco_crate::engine::types::{AssessmentData, VitalSigns};
use casualty_card_form_loco_crate::engine::news2_calculator::{calculate_news2, clinical_response};
