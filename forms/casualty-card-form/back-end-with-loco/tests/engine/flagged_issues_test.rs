use casualty_card_form_loco_crate::engine::types::{AssessmentData, Allergy, Medication};
use casualty_card_form_loco_crate::engine::flagged_issues::detect_additional_flags;
