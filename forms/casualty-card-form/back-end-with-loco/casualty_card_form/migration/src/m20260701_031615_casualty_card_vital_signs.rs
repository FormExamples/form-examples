...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "casualty_card_vital_signs",
            ...
            ("supplemental_oxygen", ColType::Text),
            ("oxygen_flow_rate", ColType::Text),
            ("temperature", ColType::DoubleNull),
            ("blood_glucose", ColType::DoubleNull),
            ("consciousness_level", ColType::Text),
            ("pupil_left_size", ColType::IntegerNull),
            ("pupil_left_reactive", ColType::Text),
            ("pupil_right_size", ColType::IntegerNull),
            ("pupil_right_reactive", ColType::Text),
            ("capillary_refill_time", ColType::Text),
