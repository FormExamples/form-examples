//! Casualty Card Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Casualty Card Form** medical form, built on the
...
//!
//! ```
//! use casualty_card_form_loco_crate::engine::types::AssessmentData;
//!
