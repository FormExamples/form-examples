<script lang="ts">
	...
	const ps = assessment.data.primarySurvey;
...
<Fieldset title="Primary Survey (ABCDE)" description="Systematic ABCDE assessment">
	<!-- Airway -->
	<h3 class="mb-3 text-lg font-semibold text-base-content">A — Airway</h3>
	<Select
		label="Airway Status"
		name="airwayStatus"
	...
	<!-- Breathing -->
	<h3 class="mb-3 text-lg font-semibold text-base-content">B — Breathing</h3>
	<Select
	...
	<!-- Circulation -->
	<h3 class="mb-3 text-lg font-semibold text-base-content">C — Circulation</h3>
	...
	<!-- Disability -->
	<h3 class="mb-3 text-lg font-semibold text-base-content">D — Disability</h3>
	...
	{#if gcsTotal !== null}
		<div class="mb-4 rounded-lg bg-base-200 p-3 text-sm">
			...
			{#if gcsTotal <= 8}
				<span class="ml-2 rounded bg-error/10 px-2 py-0.5 text-xs font-bold text-error">Unconscious — consider airway</span>
			{/if}
		</div>
	{/if}
	...
	<!-- Exposure -->
	<h3 class="mb-3 text-lg font-semibold text-base-content">E — Exposure</h3>
