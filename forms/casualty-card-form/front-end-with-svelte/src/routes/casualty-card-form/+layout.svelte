...
<svelte:head>
	<title>Casualty Card</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/casualty-card-form/" class="text-lg font-bold text-base-content">Casualty Card</a>
			<div class="flex items-center gap-1">
				<a href="/casualty-card-form/" class={navClass('/')}>Welcome</a>
				<a href="/casualty-card-form/casualty-cards/new" class={navClass('/casualty-cards/new')}>New card</a>
				<a href="/casualty-card-form/casualty-cards" class={navClass('/casualty-cards')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
