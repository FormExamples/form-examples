//! Nutrition Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Nutrition Assessment** medical form, built on the
...
//!
//! ```
//! use nutrition_assessment_loco_crate::engine::types::AssessmentData;
//!
