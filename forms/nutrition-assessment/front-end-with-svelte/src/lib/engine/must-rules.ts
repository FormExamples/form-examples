import type { MUSTRule } from './types';
 ...
 *
 *   MUST-001: BMI score (0-2)        >20 -> 0, 18.5-20 -> 1, <18.5 -> 2
 *   MUST-002: Unplanned weight loss   <5% -> 0, 5-10% -> 1, >10% -> 2
 *   MUST-003: Acute disease effect    none -> 0, acutely ill no intake >5d -> 2
 *
 * Total score interpretation: 0 -> low risk, 1 -> medium risk, >=2 -> high risk.
 * An evaluate() result of -1 indicates the step was not answered.
 */
export const mustRules: MUSTRule[] = [
	{
		id: 'MUST-001',
		category: 'BMI Score',
