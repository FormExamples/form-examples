...
function storageKey(id: string): string {
	return `nutrition-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank nutrition assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the nutrition assessment, with localStorage
