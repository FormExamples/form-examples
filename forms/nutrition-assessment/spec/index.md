...
- `bin/lily-html-refactor --check nutrition-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `nutrition-assessment.front-end-form-with-html.v1` (HTML)
  - `nutrition-assessment.front-end-form-with-svelte.v1` (SvelteKit)
