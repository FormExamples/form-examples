// Backend API client for the nerve conduction study vetting dashboard.
//
...
window.NerveConductionStudyTestRequestDashboard.fetchRequests = fetchRequests;
window.NerveConductionStudyTestRequestDashboard.API_BASE = API_BASE;
})();
