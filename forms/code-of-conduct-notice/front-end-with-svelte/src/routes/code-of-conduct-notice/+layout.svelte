...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/code-of-conduct-notice/" class="text-lg font-bold text-base-content">Code of Conduct Notice</a>
			<div class="flex items-center gap-1">
				<a href="/code-of-conduct-notice/" class={navClass('/')}>Welcome</a>
				<a
					href="/code-of-conduct-notice/code-of-conduct-notices/new"
					class={navClass('/code-of-conduct-notices/new')}>New notice</a
				>
				<a href="/code-of-conduct-notice/code-of-conduct-notices" class={navClass('/code-of-conduct-notices')}>Dashboard</a>
