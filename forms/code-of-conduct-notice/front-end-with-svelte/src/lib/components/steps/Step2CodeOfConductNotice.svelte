...
<Fieldset legend="Step 2 — Code of Conduct Notice">
  <p class="hint">
    All medical-service providers, employed staff, contractors, eligible
    family members, and re-employed annuitants are expected to uphold the
    following principles.
  </p>

  <div class="notice-prose">
    <p>
      This Code of Conduct reflects four fundamental principles: (1)
      responsibilities to patients; (2) respect for patients and colleagues;
      (3) adherence to established medical standards; (4) acknowledgement
      that medicine is an ever-evolving field that requires providers to
      stay current in their fields to ensure excellent patient care.
    </p>
    ...
    <p class="signoff-note">
      Please read each principle carefully before proceeding to acknowledge
      and sign.
    </p>
  </div>
</Fieldset>
...
<style>
  ...
  .principles li { font-size: 0.9375rem; line-height: 1.5; }
  .signoff-note {
    font-size: 0.875rem;
