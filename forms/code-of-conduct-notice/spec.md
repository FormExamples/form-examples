...
- LocalStorage key `code-of-conduct-notice.front-end-form-with-html.v1` (HTML) and
  `code-of-conduct-notice.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
