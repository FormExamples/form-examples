//! Code of Conduct Notice — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Code of Conduct Notice** medical form, built on the
...
//!
//! ```
//! use code_of_conduct_notice_loco_crate::engine::types::AssessmentData;
//!
