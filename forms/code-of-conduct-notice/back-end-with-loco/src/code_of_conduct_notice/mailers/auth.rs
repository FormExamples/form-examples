...
static welcome: Dir<'_> = include_dir!("src/code_of_conduct_notice/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/code_of_conduct_notice/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/code_of_conduct_notice/mailers/auth/magic_link");
