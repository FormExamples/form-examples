# Code of Conduct Notice — specification
...
- `bin/test-form code-of-conduct-notice` exits cleanly.
...
- `bin/lily-html-refactor --check code-of-conduct-notice` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `code-of-conduct-notice.front-end-form-with-html.v1` (HTML)
  - `code-of-conduct-notice.front-end-form-with-svelte.v1` (SvelteKit)
