...
static welcome: Dir<'_> = include_dir!("src/glasgow_blatchford_bleeding_score/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/glasgow_blatchford_bleeding_score/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/glasgow_blatchford_bleeding_score/mailers/auth/magic_link");
