...
Server-side Rust JSON API for the Glasgow-Blatchford Bleeding Score (GBS) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`glasgow_blatchford_bleeding_score/`](glasgow_blatchford_bleeding_score/) — one migration, SeaORM
