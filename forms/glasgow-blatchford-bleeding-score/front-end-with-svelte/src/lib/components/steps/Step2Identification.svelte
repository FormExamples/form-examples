...
<Fieldset legend="Step 2 of 6 — Patient identification">
	<p class="hint">
		Local identifier, age band, and sex. The Glasgow-Blatchford score applies to adults (&ge; 16
		years) with suspected acute upper GI bleeding. Sex selects the haemoglobin band table.
	</p>
