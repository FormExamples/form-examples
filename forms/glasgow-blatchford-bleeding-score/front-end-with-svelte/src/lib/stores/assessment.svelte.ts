...
function storageKey(id: string): string {
	return `glasgow-blatchford-bleeding-score.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Glasgow-Blatchford assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Glasgow-Blatchford assessment, with
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.labs`) stay bound to live state.
	 */
