...
<svelte:head>
	<title>Glasgow-Blatchford Bleeding Score</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/glasgow-blatchford-bleeding-score/" class="text-lg font-bold text-base-content">Glasgow-Blatchford score</a>
			<div class="flex items-center gap-1">
				<a href="/glasgow-blatchford-bleeding-score/" class={navClass('/')}>Welcome</a>
				<a
					href="/glasgow-blatchford-bleeding-score/glasgow-blatchford-bleeding-scores/new"
					class={navClass('/glasgow-blatchford-bleeding-scores/new')}>New assessment</a
				>
				<a
					href="/glasgow-blatchford-bleeding-score/glasgow-blatchford-bleeding-scores"
					class={navClass('/glasgow-blatchford-bleeding-scores')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
