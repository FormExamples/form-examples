...
/**
 * Total Glasgow-Blatchford score — integer 0-23, or null when not yet scored.
 *
 * @typedef {number | null} GbsScoreValue
 */
 ...
 * `forms/glasgow-blatchford-bleeding-score/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {GbsScoreValue} gbsScore      - total Glasgow-Blatchford score (0-23) or null
 * @property {RiskBand} riskBand           - derived risk band
 * @property {boolean} admitFlag           - true when high risk (score >= 6): admit and endoscope
...
// namespace, `window.GlasgowBlatchfordBleedingScoreDashboard`.

// No runtime exports; types are JSDoc-only. Touch the namespace so this file
// is unambiguously side-effecting and other files can rely on it loading
// before they read `window.GlasgowBlatchfordBleedingScoreDashboard`.
