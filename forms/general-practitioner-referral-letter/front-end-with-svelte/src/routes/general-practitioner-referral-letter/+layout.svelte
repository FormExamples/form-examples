...
<svelte:head>
	<title>General Practitioner Referral Letter</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/general-practitioner-referral-letter/" class="text-lg font-bold text-base-content">General Practitioner Referral Letter</a>
			<div class="flex items-center gap-1">
				<a href="/general-practitioner-referral-letter/" class={navClass('/')}>Welcome</a>
				<a
					href="/general-practitioner-referral-letter/general-practitioner-referral-letters/new"
					class={navClass('/general-practitioner-referral-letters/new')}>New referral</a
				>
				<a
					href="/general-practitioner-referral-letter/general-practitioner-referral-letters"
					class={navClass('/general-practitioner-referral-letters')}>Dashboard</a
				>
