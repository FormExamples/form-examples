...
static welcome: Dir<'_> = include_dir!("src/general_practitioner_referral_letter/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/general_practitioner_referral_letter/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/general_practitioner_referral_letter/mailers/auth/magic_link");
