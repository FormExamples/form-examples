...
Server-side Rust JSON API for the General Practitioner Referral Letter form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`general_practitioner_referral_letter/`](general_practitioner_referral_letter/) — one migration, SeaORM
