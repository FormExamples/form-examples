//! Screening Program Privacy Notice — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Screening Program Privacy Notice** medical form, built on the
...
//!
//! ```
//! use screening_program_privacy_notice_loco_crate::engine::types::AssessmentData;
//!
