...
static welcome: Dir<'_> = include_dir!("src/screening_program_privacy_notice/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/screening_program_privacy_notice/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/screening_program_privacy_notice/mailers/auth/magic_link");
