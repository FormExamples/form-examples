# Screening Program Privacy Notice: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Screening Program Privacy Notice form. Pure back-end: no HTML
