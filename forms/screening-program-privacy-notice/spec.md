...
- LocalStorage key `screening-program-privacy-notice.front-end-form-with-html.v1` (HTML) and
  `screening-program-privacy-notice.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
