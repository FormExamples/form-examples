# Screening Program Privacy Notice — specification
...
- `bin/test-form screening-program-privacy-notice` exits cleanly.
...
- `bin/lily-html-refactor --check screening-program-privacy-notice` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `screening-program-privacy-notice.front-end-form-with-html.v1` (HTML)
  - `screening-program-privacy-notice.front-end-form-with-svelte.v1` (SvelteKit)
