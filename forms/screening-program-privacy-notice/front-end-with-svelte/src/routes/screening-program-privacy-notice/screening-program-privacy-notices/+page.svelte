<script lang="ts">
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/screening-program-privacy-notice/screening-program-privacy-notices/${ev.id}`);
		});
	}
</script>
	...
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-base-content">
				Screening program privacy notice dashboard
			</h1>
		...
		<a href="/screening-program-privacy-notice/screening-program-privacy-notices/new" class="button" data-variant="primary"
