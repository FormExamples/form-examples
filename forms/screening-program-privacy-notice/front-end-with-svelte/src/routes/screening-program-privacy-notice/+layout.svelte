...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/screening-program-privacy-notice/"
                class="text-lg font-bold text-base-content"
                >Screening Program Privacy Notice</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/screening-program-privacy-notices/new")}
                    >New acknowledgment</a
                >
                <a
                    href="/screening-program-privacy-notice/screening-program-privacy-notices"
                    class={navClass("/screening-program-privacy-notices")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
