...
- `bin/test-form issue-tracker` exits cleanly.
...
- `bin/lily-html-refactor --check issue-tracker` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `issue-tracker.front-end-form-with-html.v1` (HTML)
  - `issue-tracker.front-end-form-with-svelte.v1` (SvelteKit)
