...
static welcome: Dir<'_> = include_dir!("src/issue_tracker/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/issue_tracker/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/issue_tracker/mailers/auth/magic_link");
