//! Issue Tracker — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Issue Tracker** medical form, built on the
...
//!
//! ```
//! use issue_tracker_loco_crate::engine::types::AssessmentData;
//!
