...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/issue-tracker/" class="text-lg font-bold text-base-content">Issue Tracker</a>
			<div class="flex items-center gap-1">
				<a href="/issue-tracker/" class={navClass('/')}>Welcome</a>
				<a href="/issue-tracker/issues/new" class={navClass('/issues/new')}>New issue</a>
				<a href="/issue-tracker/issues" class={navClass('/issues')}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
