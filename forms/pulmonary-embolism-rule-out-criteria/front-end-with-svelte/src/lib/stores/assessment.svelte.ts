...
function storageKey(id: string): string {
	return `pulmonary-embolism-rule-out-criteria.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank PERC assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the PERC assessment, with localStorage
