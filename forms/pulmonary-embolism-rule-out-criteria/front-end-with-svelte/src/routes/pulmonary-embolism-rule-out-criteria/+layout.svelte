...
<svelte:head>
	<title>Pulmonary Embolism Rule-out Criteria (PERC)</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/pulmonary-embolism-rule-out-criteria/" class="text-lg font-bold text-base-content">PERC</a>
			<div class="flex items-center gap-1">
				<a href="/pulmonary-embolism-rule-out-criteria/" class={navClass('/')}>Welcome</a>
				<a
					href="/pulmonary-embolism-rule-out-criteria/pulmonary-embolism-rule-out-criterias/new"
					class={navClass('/pulmonary-embolism-rule-out-criterias/new')}>New assessment</a
				>
				<a
					href="/pulmonary-embolism-rule-out-criteria/pulmonary-embolism-rule-out-criterias"
					class={navClass('/pulmonary-embolism-rule-out-criterias')}>Dashboard</a
				>
