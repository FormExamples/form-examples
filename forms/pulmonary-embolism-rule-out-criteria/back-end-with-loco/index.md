...
Server-side Rust JSON API for the Pulmonary Embolism Rule-out Criteria (PERC) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`pulmonary_embolism_rule_out_criteria/`](pulmonary_embolism_rule_out_criteria/) — one migration, SeaORM
