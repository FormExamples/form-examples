...
impl Hooks for App {
    ...
    async fn seed(ctx: &AppContext, _base: &Path) -> Result<()> {
        ...
        loco_rs::db::seed::<crate::models::_entities::clinicians::ActiveModel>(
            &ctx.db,
            &format!("{}/src/pulmonary_embolism_rule_out_criteria/fixtures/clinicians.yaml", env!("CARGO_MANIFEST_DIR")),
        )
        .await?;
        ...
        loco_rs::db::seed::<crate::models::_entities::pulmonary_embolism_rule_out_criteria_grade_flags::ActiveModel>(
            &ctx.db,
            &format!("{}/src/pulmonary_embolism_rule_out_criteria/fixtures/pulmonary_embolism_rule_out_criteria_grade_flags.yaml", env!("CARGO_MANIFEST_DIR")),
        )
        .await?;
        loco_rs::db::seed::<crate::models::_entities::pulmonary_embolism_rule_out_criteria_grade_rules::ActiveModel>(
            &ctx.db,
            &format!("{}/src/pulmonary_embolism_rule_out_criteria/fixtures/pulmonary_embolism_rule_out_criteria_grade_rules.yaml", env!("CARGO_MANIFEST_DIR")),
        )
        .await?;
