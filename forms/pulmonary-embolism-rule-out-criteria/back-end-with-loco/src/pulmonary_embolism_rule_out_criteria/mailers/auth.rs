...
static welcome: Dir<'_> = include_dir!("src/pulmonary_embolism_rule_out_criteria/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/pulmonary_embolism_rule_out_criteria/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/pulmonary_embolism_rule_out_criteria/mailers/auth/magic_link");
