# United Kingdom Lasting Power of Attorney for Health and Care Decisions — specification
...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql-migrations/` (20 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- `bin/test-form united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions` exits cleanly.
...
- `bin/lily-html-refactor --check united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions.front-end-form-with-html.v1` (HTML)
  - `united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions.front-end-form-with-svelte.v1` (SvelteKit)
