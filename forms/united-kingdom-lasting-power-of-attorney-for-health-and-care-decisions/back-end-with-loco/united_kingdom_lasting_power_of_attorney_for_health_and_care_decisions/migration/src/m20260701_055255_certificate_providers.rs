...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "certificate_providers",
            ...
            ("profession", ColType::String),
            ("profession_registration_number", ColType::String),
            ("years_known_donor", ColType::DoubleNull),
            ("relationship_to_donor", ColType::String),
            ("declared_not_family", ColType::String),
            ("declared_not_employee", ColType::String),
            ("declared_not_attorney", ColType::String),
            ],
            &[
            ]
        ).await
