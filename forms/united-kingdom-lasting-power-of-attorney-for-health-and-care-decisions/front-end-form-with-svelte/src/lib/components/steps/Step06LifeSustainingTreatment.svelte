...
<div class="space-y-4">
  ...
  <fieldset class="space-y-3">
    <legend class="text-sm font-medium text-slate-700">Life-sustaining treatment</legend>

    <label class="flex items-start gap-3 rounded border border-slate-200 bg-white p-4">
      <input
        type="radio"
        name="lst"
        value="option-a"
      ...
      />
      <div>
        <div class="font-medium text-slate-900">Option A</div>
    ...
    <label class="flex items-start gap-3 rounded border border-slate-200 bg-white p-4">
      ...
      />
      <div>
        <div class="font-medium text-slate-900">Option B</div>
        <p class="text-sm text-slate-600">
