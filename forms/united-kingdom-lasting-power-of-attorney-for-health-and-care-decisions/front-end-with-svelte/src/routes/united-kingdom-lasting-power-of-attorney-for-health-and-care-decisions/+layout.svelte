...
<svelte:head>
	<title>UK Lasting Power of Attorney for Health and Care Decisions</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions/" class="text-lg font-bold text-base-content">UK LPA — Health &amp; Care</a>
			<div class="flex items-center gap-1">
				<a href="/united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions/" class={navClass('/')}>Welcome</a>
				<a href="/united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions/{plural}/new" class={navClass(`/${plural}/new`)}>New application</a>
				<a href="/united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
