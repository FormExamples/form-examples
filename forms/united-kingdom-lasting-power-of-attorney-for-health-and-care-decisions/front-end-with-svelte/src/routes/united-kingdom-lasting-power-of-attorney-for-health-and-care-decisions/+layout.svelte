<script lang="ts">
    ...
    const plural =
        "united-kingdom-lasting-powers-of-attorney-for-health-and-care-decisions";
...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions/"
                class="text-lg font-bold text-base-content"
                >UK LPA — Health &amp; Care</a
            >
