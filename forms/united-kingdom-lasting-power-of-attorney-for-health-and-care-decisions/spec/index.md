...
**Inputs.** A typed assessment object whose shape mirrors the SQL schema in `sql/` (21 migration files). Unanswered text and enum fields default to `''`; unanswered numeric, date, and time fields default to `null`.
...
- LocalStorage keys preserve draft state across reloads:
  - `united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions.front-end-with-html.v1` (HTML)
  - `united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions.front-end-with-svelte.v1` (SvelteKit)
