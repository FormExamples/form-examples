// Lily Design System — text-size-chooser (headless, vanilla JS).
...
const STORAGE_KEY = 'united-kingdom-lasting-power-of-attorney-for-health-and-care-decisions.text-size.v1';
...
function init() {
  const select = document.getElementById('text-size-chooser');
