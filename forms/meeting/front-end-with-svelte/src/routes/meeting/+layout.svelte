...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a href="/meeting/" class="text-lg font-bold text-base-content"
                >Meeting</a
            >
            <div class="flex items-center gap-1">
                <a href="/meeting/" class={navClass("/")}>Welcome</a>
                <a
                    href="/meeting/meetings/new"
                    class={navClass("/meetings/new")}>New meeting</a
                >
                <a href="/meeting/meetings" class={navClass("/meetings")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
