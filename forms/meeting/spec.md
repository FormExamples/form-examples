...
- `bin/test-form meeting` exits cleanly.
...
- `bin/lily-html-refactor --check meeting` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `meeting.front-end-form-with-html.v1` (HTML)
  - `meeting.front-end-form-with-svelte.v1` (SvelteKit)
