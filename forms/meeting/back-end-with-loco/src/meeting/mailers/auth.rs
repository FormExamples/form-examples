...
static welcome: Dir<'_> = include_dir!("src/meeting/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/meeting/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/meeting/mailers/auth/magic_link");
