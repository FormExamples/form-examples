...
<svelte:head>
	<title>Advance Statement About Care</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/advance-statement-about-care/" class="text-lg font-bold text-base-content">Advance Statement About Care</a>
			<div class="flex items-center gap-1">
				<a href="/advance-statement-about-care/" class={navClass('/')}>Welcome</a>
				<a
					href="/advance-statement-about-care/advance-statements-about-care/new"
					class={navClass('/advance-statements-about-care/new')}>New statement</a
				>
				<a href="/advance-statement-about-care/advance-statements-about-care" class={navClass('/advance-statements-about-care')}
					>Dashboard</a
				>
