//! Advance Statement About Care — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Advance Statement About Care** medical form, built on the
...
//!
//! ```
//! use advance_statement_loco_crate::engine::types::AssessmentData;
//!
