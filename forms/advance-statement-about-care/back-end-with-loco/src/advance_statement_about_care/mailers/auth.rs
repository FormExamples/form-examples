...
static welcome: Dir<'_> = include_dir!("src/advance_statement_about_care/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/advance_statement_about_care/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/advance_statement_about_care/mailers/auth/magic_link");
