...
- LocalStorage key `advance-statement-about-care.front-end-form-with-html.v1` (HTML) and
  `advance-statement-about-care.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
