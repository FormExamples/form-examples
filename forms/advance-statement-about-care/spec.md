# Advance Statement About Care — specification
...
- `bin/test-form advance-statement-about-care` exits cleanly.
...
- `bin/lily-html-refactor --check advance-statement-about-care` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `advance-statement-about-care.front-end-form-with-html.v1` (HTML)
  - `advance-statement-about-care.front-end-form-with-svelte.v1` (SvelteKit)
