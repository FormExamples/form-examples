...
- `bin/test-form return-to-work` exits cleanly.
...
- `bin/lily-html-refactor --check return-to-work` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `return-to-work.front-end-form-with-html.v1` (HTML)
  - `return-to-work.front-end-form-with-svelte.v1` (SvelteKit)
