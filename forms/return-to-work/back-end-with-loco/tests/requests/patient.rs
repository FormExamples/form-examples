...
async fn can_create_and_read_back_patient() {
    request::<App, _, _>(|request, _ctx| async move {
        let new_patient = serde_json::json!({
            ...
            "contractedHoursPerWeek": 1.0,
            "shiftPattern": "day",
            "safetyCriticalRole": "yes",
            "dvlaGroup1LicenceHeld": "yes",
            "dvlaGroup2LicenceHeld": "yes"
        });
        ...
        assert_eq!(fetched["jobTitle"], "Test jobTitle");
        assert_eq!(fetched["roleDescription"], "Test roleDescription");
        assert_eq!(fetched["contractedHoursPerWeek"].as_f64(), Some(1.0));
        assert_eq!(fetched["shiftPattern"], "day");
        assert_eq!(fetched["safetyCriticalRole"], "yes");
        assert_eq!(fetched["dvlaGroup1LicenceHeld"], "yes");
        assert_eq!(fetched["dvlaGroup2LicenceHeld"], "yes");
