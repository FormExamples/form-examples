...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "patients",
            ...
            ("role_description", ColType::Text),
            ("contracted_hours_per_week", ColType::DoubleNull),
            ("shift_pattern", ColType::String),
            ("safety_critical_role", ColType::String),
            ("dvla_group_1_licence_held", ColType::String),
            ("dvla_group_2_licence_held", ColType::String),
            ],
            &[
            ]
        ).await
