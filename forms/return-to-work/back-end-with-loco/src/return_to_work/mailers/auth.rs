...
static welcome: Dir<'_> = include_dir!("src/return_to_work/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/return_to_work/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/return_to_work/mailers/auth/magic_link");
