...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/return-to-work/" class="text-lg font-bold text-base-content">Return to Work</a>
			<div class="flex items-center gap-1">
				<a href="/return-to-work/" class={navClass('/')}>Welcome</a>
				<a href="/return-to-work/return-to-work-records/new" class={navClass('/return-to-work-records/new')}>New record</a>
				<a href="/return-to-work/return-to-work-records" class={navClass('/return-to-work-records')}>Dashboard</a>
