<script lang="ts">
	...
	import { fitnessStatementLabel, restrictionPriorityLabel } from '#lib/engine/utils.js';
	import type { FitnessStatement, RestrictionPriority } from '#lib/engine/types.js';
