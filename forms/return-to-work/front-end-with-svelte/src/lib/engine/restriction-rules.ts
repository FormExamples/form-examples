import type { AssessmentData, RestrictionRule } from './types';

/** Count the number of enumerated workplace adjustments that are active. */
export function countAdjustments(data: AssessmentData): number {
 ...
 * the most severe fired rule sets the overall restriction priority (max-grade
 * rule). Grade 1 = routine, 2 = standard, 3 = restricted, 4 = high-risk.
 */
