...
static welcome: Dir<'_> = include_dir!("src/wells_score_for_deep_vein_thrombosis/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/wells_score_for_deep_vein_thrombosis/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/wells_score_for_deep_vein_thrombosis/mailers/auth/magic_link");
