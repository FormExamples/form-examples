...
// judged at least as likely as DVT. Each rule below evaluates the patient data
// and returns true when its criterion is positive (its yes/no input is 'yes');
// the grader (`grader.js`) sums the points into the total Wells score (−2..9)
// and derives the two-level and three-level bands. Rows here mirror the
 ...
 * @property {number} points      - point contributed when the rule fires (+1 or −2)
...
const wellsRules = [
  // ─── CRITERION 1: ACTIVE CANCER ───────────────────────────────
  {
    ...
    description: 'Active cancer — treatment ongoing, within the previous 6 months, or palliative',
  ...
  // ─── CRITERION 2: PARALYSIS / IMMOBILISATION ──────────────────
  {
    ...
    points: 1,
    category: 'wells-criterion',
    description: 'Paralysis, paresis, or recent plaster immobilisation of the lower extremities',
  ...
  // ─── CRITERION 3: BEDRIDDEN / MAJOR SURGERY ───────────────────
  {
    ...
    points: 1,
    category: 'wells-criterion',
    description: 'Recently bedridden >= 3 days, or major surgery within the previous 12 weeks requiring general or regional anaesthesia',
  ...
  // ─── CRITERION 6: CALF SWELLING >= 3 CM ───────────────────────
  {
    ...
    points: 1,
    category: 'wells-criterion',
    description: 'Calf swelling >= 3 cm larger than the asymptomatic side (measured 10 cm below the tibial tuberosity)',
