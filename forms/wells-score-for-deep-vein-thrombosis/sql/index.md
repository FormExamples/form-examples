# Wells Score for Deep Vein Thrombosis (DVT) — SQL schema
...
| 04 | `04_create_table_wells_score_for_deep_vein_thrombosis.sql` | `wells_score_for_deep_vein_thrombosis` | Main assessment: context plus the nine criterion inputs and the −2 alternative-diagnosis adjustment. |
| 05 | `05_create_table_wells_score_for_deep_vein_thrombosis_grade.sql` | `wells_score_for_deep_vein_thrombosis_grade` | Computed result (1:1): total score, two-level and three-level bands, recommended pathway. |
| 06 | `06_create_table_wells_score_for_deep_vein_thrombosis_grade_rule.sql` | `wells_score_for_deep_vein_thrombosis_grade_rule` | Audit trail of fired scoring rules. |
| 07 | `07_create_table_wells_score_for_deep_vein_thrombosis_grade_flag.sql` | `wells_score_for_deep_vein_thrombosis_grade_flag` | Clinically significant flags with priority and suggested action. |
