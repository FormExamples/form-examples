...
<Fieldset legend="Step 2 of 6 — Patient identification">
	<p class="hint">Local identifier, age band, sex, and the symptomatic leg. Wells is for adults (>= 18 years).</p>
	...
	<Field label="Symptomatic leg" inputId="identification-symptomaticLeg">
		<Select
			id="identification-symptomaticLeg"
			label="Symptomatic leg"
			bind:value={p.symptomaticLeg}
		>
			<option value="">— Select —</option>
