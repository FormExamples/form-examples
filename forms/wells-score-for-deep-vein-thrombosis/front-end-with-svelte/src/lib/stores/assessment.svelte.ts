...
function storageKey(id: string): string {
	return `wells-score-for-deep-vein-thrombosis.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank Wells DVT assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the Wells DVT assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.predisposing`) stay bound to live state.
	 */
