<script lang="ts">
	...
	import Step3Predisposing from '#lib/components/steps/Step3Predisposing.svelte';
	import Step4Examination from '#lib/components/steps/Step4Examination.svelte';
	import Step5Alternative from '#lib/components/steps/Step5Alternative.svelte';
	...
	function submit() {
		...
		goto(`/wells-score-for-deep-vein-thrombosis/wells-score-for-deep-vein-thromboses/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New Wells DVT assessment' : `Wells DVT assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the six sections; the Wells score, bands, and recommended investigation are computed
		on submit.
	</p>
	...
	<Form label="Wells DVT assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3Predisposing />
		<Step4Examination />
