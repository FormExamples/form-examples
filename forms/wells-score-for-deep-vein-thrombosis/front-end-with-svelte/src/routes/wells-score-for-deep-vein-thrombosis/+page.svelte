<script lang="ts">
	...
	// dashboard.
	const plural = 'wells-score-for-deep-vein-thromboses';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/wells-score-for-deep-vein-thrombosis/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-primary-content/80">
				Open the step-by-step Wells DVT rule. One continuous single-page wizard that scores the
				patient as you complete it.
			</p>
			<span class="mt-4 inline-block text-sm font-semibold">Open the form &rarr;</span>
		</a>
		<a
			href="/wells-score-for-deep-vein-thrombosis/{plural}"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed Wells score and two-level band, and filter by
				care setting and band.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Drawn from Wells et al. (Lancet 1997; NEJM 2003) and NICE NG158. The output selects the
					next diagnostic step; it does not diagnose or exclude DVT on its own.
				</dd>
			</div>
		</dl>
	</section>
