...
<svelte:head>
	<title>Wells Score for Deep Vein Thrombosis (DVT)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/wells-score-for-deep-vein-thrombosis/" class="text-lg font-bold text-base-content">Wells DVT</a>
			<div class="flex items-center gap-1">
				<a href="/wells-score-for-deep-vein-thrombosis/" class={navClass('/')}>Welcome</a>
				<a href="/wells-score-for-deep-vein-thrombosis/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/wells-score-for-deep-vein-thrombosis/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
