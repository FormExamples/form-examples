// Backend API client for the Lifeguard Certification Checklist training
...
window.LifeguardCertificationChecklistDashboard.fetchCandidates =
  fetchCandidates;
window.LifeguardCertificationChecklistDashboard.API_BASE = API_BASE;
})();
