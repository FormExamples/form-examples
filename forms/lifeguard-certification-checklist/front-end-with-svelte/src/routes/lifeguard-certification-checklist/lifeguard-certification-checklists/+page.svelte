<script lang="ts">
	...
	import { outcomeLabel, venueTypeLabel } from '#lib/engine/utils.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/lifeguard-certification-checklist/lifeguard-certification-checklists/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/lifeguard-certification-checklist/lifeguard-certification-checklists/new" class="button" data-variant="primary">New checklist</a>
	</div>
