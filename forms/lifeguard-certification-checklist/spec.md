...
- LocalStorage key `lifeguard-certification-checklist.front-end-form-with-html.v1` (HTML) and
  `lifeguard-certification-checklist.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
