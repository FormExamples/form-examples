# Lifeguard Certification Checklist — specification
...
- `bin/test-form lifeguard-certification-checklist` exits cleanly.
...
- `bin/lily-html-refactor --check lifeguard-certification-checklist` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `lifeguard-certification-checklist.front-end-form-with-html.v1` (HTML)
  - `lifeguard-certification-checklist.front-end-form-with-svelte.v1` (SvelteKit)
