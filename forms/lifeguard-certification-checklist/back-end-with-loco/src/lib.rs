//! Lifeguard Certification Checklist — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Lifeguard Certification Checklist** medical form, built on the
...
//!
//! ```
//! use lifeguard_certification_checklist_loco_crate::engine::types::AssessmentData;
//!
