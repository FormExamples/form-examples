...
<svelte:head>
	<title>Patient Room Readiness</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/patient-room-readiness/" class="text-lg font-bold text-base-content">Patient Room Readiness</a>
			<div class="flex items-center gap-1">
				<a href="/patient-room-readiness/" class={navClass('/')}>Welcome</a>
				<a
					href="/patient-room-readiness/patient-room-readiness-checklists/new"
					class={navClass('/patient-room-readiness-checklists/new')}>New checklist</a
				>
				<a
					href="/patient-room-readiness/patient-room-readiness-checklists"
					class={navClass('/patient-room-readiness-checklists')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
