...
static welcome: Dir<'_> = include_dir!("src/patient_room_readiness/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/patient_room_readiness/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/patient_room_readiness/mailers/auth/magic_link");
