...
// `src/lib/engine/types.ts` data model for the Coagulation Test Result form.
//
// The camelCase property names mirror the snake_case SQL columns in
// `sql/04_create_table_coagulation_test_result.sql` and
// `sql/05_create_table_coagulation_test_result_grade.sql`. This file builds
// and exports the canonical empty CoagulationResult shape used by the wizard,
 ...
 * @typedef {'satisfactory' | 'clotted' | 'underfilled' | 'haemolysed' |
 ...
 *           'urgent-referral' | 'specimen-quality-issue' | 'unexpected-finding' |
 ...
 * four-axis interpretation grade is computed from. Mirrors `CoagulationResult`
 * in `front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} CoagulationResult
 ...
 * @property {boolean} onAnticoagulant
 * @property {string} anticoagulantAgent
 * @property {number | null} prothrombinTimeSeconds
 * @property {number | null} inr
 * @property {number | null} activatedPartialThromboplastinTimeSeconds
 * @property {number | null} apttRatio
 * @property {number | null} fibrinogenGL
 * @property {number | null} dDimer
 * @property {number | null} thrombinTimeSeconds
 * @property {string} factorAssays
...
function specimenConditionLabel(value) {
  switch (value) {
    ...
    case 'underfilled': return 'Underfilled';
