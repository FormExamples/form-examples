 ...
 * `forms/coagulation-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {OverallResultStatus} overallResultStatus      - reported result status
...
// namespace, `window.CoagulationTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.CoagulationTestResultDashboard`.
})();
