import type { CoagulationResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for a coagulation test result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical value (INR > 8, fibrinogen < 1.0 g/L, a DIC picture, or
 * a flagged critical result) auto-escalates Axis D to critical-alert and raises
 ...
 */
export function calculateGrade(result: CoagulationResult): GradingResult {
