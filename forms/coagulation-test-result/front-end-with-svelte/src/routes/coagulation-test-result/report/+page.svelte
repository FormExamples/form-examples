<script lang="ts">
	...
	import Step2SpecimenContext from '$lib/components/steps/Step2SpecimenContext.svelte';
	...
	import Step5Comparison from '$lib/components/steps/Step5Comparison.svelte';
	...
	function submit() {
		...
		goto('/coagulation-test-result/report/view');
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-gray-900">New coagulation report</h1>
	...
	<Form label="Coagulation test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2SpecimenContext />
		<Step3ResultValues />
		<Step4Findings />
		<Step5Comparison />
		<Step6Impression />
