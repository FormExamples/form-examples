...
Server-side Rust JSON API for the Coagulation Test Result form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`coagulation_test_result/`](coagulation_test_result/) — one migration, SeaORM
