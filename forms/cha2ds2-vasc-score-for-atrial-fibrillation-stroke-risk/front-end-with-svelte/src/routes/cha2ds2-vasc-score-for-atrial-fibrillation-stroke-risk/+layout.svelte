...
<svelte:head>
	<title>CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/cha2ds2-vasc-score-for-atrial-fibrillation-stroke-risk/" class="text-lg font-bold text-base-content">CHA2DS2-VASc</a>
			<div class="flex items-center gap-1">
				<a href="/cha2ds2-vasc-score-for-atrial-fibrillation-stroke-risk/" class={navClass('/')}>Welcome</a>
				<a
					href="/cha2ds2-vasc-score-for-atrial-fibrillation-stroke-risk/cha2ds2-vasc-assessments/new"
					class={navClass('/cha2ds2-vasc-assessments/new')}>New assessment</a
				>
				<a
					href="/cha2ds2-vasc-score-for-atrial-fibrillation-stroke-risk/cha2ds2-vasc-assessments"
					class={navClass('/cha2ds2-vasc-assessments')}>Dashboard</a
				>
				<LocalePicker
					label="Language"
					class="ml-2"
