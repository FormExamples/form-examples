...
function storageKey(id: string): string {
	return `cha2ds2-vasc-score-for-atrial-fibrillation-stroke-risk.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank CHA2DS2-VASc assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the CHA2DS2-VASc assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.cardiac`) stay bound to live state.
	 */
