# Changelog — CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk
...
file only records changes scoped to the **CHA2DS2-VASc Score for Atrial Fibrillation Stroke Risk** form.
