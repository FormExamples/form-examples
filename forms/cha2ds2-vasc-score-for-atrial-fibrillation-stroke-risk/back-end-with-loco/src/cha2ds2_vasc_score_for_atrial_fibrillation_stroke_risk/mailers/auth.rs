...
static welcome: Dir<'_> = include_dir!("src/cha2ds2_vasc_score_for_atrial_fibrillation_stroke_risk/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/cha2ds2_vasc_score_for_atrial_fibrillation_stroke_risk/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/cha2ds2_vasc_score_for_atrial_fibrillation_stroke_risk/mailers/auth/magic_link");
