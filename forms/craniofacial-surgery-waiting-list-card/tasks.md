# Tasks: Craniofacial Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/craniofacial-surgery-waiting-list-card/`.
...
- [x] `cargo loco new craniofacial-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form craniofacial-surgery-waiting-list-card` exits cleanly.
