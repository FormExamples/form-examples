# craniofacial-surgery-waiting-list-card — sql
...
- `cranio_surgery_waiting_list_card` — top-level waiting list card.
- `cranio_surgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `cranio_surgery_waiting_list_card_grade` — computed grading result.
- `cranio_surgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `cranio_surgery_waiting_list_card_grade_flag` — safety / operational flags fired
