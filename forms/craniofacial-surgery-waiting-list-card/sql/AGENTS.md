# Craniofacial Surgery Waiting List Card — PostgreSQL migrations
...
Child `cranio_surgery_waiting_list_card_*` tables reference
`cranio_surgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
