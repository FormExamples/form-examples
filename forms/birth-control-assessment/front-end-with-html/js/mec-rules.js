...
// rule fires when its condition is true; the grader takes the worst MEC
// category per affected method (and MEC 1 by default for unaffected methods).
//
// MEC 1 = no restriction
// MEC 2 = advantages generally outweigh risks
// MEC 3 = risks usually outweigh advantages
// MEC 4 = unacceptable health risk

/**
 * @typedef {import('./types.js').AssessmentData} AssessmentData
 *
 * @typedef {Object} MECRule
 * @property {string} id
  ...
  // ─── SMOKING & AGE ───────────────────────────────
  {
    ...
    evaluate: (d) => {
      ...
      return age !== null && age >= 35 && d.lifestyleAssessment.smoking === 'current' &&
        d.lifestyleAssessment.cigarettesPerDay !== null && d.lifestyleAssessment.cigarettesPerDay >= 15;
    }
  },
  {
    id: 'SM-002',
