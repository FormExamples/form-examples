...
function storageKey(id: string): string {
	return `birth-control-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank birth control assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the birth control assessment, with localStorage
