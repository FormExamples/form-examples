...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/birth-control-assessment/"
                class="text-lg font-bold text-base-content"
                >Birth Control Assessment</a
            >
            <div class="flex items-center gap-1">
                <a href="/birth-control-assessment/" class={navClass("/")}
                    >Welcome</a
                >
                <a
                    href="/birth-control-assessment/birth-control-assessments/new"
                    class={navClass("/birth-control-assessments/new")}
                    >New assessment</a
                >
                <a
                    href="/birth-control-assessment/birth-control-assessments"
                    class={navClass("/birth-control-assessments")}>Dashboard</a
                >
                <LocalePicker
                    label="Language"
                    class="ml-2"
