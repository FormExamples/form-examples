...
- LocalStorage key `birth-control-assessment.front-end-form-with-html.v1` (HTML) and
  `birth-control-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
