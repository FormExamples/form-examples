//! Birth Control Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Birth Control Assessment** medical form, built on the
...
//!
//! ```
//! use birth_control_assessment_loco_crate::engine::types::AssessmentData;
//!
