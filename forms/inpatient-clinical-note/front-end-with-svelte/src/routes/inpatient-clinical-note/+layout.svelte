...
<svelte:head>
	<title>Inpatient Clinical Note</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/inpatient-clinical-note/" class="text-lg font-bold text-base-content">Inpatient Clinical Note</a>
			<div class="flex items-center gap-1">
				<a href="/inpatient-clinical-note/" class={navClass('/')}>Welcome</a>
				<a href="/inpatient-clinical-note/inpatient-clinical-notes/new" class={navClass('/inpatient-clinical-notes/new')}>New note</a>
				<a href="/inpatient-clinical-note/inpatient-clinical-notes" class={navClass('/inpatient-clinical-notes')}>Dashboard</a>
				<LocalePicker
					label="Language"
					class="ml-2"
