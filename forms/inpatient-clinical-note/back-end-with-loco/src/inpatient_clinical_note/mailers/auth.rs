...
static welcome: Dir<'_> = include_dir!("src/inpatient_clinical_note/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/inpatient_clinical_note/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/inpatient_clinical_note/mailers/auth/magic_link");
