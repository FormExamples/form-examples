...
- LocalStorage key `gynecology-assessment.front-end-form-with-html.v1` (HTML) and
  `gynecology-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
