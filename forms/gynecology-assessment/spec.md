# Gynecology Assessment — specification
...
- `bin/test-form gynecology-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check gynecology-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `gynecology-assessment.front-end-form-with-html.v1` (HTML)
  - `gynecology-assessment.front-end-form-with-svelte.v1` (SvelteKit)
