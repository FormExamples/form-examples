//! Gynecology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Gynecology Assessment** medical form, built on the
...
//!
//! ```
//! use gynecology_assessment_loco_crate::engine::types::AssessmentData;
//!
