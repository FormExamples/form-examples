use gynecology_assessment_loco_crate::engine::gynecology_grader::calculate_severity;
use gynecology_assessment_loco_crate::engine::gynecology_rules::all_rules;
use gynecology_assessment_loco_crate::engine::types::*;
