...
<svelte:head>
	<title>Gynecology Assessment</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/gynecology-assessment/" class="text-lg font-bold text-base-content">Gynecology Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/gynecology-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/gynecology-assessment/gynecology-assessments/new" class={navClass('/gynecology-assessments/new')}>New assessment</a>
				<a href="/gynecology-assessment/gynecology-assessments" class={navClass('/gynecology-assessments')}>Dashboard</a>
