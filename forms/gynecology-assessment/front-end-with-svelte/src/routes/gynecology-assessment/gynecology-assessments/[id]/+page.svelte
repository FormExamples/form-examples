<script lang="ts">
	...
	function submit() {
		...
		goto(`/gynecology-assessment/gynecology-assessments/${id}/report`);
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-base-content">
			{isNew ? 'New gynecology assessment' : `Gynecology assessment ${id}`}
		</h1>
		<p class="mt-1 text-sm text-base-content/70">
			Complete the ten sections; the symptom severity score and category are computed on submit.
		</p>
	...
	<Form label="Gynecology assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2ChiefComplaint />
