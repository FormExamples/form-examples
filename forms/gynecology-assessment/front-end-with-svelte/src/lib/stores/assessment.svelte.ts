...
function storageKey(id: string): string {
	return `gynecology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank gynecology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the gynecology assessment, with localStorage
