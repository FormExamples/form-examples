// Flagged-issue detection. Independent of the symptom score (which the
// grader computes), this module raises clinician-facing flags for
// abnormal bleeding, post-menopausal bleeding, overdue cervical
// screening, abnormal smears, STI risk, obstetric complications, pelvic
// mass suspicion, autoimmune disease, family cancer histories, missing
// HPV vaccination, and worsening symptoms.
...
function detectAdditionalFlags(data) {
  ...
  if (data.cervicalScreening.lastSmearDate) {
    ...
    if (!isNaN(lastSmear.getTime()) && lastSmear < threeYearsAgo) {
      flags.push({
        id: 'FLAG-SCREEN-001',
