# Plan: Gastroenterology Waiting List Card
...
months later. The Gastroenterology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form gastroenterology-waiting-list-card`.
