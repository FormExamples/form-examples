# Gastroenterology Waiting List Card — PostgreSQL migrations
...
Child `gastro_waiting_list_card_*` tables reference
`gastro_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
