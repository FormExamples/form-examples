-- Practitioner who places the patient on a gastroenterology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a gastroenterology waiting list card on behalf of the patient.';
