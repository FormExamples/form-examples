# gastroenterology-waiting-list-card — sql
...
- `gastro_waiting_list_card` — top-level waiting list card.
- `gastro_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `gastro_waiting_list_card_grade` — computed grading result.
- `gastro_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `gastro_waiting_list_card_grade_flag` — safety / operational flags fired
