# Gastroenterology Waiting List Card — specification
...
gastroenterology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form gastroenterology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check gastroenterology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `gastroenterology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `gastroenterology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
