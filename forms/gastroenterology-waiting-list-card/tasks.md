# Tasks: Gastroenterology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/gastroenterology-waiting-list-card/`.
...
- [x] `cargo loco new gastroenterology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form gastroenterology-waiting-list-card` exits cleanly.
