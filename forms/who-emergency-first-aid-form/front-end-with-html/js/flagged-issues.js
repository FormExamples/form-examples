...
// without intervention, tourniquet without recorded time, abnormal airway
// without intervention, pregnancy, and selected precaution toggles.
// Priorities (urgent → high → medium → low) drive sort order in the
// report. Ported 1:1 from the SvelteKit `flagged-issues.ts`.
