...
<svelte:head>
	<title>WHO Emergency First Aid Form</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/who-emergency-first-aid-form/" class="text-lg font-bold text-base-content">WHO Emergency First Aid Form</a>
			<div class="flex items-center gap-1">
				<a href="/who-emergency-first-aid-form/" class={navClass('/')}>Welcome</a>
				<a
					href="/who-emergency-first-aid-form/who-emergency-first-aid-forms/new"
					class={navClass('/who-emergency-first-aid-forms/new')}>New encounter</a
				>
				<a href="/who-emergency-first-aid-form/who-emergency-first-aid-forms" class={navClass('/who-emergency-first-aid-forms')}
					>Dashboard</a
				>
