// Backend API client for the WHO Emergency First Aid clinician dashboard.
//
...
window.WhoEmergencyFirstAidDashboard.fetchPatients = fetchPatients;
window.WhoEmergencyFirstAidDashboard.API_BASE = API_BASE;
})();
