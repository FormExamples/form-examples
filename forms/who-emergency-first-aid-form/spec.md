...
- LocalStorage key `who-emergency-first-aid-form.front-end-form-with-html.v1` (HTML) and
  `who-emergency-first-aid-form.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
