# WHO Emergency First Aid Form — specification
...
- `bin/test-form who-emergency-first-aid-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-emergency-first-aid-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-emergency-first-aid-form.front-end-form-with-html.v1` (HTML)
  - `who-emergency-first-aid-form.front-end-form-with-svelte.v1` (SvelteKit)
