//! Who Emergency First Aid Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Emergency First Aid Form** medical form, built on the
...
//!
//! ```
//! use who_emergency_first_aid_form_loco_crate::engine::types::AssessmentData;
//!
