<script lang="ts">
  ...
  // Mirrors forms/lily-svelte-spec/Fieldset/Fieldset.svelte.
  //
  ...
  // and the children. This keeps existing step files that used
  // `<SectionCard title=… description=…>` working while presenting the
  // canonical Lily class shape.
