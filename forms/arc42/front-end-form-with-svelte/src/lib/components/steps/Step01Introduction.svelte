...
<section>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
    <label class="block">
      ...
      <input type="text" class="w-full border rounded px-2 py-1" bind:value={store.data.architecture.name} />
    </label>
    <label class="block">
    ...
    <label class="block">
      <span class="text-sm text-slate-700">Author role</span>
      <input type="text" class="w-full border rounded px-2 py-1" bind:value={store.data.authorRole} />
    </label>
    <label class="block">
      <span class="text-sm text-slate-700">Document date</span>
