...
static welcome: Dir<'_> = include_dir!("src/arc42/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/arc42/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/arc42/mailers/auth/magic_link");
