<script lang="ts">
	...
	import { sampleDocumentRows } from '#lib/data/sample-reports.js';
	import { maturityLabel, recommendationLabel } from '#lib/grading/utils.js';
	import type { Maturity } from '#lib/grading/types.js';
