...
- `bin/test-form arc42` exits cleanly.
...
- `bin/lily-html-refactor --check arc42` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `arc42.front-end-form-with-html.v1` (HTML)
  - `arc42.front-end-form-with-svelte.v1` (SvelteKit)
