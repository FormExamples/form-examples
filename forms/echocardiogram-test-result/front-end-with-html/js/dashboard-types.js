 ...
 * `forms/echocardiogram-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {EchoType} echoType                            - performed echo modality
...
// namespace, `window.EchocardiogramTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.EchocardiogramTestResultDashboard`.
})();
