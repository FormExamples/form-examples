import type { EchocardiogramResult, GradingResult, Recommendation, FiredRule } from './types';
...
/**
 * Pure four-axis interpretation engine for an echocardiogram result.
 *
 * Computes:
 ...
 *
 * Invariant: a critical finding (severe valve disease, vegetation, pericardial
 * effusion, severe LV impairment, intracardiac thrombus) auto-escalates Axis D
 ...
 */
export function calculateGrade(result: EchocardiogramResult): GradingResult {
