...
```sh
bin/test-form general-surgery-waiting-list-card
bin/test-sql-apply general-surgery-waiting-list-card
bin/test-personas general-surgery-waiting-list-card
bin/test-e2e --html general-surgery-waiting-list-card
```
