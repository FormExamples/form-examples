# General Surgery Waiting List Card — specification
...
general surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form general-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check general-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `general-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `general-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
