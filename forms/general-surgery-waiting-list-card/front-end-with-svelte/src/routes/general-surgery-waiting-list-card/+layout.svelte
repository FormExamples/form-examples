...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/general-surgery-waiting-list-card/"
                class="text-lg font-bold text-base-content"
                >General Surgery Waiting List Card</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/general-surgery-waiting-list-cards/new")}
                    >New card</a
                >
                <a
                    href="/general-surgery-waiting-list-card/general-surgery-waiting-list-cards"
