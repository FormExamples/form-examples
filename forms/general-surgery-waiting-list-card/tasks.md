# Tasks: General Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/general-surgery-waiting-list-card/`.
...
- [x] `cargo loco new general-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form general-surgery-waiting-list-card` exits cleanly.
