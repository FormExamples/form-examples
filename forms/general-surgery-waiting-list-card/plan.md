# Plan: General Surgery Waiting List Card
...
months later. The General Surgery Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form general-surgery-waiting-list-card`.
