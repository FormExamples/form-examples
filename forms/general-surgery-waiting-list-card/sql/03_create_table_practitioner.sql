-- Practitioner who places the patient on a general surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a general surgery waiting list card on behalf of the patient.';
