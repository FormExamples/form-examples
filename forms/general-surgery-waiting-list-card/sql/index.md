# general-surgery-waiting-list-card — sql
...
- `gen_surgery_waiting_list_card` — top-level waiting list card.
- `gen_surgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `gen_surgery_waiting_list_card_grade` — computed grading result.
- `gen_surgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `gen_surgery_waiting_list_card_grade_flag` — safety / operational flags fired
