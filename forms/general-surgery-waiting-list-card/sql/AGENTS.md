# General Surgery Waiting List Card — PostgreSQL migrations
...
Child `gen_surgery_waiting_list_card_*` tables reference
`gen_surgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
