...
<svelte:head>
	<title>Neurodiversity Adjustment Review</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/neurodiversity-adjustment-review/" class="text-lg font-bold text-base-content">Neurodiversity Adjustment Review</a>
			<div class="flex items-center gap-1">
				<a href="/neurodiversity-adjustment-review/" class={navClass('/')}>Welcome</a>
				<a
					href="/neurodiversity-adjustment-review/neurodiversity-adjustment-reviews/new"
					class={navClass('/neurodiversity-adjustment-reviews/new')}>New review</a
				>
				<a
					href="/neurodiversity-adjustment-review/neurodiversity-adjustment-reviews"
					class={navClass('/neurodiversity-adjustment-reviews')}>Reviews</a
				>
