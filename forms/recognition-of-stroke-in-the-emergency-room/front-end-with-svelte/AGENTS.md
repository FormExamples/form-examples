...
for the ROSIER specification and scoring engine. Lily Svelte headless
conventions: [`../../AGENTS-front-end-svelte.md`](../../AGENTS-front-end-svelte.md).

## Layout

- `src/lib/engine/` — pure scoring engine (`types.ts`, `utils.ts`,
  `rosier-rules.ts`, `rosier-grader.ts`, `flagged-issues.ts`) + `rosier-grader.test.ts`.
...
- `src/routes/recognition-of-stroke-in-the-emergency-rooms/` — RESTful routes:
