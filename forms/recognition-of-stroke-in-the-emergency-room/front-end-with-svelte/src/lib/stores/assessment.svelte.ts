...
function storageKey(id: string): string {
	return `recognition-of-stroke-in-the-emergency-room.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank ROSIER assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the ROSIER assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.signs`) stay bound to live state.
	 */
