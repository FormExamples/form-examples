<script lang="ts">
	...
	import Step3BloodGlucose from '#lib/components/steps/Step3BloodGlucose.svelte';
	import Step4MimicExclusions from '#lib/components/steps/Step4MimicExclusions.svelte';
	import Step5NeurologicalSigns from '#lib/components/steps/Step5NeurologicalSigns.svelte';
	...
	function submit() {
		...
		assessment.result = calculateRosierGrade(assessment.data);
		goto(`/recognition-of-stroke-in-the-emergency-room/recognition-of-stroke-in-the-emergency-rooms/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New ROSIER assessment' : `ROSIER assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the six sections; the ROSIER score and band are computed on submit.
	</p>
	...
	<Form label="ROSIER assessment" onsubmit={submit}>
		<Step1Context />
		<Step2Identification />
		<Step3BloodGlucose />
		<Step4MimicExclusions />
		<Step5NeurologicalSigns />
		<Step6Summary />
