...
<svelte:head>
	<title>Recognition Of Stroke In the Emergency Room (ROSIER)</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/recognition-of-stroke-in-the-emergency-room/" class="text-lg font-bold text-base-content">ROSIER</a>
			<div class="flex items-center gap-1">
				<a href="/recognition-of-stroke-in-the-emergency-room/" class={navClass('/')}>Welcome</a>
				<a
					href="/recognition-of-stroke-in-the-emergency-room/recognition-of-stroke-in-the-emergency-rooms/new"
					class={navClass('/recognition-of-stroke-in-the-emergency-rooms/new')}>New assessment</a
				>
				<a
					href="/recognition-of-stroke-in-the-emergency-room/recognition-of-stroke-in-the-emergency-rooms"
					class={navClass('/recognition-of-stroke-in-the-emergency-rooms')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
