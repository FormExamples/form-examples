# Changelog — Recognition Of Stroke In the Emergency Room (ROSIER)
...
file only records changes scoped to the **Recognition Of Stroke In the Emergency Room (ROSIER)** form.
