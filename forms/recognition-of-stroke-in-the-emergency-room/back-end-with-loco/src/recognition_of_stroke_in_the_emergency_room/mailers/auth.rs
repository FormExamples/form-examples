...
static welcome: Dir<'_> = include_dir!("src/recognition_of_stroke_in_the_emergency_room/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/recognition_of_stroke_in_the_emergency_room/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/recognition_of_stroke_in_the_emergency_room/mailers/auth/magic_link");
