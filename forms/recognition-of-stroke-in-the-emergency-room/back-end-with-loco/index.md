...
Server-side Rust JSON API for the Recognition Of Stroke In the Emergency Room (ROSIER) form. Pure back-end: no HTML
rendering, no Tera templates, no HTMX, no Alpine.js, no CSS, no Lily
Design System.

The Loco crate lives in [`recognition_of_stroke_in_the_emergency_room/`](recognition_of_stroke_in_the_emergency_room/) — one migration, SeaORM
