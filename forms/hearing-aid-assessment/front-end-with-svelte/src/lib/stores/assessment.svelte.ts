...
function storageKey(id: string): string {
	return `hearing-aid-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank hearing aid assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the hearing aid assessment, with localStorage
