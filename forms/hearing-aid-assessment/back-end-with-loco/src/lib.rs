//! Hearing Aid Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Hearing Aid Assessment** medical form, built on the
...
//!
//! ```
//! use hearing_aid_assessment_loco_crate::engine::types::AssessmentData;
//!
