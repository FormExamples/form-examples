# Hearing Aid Assessment — specification
...
- `bin/test-form hearing-aid-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check hearing-aid-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `hearing-aid-assessment.front-end-form-with-html.v1` (HTML)
  - `hearing-aid-assessment.front-end-form-with-svelte.v1` (SvelteKit)
