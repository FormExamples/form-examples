...
- LocalStorage key `hearing-aid-assessment.front-end-form-with-html.v1` (HTML) and
  `hearing-aid-assessment.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
