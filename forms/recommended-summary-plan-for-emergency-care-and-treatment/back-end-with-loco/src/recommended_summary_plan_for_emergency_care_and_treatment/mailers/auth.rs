...
static welcome: Dir<'_> = include_dir!("src/recommended_summary_plan_for_emergency_care_and_treatment/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/recommended_summary_plan_for_emergency_care_and_treatment/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/recommended_summary_plan_for_emergency_care_and_treatment/mailers/auth/magic_link");
