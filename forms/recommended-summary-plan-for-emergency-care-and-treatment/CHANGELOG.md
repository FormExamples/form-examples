# Changelog — Recommended Summary Plan for Emergency Care and Treatment (ReSPECT)
...
file only records changes scoped to the **Recommended Summary Plan for Emergency Care and Treatment (ReSPECT)** form.
