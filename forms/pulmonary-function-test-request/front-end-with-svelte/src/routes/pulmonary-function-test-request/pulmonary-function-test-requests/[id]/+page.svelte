<script lang="ts">
	...
	import Step6SafetyScreen from '#lib/components/steps/Step6SafetyScreen.svelte';
	...
	function submit() {
		...
		goto(`/pulmonary-function-test-request/pulmonary-function-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New pulmonary function test request' : `Request ${id}`}
	</h1>
	...
	<Form label="Pulmonary function test request" onsubmit={submit}>
