<script lang="ts">
	...
	const plural = 'pulmonary-function-test-requests';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	<header class="mb-10">
		...
		<h1 class="mt-2 text-3xl font-bold text-base-content">
			Lung-function / spirometry test request
		</h1>
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/pulmonary-function-test-request/{plural}/new"
		...
		<a
			href="/pulmonary-function-test-request/{plural}"
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Aligned with NICE NG80 (asthma) and NG115 (COPD), the ARTP statement on pulmonary function
					testing, ERS/ATS spirometry standards, and forced-expiration / infection-control
