// Backend API client for the pulmonary function test vetting dashboard.
//
...
window.PulmonaryFunctionTestRequestDashboard.fetchRequests = fetchRequests;
window.PulmonaryFunctionTestRequestDashboard.API_BASE = API_BASE;
})();
