...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "pulmonary_function_test_requests",
            ...
            ("symptom_wheeze", ColType::BooleanWithDefault(false)),
            ("smoking_status", ColType::StringWithDefault(String::new())),
            ("current_inhalers", ColType::StringWithDefault(String::new())),
            ("recent_respiratory_infection", ColType::BooleanWithDefault(false)),
            ("recent_mi_or_eye_abdominal_surgery", ColType::BooleanWithDefault(false)),
            ("suspected_active_tuberculosis", ColType::BooleanWithDefault(false)),
