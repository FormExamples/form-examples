// Backend API client for the blood-test-request vetting dashboard.
//
...
window.BloodTestRequestDashboard.fetchRequests = fetchRequests;
window.BloodTestRequestDashboard.API_BASE = API_BASE;
})();
