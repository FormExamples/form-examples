...
export const steps: StepConfig[] = [
	...
	{ number: 3, title: 'Requested Panels', shortTitle: 'Panels' },
	{ number: 4, title: 'Clinical Context', shortTitle: 'Clinical' },
	{ number: 5, title: 'Pre-analytical and Specimen', shortTitle: 'Specimen' },
	{ number: 6, title: 'Patient Safety', shortTitle: 'Safety' },
