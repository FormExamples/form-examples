<script lang="ts">
	...
	import Step3RequestedPanels from '$lib/components/steps/Step3RequestedPanels.svelte';
	import Step4ClinicalContext from '$lib/components/steps/Step4ClinicalContext.svelte';
	import Step5PreanalyticalSpecimen from '$lib/components/steps/Step5PreanalyticalSpecimen.svelte';
	import Step6PatientSafety from '$lib/components/steps/Step6PatientSafety.svelte';
	...
	function submit() {
		...
		goto(`/blood-test-request/blood-test-requests/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New blood-test request' : `Blood-test request ${id}`}
	</h1>
	...
	<Form label="Blood test request" onsubmit={submit}>
		<Step1RequestingClinician />
		<Step2PatientIdentification />
		<Step3RequestedPanels />
		<Step4ClinicalContext />
		<Step5PreanalyticalSpecimen />
		<Step6PatientSafety />
