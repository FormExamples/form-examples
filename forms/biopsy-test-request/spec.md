# Biopsy Test Request — specification
...
- `bin/test-form biopsy-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check biopsy-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `biopsy-test-request.front-end-form-with-html.v1` (HTML)
  - `biopsy-test-request.front-end-form-with-svelte.v1` (SvelteKit)
