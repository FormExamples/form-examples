// Backend API client for the biopsy vetting dashboard.
//
...
window.BiopsyTestRequestDashboard.fetchRequests = fetchRequests;
window.BiopsyTestRequestDashboard.API_BASE = API_BASE;
})();
