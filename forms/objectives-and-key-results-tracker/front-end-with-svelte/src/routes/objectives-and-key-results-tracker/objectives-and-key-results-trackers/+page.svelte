<script lang="ts">
	...
	import { sampleObjectiveRows } from '#lib/data/sample-reports.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/objectives-and-key-results-tracker/objectives-and-key-results-trackers/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/objectives-and-key-results-tracker/objectives-and-key-results-trackers/new" class="button" data-variant="primary">New objective</a>
	</div>
