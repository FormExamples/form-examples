...
- LocalStorage key `objectives-and-key-results-tracker.front-end-form-with-html.v1` (HTML) and
  `objectives-and-key-results-tracker.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
