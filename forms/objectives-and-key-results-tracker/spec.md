# Objectives and Key Results tracker — specification
...
- `bin/test-form objectives-and-key-results-tracker` exits cleanly.
...
- `bin/lily-html-refactor --check objectives-and-key-results-tracker` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `objectives-and-key-results-tracker.front-end-form-with-html.v1` (HTML)
  - `objectives-and-key-results-tracker.front-end-form-with-svelte.v1` (SvelteKit)
