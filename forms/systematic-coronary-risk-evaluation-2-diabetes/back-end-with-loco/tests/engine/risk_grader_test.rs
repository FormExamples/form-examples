use score2_diabetes_loco_crate::engine::risk_grader::calculate_risk;
use score2_diabetes_loco_crate::engine::risk_rules::all_rules;
use score2_diabetes_loco_crate::engine::types::*;
