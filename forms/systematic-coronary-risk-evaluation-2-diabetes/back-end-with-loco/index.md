# Systematic Coronary Risk Evaluation 2 Diabetes: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the Systematic Coronary Risk Evaluation 2 Diabetes form. Pure back-end: no HTML
