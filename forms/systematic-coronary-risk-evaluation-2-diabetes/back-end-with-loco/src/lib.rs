//! Systematic Coronary Risk Evaluation 2 Diabetes — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Systematic Coronary Risk Evaluation 2 Diabetes** medical form, built on the
...
//!
//! ```
//! use score2_diabetes_loco_crate::engine::types::AssessmentData;
//!
