...
static welcome: Dir<'_> = include_dir!("src/systematic_coronary_risk_evaluation_2_diabetes/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/systematic_coronary_risk_evaluation_2_diabetes/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/systematic_coronary_risk_evaluation_2_diabetes/mailers/auth/magic_link");
