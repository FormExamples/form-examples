...
- LocalStorage keys preserve draft state across reloads:
  - `systematic-coronary-risk-evaluation-2-diabetes.front-end-with-html.v1` (HTML)
  - `systematic-coronary-risk-evaluation-2-diabetes.front-end-with-svelte.v1` (SvelteKit)
