...
- LocalStorage key `systematic-coronary-risk-evaluation-2-diabetes.front-end-form-with-html.v1` (HTML) and
  `systematic-coronary-risk-evaluation-2-diabetes.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
