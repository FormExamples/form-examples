...
- `bin/test-form systematic-coronary-risk-evaluation-2-diabetes` exits cleanly.
...
- `bin/lily-html-refactor --check systematic-coronary-risk-evaluation-2-diabetes` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `systematic-coronary-risk-evaluation-2-diabetes.front-end-form-with-html.v1` (HTML)
  - `systematic-coronary-risk-evaluation-2-diabetes.front-end-form-with-svelte.v1` (SvelteKit)
