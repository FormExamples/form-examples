...
function allRules() {
  return [
    ...
    // MEDIUM RISK rules
    {
      id: 'CVR-008',
      category: 'Blood Pressure',
      description: 'Elevated blood pressure (systolic 140-179 mmHg)',
      riskLevel: 'medium',
      evaluate: (d) =>
    ...
    },
    {
      id: 'CVR-009',
      category: 'Glycaemic Control',
      description: 'Above-target HbA1c (53-74 mmol/mol / 7-8.9%)',
      riskLevel: 'medium',
      evaluate: (d) => {
        const v = hba1cMmolMol(d);
...
/** Run every rule and return only those that fire. */
