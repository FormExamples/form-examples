...
<svelte:head>
	<title>SCORE2-Diabetes</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/systematic-coronary-risk-evaluation-2-diabetes/" class="text-lg font-bold text-base-content">SCORE2-Diabetes</a>
			<div class="flex items-center gap-1">
				<a href="/systematic-coronary-risk-evaluation-2-diabetes/" class={navClass('/')}>Welcome</a>
				<a href="/systematic-coronary-risk-evaluation-2-diabetes/{plural}/new" class={navClass(`/${plural}/new`)}>New assessment</a>
				<a href="/systematic-coronary-risk-evaluation-2-diabetes/{plural}" class={navClass(`/${plural}`)}>Dashboard</a>
				<LocaleChooser
					label="Language"
					class="ml-2"
