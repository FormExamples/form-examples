// Plain-JavaScript / JSDoc type definitions for the ABPM vetting dashboard.
//
...
/**
 * Appropriateness band emitted by the engine's Axis A (NICE NG136 1-9).
 * @typedef {'usually-appropriate' | 'may-be-appropriate' | 'usually-not-appropriate'} AppropriatenessBand
 */

/**
 * Oscillometric suitability band emitted by Axis B.
 * @typedef {'ok' | 'caution' | 'limited'} SuitabilityBand
 */

/**
 * Triage tier emitted by Axis D (severe-BP escalation).
 ...
 * @property {string} clinicBp        - Clinic BP "S/D" (e.g. "152/96")
 * @property {AppropriatenessBand} appropriatenessBand - Axis A band
 * @property {SuitabilityBand} suitabilityBand - Axis B suitability band
...
// before they read `window.AmbulatoryBloodPressureTestRequestDashboard`.
