// Backend API client for the ABPM vetting dashboard.
//
...
window.AmbulatoryBloodPressureTestRequestDashboard.fetchRequests = fetchRequests;
window.AmbulatoryBloodPressureTestRequestDashboard.API_BASE = API_BASE;
})();
