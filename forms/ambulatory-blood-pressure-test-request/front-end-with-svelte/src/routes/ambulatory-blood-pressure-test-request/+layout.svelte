...
<svelte:head>
	<title>Ambulatory Blood Pressure Test Request</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/ambulatory-blood-pressure-test-request/" class="text-lg font-bold text-base-content">ABPM Test Request</a>
			<div class="flex items-center gap-1">
				<a href="/ambulatory-blood-pressure-test-request/" class={navClass('/')}>Welcome</a>
				<a
					href="/ambulatory-blood-pressure-test-request/ambulatory-blood-pressure-test-requests/new"
					class={navClass('/ambulatory-blood-pressure-test-requests/new')}>New request</a
				>
				<a
					href="/ambulatory-blood-pressure-test-request/ambulatory-blood-pressure-test-requests"
					class={navClass('/ambulatory-blood-pressure-test-requests')}>Dashboard</a
				>
