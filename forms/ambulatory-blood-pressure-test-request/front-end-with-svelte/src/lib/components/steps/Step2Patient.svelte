...
<Fieldset legend="Patient identification">
	<p class="hint">Patient demographics. BMI informs cuff-sizing suitability.</p>
	...
	<Field label="Body mass index (kg/m²)" inputId="bodyMassIndex">
		<NumberInput id="bodyMassIndex" label="Body mass index" min={10} max={80} step={0.1} bind:value={d.bodyMassIndex} />
	</Field>
</Fieldset>
