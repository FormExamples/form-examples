// Backend API client for the SMR clinician dashboard.
//
...
window.StructuredMedicationReviewDashboard.fetchReviews = fetchReviews;
window.StructuredMedicationReviewDashboard.API_BASE = API_BASE;
})();
