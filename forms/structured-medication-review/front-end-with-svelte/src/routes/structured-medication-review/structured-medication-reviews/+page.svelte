<script lang="ts">
	...
	import { sampleReviewRows } from '#lib/data/sample-reports.js';
	import { reviewStatusLabel, burdenBandLabel, careSettingLabel } from '#lib/engine/utils.js';
