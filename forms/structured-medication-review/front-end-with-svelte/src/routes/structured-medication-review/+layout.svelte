...
<svelte:head>
	<title>Structured Medication Review</title>
...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/structured-medication-review/" class="text-lg font-bold text-base-content">Structured Medication Review</a>
			<div class="flex items-center gap-1">
				<a href="/structured-medication-review/" class={navClass('/')}>Welcome</a>
				<a
					href="/structured-medication-review/structured-medication-reviews/new"
					class={navClass('/structured-medication-reviews/new')}>New review</a
				>
				<a href="/structured-medication-review/structured-medication-reviews" class={navClass('/structured-medication-reviews')}
					>Dashboard</a
				>
