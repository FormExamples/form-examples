<script lang="ts">
	...
	function submit() {
		...
		goto(`/dental-assessment/dental-assessments/${id}/report`);
	}
...
<main class="mx-16 px-4 py-6">
	<h1 class="text-2xl font-bold text-base-content">
		{isNew ? 'New dental assessment' : `Dental assessment ${id}`}
	</h1>
	<p class="mt-1 text-sm text-base-content/70">
		Complete the nine sections; the DMFT score and caries-risk category are computed on submit.
	</p>
	...
	<Form label="Dental assessment" onsubmit={submit}>
		<Step1Demographics />
		<Step2ChiefComplaint />
		<Step3DentalHistory />
		<Step4DMFTAssessment />
