<script lang="ts">
	...
	// dashboard. The collection routes (`/dental-assessments` and
	// `/dental-assessments/new`) hold the actual functionality.
	const plural = 'dental-assessments';
</script>
...
<main class="mx-auto max-w-4xl px-4 py-12">
	...
	<div class="grid gap-4 sm:grid-cols-2">
		<a
			href="/dental-assessment/{plural}/new"
		...
		>
			...
			<p class="mt-2 text-sm text-base-content/70">
				Browse assessed patients with their computed DMFT score and caries-risk category, and filter
				by category and periodontal status.
			</p>
	...
	<section class="mt-12">
		...
		<dl class="mt-4 space-y-4 text-sm">
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Spec-driven: the living domain spec defines the data model, the DMFT grading engine, and
			...
			<div>
				...
				<dd class="mt-1 text-base-content/70">
					Uses the WHO DMFT (Decayed, Missing, Filled Teeth) Index for caries experience, with
					periodontal and radiographic findings to support the clinical picture.
				</dd>
			</div>
		</dl>
	</section>
