...
<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/dental-assessment/" class="text-lg font-bold text-base-content">Dental Assessment</a>
			<div class="flex items-center gap-1">
				<a href="/dental-assessment/" class={navClass('/')}>Welcome</a>
				<a href="/dental-assessment/dental-assessments/new" class={navClass('/dental-assessments/new')}>New assessment</a>
				<a href="/dental-assessment/dental-assessments" class={navClass('/dental-assessments')}>Dashboard</a>
