//! Dental Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Dental Assessment** medical form, built on the
...
//!
//! ```
//! use dental_assessment_loco_crate::engine::types::AssessmentData;
//!
