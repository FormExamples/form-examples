// Flagged-issue detection for the Dental Assessment. Independent of
// the DMFT score, this module raises clinician-facing flags for
// dental emergencies, anticoagulation, bisphosphonate use,
// severe anxiety, bleeding disorders, anaesthetic allergies, cardiac
// disease, poorly-controlled diabetes, head/neck radiation,
// immunosuppression, tooth mobility, active decay, and immunosuppressant
// medication use.
...
function detectAdditionalFlags(data) {
  ...
  // ─── Diabetes ───────────────────────────────────────────
  if (
    data.medicalHistory.diabetes === 'yes' &&
    data.medicalHistory.diabetesControlled === 'no'
  ) {
    flags.push({
  ...
  if (
    data.dmftAssessment.decayedTeeth !== null &&
    data.dmftAssessment.decayedTeeth >= 5
  ) {
    flags.push({
      id: 'FLAG-DECAY-001',
      category: 'Caries',
