# Dental Assessment — specification
...
- `bin/test-form dental-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check dental-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `dental-assessment.front-end-form-with-html.v1` (HTML)
  - `dental-assessment.front-end-form-with-svelte.v1` (SvelteKit)
