...
<svelte:head>
	<title>Medical Certificate of Cause of Death</title>
</svelte:head>

<div class="min-h-screen bg-base-200 text-base-content">
	<nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
		<div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
			<a href="/medical-certificate-of-cause-of-death/" class="text-lg font-bold text-base-content">MCCD</a>
			<div class="flex items-center gap-1">
				<a href="/medical-certificate-of-cause-of-death/" class={navClass('/')}>Welcome</a>
				<a
					href="/medical-certificate-of-cause-of-death/medical-certificates-of-cause-of-death/new"
					class={navClass('/medical-certificates-of-cause-of-death/new')}>New certificate</a
				>
				<a
					href="/medical-certificate-of-cause-of-death/medical-certificates-of-cause-of-death"
					class={navClass('/medical-certificates-of-cause-of-death')}>Dashboard</a
				>
				<LocaleChooser
					label="Language"
					class="ml-2"
