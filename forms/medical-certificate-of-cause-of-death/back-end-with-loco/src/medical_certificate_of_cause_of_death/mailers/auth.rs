...
static welcome: Dir<'_> = include_dir!("src/medical_certificate_of_cause_of_death/mailers/auth/welcome");
static forgot: Dir<'_> = include_dir!("src/medical_certificate_of_cause_of_death/mailers/auth/forgot");
static magic_link: Dir<'_> = include_dir!("src/medical_certificate_of_cause_of_death/mailers/auth/magic_link");
