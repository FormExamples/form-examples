//! Renal Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Renal Assessment** medical form, built on the
...
//!
//! ```
//! use renal_assessment_loco_crate::engine::types::AssessmentData;
//!
