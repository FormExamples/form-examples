# Renal Assessment — specification
...
- `bin/test-form renal-assessment` exits cleanly.
...
- `bin/lily-html-refactor --check renal-assessment` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `renal-assessment.front-end-form-with-html.v1` (HTML)
  - `renal-assessment.front-end-form-with-svelte.v1` (SvelteKit)
