...
function storageKey(id: string): string {
	return `renal-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank renal assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the renal assessment, with localStorage
