# Nerve Conduction Study Test Result — specification
...
- `bin/test-form nerve-conduction-study-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check nerve-conduction-study-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `nerve-conduction-study-test-result.front-end-with-html.v1` (HTML)
  - `nerve-conduction-study-test-result.front-end-with-svelte.v1` (SvelteKit)
