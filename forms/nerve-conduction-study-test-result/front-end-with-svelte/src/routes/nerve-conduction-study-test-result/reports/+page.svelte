...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-gray-900">Graded NCS / EMG reports</h1>
			<p class="mt-1 text-sm text-gray-600">
				Four-axis interpretation grades for completed nerve conduction study / EMG reports.
			</p>
		</div>
		<a href="/nerve-conduction-study-test-result/report" class="button" data-variant="primary">New report</a>
	</div>
		...
		<table class="w-full text-left text-sm">
			<thead class="border-b border-gray-200 bg-gray-50 text-gray-600">
				<tr>
					...
					<th class="px-4 py-3 font-semibold">Study type</th>
			...
			<tbody>
				{#each rows as r (r.id)}
					<tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50">
						...
						<td class="px-4 py-3 text-gray-700">{studyTypeLabel(r.studyType)}</td>
