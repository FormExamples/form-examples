<script lang="ts">
	...
	import Step2StudyDetails from '$lib/components/steps/Step2StudyDetails.svelte';
	...
	import Step5Characterisation from '$lib/components/steps/Step5Characterisation.svelte';
	...
	function validate(): boolean {
		...
		if (d.region === '') {
			found.push({ id: 'region', message: 'Region is required.' });
		}
	...
	function submit() {
		...
		goto('/nerve-conduction-study-test-result/report/view');
	}
...
<main class="mx-auto max-w-3xl px-4 py-6">
	<header class="mb-6 no-print">
		<h1 class="text-2xl font-bold text-gray-900">New NCS / EMG report</h1>
	...
	<Form label="Nerve conduction study test result" onsubmit={submit}>
		<Step1ReportIdentification />
		<Step2StudyDetails />
		<Step3ClinicalHistory />
		<Step4Findings />
		<Step5Characterisation />
		<Step6Impression />
