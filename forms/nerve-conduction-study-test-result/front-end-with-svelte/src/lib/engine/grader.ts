...
/**
 * Pure four-axis interpretation engine for a nerve conduction study / EMG result.
 *
 * Computes:
 ...
 */
export function calculateGrade(result: NerveConductionStudyResult): GradingResult {
