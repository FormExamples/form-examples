...
// endpoint returns a `DashboardReportsResponse`. When the fetch fails (CORS,
...
window.NerveConductionStudyTestResultDashboard.fetchReports = fetchReports;
window.NerveConductionStudyTestResultDashboard.API_BASE = API_BASE;
})();
