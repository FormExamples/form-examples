 ...
 * `forms/nerve-conduction-study-test-result/front-end-with-svelte/src/lib/engine/types.ts`.
 *
 * @typedef {Object} ReportRow
 * @property {string} id                                    - report identifier
 * @property {string} patientName                           - patient display name
 * @property {StudyType} studyType                          - performed study type
...
// namespace, `window.NerveConductionStudyTestResultDashboard`.
(function () {
'use strict';
...
// before they read `window.NerveConductionStudyTestResultDashboard`.
})();
