use neurology_assessment_loco_crate::engine::neurology_grader::calculate_severity;
use neurology_assessment_loco_crate::engine::neurology_rules::all_rules;
use neurology_assessment_loco_crate::engine::types::*;
