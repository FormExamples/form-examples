//! Neurology Assessment — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Neurology Assessment** medical form, built on the
...
//!
//! ```
//! use neurology_assessment_loco_crate::engine::types::AssessmentData;
//!
