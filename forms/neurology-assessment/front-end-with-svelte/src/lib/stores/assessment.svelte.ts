...
function storageKey(id: string): string {
	return `neurology-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank neurology assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the neurology assessment, with localStorage
