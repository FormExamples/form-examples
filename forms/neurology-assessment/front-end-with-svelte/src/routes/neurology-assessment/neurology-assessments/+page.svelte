<script lang="ts">
	...
	const rows = $derived(sampleAssessmentRows.filter((r) => (severityFilter === '' || band(r.nihssScore) === severityFilter) && (anticoagFilter === '' || anticoagFilter === 'yes' === r.anticoagulantFlag)));
