...
/**
 * Total qSOFA score — integer 0-3, or null when not yet scored.
 *
 * @typedef {0 | 1 | 2 | 3 | null} QsofaScore
 */
 ...
 * `forms/quick-sequential-organ-failure-assessment/front-end-with-svelte/src/lib/types.ts`.
 *
 ...
 * @property {QsofaScore} qsofaScore     - total qSOFA score (0-3) or null
 * @property {RiskBand} riskBand         - derived risk band
 * @property {boolean} escalationFlag    - true when qSOFA >= 2 (sepsis escalation)
...
// namespace, `window.QuickSequentialOrganFailureAssessmentDashboard`.

// No runtime exports; types are JSDoc-only. Touch the namespace so this file
// is unambiguously side-effecting and other files can rely on it loading
// before they read `window.QuickSequentialOrganFailureAssessmentDashboard`.
