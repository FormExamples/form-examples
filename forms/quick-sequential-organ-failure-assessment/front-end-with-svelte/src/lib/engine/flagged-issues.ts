 ...
 *
 * Rows mirror the `quick_sequential_organ_failure_assessment_grade_flag` SQL
 * table (flag_id, category, priority, description, suggested_action).
 */
export function detectFlaggedIssues(data: AssessmentData, qsofaScore: number): FlaggedIssue[] {
