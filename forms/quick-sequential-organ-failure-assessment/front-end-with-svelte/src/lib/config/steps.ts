...
export const steps: StepConfig[] = [
	...
	{ number: 3, title: 'Respiratory rate', shortTitle: 'Respiratory', section: 'respiratory' },
	{ number: 4, title: 'Mentation', shortTitle: 'Mentation', section: 'mentation' },
	{ number: 5, title: 'Systolic blood pressure', shortTitle: 'Systolic BP', section: 'circulation' },
	{ number: 6, title: 'Summary and score', shortTitle: 'Summary', section: 'note' }
];

export function getVisibleSteps(_data: AssessmentData): StepConfig[] {
	// All steps are always visible in the qSOFA assessment.
	return steps;
}
