...
function storageKey(id: string): string {
	return `quick-sequential-organ-failure-assessment.front-end-with-svelte.${id || 'new'}.v1`;
}

/** A blank qSOFA assessment with all fields at their unanswered defaults. */
...
/**
 * Svelte 5 reactive store for the qSOFA assessment, with localStorage
...
class AssessmentStore {
	 ...
	 * (e.g. `const d = assessment.data.respiratory`) stay bound to live state.
	 */
