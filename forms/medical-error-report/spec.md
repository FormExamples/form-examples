# Medical Error Report — specification
...
- `bin/test-form medical-error-report` exits cleanly.
...
- `bin/lily-html-refactor --check medical-error-report` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `medical-error-report.front-end-form-with-html.v1` (HTML)
  - `medical-error-report.front-end-form-with-svelte.v1` (SvelteKit)
