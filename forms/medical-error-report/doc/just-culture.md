...
- **Chartered Institute of Ergonomics and Human Factors (CIEHF).**
  *Human Factors in Healthcare.*
  <https://www.ergonomics.org.uk/Public/Resources/Publications/Human_Factors_in_Healthcare.aspx>
- **NHS Improvement.** *Patient Safety Strategy — A safety culture:
  Programme A.* 2019.
  <https://www.england.nhs.uk/patient-safety/the-nhs-patient-safety-strategy/>

## Root cause analysis methods

The *Root Cause Analysis* step uses any of the following methods.
Document the chosen method on the form.

- **5 Whys.** Simple sequential causal chain.
- **Ishikawa (fishbone) diagram.** Categorical cause grouping —
  typically *people, methods, machines, materials, environment,
  measurement* in healthcare.
- **PRISMA-Medical.** Prevention and Recovery Information System for
  Monitoring and Analysis.
- **AcciMap.** Sociotechnical-system accident analysis (Rasmussen).
- **TRIPOD-Delta.** Latent failure analysis.

NHS England's PSIRF moves the recommended method away from formal RCA
toward *Patient Safety Incident Investigation* (PSII) and *After
Action Review* (AAR); see the PSIRF documentation cited in
`reporting-pathways.md`.

## Reporting on near-misses and good catches

The form's NCC MERP **Category A** (capacity to cause error) and
