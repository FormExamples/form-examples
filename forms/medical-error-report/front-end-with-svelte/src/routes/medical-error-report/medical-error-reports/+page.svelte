<script lang="ts">
	...
	import { whoSeverityLabel, riskLevelLabel, errorTypeLabel } from '#lib/engine/utils.js';
	...
	function init(api: any) {
		...
		api.on('select-row', (ev: { id?: string | number }) => {
			if (ev?.id != null) goto(`/medical-error-report/medical-error-reports/${ev.id}`);
		});
	}
</script>
...
<main class="mx-16 px-4 py-6">
	<div class="mb-6 flex flex-wrap items-end justify-between gap-4">
		...
		<a href="/medical-error-report/medical-error-reports/new" class="button" data-variant="primary">New report</a>
	</div>
