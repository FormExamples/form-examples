//! Medical Error Report — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Medical Error Report** medical form, built on the
...
//!
//! ```
//! use medical_error_report_loco_crate::engine::types::AssessmentData;
//!
