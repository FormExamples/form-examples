...
impl ActiveModel {
    /// Create a new in-progress report with empty data.
...
/// List all completed reports (those with a grading result).
...
/// List reports with pagination (page is 0-indexed, per_page items each).
