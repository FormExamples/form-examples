# Genetic Test Request — specification
...
- `bin/test-form genetic-test-request` exits cleanly.
...
- `bin/lily-html-refactor --check genetic-test-request` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `genetic-test-request.front-end-form-with-html.v1` (HTML)
  - `genetic-test-request.front-end-form-with-svelte.v1` (SvelteKit)
