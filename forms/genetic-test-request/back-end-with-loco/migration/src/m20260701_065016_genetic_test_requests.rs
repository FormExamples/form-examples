...
impl MigrationTrait for Migration {
    async fn up(&self, m: &SchemaManager) -> Result<(), DbErr> {
        create_table(m, "genetic_test_requests",
            ...
            ("family_history", ColType::StringWithDefault(String::new())),
            ("suspected_condition", ColType::StringWithDefault(String::new())),
            ("consent_obtained", ColType::BooleanWithDefault(false)),
            ("genetic_counselling_offered", ColType::BooleanWithDefault(false)),
            ("affected_relative_tested", ColType::BooleanWithDefault(false)),
