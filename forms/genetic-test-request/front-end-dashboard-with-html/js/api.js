// Backend API client for the genetic test request vetting dashboard.
//
...
window.GeneticTestRequestDashboard.fetchRequests = fetchRequests;
window.GeneticTestRequestDashboard.API_BASE = API_BASE;
})();
