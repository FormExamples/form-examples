# Otorhinolaryngology Waiting List Card — specification
...
otorhinolaryngology waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form otorhinolaryngology-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check otorhinolaryngology-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `otorhinolaryngology-waiting-list-card.front-end-with-html.v1` (HTML)
  - `otorhinolaryngology-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
