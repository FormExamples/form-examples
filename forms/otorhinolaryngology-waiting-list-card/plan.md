# Plan: Otorhinolaryngology Waiting List Card
...
months later. The Otorhinolaryngology Waiting List Card gives the patient a single
...
15. [ ] Run `bin/test-form otorhinolaryngology-waiting-list-card`.
