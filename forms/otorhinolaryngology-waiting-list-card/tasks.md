# Tasks: Otorhinolaryngology Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/otorhinolaryngology-waiting-list-card/`.
...
- [x] `cargo loco new otorhinolaryngology-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form otorhinolaryngology-waiting-list-card` exits cleanly.
