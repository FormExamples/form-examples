-- Practitioner who places the patient on a otorhinolaryngology waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a otorhinolaryngology waiting list card on behalf of the patient.';
