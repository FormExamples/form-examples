# otorhinolaryngology-waiting-list-card — sql
...
- `ent_waiting_list_card` — top-level waiting list card.
- `ent_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `ent_waiting_list_card_grade` — computed grading result.
- `ent_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `ent_waiting_list_card_grade_flag` — safety / operational flags fired
