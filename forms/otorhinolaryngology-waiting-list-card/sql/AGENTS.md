# Otorhinolaryngology Waiting List Card — PostgreSQL migrations
...
Child `ent_waiting_list_card_*` tables reference
`ent_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
