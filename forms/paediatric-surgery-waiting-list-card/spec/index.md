# Paediatric Surgery Waiting List Card — specification
...
paediatric surgery waiting list and gives the patient a transparent, easy-to-use view of
...
- `bin/test-form paediatric-surgery-waiting-list-card` exits cleanly.
...
- `bin/lily-html-refactor --check paediatric-surgery-waiting-list-card` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `paediatric-surgery-waiting-list-card.front-end-with-html.v1` (HTML)
  - `paediatric-surgery-waiting-list-card.front-end-with-svelte.v1` (SvelteKit)
