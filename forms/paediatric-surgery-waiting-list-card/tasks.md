# Tasks: Paediatric Surgery Waiting List Card

## Scaffolding
- [x] Existing scaffold under `forms/paediatric-surgery-waiting-list-card/`.
...
- [x] `cargo loco new paediatric-surgery-waiting-list-card`.
- [x] Run the generated scaffold script.
- [x] Pure scoring engine ported from TypeScript.

## Verify
- [x] `bin/test-form paediatric-surgery-waiting-list-card` exits cleanly.
