# paediatric-surgery-waiting-list-card — sql
...
- `paeds_surgery_waiting_list_card` — top-level waiting list card.
- `paeds_surgery_waiting_list_card_appointment` — scheduled / upcoming appointments
  attached to the card.
- `paeds_surgery_waiting_list_card_grade` — computed grading result.
- `paeds_surgery_waiting_list_card_grade_rule` — audit trail of fired grading rules.
- `paeds_surgery_waiting_list_card_grade_flag` — safety / operational flags fired
