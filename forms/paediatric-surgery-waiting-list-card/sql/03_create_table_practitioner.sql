-- Practitioner who places the patient on a paediatric surgery waiting list.
...
COMMENT ON TABLE practitioner IS
    'Practitioner who completes a paediatric surgery waiting list card on behalf of the patient.';
