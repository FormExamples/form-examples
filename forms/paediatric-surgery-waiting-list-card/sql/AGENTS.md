# Paediatric Surgery Waiting List Card — PostgreSQL migrations
...
Child `paeds_surgery_waiting_list_card_*` tables reference
`paeds_surgery_waiting_list_card(id) ON DELETE CASCADE`. The grade child uses a
