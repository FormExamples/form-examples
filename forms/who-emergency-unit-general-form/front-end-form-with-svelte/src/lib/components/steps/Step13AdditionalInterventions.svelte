...
>
	<h3 class="mb-2 text-base font-semibold text-gray-800">Fluids and medications given</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-gray-800">Procedures</h3>
	<p class="mb-3 text-xs text-gray-500">Record time and outcome for each procedure performed.</p>
