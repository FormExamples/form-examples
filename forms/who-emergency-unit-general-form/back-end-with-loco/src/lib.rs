//! Who Emergency Unit General Form — Loco JSON API back-end.
//!
//! Server-side JSON API for the **Who Emergency Unit General Form** medical form, built on the
...
//!
//! ```
//! use who_emergency_unit_general_form_loco_crate::engine::types::AssessmentData;
//!
