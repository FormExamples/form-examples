# WHO Emergency Unit General Form: Back-end with Rust Axum Loco (JSON API)

Server-side Rust JSON API for the WHO Emergency Unit General Form form. Pure back-end: no HTML
