...
<div class="min-h-screen bg-base-200 text-base-content">
    <nav class="border-b border-base-300 bg-base-100 shadow-sm no-print">
        ...
        >
            <a
                href="/who-emergency-unit-general-form/"
                class="text-lg font-bold text-base-content"
                >WHO Emergency Unit General Form</a
            >
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    class={navClass("/who-emergency-unit-general-forms/new")}
                    >New encounter</a
                >
                <a
                    href="/who-emergency-unit-general-form/who-emergency-unit-general-forms"
                    class={navClass("/who-emergency-unit-general-forms")}
                    >Dashboard</a
                >
                <LocalePicker
                    label="Language"
