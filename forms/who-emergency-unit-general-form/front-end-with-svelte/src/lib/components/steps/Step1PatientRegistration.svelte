...
>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Emergency system timestamps</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Background &amp; identifiers</h3>
	...
	<h3 class="mt-6 mb-2 text-base font-semibold text-base-content">Status</h3>
	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
