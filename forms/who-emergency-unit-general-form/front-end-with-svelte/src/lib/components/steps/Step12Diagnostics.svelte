...
>
	<h3 class="mb-2 text-base font-semibold text-base-content">CBC (complete blood count)</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Lytes / Cr / glucose</h3>
	<div class="grid grid-cols-2 gap-x-4 sm:grid-cols-4">
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Rapid tests</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Urine dip</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">ECG</h3>
