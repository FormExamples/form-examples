...
>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Reproductive history</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Vaccinations</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Substance use</h3>
	...
	<h3 class="mt-4 mb-2 text-base font-semibold text-base-content">Past medical conditions</h3>
