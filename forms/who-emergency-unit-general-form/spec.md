...
- LocalStorage key `who-emergency-unit-general-form.front-end-form-with-html.v1` (HTML) and
  `who-emergency-unit-general-form.front-end-form-with-svelte.v1` (SvelteKit) preserve draft
