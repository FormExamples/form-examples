# WHO Emergency Unit Form: General — specification
...
- `bin/test-form who-emergency-unit-general-form` exits cleanly.
...
- `bin/lily-html-refactor --check who-emergency-unit-general-form` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `who-emergency-unit-general-form.front-end-form-with-html.v1` (HTML)
  - `who-emergency-unit-general-form.front-end-form-with-svelte.v1` (SvelteKit)
