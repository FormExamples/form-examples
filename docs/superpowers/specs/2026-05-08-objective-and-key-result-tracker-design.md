# Objective and Key Result tracker — design spec

**Date:** 2026-05-08
**Slug:** `objective-and-key-result-tracker`
**Form directory:** `forms/objective-and-key-result-tracker/`
**Status:** Draft, pending implementation plan

## 1. Overview

A general-purpose Objective and Key Result (OKR) tracker that adapts the
...
`forms/objective-and-key-result-tracker/sql-migrations/`. Most fields are
